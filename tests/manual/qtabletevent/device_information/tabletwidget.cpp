...
name|QString
argument_list|(
literal|"High res global position: %1 %2"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|QString
argument_list|(
literal|"Buttons currently pressed: %1 (0x%2)"
argument_list|)
operator|.
name|arg
argument_list|(
