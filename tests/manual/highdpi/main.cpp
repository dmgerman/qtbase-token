...
argument_list|)
decl_stmt|;
comment|//    layout->addWidget(label1x); //expected low-res on high-dpi displays
name|layout
operator|->
name|addWidget
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//    layout->addWidget(labelIcon);
comment|//    layout->addWidget(labelLarge); // expected large size and low-res
name|setLayout
argument_list|(
name|layout
argument_list|)
...
name|pixmapPainter
decl_stmt|;
comment|//  Enable for lots of pixmap drawing
name|pixmapPainter
operator|.
name|show
argument_list|()
