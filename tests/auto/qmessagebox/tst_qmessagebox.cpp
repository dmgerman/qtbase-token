...
name|ret
decl_stmt|;
comment|// binary compat tests for< 4.2
name|keyToSend
operator|=
name|Qt
operator|::
...
directive|if
literal|0
block|keyToSend = Qt::Key_Escape;     sendKeySoon();     ret = QMessageBox::information(0, "title", "text", Old_Yes, Old_No | Old_Default, 0);     QCOMPARE(ret, -1);     QCOMPARE(keyToSend, -1);
endif|#
directive|endif
name|keyToSend
operator|=
...
directive|ifdef
name|QT3_SUPPORT
comment|//test QT3_SUPPORT stuff
name|QMessageBox
name|mb4
argument_list|(
literal|"title"
