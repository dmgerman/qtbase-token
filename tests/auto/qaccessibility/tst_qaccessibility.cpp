...
block|QPushButton menuButton("Menu",&window);     Q3PopupMenu buttonMenu(&menuButton);     buttonMenu.insertItem("Some item");     menuButton.setPopup(&buttonMenu);
comment|// menu toolbutton
block|QToolButton menuToolButton(&window);     menuToolButton.setText("Menu Tool");     Q3PopupMenu toolMenu(&menuToolButton);     toolMenu.insertItem("Some item");     menuToolButton.setPopup(&toolMenu);     menuToolButton.setMinimumSize(20,20);
comment|// splitted menu toolbutton
block|QToolButton splitToolButton(&window);     splitToolButton.setTextLabel("Split Tool");     Q3PopupMenu splitMenu(&splitToolButton);     splitMenu.insertItem("Some item");     splitToolButton.setPopup(&splitMenu);     splitToolButton.setPopupDelay(0);     splitToolButton.setMinimumSize(20,20);
endif|#
directive|endif
...
argument_list|)
expr_stmt|;
comment|// the text will be empty since it is not visible
name|QCOMPARE
argument_list|(
name|stackChild2Interface
operator|->
