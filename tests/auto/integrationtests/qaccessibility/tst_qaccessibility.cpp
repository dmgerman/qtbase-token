...
argument_list|)
expr_stmt|;
comment|//    QCOMPARE(test->actionText(1, QAccessible::Name, 0), QString());
comment|//    QCOMPARE(test->actionText(0, QAccessible::Name, 1), QString());
comment|//    QCOMPARE(test->actionText(1, QAccessible::Name, 1), QString());
comment|//    QCOMPARE(test->actionText(QAccessible::SetFocus, QAccessible::Name, -1), QString());
comment|//    QCOMPARE(test->actionText(QAccessible::DefaultAction, QAccessible::Name, 0), QString("SetFocus"));
comment|//    QCOMPARE(test->actionText(QAccessible::SetFocus, QAccessible::Name, 0), QString("SetFocus"));
operator|delete
name|test
expr_stmt|;
operator|delete
