...
directive|if
literal|0
block|QFETCH(QString, indexMethod);     QGraphicsSceneIndex *index = createIndex(indexMethod);      QGraphicsScene scene;     scene.setSceneIndex(index);      scene.addRect(0, 0, 30, 40);     QCOMPARE(scene.items(QRectF(0, 0, 10, 10)).count(), 1);
endif|#
directive|endif
block|}
end_function
...
directive|ifdef
name|Q_CC_RVCT
comment|//using keyword doesn't change visibility to public in RVCT2.2 compiler
specifier|inline
name|int
name|receivers
parameter_list|(
