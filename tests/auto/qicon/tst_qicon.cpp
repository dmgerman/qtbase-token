...
function_decl|;
name|void
name|task239461_custom_iconengine_crash
parameter_list|()
function_decl|;
private|private:
...
block|}
block|{
comment|// checks that there are no availableSizes for scalable images.
name|QIcon
name|icon
argument_list|(
literal|"heart.svg"
...
block|}
block|{
comment|// even if an a scalable image contain added pixmaps,
comment|// availableSizes still should be empty.
name|QIcon
name|icon
argument_list|(
literal|"heart.svg"
...
end_function
begin_comment
comment|// During detach, v2 engines are cloned, while v1 engines are only
end_comment
begin_comment
comment|// passed on, so v1 engines need to be referenced counted. This test
end_comment
begin_comment
comment|// verifies that the engine is destroyed once and only once.
end_comment
begin_class
