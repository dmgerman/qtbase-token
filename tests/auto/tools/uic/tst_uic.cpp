...
end_function
begin_comment
comment|// Helpers to generate a diff using the standard diff tool if present for failures.
end_comment
begin_function
...
name|QLatin1String
argument_list|(
literal|"/translation/Dialog_without_Buttons_tr.h"
argument_list|)
decl_stmt|;
name|process
operator|.
...
name|filePath
argument_list|(
literal|"Dialog_without_Buttons.ui"
argument_list|)
argument_list|)
operator|<<
name|QString
