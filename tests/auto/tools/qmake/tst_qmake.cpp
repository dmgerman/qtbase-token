...
name|QSKIP
argument_list|(
literal|"Test for C++11 raw strings depends on compiler support for them"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
literal|"/.rcc/"
name|DIR_INFIX
literal|"qmake_qmake_immediate.qrc"
argument_list|)
decl_stmt|;
name|QVERIFY
argument_list|(
