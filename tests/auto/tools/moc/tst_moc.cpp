...
include|#
directive|include
file|"related-metaobjects-in-namespaces.h"
end_include
begin_include
include|#
directive|include
file|"related-metaobjects-in-gadget.h"
end_include
begin_include
include|#
directive|include
file|"related-metaobjects-name-conflict.h"
end_include
begin_include
include|#
directive|include
file|"non-gadget-parent-class.h"
end_include
begin_include
include|#
directive|include
file|"grand-parent-gadget-class.h"
end_include
begin_expr_stmt
...
end_decl_stmt
begin_comment
comment|// Force the compiler to use the constructor
end_comment
begin_struct
struct|struct
name|MyStruct
...
function_decl|;
name|void
name|specifyMetaTagsFromCmdline
parameter_list|()
function_decl|;
name|void
name|invokable
...
function_decl|;
name|void
name|writeEnumFromUnrelatedClass
parameter_list|()
function_decl|;
name|void
name|relatedMetaObjectsWithinNamespaces
parameter_list|()
function_decl|;
name|void
name|relatedMetaObjectsInGadget
parameter_list|()
function_decl|;
name|void
name|relatedMetaObjectsNameConflict_data
parameter_list|()
function_decl|;
name|void
name|relatedMetaObjectsNameConflict
parameter_list|()
function_decl|;
name|void
name|strignLiteralsInMacroExtension
parameter_list|()
function_decl|;
name|void
name|unnamedNamespaceObjectsAndGadgets
parameter_list|()
function_decl|;
name|void
name|veryLongStringData
parameter_list|()
function_decl|;
name|void
name|gadgetHierarchy
parameter_list|()
function_decl|;
name|void
name|optionsFileError_data
parameter_list|()
function_decl|;
name|void
name|optionsFileError
parameter_list|()
function_decl|;
signals|signals:
name|void
...
end_function
begin_comment
comment|// tst_Moc::specifyMetaTagsFromCmdline()
end_comment
begin_comment
comment|// plugin_metadata.h contains a plugin which we register here. Since we're not building this
end_comment
begin_comment
comment|// application as a plugin, we need top copy some of the initializer code found in qplugin.h:
end_comment
begin_extern
extern|extern
literal|"C"
...
name|QLatin1String
argument_list|(
literal|"test.meta.tags"
argument_list|)
condition|)
block|{
specifier|const
name|QJsonArray
name|metaTagsUriList
init|=
name|plugin
operator|.
name|metaData
...
argument_list|)
expr_stmt|;
comment|// The following uri-s are set in the pro file using
comment|// -Muri=com.company.app -Muri=com.company.app.private
name|QCOMPARE
argument_list|(
name|metaTagsUriList
index|[
...
name|QLatin1String
argument_list|(
literal|"com.company.app.private"
argument_list|)
argument_list|)
expr_stmt|;
return|return;
...
name|QFAIL
argument_list|(
literal|"Could not find plugin with IID 'test.meta.tags'"
argument_list|)
expr_stmt|;
block|}
end_function
...
name|indexOfSlot
argument_list|(
literal|"doSomethingElse(QSharedPointer<QVarLengthArray<QString,(16>>2)>>)"
argument_list|)
operator|!=
operator|-
literal|1
...
name|indexOfSlot
argument_list|(
literal|"performSomething(QVector<QList<QString>>,QHash<int,QVector<QString>>)"
argument_list|)
operator|!=
operator|-
literal|1
...
name|indexOfSignal
argument_list|(
literal|"cmdlineSignal(QMap<int,int>)"
argument_list|)
expr_stmt|;
name|QVERIFY
argument_list|(
...
name|relatedMetaObjects
decl_stmt|;
comment|// the related objects should be empty because the enums is in the same object.
name|QVERIFY
argument_list|(
operator|!
name|objects
...
end_class
begin_comment
comment|// The presence of this macro used to confuse moc and prevent
end_comment
begin_comment
comment|// UnrelatedClass from being listed in the related meta objects.
end_comment
begin_macro
name|Q_DECLARE_METATYPE
argument_list|(
argument|UnrelatedClass::UnrelatedEnum
argument_list|)
end_macro
begin_class
...
name|newRow
argument_list|(
literal|"N1::dependingObject"
argument_list|)
operator|<<
operator|&
name|NS1
operator|::
name|DependingObject
operator|::
name|staticMetaObject
operator|<<
operator|(
...
name|newRow
argument_list|(
literal|"N1::dependingNestedObject"
argument_list|)
operator|<<
operator|&
name|NS1
operator|::
name|DependingNestedObject
operator|::
name|staticMetaObject
operator|<<
operator|(
...
name|newRow
argument_list|(
literal|"N2::dependingNestedObject"
argument_list|)
operator|<<
operator|&
name|NS2
...
name|newRow
argument_list|(
literal|"N1::dependingNestedGadget"
argument_list|)
operator|<<
operator|&
name|NS1
operator|::
name|DependingNestedGadget
operator|::
name|staticMetaObject
operator|<<
operator|(
...
name|newRow
argument_list|(
literal|"N2::dependingNestedGadget"
argument_list|)
operator|<<
operator|&
name|NS2
...
argument_list|)
expr_stmt|;
comment|// load all specified metaobjects int a set
name|QSet
argument_list|<
specifier|const
name|QMetaObject
...
expr_stmt|;
block|}
comment|// check if all required metaobjects are specified
foreach|foreach
control|(
specifier|const
name|QMetaObject
...
argument_list|)
expr_stmt|;
comment|// check if no additional metaobjects ara specified
name|QCOMPARE
argument_list|(
name|dependency
operator|.
...
class|class
name|StringLiteralsInMacroExtension
super|:
specifier|public
name|QObject
block|{
...
name|V
parameter_list|)
value|repeat1024(V) repeat1024(V)
...
name|V
parameter_list|)
value|repeat2048(V) repeat2048(V)
...
name|V
parameter_list|)
value|repeat4096(V) repeat4096(V)
...
name|V
parameter_list|)
value|repeat8192(V) repeat8192(V)
...
name|V
parameter_list|)
value|repeat16384(V) repeat16384(V)
...
name|V
parameter_list|)
value|repeat32768(V) repeat16384(V) repeat8192(V) repeat4096(V) repeat2048(V) repeat1024(V) repeat512(V) repeat256(V) repeat128(V) repeat64(V) repeat32(V) repeat16(V) repeat8(V) repeat4(V) repeat2(V)
name|Q_CLASSINFO
argument_list|(
name|repeat65534
argument_list|(
...
parameter_list|()
block|{
comment|// these just test very basic functionality of gadgets and objects
comment|// defined in unnamed namespaces.
block|{
name|GadgetInUnnamedNS
name|gadget
argument_list|(
