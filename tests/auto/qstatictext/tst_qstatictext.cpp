...
end_endif
begin_endif
unit|if (!supportsTransformations())       QEXPECT_FAIL("", "Graphics system does not support transformed text on this platform", Abort);     QCOMPARE(imageDrawStaticText, imageDrawText); }
endif|#
directive|endif
end_endif
begin_function
