...
name|int
name|mousePressStateBefore
decl_stmt|;
DECL|member|mousePressStateAfter
name|int
name|mousePressStateAfter
decl_stmt|;
endif|#
directive|endif
...
name|int
name|mouseReleaseStateBefore
decl_stmt|;
DECL|member|mouseReleaseStateAfter
name|int
name|mouseReleaseStateAfter
decl_stmt|;
endif|#
directive|endif
...
directive|else
comment|// make sure the state() and stateAfter() functions return the
comment|// same thing they did in Qt 3 when using these constructors
block|{
name|QMouseEvent
name|e
argument_list|(
