...
name|QSKIP
argument_list|(
literal|"Qt does not support reading the \""
operator|+
name|format
operator|+
literal|"\" format"
...
directive|endif
comment|// !QTEST_HAVE_SVG
name|QSKIP
argument_list|(
operator|(
literal|"Qt does not support the "
operator|+
name|format
operator|+
literal|" format."
...
name|defined
name|QTEST_HAVE_GIF
comment|//    QTest::newRow("gif-1")<< QString("images/earth.gif")<< QByteArray("gif");
comment|//    QTest::newRow("gif-2")<< QString("images/trolltech.gif")<< QByteArray("gif");
endif|#
directive|endif
name|QTest
operator|::
...
argument_list|)
expr_stmt|;
comment|//    QTest::newRow("mng-1")<< QString("images/ball.mng")<< QByteArray("mng");
comment|//    QTest::newRow("mng-2")<< QString("images/fire.mng")<< QByteArray("mng");
if|#
directive|if
name|defined
name|QTEST_HAVE_SVG
...
name|QString
argument_list|(
literal|"Skipping %1; no %2 support"
argument_list|)
operator|.
name|arg
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//    QTest::newRow("corrupt.xbm")<< QString("corrupt.xbm")<< QByteArray("xbm")<< QSize(0, 0);
name|QTest
operator|::
name|newRow
argument_list|(
