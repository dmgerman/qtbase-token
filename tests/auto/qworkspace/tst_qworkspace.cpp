...
name|QSKIP
argument_list|(
literal|"Until QTest::keyPress() sends the events via the OS, this will skip"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
comment|// See #13987 for details of bug report related to this
name|QMainWindow
name|mw
argument_list|(
literal|0
...
argument_list|)
decl_stmt|;
comment|// The popup menu has to have no parent, this is vital in the
comment|// original case of reproducing the bug
name|Q3PopupMenu
modifier|*
name|popup
init|=
...
argument_list|)
expr_stmt|;
comment|// Check the popup menu did appear to be sure
name|QVERIFY
argument_list|(
name|qApp
operator|->
...
argument_list|)
expr_stmt|;
comment|// Check we did actually cause the popup menu to be closed
name|QVERIFY
argument_list|(
operator|!
name|popup
...
argument_list|)
expr_stmt|;
comment|// Now we check that the accelarator still works
name|QTest
operator|::
name|keyPress
argument_list|(
...
name|QSKIP
argument_list|(
literal|"No Qt3Support. Skipping."
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
