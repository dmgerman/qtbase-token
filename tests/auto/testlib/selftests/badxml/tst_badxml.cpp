...
end_function
begin_comment
comment|// QTBUG-35743, test whether XML is using correct UTF-8 encoding
end_comment
begin_comment
comment|// on platforms where the console encoding differs.
end_comment
begin_function
...
argument_list|()
expr_stmt|;
comment|// Prevent match on binary "badxml"
if|if
condition|(
name|arguments
operator|.
...
name|QSKIP
argument_list|(
literal|"Skipped for text due to unpredictable console encoding."
argument_list|)
expr_stmt|;
name|QString
name|string
