...
name|LoggerSet
argument_list|(
literal|"old stdout csv"
argument_list|,
comment|// benchmarks only
name|QStringList
argument_list|()
operator|<<
literal|"stdout csv"
...
name|LoggerSet
argument_list|(
literal|"old stdout teamcity"
argument_list|,
name|QStringList
argument_list|()
operator|<<
literal|"stdout teamcity"
argument_list|,
name|QStringList
argument_list|()
operator|<<
...
literal|"-,xunitxml"
argument_list|)
comment|// All loggers at the same time (except csv)
operator|<<
name|LoggerSet
argument_list|(
literal|"all loggers"
...
condition|)
continue|continue;
comment|// Skip benchmark for TeamCity logger
specifier|const
name|bool
name|crashes
init|=
...
specifier|const
name|bool
name|preserveLibPath
init|=
name|qEnvironmentVariableIsSet
argument_list|(
literal|"QT_PRESERVE_TESTLIB_PATH"
argument_list|)
decl_stmt|;
foreach|foreach
control|(
...
literal|"USER"
argument_list|)
comment|// Required for X11 on openSUSE
if|#
directive|if
operator|!
name|defined
...
directive|ifndef
name|Q_OS_WIN
comment|// Remove digits of times to match the expected file.
specifier|const
name|QLatin1String
name|timePattern
argument_list|(
literal|"Function time:"
argument_list|)
decl_stmt|;
name|int
name|timePos
...
directive|else
comment|// !Q_OS_WIN
comment|// Remove stack trace which is output to stdout.
specifier|const
name|int
name|exceptionLogStart
init|=
name|actual
operator|.
name|indexOf
argument_list|(
literal|"A crash occurred in "
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|fromLatin1
argument_list|(
literal|"Mismatch in line count: %1 != %2 (%3, %4)."
argument_list|)
operator|.
name|arg
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// Special handling for ignoring _FILE_ and _LINE_ if logger is teamcity
if|if
condition|(
name|logFormat
argument_list|(
...
name|fromLatin1
argument_list|(
literal|"Invalid Duration tag at line %1 (%2): '%3'"
argument_list|)
operator|.
name|arg
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Plain text logger: strip time (", 2323dms").
block|}
else|else
block|{
name|QVERIFY2
...
name|QString
argument_list|(
literal|"Wrong number of columns (%1)"
argument_list|)
operator|.
name|arg
argument_list|(
