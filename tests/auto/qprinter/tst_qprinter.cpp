...
name|QSKIP
argument_list|(
literal|"QPrinter::winPageSize() does not exist for nonwindows platforms"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"QT_NO_COMPLETER || QT_NO_FILEDIALOG: Auto-complete turned off in QPrinterDialog."
argument_list|,
name|QTest
operator|::
name|SkipAll
