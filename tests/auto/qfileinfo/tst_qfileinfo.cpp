...
literal|true
expr_stmt|;
comment|//    QTest::newRow("data2")<< "tst_qfileinfo.cpp"<< int(QFile::WriteUser)<< false;
name|QTest
operator|::
name|newRow
argument_list|(
...
name|QSKIP
argument_list|(
literal|"No user based rights in Symbian OS - SOS needs platform security tests instead"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
literal|"longfile"
argument_list|,
literal|"Maximum total filepath cannot exceed 256 characters in Symbian"
argument_list|,
name|Abort
argument_list|)
expr_stmt|;
...
literal|"simple"
argument_list|,
literal|"Symbian implementation of stat doesn't return read time right"
argument_list|,
name|Abort
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"no symbolic link support on this platform"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
directive|ifdef
name|Q_OS_SYMBIAN
comment|// No guaranteed hidden file knows to exist in Symbian filesystem, so make one.
name|QString
name|hiddenFileName
argument_list|(
literal|"hidden.txt"
...
name|appPath
init|=
literal|"c:/sys/bin/tst_qfileinfo.exe"
decl_stmt|;
else|#
directive|else
name|QString
