...
end_decl_stmt
begin_comment
comment|/*!     Test plan: 	insertItem (all flavours and combinations) 	removing menu items 	clearing the menu  	check the common behaviour + emitted signals for: 	    accelerator keys 	    navigating tru the menu and then pressing ENTER 	    mouse clicks 	    mouse drags 	    combinations of key + mouse (if possible) 	    checked / unckecked state of menu options 	    active / inactive state      Can't test these without pixmap comparison... 	show and hide 	icons in a menu 	pixmaps in a menu  */
end_comment
begin_constructor
...
argument_list|)
expr_stmt|;
comment|//    pm->setAccel( ALT + Key_A, idAccel );
name|pm1
operator|->
name|setAccel
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//    idAccel1 = pm2->insertItem( "&Open...", this, SLOT(onActivated(int)), Qt::Key_O, 456 );
name|idAccel1
operator|=
name|pm2
operator|->
...
name|QSKIP
argument_list|(
literal|"On Mac, native key events are needed to test menu action activation"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// use the form insertItem( QString, Q3PopupMenu )
name|mb
operator|->
name|insertItem
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// use the form insertItem( QString, QObject, slot, keysequence )
name|mb
operator|->
name|insertItem
argument_list|(
...
condition|)
return|return;
comment|// but the menubar item should stay selected
name|QVERIFY
argument_list|(
name|mb
operator|->
...
argument_list|)
expr_stmt|;
comment|// Should still be the active window
else|#
directive|else
name|QVERIFY
argument_list|(
