...
name|N
value|false
comment|//            bita bitm bool brsh byta cstr col  colg curs date dt   dbl  font icon img  int  inv  kseq list ll   map  pal  pen  pix  pnta pnt  rect reg  size sp   str  strl time uint ull
name|QVariant
name|var
argument_list|(
name|QBitArray
...
name|QSKIP
argument_list|(
literal|"Qt compiled without Qt3Support"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Qt not build with Qt3Support"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|Size
condition|)
comment|// QSize has its own ideas of ::isNull
continue|continue;
if|if
condition|(
operator|!
...
name|QString
argument_list|(
literal|"'null.isNull()' failed for type: %1"
argument_list|)
operator|.
name|arg
argument_list|(
