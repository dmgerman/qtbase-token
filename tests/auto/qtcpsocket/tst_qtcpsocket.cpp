...
end_comment
begin_comment
comment|// Just to get Q_OS_SYMBIAN
end_comment
begin_include
include|#
directive|include
...
name|QSKIP
argument_list|(
literal|"adopting open c socket handles is not supported"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"stressTest subprocess needs Qt3Support"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Symbian: QProcess IO is not yet supported, fix when supported"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
