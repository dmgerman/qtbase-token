...
directive|ifndef
name|Q_OS_SYMBIAN
comment|//symbian implementation will return empty string if all char are invalid
name|QTest
operator|::
name|newRow
argument_list|(
...
name|QSKIP
argument_list|(
literal|"This test requires QProcess"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"This test requires streams support in QProcess"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"This function is not yet supported with QT_NO_CONCURRENT defined."
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
