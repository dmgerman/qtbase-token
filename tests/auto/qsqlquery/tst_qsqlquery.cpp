...
name|qtest_prepare
operator|+
literal|" (id int primary key, name nvarchar(200) null)"
expr_stmt|;
elseif|else
if|if
condition|(
...
name|qtest_prepare
operator|+
literal|" (id int not null primary key, name varchar(200) character set utf8)"
expr_stmt|;
else|else
name|createQuery
operator|=
...
name|qtest_prepare
operator|+
literal|" (id int not null primary key, name varchar(200))"
expr_stmt|;
name|QVERIFY_SQL
argument_list|(
name|q
