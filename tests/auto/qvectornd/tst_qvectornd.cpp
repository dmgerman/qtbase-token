...
end_comment
begin_comment
comment|// to precision issues when converting to and from qreal.
end_comment
begin_comment
comment|// This fuzzy compare is slightly "fuzzier" than the default
end_comment
begin_comment
comment|// qFuzzyCompare for qreal to compensate.
end_comment
begin_function
