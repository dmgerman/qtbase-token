...
name|void
name|psql_specialFloatValues_data
parameter_list|()
block|{
name|generic_data
argument_list|(
...
name|QSKIP
argument_list|(
literal|"Platform does not have quiet_NaN"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|QSKIP
argument_list|(
literal|"Platform does not have infinity"
argument_list|)
expr_stmt|;
name|QFETCH
argument_list|(
...
name|exec
argument_list|(
literal|"SELECT 1::bit, '10101010000111101101'::varbit, "
literal|"'10101111011'::varbit(15), '22222.20'::numeric(16,2), "
literal|"'333333'::numeric(18), '444444'::numeric"
argument_list|)
argument_list|)
expr_stmt|;
name|QVERIFY_SQL
...
name|QString
argument_list|(
literal|"CREATE TABLE %1 (dtwtz timestamptz, dtwotz timestamp)"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|tableName
operator|+
literal|" (dtwtz, dtwotz) VALUES (:dt, :dt)"
argument_list|)
argument_list|)
expr_stmt|;
name|q
...
name|exec
argument_list|(
literal|"SELECT dtwtz, dtwotz FROM "
operator|+
name|tableName
argument_list|)
argument_list|)
...
name|QString
argument_list|(
literal|"CREATE TABLE %1 (id INT AUTO_INCREMENT PRIMARY KEY, "
literal|"test_number TINYINT(3) UNSIGNED)"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|tableName
operator|+
literal|" (test_number) VALUES (:value)"
argument_list|)
argument_list|)
expr_stmt|;
name|QVector
...
name|prepare
argument_list|(
literal|"SELECT test_number FROM "
operator|+
name|tableName
argument_list|)
argument_list|)
...
name|void
name|runIntegralTypesMysqlTest
parameter_list|(
name|QSqlDatabase
modifier|&
name|db
...
expr_stmt|;
block|}
comment|// ensure we can read them back properly
name|QVERIFY_SQL
argument_list|(
name|q
argument_list|,
