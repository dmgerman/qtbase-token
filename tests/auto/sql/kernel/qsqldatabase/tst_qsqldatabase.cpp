...
function_decl|;
name|void
name|mysql_connectWithInvalidAddress
parameter_list|()
function_decl|;
...
parameter_list|()
block|{
comment|// Ensure that giving invalid connection parameters fails correctly
name|QSqlDatabase
name|db
init|=
name|QSqlDatabase
