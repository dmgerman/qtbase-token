...
end_function
begin_comment
comment|/* \internal     Ensure that the macro is available even though QT_NO_DEBUG     is defined. We do this by undefining it, and turning it on again     backwards(just so we don't break stuff), if it was in fact defined.  */
end_comment
begin_function
