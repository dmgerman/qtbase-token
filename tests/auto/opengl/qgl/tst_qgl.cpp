...
class|class
name|QOpenGLFramebufferObjectPaintDevice
super|:
specifier|public
...
argument_list|()
expr_stmt|;
comment|// check that the OpenGL paint engine now knows it needs to sync
name|fbo2Painter
operator|.
name|drawImage
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// Mipmapping is always available in GL2/GLES2+. Verify this.
if|if
condition|(
name|format
operator|.
...
directive|endif
comment|// Now look for some features should always be available in a given version.
name|QOpenGLFunctions
operator|::
name|OpenGLFeatures
name|allFeatures
