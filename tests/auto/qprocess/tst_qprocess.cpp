...
name|QSKIP
argument_list|(
literal|"Reading and writing to a process is not supported on Qt/Symbian"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|start
argument_list|(
literal|"testProcessEcho/testProcessEcho.app"
argument_list|)
expr_stmt|;
else|#
directive|else
...
name|start
argument_list|(
literal|"testProcessEcho2/testProcessEcho2.app"
argument_list|)
expr_stmt|;
else|#
directive|else
...
name|start
argument_list|(
literal|"testProcessLoopback/testProcessLoopback.app"
argument_list|)
expr_stmt|;
else|#
directive|else
...
name|QSKIP
argument_list|(
literal|"Batch files are not supported on Symbian"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|start
argument_list|(
literal|"testProcessOutput/testProcessOutput.app"
argument_list|)
expr_stmt|;
else|#
directive|else
...
name|Q_OS_SYMBIAN
argument_list|)
comment|// Symbian test outputs to a file, so check that
name|FILE
modifier|*
name|file
init|=
name|fopen
argument_list|(
literal|"c:\\logs\\qprocess_output_test.txt"
argument_list|,
literal|"r"
argument_list|)
decl_stmt|;
...
name|start
argument_list|(
literal|"testProcessDeadWhileReading/testProcessDeadWhileReading.app"
argument_list|)
expr_stmt|;
else|#
directive|else
...
name|start
argument_list|(
literal|"testProcessEcho3/testProcessEcho3.app"
argument_list|)
expr_stmt|;
else|#
directive|else
...
name|QSKIP
argument_list|(
literal|"Killing started processes is not supported on Qt/Symbian due platform security"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Terminating started processes is not supported on Qt/Symbian due platform security"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
argument_list|)
operator|<<
literal|"testGuiProcess/testGuiProcess.app"
expr_stmt|;
else|#
directive|else
name|QTest
...
name|Q_CC_NOKIAX86
argument_list|)
comment|// WINSCW builds in Symbian do not allow multiple processes to load Qt libraries,
comment|// so use just a simple process instead of testDetached.
name|process
operator|.
name|start
argument_list|(
...
name|Q_OS_SYMBIAN
argument_list|)
comment|// testDetached used because it does something, but doesn't take too long.
name|QFile
name|infoFile
argument_list|(
name|QString
argument_list|(
literal|"c:\\logs\\detinfo%1"
argument_list|)
operator|.
name|arg
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Symbian toolchain doesn't like exes with spaces in the name
else|#
directive|else
operator|<<
name|QString
...
name|Q_OS_SYMBIAN
argument_list|)
comment|// Kernel will run out of process handles on some hw, as there is some
comment|// delay before they are recycled, so limit the amount of processes.
for|for
control|(
name|int
name|i
...
argument_list|)
comment|// WINSCW builds in Symbian do not allow multiple processes to load Qt libraries,
comment|// so this test must be skipped.
name|QSKIP
argument_list|(
literal|"Multiple processes loading Qt are not allowed in Qt/Symbian emulator."
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|Q_OS_SYMBIAN
argument_list|)
comment|// Symbian has no working directory support, so use logs dir as a shared directory
name|QFile
name|infoFile
argument_list|(
name|QLatin1String
argument_list|(
literal|"c:\\logs\\detachedinfo.txt"
argument_list|)
argument_list|)
decl_stmt|;
else|#
...
literal|""
argument_list|,
literal|"Working directory is not supported on Qt/symbian"
argument_list|,
name|Continue
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Symbian does not support working directory logic"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|start
argument_list|(
literal|"testSetWorkingDirectory/testSetWorkingDirectory.app"
argument_list|)
expr_stmt|;
else|#
directive|else
