...
name|newRow
argument_list|(
literal|"test rotation on (1, 1, 1)"
argument_list|)
operator|<<
name|axis1
operator|<<
...
name|newRow
argument_list|(
literal|"test rotation on (2, -3, .5)"
argument_list|)
operator|<<
name|axis2
operator|<<
...
name|newRow
argument_list|(
literal|"test rotation on (-2, 0, -.5)"
argument_list|)
operator|<<
name|axis3
operator|<<
...
name|newRow
argument_list|(
literal|"test rotation on (.0001, .0001, .0001)"
argument_list|)
operator|<<
name|axis4
operator|<<
...
name|newRow
argument_list|(
literal|"test rotation on (.01, .01, .01)"
argument_list|)
operator|<<
name|axis5
operator|<<
