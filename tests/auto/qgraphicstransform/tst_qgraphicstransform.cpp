...
end_function
begin_comment
comment|// QMatrix4x4 uses float internally, whereas QTransform uses qreal.
end_comment
begin_comment
comment|// This can lead to issues with qFuzzyCompare() where it uses double
end_comment
begin_comment
comment|// precision to compare values that have no more than float precision
end_comment
begin_comment
comment|// after conversion from QMatrix4x4 to QTransform.  The following
end_comment
begin_comment
comment|// definitions correct for the difference.
end_comment
begin_function
...
parameter_list|)
block|{
comment|// increase delta on small machines using float instead of double
if|if
condition|(
sizeof|sizeof
argument_list|(
...
condition|)
block|{
comment|// This test fails, on only this angle, when qreal == float
comment|// because the deg2rad value in QTransform is not accurate
comment|// enough to match what QMatrix4x4 is doing.
block|}
else|else
block|{
name|QVERIFY
...
name|QEXPECT_FAIL
argument_list|(
literal|"rotation of 120 on (1, 1, 1)"
argument_list|,
literal|"QTBUG-20661"
argument_list|,
name|Abort
...
name|QEXPECT_FAIL
argument_list|(
literal|"rotation of 240 on (1, 1, 1)"
argument_list|,
literal|"QTBUG-20661"
argument_list|,
name|Abort
...
name|QEXPECT_FAIL
argument_list|(
literal|"rotation of 120 on (0.01, 0.01, 0.01)"
argument_list|,
literal|"QTBUG-20661"
argument_list|,
name|Abort
...
name|QEXPECT_FAIL
argument_list|(
literal|"rotation of 240 on (0.01, 0.01, 0.01)"
argument_list|,
literal|"QTBUG-20661"
argument_list|,
name|Abort
...
name|QEXPECT_FAIL
argument_list|(
literal|"rotation of 120 on (0.0001, 0.0001, 0.0001)"
argument_list|,
literal|"QTBUG-20661"
argument_list|,
name|Abort
...
name|QEXPECT_FAIL
argument_list|(
literal|"rotation of 240 on (0.0001, 0.0001, 0.0001)"
argument_list|,
literal|"QTBUG-20661"
argument_list|,
name|Abort
