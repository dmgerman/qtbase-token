...
argument_list|)
name|void
name|indexBasedInsertion_data
parameter_list|()
function_decl|;
name|void
name|indexBasedInsertion
parameter_list|()
function_decl|;
endif|#
directive|endif
...
name|newRow
argument_list|(
literal|"negative-index-appends"
argument_list|)
operator|<<
operator|-
literal|1
...
parameter_list|()
block|{
comment|// test the compat'ed index based insertion
name|QFETCH
argument_list|(
name|int
argument_list|,
name|indexForInsertion
argument_list|)
expr_stmt|;
name|QFETCH
argument_list|(
