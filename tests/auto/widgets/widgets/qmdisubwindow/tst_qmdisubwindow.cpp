...
function_decl|;
name|void
name|testFullScreenState
parameter_list|()
function_decl|;
name|void
name|testRemoveBaseWidget
parameter_list|()
function_decl|;
block|}
class|;
...
parameter_list|()
block|{
comment|// QTBUG-38378, verify that the focus child of a subwindow
comment|// is not "forgotten" when adding yet another subwindow.
name|QMdiArea
name|mdiArea
decl_stmt|;
name|mdiArea
...
name|QStringLiteral
argument_list|(
literal|"restoreFocusOverCreation"
argument_list|)
argument_list|)
expr_stmt|;
name|MultiWidget
...
name|newRow
argument_list|(
literal|"disabled-restore-action"
argument_list|)
operator|<<
literal|0
operator|<<
...
argument_list|()
expr_stmt|;
comment|// QMdiSubWindow does not support the fullscreen state. This call
comment|// should be equivalent to setVisible(true) (and not showNormal())
name|QVERIFY
argument_list|(
name|QTest
operator|::
