...
function_decl|;
name|void
name|activeSubMenuPositionExec
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|QTBUG30595_rtl_submenu
parameter_list|()
function_decl|;
name|void
name|QTBUG20403_nested_popup_on_shortcut_trigger
parameter_list|()
function_decl|;
ifndef|#
directive|ifndef
name|QT_NO_CURSOR
name|void
name|QTBUG47515_widgetActionEnterLeave
parameter_list|()
function_decl|;
endif|#
directive|endif
...
name|Q_OS_MAC
name|void
name|QTBUG_37933_ampersands_data
parameter_list|()
function_decl|;
name|void
name|QTBUG_37933_ampersands
parameter_list|()
function_decl|;
endif|#
directive|endif
...
directive|ifndef
name|QT_NO_CURSOR
comment|// Test under-mouse positioning
name|menu
operator|->
...
argument_list|)
expr_stmt|;
comment|// Some platforms include the window title bar in its geometry.
name|QTRY_COMPARE
argument_list|(
name|torn
operator|->
...
argument_list|)
expr_stmt|;
comment|// Test custom positioning
specifier|const
name|QPoint
modifier|&
name|pos
...
argument_list|)
decl_stmt|;
comment|// Move then click to avoid the submenu moves from causing it to close
name|QTest
operator|::
name|mouseMove
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Make sure we enter the submenu frame directly on the tear-off area
name|QTest
operator|::
name|mouseMove
argument_list|(
...
name|qWarning
argument_list|(
literal|"Sloppy menu timer disabled by the style: %s"
argument_list|,
name|qPrintable
argument_list|(
name|QApplication
...
argument_list|)
expr_stmt|;
comment|// Submenu must get the enter event
name|QTRY_VERIFY
argument_list|(
name|submenu
operator|->
...
argument_list|)
expr_stmt|;
comment|// Menu must not disappear and it must get the enter event
name|QVERIFY
argument_list|(
name|submenu
operator|->
...
end_function
begin_comment
comment|// QTBUG-49588, QTBUG-48396: activeSubMenuPositionExec() is the same as
end_comment
begin_comment
comment|// activeSubMenuPosition(), but uses QMenu::exec(), which produces a different
end_comment
begin_comment
comment|// sequence of events. Verify that the sub menu is positioned to the right of the
end_comment
begin_comment
comment|// main menu.
end_comment
...
argument_list|)
expr_stmt|;
comment|// Mac: Ensure cursor is outside
endif|#
directive|endif
name|menu
operator|.
...
argument_list|)
expr_stmt|;
comment|// 20ms delay with previous behavior
name|QTRY_VERIFY
argument_list|(
name|sub1
operator|.
...
argument_list|)
expr_stmt|;
comment|// Check whether leave event is not delivered on mouse move
name|w1
operator|->
name|move
operator|=
...
name|newRow
argument_list|(
literal|"ampersand_in_parentheses"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"ampersand_in_parentheses_after_space"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"ampersand_in_parentheses_after_spaces"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"ampersand_in_parentheses_before_space"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"only_ampersand_in_parentheses"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"only_ampersand_in_parentheses_after_space"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"parentheses_after_space"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"ampersand_after_space"
argument_list|)
operator|<<
name|QString
argument_list|(
literal|"About&Qt Project"
argument_list|)
operator|<<
name|QString
argument_list|(
...
begin_function_decl
name|void
name|tst_qmenu_QTBUG_37933_ampersands
parameter_list|()
function_decl|;
end_function_decl
begin_function
