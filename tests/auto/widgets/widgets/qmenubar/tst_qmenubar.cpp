...
end_endif
begin_comment
comment|/*!     If a popupmenu is active you can use Left to move to the menu to the left of it.     Qt/Mac,WinCE does not use the native popups/menubar. */
end_comment
begin_if
if|#
directive|if
...
end_endif
begin_comment
comment|// Qt/Mac does not use the native popups/menubar.
end_comment
begin_comment
comment|// Qt/CE uses native menubar.
end_comment
begin_if
if|#
directive|if
