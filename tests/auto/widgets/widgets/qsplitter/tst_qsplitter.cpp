...
function_decl|;
name|void
name|saveAndRestoreHandleWidth
parameter_list|()
function_decl|;
...
argument_list|)
expr_stmt|;
comment|// Constructing a child widget on the splitter should
comment|// automatically add and show it.
name|QWidget
modifier|*
name|childWidget
init|=
...
argument_list|)
expr_stmt|;
comment|// Deleting should automatically remove it
operator|delete
name|childWidget
expr_stmt|;
name|QCOMPARE
...
argument_list|)
expr_stmt|;
comment|// QTBUG-40132, top level windows should not be affected by this.
name|QDialog
modifier|*
name|dialog
init|=
