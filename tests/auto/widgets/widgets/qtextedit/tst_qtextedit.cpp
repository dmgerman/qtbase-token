...
end_function
begin_comment
comment|//check for bug 15003, are there multiple textChanged() signals on remove?
end_comment
begin_function
...
name|QStringLiteral
argument_list|(
literal|"arbitrary te<span style=\"color:#ff0000\">xt</span>"
argument_list|)
argument_list|)
expr_stmt|;
name|QRegExp
