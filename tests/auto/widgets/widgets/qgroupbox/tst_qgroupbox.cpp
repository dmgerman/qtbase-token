...
function_decl|;
name|void
name|task_QTBUG_15519_propagateMouseEvents
parameter_list|()
function_decl|;
private|private:
DECL|member|checked
...
argument_list|)
expr_stmt|;
comment|// The value of isChecked() should be reflected in the isEnabled() of newly
comment|// added child widgets, but not in top level widgets.
name|QWidget
modifier|*
name|childWidget
init|=
...
name|setTitle
argument_list|(
literal|"This is a test for QTBUG-15519"
argument_list|)
expr_stmt|;
name|box
operator|.
...
argument_list|)
decl_stmt|;
comment|// Without a checkbox, all mouse events should propagate
name|parent
operator|.
name|reset
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// With a checkbox, presses and releases to the checkbox should not propagate
name|box
operator|.
name|setCheckable
argument_list|(
...
parameter_list|)
block|{
comment|// Send a MouseMove event without actually moving the pointer
name|QMouseEvent
name|event
argument_list|(
name|QEvent
