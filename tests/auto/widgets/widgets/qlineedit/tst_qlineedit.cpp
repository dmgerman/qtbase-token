...
function_decl|;
name|void
name|fixupDoesNotModify_QTBUG_49295
parameter_list|()
function_decl|;
name|void
name|insert
...
function_decl|;
name|void
name|shortcutOverrideOnReadonlyLineEdit_data
parameter_list|()
function_decl|;
name|void
name|shortcutOverrideOnReadonlyLineEdit
parameter_list|()
function_decl|;
protected|protected
name|slots
...
argument_list|)
expr_stmt|;
comment|// trigger a fixup, which should not reset the modified flag
name|QFocusEvent
name|lostFocus
argument_list|(
name|QEvent
...
literal|""
argument_list|,
literal|"QTBUG-49295: a fixup of a line edit should keep it modified"
argument_list|,
name|Continue
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// QTBUG-48899 , action hidden before show().
name|QVERIFY
argument_list|(
name|toolButton1
operator|->
...
argument_list|)
expr_stmt|;
comment|// QTBUG-48806, positioned beside each other.
name|iconAction1
operator|->
name|setEnabled
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// QTBUG-39660, button 2 takes position of invisible button 1.
name|QCOMPARE
argument_list|(
name|toolButton2
operator|->
...
argument_list|>
argument_list|(
literal|"shouldBeHandledByQLineEdit"
argument_list|)
expr_stmt|;
name|QTest
operator|::
...
name|bool
argument_list|,
name|shouldBeHandledByQLineEdit
argument_list|)
expr_stmt|;
name|QWidget
name|widget
