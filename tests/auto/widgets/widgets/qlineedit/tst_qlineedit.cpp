...
function_decl|;
name|void
name|inputMethodTentativeCommit
parameter_list|()
function_decl|;
protected|protected
name|slots
...
parameter_list|()
block|{
comment|// test that basic tentative commit gets to text property on preedit state
name|QList
argument_list|<
name|QInputMethodEvent
operator|::
...
argument_list|)
expr_stmt|;
comment|// tentative commit not allowed present in surrounding text
name|QInputMethodQueryEvent
name|queryEvent
argument_list|(
name|Qt
...
argument_list|)
expr_stmt|;
comment|// if text with tentative commit does not validate, not allowed to be part of text property
name|testWidget
operator|->
name|setText
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// ensure input state is reset
name|QValidator
modifier|*
name|validator
init|=
...
name|validator
expr_stmt|;
comment|// text remains when focus is removed
name|testWidget
operator|->
name|setText
argument_list|(
