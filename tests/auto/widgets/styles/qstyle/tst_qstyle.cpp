...
function_decl|;
name|void
name|testProxyCalled
parameter_list|()
function_decl|;
name|void
name|testStyleOptionInit
parameter_list|()
function_decl|;
private|private:
name|void
...
name|asprintf
argument_list|(
literal|"QSizePolicy::ControlType(%i), QSizePolicy::ControlType(%i)"
argument_list|,
name|control1
argument_list|,
name|control2
...
argument_list|()
operator|<<
literal|"Invalid QStyleOption found for"
operator|<<
name|info
expr_stmt|;
name|qWarning
