...
function_decl|;
name|void
name|widgetStylePropagation_data
parameter_list|()
function_decl|;
name|void
name|widgetStylePropagation
parameter_list|()
function_decl|;
name|void
...
argument_list|>
argument_list|(
literal|"widgetStylePropagation"
argument_list|)
expr_stmt|;
name|QTest
operator|::
name|newRow
argument_list|(
literal|"Widget style propagation"
argument_list|)
operator|<<
literal|" "
operator|<<
...
name|newRow
argument_list|(
literal|"Widget style propagation, no application style sheet"
argument_list|)
operator|<<
name|QString
argument_list|()
...
name|newRow
argument_list|(
literal|"Default propagation, no application style sheet"
argument_list|)
operator|<<
name|QString
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// palette should propagate in standard mode
block|}
else|else
block|{
name|QCOMPARE
...
condition|)
block|{
comment|// In standard propagation mode, widgets that are not explicitly
comment|// targeted do not have their propagated palette unset when they are
comment|// unpolished by changing parents.  This is consistent with regular Qt
comment|// widgets, who also maintain their propagated palette when changing
comment|// parents
name|QCOMPARE
argument_list|(
name|COLOR
...
argument_list|)
decl_stmt|;
comment|// Check regular Qt propagation works as expected, with and without a
comment|// non-interfering application stylesheet
name|QTest
operator|::
name|newRow
argument_list|(
...
name|newRow
argument_list|(
literal|"parent font propagation, no application style sheet"
argument_list|)
operator|<<
name|QString
argument_list|()
...
name|newRow
argument_list|(
literal|"parent font propagation, dummy application style sheet"
argument_list|)
operator|<<
literal|"QGroupBox { font-size: 64pt }"
operator|<<
name|QString
argument_list|()
operator|<<
...
name|newRow
argument_list|(
literal|"parent color propagation, no application style sheet"
argument_list|)
operator|<<
name|QString
argument_list|()
...
name|newRow
argument_list|(
literal|"parent color propagation, dummy application style sheet"
argument_list|)
operator|<<
literal|"QGroupBox { color: blue }"
operator|<<
name|QString
argument_list|()
operator|<<
...
name|redColor
expr_stmt|;
comment|// Parent style sheet propagates to child if child has not explicitly
comment|// set a value
name|QTest
operator|::
name|newRow
argument_list|(
literal|"parent style sheet color propagation"
argument_list|)
operator|<<
literal|"#parentLabel { color: red }"
operator|<<
name|QString
argument_list|()
operator|<<
...
name|newRow
argument_list|(
literal|"parent style sheet font propagation"
argument_list|)
operator|<<
literal|"#parentLabel { font-size: 45pt }"
operator|<<
name|QString
argument_list|()
operator|<<
...
name|defaultColor
expr_stmt|;
comment|// Parent style sheet does not propagate to child if child has explicitly
comment|// set a value
name|QTest
operator|::
name|newRow
argument_list|(
literal|"parent style sheet color propagation, child explicitly set"
argument_list|)
operator|<<
literal|"#parentLabel { color: red }"
operator|<<
...
name|newRow
argument_list|(
literal|"parent style sheet font propagation, child explicitly set"
argument_list|)
operator|<<
literal|"#parentLabel { font-size: 45pt }"
operator|<<
...
name|defaultColor
expr_stmt|;
comment|// Parent does not propagate to child when child is target of style sheet
name|QTest
operator|::
name|newRow
argument_list|(
literal|"parent style sheet font propagation, child application style sheet"
argument_list|)
operator|<<
literal|"#childLabel { font-size: 32pt }"
operator|<<
name|QString
argument_list|()
operator|<<
...
name|newRow
argument_list|(
literal|"parent style sheet color propagation, child application style sheet"
argument_list|)
operator|<<
literal|"#childLabel { color: green }"
operator|<<
name|QString
argument_list|()
operator|<<
