...
specifier|inline
name|int
name|visibleTopLevelWidgetCount
parameter_list|()
block|{
name|int
name|result
...
parameter_list|()
block|{
comment|// Verify that no visible top levels are leaked. Cannot check for
comment|// topLevelWidgets().isEmpty() here since the data driven test layoutSpacing()
comment|// will appear to "leak" top levels due to it creating widgets in the test data.
name|QCOMPARE
argument_list|(
name|visibleTopLevelWidgetCount
argument_list|()
