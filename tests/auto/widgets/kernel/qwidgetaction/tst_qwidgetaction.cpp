...
parameter_list|()
block|{
comment|// Disable menu/combo animations to prevent the alpha widgets from getting in the
comment|// way in popup(), failing the top level leak check in cleanup().
name|QApplication
operator|::
