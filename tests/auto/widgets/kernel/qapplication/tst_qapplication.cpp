...
argument_list|)
expr_stmt|;
comment|// This should NOT quit the application (see CloseEventTestWindow)
name|quitApplicationTriggered
operator|=
literal|false
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// This actually quits the application.
name|app
operator|.
name|exec
argument_list|()
...
block|}
block|{
comment|// QTBUG-31569: If the last widget with Qt::WA_QuitOnClose set is closed, other
comment|// widgets that don't have the attribute set should be closed automatically.
name|int
name|argc
init|=
literal|0
...
argument_list|)
expr_stmt|;
comment|// front most widget has Qt::TabFocus, parent widget accepts clicks as well
comment|// now send a mouse button press event and check what happens with the focus
comment|// it should be given to the parent widget
name|QMouseEvent
name|ev
argument_list|(
name|QEvent
...
argument_list|)
expr_stmt|;
comment|// then we give the inner widget strong focus -> it should get focus
name|w2
operator|.
name|setFocusPolicy
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// now back to tab focus and click again (it already had focus) -> focus should stay
comment|// (focus was revoked as of QTBUG-34042)
name|w2
operator|.
name|setFocusPolicy
argument_list|(
