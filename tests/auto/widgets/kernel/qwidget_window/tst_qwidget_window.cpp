...
end_function
begin_comment
comment|// QTBUG-33520, a toplevel fully obscured by native children should still receive Qt::WA_Mapped
end_comment
begin_function
...
name|QSKIP
argument_list|(
literal|"This test fails on Mac."
argument_list|)
expr_stmt|;
