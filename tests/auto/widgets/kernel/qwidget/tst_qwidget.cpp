...
argument_list|)
member_init_list|,
name|m_spontaneousResizeEventCount
argument_list|(
literal|0
argument_list|)
member_init_list|,
name|m_synthesizedResizeEventCount
argument_list|(
literal|0
argument_list|)
member_init_list|,
name|m_spontaneousMoveEventCount
argument_list|(
literal|0
argument_list|)
member_init_list|,
name|m_synthesizedMoveEventCount
argument_list|(
literal|0
argument_list|)
block|{
...
specifier|const
name|int
name|synthesizedResizeEventCountAfterShow
init|=
name|wTopLevel
operator|.
name|m_synthesizedResizeEventCount
...
specifier|const
name|int
name|synthesizedMoveEventCountAfterShow
init|=
name|wTopLevel
operator|.
name|m_synthesizedMoveEventCount
