...
literal|""
argument_list|,
literal|"On X11, the window manager will apply NorthWestGravity rules to 'child', which"
literal|" means the top-left corner of the window frame will be placed at 'childPos'"
literal|" causing this test to fail."
argument_list|,
name|Continue
argument_list|)
expr_stmt|;
