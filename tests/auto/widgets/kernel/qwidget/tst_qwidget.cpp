...
argument_list|()
expr_stmt|;
comment|// Note about commented out compares below:
comment|// Widgets are not receiving enter/leave events properly when there is a popup up,
comment|// so all enter and leave counts are not correct yet.
comment|// Fix this test when QTBUG-27800 is fixed (i.e. uncomment commented out compares).
comment|// Moving around while popup active should not change undermouse either,
comment|// but should send enter and leave events for widgets
name|QTest
operator|::
name|mouseMove
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//QCOMPARE(topLevelWidget.enters, 1); // QTBUG-27800
name|QCOMPARE
argument_list|(
name|topLevelWidget
operator|.
...
argument_list|)
expr_stmt|;
comment|//QCOMPARE(childWidget2.enters, 1); // QTBUG-27800
name|QCOMPARE
argument_list|(
name|childWidget2
operator|.
...
argument_list|)
expr_stmt|;
comment|//QCOMPARE(childWidget2.leaves, 1); // QTBUG-27800
name|childWidget2
operator|.
name|resetCounts
argument_list|()
...
argument_list|)
expr_stmt|;
comment|//QCOMPARE(childWidget1.enters, 1); // QTBUG-27800
name|QCOMPARE
argument_list|(
name|childWidget1
operator|.
...
argument_list|()
expr_stmt|;
comment|// Mouse moves off-application, should cause leaves for currently entered widgets
name|QWindowSystemInterface
operator|::
...
argument_list|)
expr_stmt|;
comment|//QCOMPARE(childWidget1.leaves, 1); // QTBUG-27800
name|QCOMPARE
argument_list|(
name|childWidget2
operator|.
...
argument_list|()
expr_stmt|;
comment|// Mouse enters back in, should cause enter to topLevelWidget
name|QWindowSystemInterface
operator|::
name|handleEnterEvent
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Mouse moves to child widget, should cause enter to child
name|QTest
operator|::
name|mouseMove
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Mouse enters popup, should cause enter to popup and leave to current widgets under mouse
name|QWindowSystemInterface
operator|::
name|handleLeaveEvent
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Mouse leaves popup and enters topLevelWidget, should cause enter to topLevelWidget and leave for popup
name|QWindowSystemInterface
operator|::
name|handleLeaveEvent
argument_list|(
