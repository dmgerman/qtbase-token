...
block|{         QWidget widgetToSave;         widgetToSave.move(expectedPosition);         widgetToSave.resize(expectedSize);         widgetToSave.show();         QTest::qWaitForWindowShown(widget.windowHandle());         QTest::qWait(500);
comment|// stabilize
