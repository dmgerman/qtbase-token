...
comment|// Check platforms (QTBUG-22326)
if|#
directive|if
literal|0
block|QCOMPARE(layouted.size(), layouted.sizeHint());
endif|#
directive|endif
name|layouted
operator|.
...
argument_list|)
expr_stmt|;
comment|// ### fixme: embedded may choose a different size to fit on the screen. (QTBUG-22326)
if|#
directive|if
literal|0
block|QCOMPARE(layouted.size(), layouted.sizeHint());
