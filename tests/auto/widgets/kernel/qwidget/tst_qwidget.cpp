...
comment|// grabs the window *without including any overlapping windows*
...
end_else
begin_comment
comment|// fallback for other platforms.
end_comment
begin_function
DECL|function|grabWindow
specifier|static
