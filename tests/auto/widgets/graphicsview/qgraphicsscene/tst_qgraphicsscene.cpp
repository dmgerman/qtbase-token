...
name|QSKIP
argument_list|(
literal|"Test fails on some Android devices (QTBUG-44430)"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
name|QSKIP
argument_list|(
literal|"Fails on Android (QTBUG-44430)"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
expr_stmt|;
block|}
comment|// The following two are unexpected, but fixing this (i.e., losing and gaining focus
comment|// when the scene activation changes) breaks quite a few tests so leave this fix
comment|// for some future release. See QTBUG-28346.
name|QEvent
...
argument_list|()
expr_stmt|;
comment|// Initially, everything should be repainted the same number of times
name|int
name|viewRepaints
init|=
literal|0
...
argument_list|)
expr_stmt|;
comment|// Setting a minimum render size should cause a repaint
name|scene
operator|.
...
argument_list|)
expr_stmt|;
comment|// Scaling should cause a repaint of big items only.
name|view
operator|.
name|scale
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Scaling further should cause even fewer items to be repainted
name|view
operator|.
name|scale
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Stacks with previous scale
name|qApp
operator|->
name|processEvents
argument_list|()
