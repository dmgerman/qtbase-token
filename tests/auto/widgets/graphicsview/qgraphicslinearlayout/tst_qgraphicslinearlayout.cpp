...
literal|15
expr_stmt|;
comment|// If the style method changes return value, the layout must be invalidated by the application
name|layout
operator|->
name|invalidate
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// If the style itself changes, the layout will pick that up
name|QCOMPARE
argument_list|(
name|layout
operator|->
