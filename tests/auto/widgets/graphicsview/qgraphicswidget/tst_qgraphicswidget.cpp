...
function_decl|;
name|void
name|QTBUG_45867_send_itemChildAddedChange_to_parent
parameter_list|()
function_decl|;
block|}
class|;
...
name|call_windowFrameSectionAt
parameter_list|(
specifier|const
name|QPointF
modifier|&
...
public|public:
name|int
name|m_itemChildAddedChangeNotificationsCount
decl_stmt|;
name|GraphicsItem
parameter_list|()
member_init_list|:
