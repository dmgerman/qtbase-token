...
function_decl|;
name|void
name|mapToGlobalWithoutScene
parameter_list|()
function_decl|;
name|void
name|QTBUG_43780_visibility
parameter_list|()
function_decl|;
name|void
name|forwardTouchEvent
parameter_list|()
function_decl|;
block|}
class|;
...
directive|endif
comment|// Disable menu animations to prevent the alpha widget from getting in the way
comment|// in actionsContextMenu().
name|QApplication
operator|::
...
argument_list|)
expr_stmt|;
comment|// Disable combo for QTBUG_43780_visibility()/Windows Vista.
name|QApplication
operator|::
name|setEffectEnabled
argument_list|(
...
name|w
expr_stmt|;
comment|// This leaves an invisible proxy widget behind.
name|qDeleteAll
argument_list|(
name|QApplication
operator|::
...
argument_list|)
expr_stmt|;
comment|// center in embeddedWidget
name|scene
operator|.
name|addWidget
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// This should be equivalent to the view center give or take rounding
comment|// errors due to odd window margins
specifier|const
name|QPoint
name|viewCenter
init|=
...
end_function
begin_comment
comment|// QTBUG_43780: Embedded widgets have isWindow()==true but showing them should not
end_comment
begin_comment
comment|// trigger the top-level widget code path of show() that closes all popups
end_comment
begin_comment
comment|// (for example combo popups).
end_comment
begin_function
