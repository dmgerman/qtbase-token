...
function_decl|;
name|void
name|rubberBandExtendSelection
parameter_list|()
function_decl|;
name|void
name|rotated_rubberBand
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|acceptMouseDoubleClickEvent
parameter_list|()
function_decl|;
name|void
name|forwardMousePress
parameter_list|()
function_decl|;
name|void
name|forwardMouseDoubleClick
parameter_list|()
function_decl|;
name|void
...
argument_list|()
expr_stmt|;
comment|// Now test for resize (QTBUG-52419). This is special when the viewport is
comment|// a QOpenGLWidget since the underlying FBO must also be maintained.
name|view
operator|.
name|resize
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// There is no sane way to check if the framebuffer contents got updated
comment|// (grabFramebuffer is no good for the viewport case as that does not go
comment|// through paintGL). So skip the actual verification.
block|}
end_function
begin_endif
endif|#
...
argument_list|)
expr_stmt|;
comment|// first rubberband without modifier key
name|sendMousePress
argument_list|(
name|view
operator|.
...
argument_list|)
expr_stmt|;
comment|// now rubberband with modifier key
block|{
name|QPoint
name|clickPoint
init|=
...
literal|""
argument_list|,
literal|"QCursor does not set native cursor on QNX"
argument_list|,
name|Abort
argument_list|)
expr_stmt|;
