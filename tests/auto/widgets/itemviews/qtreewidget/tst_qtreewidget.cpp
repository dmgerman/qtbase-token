...
function_decl|;
name|void
name|taskQTBUG13522_checkItemVisibilityBeforeItemShow
parameter_list|()
function_decl|;
public|public
name|slots
...
argument_list|)
member_init_list|,
name|item1_visibility
argument_list|(
literal|false
argument_list|)
member_init_list|,
name|item2_visibility
argument_list|(
literal|false
argument_list|)
block|{}
...
argument_list|)
expr_stmt|;
comment|//set visible must after setItemWidget or setItemWidget will reset the visibility
name|tw
operator|.
name|item1
operator|->
