...
function_decl|;
name|void
name|getMimeDataWithInvalidItem
parameter_list|()
function_decl|;
public|public
name|slots
...
argument_list|)
expr_stmt|;
comment|// Can't force the state to PartiallyChecked; state comes from children
name|item
operator|->
name|setCheckState
argument_list|(
...
parameter_list|()
block|{
comment|// A tree with checkable items, the parent is tristate
name|QTreeWidget
modifier|*
name|tree
init|=
...
argument_list|()
expr_stmt|;
comment|// Test clicking on the parent item, it should become Checked (not PartiallyChecked)
name|QStyleOptionViewItem
name|option
decl_stmt|;
name|option
...
argument_list|)
expr_stmt|;
comment|// Click again, it should become Unchecked.
name|QTest
operator|::
name|mouseClick
argument_list|(
