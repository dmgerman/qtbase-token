...
function_decl|;
name|void
name|editSpanFromDirections_data
parameter_list|()
function_decl|;
name|void
name|editSpanFromDirections
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|taskQTBUG_50171_selectRowAfterSwapColumns
parameter_list|()
function_decl|;
ifndef|#
directive|ifndef
...
function_decl|;
name|void
name|taskQTBUG_7232_AllowUserToControlSingleStep
parameter_list|()
function_decl|;
block|}
class|;
...
name|newRow
argument_list|(
literal|"no span, no hidden, no moved"
argument_list|)
operator|<<
literal|10
operator|<<
...
name|newRow
argument_list|(
literal|"row span, no hidden, no moved"
argument_list|)
operator|<<
literal|10
operator|<<
...
name|newRow
argument_list|(
literal|"col span, no hidden, no moved"
argument_list|)
operator|<<
literal|10
operator|<<
...
name|newRow
argument_list|(
literal|"no span, row hidden, no moved"
argument_list|)
operator|<<
literal|10
operator|<<
...
name|newRow
argument_list|(
literal|"no span, col hidden, no moved"
argument_list|)
operator|<<
literal|10
operator|<<
...
name|newRow
argument_list|(
literal|"no span, no hidden, row moved"
argument_list|)
operator|<<
literal|10
operator|<<
...
name|newRow
argument_list|(
literal|"no span, no hidden, col moved"
argument_list|)
operator|<<
literal|10
operator|<<
...
argument_list|)
expr_stmt|;
comment|// check again with no selection mode
name|view
operator|.
name|clearSelection
argument_list|()
...
argument_list|>
argument_list|(
literal|"expectedVisualCursorIndex"
argument_list|)
expr_stmt|;
name|QTest
operator|::
...
argument_list|>
argument_list|(
literal|"expectedEditedIndex"
argument_list|)
expr_stmt|;
comment|/* x = the cell that should be edited        c = the cell that should actually be the current index        +---+---+        |   |   |        +---+---+        |   | x |        +---+   +        |   | c |        +---+---+        |   | ^ |        +---+---+ */
name|QList
argument_list|<
name|Qt
operator|::
...
name|newRow
argument_list|(
literal|"row span, right to left"
argument_list|)
operator|<<
name|keyPresses
operator|<<
...
name|newRow
argument_list|(
literal|"row span, left to right"
argument_list|)
operator|<<
name|keyPresses
operator|<<
...
class|class
name|TableViewWithCursorExposed
super|:
specifier|public
name|QTableView
block|{
...
name|QModelIndex
argument_list|,
name|expectedVisualCursorIndex
argument_list|)
expr_stmt|;
name|QFETCH
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// show two and half rows/cols
name|int
name|extraWidth
init|=
name|view
...
argument_list|)
expr_stmt|;
comment|// the offset after scrollToBottom() and doItemsLayout() should not differ
comment|// as the view content should stay aligned to the last section
name|view
operator|.
name|scrollToBottom
argument_list|()
...
parameter_list|()
block|{
comment|// When we set the scrollMode to ScrollPerPixel it will adjust the scrollbars singleStep automatically
comment|// Setting a singlestep on a scrollbar should however imply that the user takes control (and it is not changed by geometry updates).
comment|// Setting a singlestep to -1 return to an automatic control of the singleStep.
name|QTableView
name|t
decl_stmt|;
name|t
