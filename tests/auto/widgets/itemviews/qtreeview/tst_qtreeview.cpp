...
name|QLatin1String
argument_list|(
literal|" - this item is extra wide"
argument_list|)
expr_stmt|;
return|return
name|result
...
end_function
begin_comment
comment|// QTBUG-45697: Using a QTreeView with a multi-column model filtered by QSortFilterProxyModel,
end_comment
begin_comment
comment|// when sorting the source model while the widget is not yet visible and showing the widget
end_comment
begin_comment
comment|// later on, corruption occurs in QTreeView.
end_comment
begin_class
DECL|class|Qtbug45697TestWidget
class|class
name|Qtbug45697TestWidget
super|:
specifier|public
name|QWidget
block|{
...
comment|// Setting a singlestep on a scrollbar should however imply that the user takes control.
