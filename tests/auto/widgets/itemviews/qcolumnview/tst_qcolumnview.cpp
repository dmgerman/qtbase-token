...
argument_list|)
expr_stmt|;
comment|// Needs some entries in 'home'.
block|}
end_function
begin_function
DECL|function|init
...
argument_list|)
expr_stmt|;
comment|// for empty directories (no way to go 'right'), next one should move down
name|QModelIndex
name|idx
init|=
name|m_fakeDirModel
...
index|[]
init|=
literal|"This test requires an empty directory followed by another directory."
decl_stmt|;
name|QVERIFY2
argument_list|(
name|idx
