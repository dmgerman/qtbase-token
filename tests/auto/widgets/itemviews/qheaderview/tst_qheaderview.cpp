...
function_decl|;
name|void
name|testVisualRegionForSelection
parameter_list|()
function_decl|;
friend|friend
class_decl|class
...
function_decl|;
name|void
name|QTBUG50171_visualRegionForSwappedItems
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|stretchAndRestoreLastSection
parameter_list|()
function_decl|;
name|void
name|sizeHintCrash
...
parameter_list|()
block|{
comment|// Show before resize and setStretchLastSection
if|#
directive|if
name|defined
argument_list|(
...
specifier|const
name|int
name|someOtherSectionSize
init|=
literal|40
decl_stmt|;
specifier|const
name|int
name|biggerSizeThanAnySection
init|=
literal|50
decl_stmt|;
name|QVERIFY
...
argument_list|)
expr_stmt|;
comment|// Default last section is larger
name|QCOMPARE
argument_list|(
name|header
operator|.
...
argument_list|)
expr_stmt|;
comment|// Moving last section away (restore old last section 9 - and make 8 larger)
name|header
operator|.
name|swapSections
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Make section 9 the large one again
name|header
operator|.
name|hideSection
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Show section 8 again - and make that one the last one.
name|header
operator|.
name|showSection
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Swap the sections so the logical indexes are equal to visible indexes again.
name|header
operator|.
name|moveSection
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Truncate sections (remove sections with the last section)
name|m
operator|.
name|setColumnCount
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Append an extra section and check restore
name|m
operator|.
name|setColumnCount
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Remove some sections but not the last one.
name|m
operator|.
name|removeColumns
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Empty the header and start over with some more tests
name|m
operator|.
name|setColumnCount
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Check resize of the last section
name|header
operator|.
name|resizeSection
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// It should still be stretched
name|header
operator|.
name|swapSections
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Hide the last 3 sections and test stretch last section on swap/move
comment|// when hidden sections with a larger visual index exists.
name|header
operator|.
name|hideSection
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Test import/export of the original (not stretched) sectionSize.
name|m
operator|.
name|setColumnCount
argument_list|(
