...
function_decl|;
name|void
name|QTBUG39324_settingSameInstanceOfIndexWidget
parameter_list|()
function_decl|;
name|void
name|sizeHintChangeTriggersLayout
parameter_list|()
function_decl|;
name|void
name|shiftSelectionAfterChangingModelContents
parameter_list|()
function_decl|;
name|void
name|QTBUG48968_reentrant_updateEditorGeometries
parameter_list|()
function_decl|;
name|void
name|QTBUG50102_SH_ItemView_ScrollMode
parameter_list|()
function_decl|;
name|void
name|QTBUG50535_update_on_new_selection_model
parameter_list|()
function_decl|;
name|void
name|testSelectionModelInSyncWithView
parameter_list|()
function_decl|;
block|}
class|;
...
argument_list|)
expr_stmt|;
comment|// Shift-click "D" -> we expect that "C" and "D" are selected
name|QTest
operator|::
name|mouseClick
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Shift-click "F" -> we expect that "D", "E", and "F" are selected
name|QTest
operator|::
name|mouseClick
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Move to "A" by pressing "Up" repeatedly
while|while
condition|(
name|view
operator|.
...
argument_list|)
expr_stmt|;
comment|// Shift-click "F" -> All items should be selected
name|QTest
operator|::
name|mouseClick
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Restore the old sort order
name|proxyModel
operator|.
name|sort
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Press Shift+Down -> "D" and "E" should be selected.
name|QTest
operator|::
name|keyClick
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Click "A" to reset the current selection starting point;
comment|//then select "D" via QAbstractItemView::setCurrentIndex(const QModelIndex&).
name|QTest
operator|::
name|mouseClick
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Add more children to idx
name|QStandardItem
modifier|*
name|item
init|=
...
name|view
decl_stmt|;
comment|// Default comes from the style
name|auto
name|styleScrollMode
init|=
cast|static_cast
argument_list|<
name|QAbstractItemView
...
argument_list|)
expr_stmt|;
comment|// Change style, get new value
name|view
operator|.
name|setStyle
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Explicitly set vertical, same value
name|view
operator|.
...
argument_list|)
expr_stmt|;
comment|// Change style, won't change value for vertical, will change for horizontal
name|view
operator|.
name|setStyle
argument_list|(
...
block|}
class|;
comment|// keep the current/selected row in the "low range", i.e. be sure it's visible, otherwise we
comment|// don't get updates and the test fails.
name|ListView
name|view
decl_stmt|;
name|view
