...
name|newRow
argument_list|(
literal|"unchecked, user-tristate, release"
argument_list|)
operator|<<
call|(
name|int
...
name|newRow
argument_list|(
literal|"partially checked, user-tristate, release"
argument_list|)
operator|<<
call|(
name|int
...
name|newRow
argument_list|(
literal|"checked, user-tristate, release"
argument_list|)
operator|<<
call|(
name|int
...
argument_list|)
expr_stmt|;
comment|// editor deletion happens via deleteLater
block|}
block|}
end_function
begin_function
