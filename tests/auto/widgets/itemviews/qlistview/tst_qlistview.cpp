...
function_decl|;
name|void
name|taskQTBUG_51086_skippingIndexesInSelectedIndexes
parameter_list|()
function_decl|;
block|}
class|;
...
name|fromLatin1
argument_list|(
literal|"This is a long string made to ensure that we get some horizontal scroll (and we want scroll)"
argument_list|)
decl_stmt|;
name|model
operator|.
...
parameter_list|()
block|{
comment|// simple way to get access to selectedIndexes()
class|class
name|QListViewWithPublicSelectedIndexes
super|:
specifier|public
name|QListView
block|{
