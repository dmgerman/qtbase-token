...
function_decl|;
name|void
name|systemMeasurementSystems_data
parameter_list|()
function_decl|;
name|void
name|systemMeasurementSystems
parameter_list|()
function_decl|;
name|void
name|dateFormat
...
function_decl|;
name|void
name|queryMeasureSystem_data
parameter_list|()
function_decl|;
name|void
name|queryMeasureSystem
parameter_list|()
function_decl|;
if|#
directive|if
...
name|QSKIP
argument_list|(
literal|"Uses unsupported Windows CE / Symbian QProcess functionality (std streams, env)"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Meh, skip the test as we do not reread the environment variables anymore"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Method should be const.
specifier|const
name|QLocale
name|locale
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Theoretically, we could include HPUX in this test, but its setenv implementation
comment|// stinks. It's called putenv, and it requires you to keep the variable you pass
comment|// to it around forever.
if|#
directive|if
name|defined
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Save any old environment variables.
name|QString
name|oldLcAll
init|=
name|QString
...
name|QSKIP
argument_list|(
literal|"Test doesn't work on Mac, Windows or Symbian"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"S60 3.1 doesn't support system format properly"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
directive|else
comment|// Simple test to verify that Symbian system locale works at all
specifier|const
name|QSystemLocale
name|locale
decl_stmt|;
...
argument_list|)
decl_stmt|;
comment|// Symbian offsets day and month from zero
name|QDate
name|date
argument_list|(
literal|2009
