...
name|Q_OS_SYMBIAN
argument_list|)
comment|// ### FIXME: task 257411 - remove xfail once this is fixed
name|QEXPECT_FAIL
argument_list|(
literal|""
argument_list|,
literal|"Symbian event dispatcher can't handle this kind of race, see task: 257411"
argument_list|,
name|Abort
argument_list|)
expr_stmt|;
...
end_if
begin_comment
comment|// Symbian needs "a bit" more time
end_comment
begin_define
...
argument_list|)
comment|// ### FIXME: task 257411 - remove xfail once this is fixed.
comment|// Oddly enough, this seems to work properly in HW, if given enough time and memory.
name|QEXPECT_FAIL
argument_list|(
literal|""
argument_list|,
literal|"Symbian event dispatcher can't handle this kind of race on emulator, see task: 257411"
argument_list|,
name|Abort
argument_list|)
expr_stmt|;
