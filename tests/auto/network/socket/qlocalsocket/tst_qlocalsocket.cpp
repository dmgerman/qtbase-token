...
function_decl|;
name|void
name|simpleCommandProtocol1
parameter_list|()
function_decl|;
name|void
name|simpleCommandProtocol2
parameter_list|()
function_decl|;
name|void
name|fullPath
...
name|QStringLiteral
argument_list|(
literal|"simpleProtocol"
argument_list|)
argument_list|)
expr_stmt|;
name|QLocalSocket
name|localSocketWrite
decl_stmt|;
name|localSocketWrite
operator|.
name|connectToServer
