...
function_decl|;
name|void
name|ensureEofTriggersNotification
parameter_list|()
function_decl|;
protected|protected
name|slots
...
name|serverData
decl_stmt|;
comment|// Set the handshake and server response data
name|serverData
operator|<<
...
argument_list|)
expr_stmt|;
comment|// Disable read notification on server response
name|socket
operator|.
...
argument_list|)
expr_stmt|;
comment|// Trigger a read notification
name|socket
operator|.
name|readAll
argument_list|()
expr_stmt|;
comment|// Check for pending EOF at input
name|QCOMPARE
argument_list|(
name|socket
operator|.
