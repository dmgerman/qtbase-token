...
argument_list|)
expr_stmt|;
comment|// Embedded NULs are not allowed and should be rejected
name|QTest
operator|::
name|newRow
argument_list|(
literal|"evil_printablestring"
argument_list|)
operator|<<
name|QAsn1Element
argument_list|(
