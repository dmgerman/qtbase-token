...
parameter_list|()
block|{
comment|// mostly a compile-only test, to check that qHash(QSslCertificate) is found.
name|QSet
argument_list|<
name|QSslCertificate
argument_list|>
...
argument_list|()
expr_stmt|;
comment|// Check opening a DER as a PEM fails
name|QFile
name|f2
argument_list|(
name|testDataDir
operator|+
literal|"/certificates/cert.der"
argument_list|)
decl_stmt|;
name|ok
operator|=
...
argument_list|()
expr_stmt|;
comment|// Check opening a DER as a DER works
name|QFile
name|f3
argument_list|(
name|testDataDir
...
argument_list|()
expr_stmt|;
comment|// Check opening a PEM as a DER fails
name|QFile
name|f4
argument_list|(
name|testDataDir
...
name|testDataDir
operator|+
literal|"/certificates/cert-ss.pem"
argument_list|)
operator|.
name|first
argument_list|()
