...
include|#
directive|include
file|<QtNetwork/qsslpresharedkeyauthenticator.h>
end_include
begin_include
include|#
directive|include
...
end_include
begin_comment
comment|// for QIODEVICE_BUFFERSIZE
end_comment
begin_include
include|#
directive|include
...
end_endif
begin_comment
comment|// Use this cipher to force PSK key sharing.
end_comment
begin_comment
comment|// Also, it's a cipher w/o auth, to check that we emit the signals warning
end_comment
begin_comment
comment|// about the identity of the peer.
end_comment
begin_decl_stmt
...
specifier|const
name|QString
name|PSK_CIPHER_WITHOUT_AUTH
init|=
name|QStringLiteral
argument_list|(
literal|"PSK-AES256-CBC-SHA"
argument_list|)
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
specifier|const
name|QByteArray
name|PSK_CLIENT_PRESHAREDKEY
init|=
name|QByteArrayLiteral
argument_list|(
literal|"\x1a\x2b\x3c\x4d\x5e\x6f"
argument_list|)
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
specifier|const
name|QByteArray
name|PSK_SERVER_IDENTITY_HINT
init|=
name|QByteArrayLiteral
argument_list|(
literal|"QtTestServerHint"
argument_list|)
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
function_decl|;
name|void
name|verifyClientCertificate_data
parameter_list|()
function_decl|;
name|void
...
name|QT_NO_OPENSSL
name|void
name|simplePskConnect_data
parameter_list|()
function_decl|;
name|void
name|simplePskConnect
parameter_list|()
function_decl|;
name|void
name|ephemeralServerKey_data
parameter_list|()
function_decl|;
name|void
...
name|Q_DECLARE_METATYPE
argument_list|(
argument|tst_QSslSocket::PskConnectTestType
argument_list|)
end_macro
begin_endif
endif|#
...
name|QSKIP
argument_list|(
literal|"Skipping flaky test - See QTBUG-29941"
argument_list|)
expr_stmt|;
name|socket
operator|->
...
argument_list|)
expr_stmt|;
comment|// check the SSL errors contain HostNameMismatch and an error due to
comment|// the certificate being self-signed
name|SslErrorList
name|sslErrors
decl_stmt|;
foreach|foreach
...
argument_list|)
expr_stmt|;
comment|// check the same errors were emitted by sslErrors
name|QVERIFY
argument_list|(
operator|!
name|sslErrorsSpy
...
argument_list|)
expr_stmt|;
comment|// check the same errors were emitted by peerVerifyError
name|QVERIFY
argument_list|(
operator|!
name|peerVerifyErrorSpy
...
argument_list|)
expr_stmt|;
comment|// Add CA certificates to verify client certificate
if|if
condition|(
operator|!
name|addCaCertificates
...
expr_stmt|;
block|}
comment|// If we have a cert issued directly from the CA
if|if
condition|(
name|m_interFile
operator|.
...
condition|)
return|return;
comment|// First using the default (server preference)
block|{
name|SslServer
name|server
decl_stmt|;
...
block|}
block|{
comment|// Now using the client preferences
name|SslServer
name|server
decl_stmt|;
name|QSslConfiguration
...
argument_list|(
name|SRCDIR
literal|"certs/leaf.key"
argument_list|)
argument_list|,
name|QLatin1String
argument_list|(
name|SRCDIR
literal|"certs/leaf.crt"
argument_list|)
argument_list|,
name|QLatin1String
argument_list|(
name|SRCDIR
literal|"certs/inter.crt"
argument_list|)
argument_list|)
decl_stmt|;
name|QVERIFY
...
name|QByteArray
argument_list|(
literal|"10:a0:ad:77:58:f6:6e:ae:46:93:a3:43:f9:59:8a:9e"
argument_list|)
argument_list|)
expr_stmt|;
name|QCOMPARE
...
name|QByteArray
argument_list|(
literal|"3b:eb:99:c5:ea:d8:0b:5d:0b:97:5d:4f:06:75:4b:e1"
argument_list|)
argument_list|)
expr_stmt|;
name|socket
...
name|QLatin1String
argument_list|(
literal|"DHE-RSA-AES256-SHA:DHE-DSS-AES256-SHA"
argument_list|)
expr_stmt|;
name|QVERIFY
argument_list|(
...
name|newRow
argument_list|(
literal|"SelfSignedCert:AutoVerifyPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"SelfSignedCert:QueryPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"SelfSignedCert:VerifyNone"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"SelfSignedCert:VerifyPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
literal|false
expr_stmt|;
comment|// valid certificate, but wrong usage (server certificate)
name|QList
argument_list|<
name|QSslCertificate
argument_list|>
...
argument_list|(
name|SRCDIR
literal|"certs/bogus-server.crt"
argument_list|)
decl_stmt|;
name|QCOMPARE
argument_list|(
...
argument_list|(
name|SRCDIR
literal|"certs/bogus-server.key"
argument_list|)
decl_stmt|;
name|QVERIFY
argument_list|(
...
name|newRow
argument_list|(
literal|"ValidServerCert:AutoVerifyPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"ValidServerCert:QueryPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"ValidServerCert:VerifyNone"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"ValidServerCert:VerifyPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
literal|false
expr_stmt|;
comment|// valid certificate, correct usage (client certificate)
name|QList
argument_list|<
name|QSslCertificate
argument_list|>
...
argument_list|(
name|SRCDIR
literal|"certs/bogus-client.crt"
argument_list|)
decl_stmt|;
name|QCOMPARE
argument_list|(
...
argument_list|(
name|SRCDIR
literal|"certs/bogus-client.key"
argument_list|)
decl_stmt|;
name|QVERIFY
argument_list|(
...
name|newRow
argument_list|(
literal|"ValidClientCert:AutoVerifyPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"ValidClientCert:QueryPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"ValidClientCert:VerifyNone"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
name|newRow
argument_list|(
literal|"ValidClientCert:VerifyPeer"
argument_list|)
operator|<<
name|QSslSocket
operator|::
...
literal|true
expr_stmt|;
comment|// valid certificate, correct usage (client certificate), with chain
name|validCerts
operator|+=
name|QSslCertificate
operator|::
...
name|newRow
argument_list|(
literal|"PskConnectDoNotHandlePsk"
argument_list|)
operator|<<
name|PskConnectDoNotHandlePsk
expr_stmt|;
...
name|newRow
argument_list|(
literal|"PskConnectEmptyCredentials"
argument_list|)
operator|<<
name|PskConnectEmptyCredentials
expr_stmt|;
...
name|newRow
argument_list|(
literal|"PskConnectWrongCredentials"
argument_list|)
operator|<<
name|PskConnectWrongCredentials
expr_stmt|;
...
name|newRow
argument_list|(
literal|"PskConnectWrongIdentity"
argument_list|)
operator|<<
name|PskConnectWrongIdentity
expr_stmt|;
...
name|newRow
argument_list|(
literal|"PskConnectWrongPreSharedKey"
argument_list|)
operator|<<
name|PskConnectWrongPreSharedKey
expr_stmt|;
...
name|newRow
argument_list|(
literal|"PskConnectRightCredentialsPeerVerifyFailure"
argument_list|)
operator|<<
name|PskConnectRightCredentialsPeerVerifyFailure
expr_stmt|;
...
name|newRow
argument_list|(
literal|"PskConnectRightCredentialsVerifyPeer"
argument_list|)
operator|<<
name|PskConnectRightCredentialsVerifyPeer
expr_stmt|;
...
name|newRow
argument_list|(
literal|"PskConnectRightCredentialsDoNotVerifyPeer"
argument_list|)
operator|<<
name|PskConnectRightCredentialsDoNotVerifyPeer
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"This test requires change 1f8cab2c3bcd91335684c95afa95ae71e00a94e4 on the network test server, QTQAINFRA-917"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|QSKIP
argument_list|(
literal|"SSL implementation does not support the necessary PSK cipher(s)"
argument_list|)
expr_stmt|;
name|QFETCH_GLOBAL
argument_list|(
...
name|QSKIP
argument_list|(
literal|"This test must not be going through a proxy"
argument_list|)
expr_stmt|;
name|QSslSocket
name|socket
...
expr_stmt|;
name|QSignalSpy
name|pskAuthenticationRequiredSpy
argument_list|(
operator|&
name|socket
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// force a PSK cipher w/o auth
name|socket
operator|.
name|setCiphers
argument_list|(
...
name|PskConnectDoNotHandlePsk
case|:
comment|// don't connect to the provider
break|break;
case|case
name|PskConnectEmptyCredentials
case|:
comment|// connect to the psk provider, but don't actually provide any PSK nor identity
name|connect
argument_list|(
operator|&
name|socket
...
name|PskConnectWrongCredentials
case|:
comment|// provide totally wrong credentials
name|provider
operator|.
name|setIdentity
argument_list|(
...
name|PskConnectWrongIdentity
case|:
comment|// right PSK, wrong identity
name|provider
operator|.
name|setIdentity
argument_list|(
...
name|PskConnectWrongPreSharedKey
case|:
comment|// right identity, wrong PSK
name|provider
operator|.
name|setIdentity
argument_list|(
...
name|PskConnectRightCredentialsPeerVerifyFailure
case|:
comment|// right identity, right PSK, but since we can't verify the other peer, we'll fail
name|provider
operator|.
name|setIdentity
argument_list|(
...
name|PskConnectRightCredentialsVerifyPeer
case|:
comment|// right identity, right PSK, verify the peer (but ignore the failure) and establish the connection
name|provider
operator|.
name|setIdentity
argument_list|(
...
name|PskConnectRightCredentialsDoNotVerifyPeer
case|:
comment|// right identity, right PSK, do not verify the peer and establish the connection
name|provider
operator|.
name|setIdentity
argument_list|(
...
break|break;
block|}
comment|// check the peer verification mode
switch|switch
condition|(
name|pskTestType
condition|)
...
argument_list|)
expr_stmt|;
comment|// We must get the PSK signal in all cases
name|QCOMPARE
argument_list|(
name|pskAuthenticationRequiredSpy
operator|.
...
name|PskConnectRightCredentialsPeerVerifyFailure
case|:
comment|// Peer verification failure
name|QCOMPARE
argument_list|(
name|socketErrorsSpy
operator|.
...
name|PskConnectRightCredentialsVerifyPeer
case|:
comment|// Peer verification failure, but ignore it and keep connecting
name|QCOMPARE
argument_list|(
name|socketErrorsSpy
operator|.
...
name|PskConnectRightCredentialsDoNotVerifyPeer
case|:
comment|// No peer verification => no failure
name|QCOMPARE
argument_list|(
name|socketErrorsSpy
operator|.
...
name|newRow
argument_list|(
literal|"NonForwardSecrecyCipher"
argument_list|)
operator|<<
literal|"RC4-SHA"
operator|<<
