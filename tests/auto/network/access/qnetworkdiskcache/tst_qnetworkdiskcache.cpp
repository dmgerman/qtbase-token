...
function_decl|;
name|void
name|setCookieHeaderMetaDataChangedSlot
parameter_list|()
function_decl|;
private|private
name|slots
...
name|url
decl_stmt|;
comment|// used by accessAfterRemove(), setCookieHeader()
DECL|member|diskCache
name|QNetworkDiskCache
modifier|*
name|diskCache
decl_stmt|;
comment|// used by accessAfterRemove()
DECL|member|manager
name|QNetworkAccessManager
modifier|*
name|manager
decl_stmt|;
comment|// used by setCookieHeader()
block|}
class|;
end_class
begin_comment
...
argument_list|)
expr_stmt|;
comment|// this used to cause a crash later on
block|}
end_function
begin_function
...
expr_stmt|;
comment|// cache magic
comment|// Following code works only for cache file version 8 and should be updated on version change
name|out
operator|<<
name|qint32
argument_list|(
