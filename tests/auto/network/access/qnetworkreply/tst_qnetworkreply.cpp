...
argument_list|)
expr_stmt|;
comment|//qDebug()<< reply->errorString();
name|QFETCH
argument_list|(
name|int
argument_list|,
...
comment|//    QFile *file41 = new QFile(SRCDIR "/image1.jpg");
...
decl_stmt|;
comment|// apparently, because of some weird behaviour of SRCDIR, the file name below needs to start with a slash
name|QList
argument_list|<
...
argument_list|)
decl_stmt|;
comment|// Do not use credentials
name|request
operator|.
name|setAttribute
argument_list|(
...
comment|// QNetworkRequest, see http://bugreports.qt.nokia.com/browse/QTBUG-14774
if|if
condition|(
name|url
operator|.
