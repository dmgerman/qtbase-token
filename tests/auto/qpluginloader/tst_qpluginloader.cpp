...
function_decl|;
name|void
name|checkingStubsFromDifferentDrives
parameter_list|()
function_decl|;
name|void
name|loadDebugObj
...
name|Q_OS_SYMBIAN
argument_list|)
comment|// This test needs C-drive + some additional drive (driveForStubs)
specifier|const
name|QString
name|driveForStubs
argument_list|(
...
name|stubName
argument_list|(
literal|"dummyStub.qtplugin"
argument_list|)
decl_stmt|;
specifier|const
name|QString
name|fullStubFileName
argument_list|(
name|stubDir
operator|+
name|stubName
...
argument_list|)
expr_stmt|;
comment|// create a stub dir and do stub drive check
if|if
condition|(
operator|!
name|dir
...
name|QSKIP
argument_list|(
literal|"Required drive not available for this test"
argument_list|,
name|SkipSingle
argument_list|)
expr_stmt|;
block|{
comment|// test without stub, should not be found
name|QPluginLoader
name|loader
argument_list|(
literal|"C:/"
...
expr_stmt|;
block|}
comment|// create a stub to defined drive
name|QFile
name|tempFile
argument_list|(
name|driveForStubs
...
decl_stmt|;
block|{
comment|// now should be found even tried to find from C:
name|QPluginLoader
name|loader
argument_list|(
literal|"C:/"
...
name|QWARN
argument_list|(
literal|"Could not remove stub file"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|QWARN
argument_list|(
literal|"Could not remove stub directory"
argument_list|)
expr_stmt|;
comment|// test after cleanup
name|QVERIFY
argument_list|(
name|test1
argument_list|)
