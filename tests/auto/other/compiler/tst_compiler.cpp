...
define|#
directive|define
name|DONT_TEST_TEMPLATE_METHODS
end_define
begin_define
...
define|#
directive|define
name|DONT_TEST_METHOD_SPECIALIZATION
end_define
begin_define
...
define|#
directive|define
name|DONT_TEST_STATIC_TEMPLATE_METHODS
end_define
begin_define
DECL|macro|DONT_TEST_STATIC_TEMPLATE_METHOD_SPECIALIZATION
define|#
directive|define
name|DONT_TEST_STATIC_TEMPLATE_METHOD_SPECIALIZATION
end_define
begin_define
...
name|QSKIP
argument_list|(
literal|"Compiler doesn't do template methods"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Compiler doesn't do template specialization"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Compiler doesn't do static template methods"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Compiler doesn't do static template method specialization"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"MS VC 6.0 instantiates the char function for type unsigned char."
argument_list|,
name|SkipSingle
argument_list|)
expr_stmt|;
