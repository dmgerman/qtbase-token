...
argument_list|)
expr_stmt|;
comment|// trigger launching of at-spi if it isn't running already
...
argument_list|)
decl_stmt|;
comment|// don't care about the result, calling any function on "org.a11y.Bus" will launch the service
name|a11yStatus
operator|->
name|isEnabled
argument_list|()
...
name|QSKIP
argument_list|(
literal|"Could not connect to AT-SPI, make sure lib atspi2 is installed."
argument_list|)
expr_stmt|;
name|QTRY_VERIFY
argument_list|(
...
name|QDBusInterface
modifier|*
name|accessibleInterfaceLineEdit1
init|=
name|getInterface
argument_list|(
name|children
...
name|QDBusInterface
modifier|*
name|accessibleInterfaceLineEdit2
init|=
name|getInterface
argument_list|(
name|children
...
name|QDBusInterface
modifier|*
name|componentInterfaceLineEdit1
init|=
name|getInterface
argument_list|(
name|children
...
argument_list|)
argument_list|,
literal|"org.a11y.atspi.Component"
argument_list|)
decl_stmt|;
name|QVERIFY
argument_list|(
...
name|QDBusInterface
modifier|*
name|componentInterfaceLineEdit2
init|=
name|getInterface
argument_list|(
name|children
