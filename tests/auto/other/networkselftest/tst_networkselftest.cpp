...
include|#
directive|include
file|<QtCore/private/qiodevice_p.h>
end_include
begin_ifndef
ifndef|#
directive|ifndef
...
name|smbclient
argument_list|,
literal|"Listing servers timed out"
argument_list|)
argument_list|)
expr_stmt|;
if|if
