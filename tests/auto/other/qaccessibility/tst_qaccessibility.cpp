...
argument_list|)
expr_stmt|;
comment|// test Controller/Controlled relations
block|{
name|QCheckBox
name|toggler
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//    QTestEventList keys;
comment|//    keys.addKeyClick('D');
comment|//    keys.addKeyClick('E');
comment|//    keys.addKeyClick(Qt::Key_Left);
comment|//    keys.addKeyClick(Qt::Key_Left);
comment|//    keys.addKeyClick('C');
comment|//    keys.addKeyClick('O');
comment|//    keys.simulate(lineEdit);
comment|//    FIXME: Test key press events...
block|}
operator|delete
name|toplevel
expr_stmt|;
