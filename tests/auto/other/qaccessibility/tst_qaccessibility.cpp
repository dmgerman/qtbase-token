...
parameter_list|)
define|\
value|do { \         if (!errorAt&& !(cond)) { \             errorAt = __LINE__; \             qWarning("level: %d, role: %d (%s)", treelevel, iface->role(), #cond); \             break; \         } \     } while (0)
end_define
begin_function
...
function_decl|;
name|void
name|lineEditTextFunctions_data
parameter_list|()
function_decl|;
name|void
name|lineEditTextFunctions
parameter_list|()
function_decl|;
name|void
name|textInterfaceTest_data
parameter_list|()
function_decl|;
name|void
name|textInterfaceTest
parameter_list|()
function_decl|;
name|void
name|groupBoxTest
...
name|button
expr_stmt|;
comment|// Make sure that invalid events don't bring down the system
comment|// these events can be in user code.
name|QWidget
modifier|*
name|widget
init|=
...
argument_list|)
expr_stmt|;
comment|// By default we create QAccessibleWidget
name|QAccessibleInterface
modifier|*
name|iface
init|=
...
argument_list|)
expr_stmt|;
comment|// The help text is only set if our factory works
name|QCOMPARE
argument_list|(
name|iface
operator|->
...
block|}
block|{
comment|// A subclass of any class should still get the right QAccessibleInterface
...
literal|0
expr_stmt|;
comment|// fixme: QVERIFY(!iface->isValid());
block|}
end_function
begin_function
...
end_function
begin_comment
comment|// note: color should probably always be part of the attributes
end_comment
begin_function
...
name|QString
argument_list|(
literal|"font-style:normal;font-weight:normal;text-align:left;text-position:baseline;font-size:13pt"
argument_list|)
operator|.
name|split
argument_list|(
...
name|append
argument_list|(
literal|"text-underline-type:single"
argument_list|)
expr_stmt|;
name|defaultFontDifferent
operator|.
...
name|QLatin1String
argument_list|(
literal|"<html><p align=\"right\">right</p>"
argument_list|)
decl_stmt|;
name|QTest
operator|::
...
name|QLatin1String
argument_list|(
literal|"<html><p><b>left</b></p><p align=\"right\">right</p><p><b>left</b></p>"
argument_list|)
decl_stmt|;
name|QTest
operator|::
...
name|newRow
argument_list|(
literal|"empty with no fragments"
argument_list|)
operator|<<
name|defaultFont
operator|<<
...
end_function
begin_comment
comment|// Dialogs and other sub-windows must appear in the
end_comment
begin_comment
comment|// accessibility hierarchy exactly once as top level objects
end_comment
begin_function
...
argument_list|)
expr_stmt|;
comment|// make sure that the line edit is not there
specifier|const
name|int
name|numChildren
init|=
...
end_function
begin_comment
comment|/* The rects does not have to be exactly the same. They may be slightly different due to    different ways of calculating them. By having an acceptable delta, this should also    make the test a bit more resilient against any future changes in the behavior of    characterRect(). */
end_comment
begin_function
DECL|function|fuzzyRectCompare
specifier|static
name|bool
name|fuzzyRectCompare
parameter_list|(
specifier|const
name|QRect
modifier|&
...
argument_list|)
expr_stmt|;
comment|// check that we have newlines handled
name|QString
name|poem
init|=
name|QStringLiteral
argument_list|(
literal|"Once upon a midnight dreary,\nwhile I pondered, weak and weary,\nOver many a quaint and curious volume of forgotten lore\n"
argument_list|)
decl_stmt|;
...
name|QStringLiteral
argument_list|(
literal|"while I pondered, weak and weary,"
argument_list|)
argument_list|)
expr_stmt|;
name|QCOMPARE
...
argument_list|()
expr_stmt|;
comment|// make sure we get notifications when typing text
name|QTestEventList
name|keys
decl_stmt|;
name|keys
...
argument_list|()
expr_stmt|;
comment|// FIXME this should get a proper string instead of space
...
argument_list|)
expr_stmt|;
comment|// it would be nicer to get a text update event, but the current implementation
comment|// instead does remove and insert which is also fine
name|edit
operator|.
name|setText
argument_list|(
...
name|QStringLiteral
argument_list|(
literal|"My characters have geometries."
argument_list|)
argument_list|,
name|toplevel
argument_list|)
decl_stmt|;
comment|// characterRect()
name|le
operator|.
name|show
argument_list|()
...
argument_list|()
decl_stmt|;
comment|// Only first 10 characters, check if they are within the bounds of line edit
for|for
control|(
name|int
name|i
...
argument_list|>
argument_list|(
literal|"textFunction"
argument_list|)
expr_stmt|;
comment|// before = 0, at = 1, after = 2
name|QTest
operator|::
name|addColumn
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// -2 gives cursor position, -1 is length
comment|// invalid positions will return empty strings and either -1 and -1 or both the cursor position, both is fine
name|QTest
operator|::
name|newRow
argument_list|(
literal|"char before -2"
argument_list|)
operator|<<
literal|"hello"
operator|<<
...
argument_list|()
decl_stmt|;
comment|// On OS X>= 10.9 the scrollbar will be hidden unless explicitly enabled in the preferences
name|bool
...
argument_list|)
expr_stmt|;
comment|// verify that unique id stays the same
name|QAccessible
operator|::
name|Id
name|axidMunich
...
argument_list|)
decl_stmt|;
comment|// insertion and deletion of items
name|listView
operator|->
name|insertItem
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// list: Oslo, Helsinki, Berlin, Brisbane, Munich
name|QAccessibleInterface
modifier|*
name|cellMunich2
init|=
...
argument_list|)
expr_stmt|;
comment|// list: Oslo, Helsinki, Munich
name|QAccessibleInterface
modifier|*
name|cellMunich3
init|=
...
name|QTreeWidget
decl_stmt|;
comment|// Empty model (do not crash, etc)
name|treeView
operator|->
name|setColumnCount
argument_list|(
...
end_function
begin_comment
comment|// The table used below is this:
end_comment
begin_comment
comment|// Button  (0) | h1   (1) | h2   (2) | h3   (3)
end_comment
begin_comment
comment|// v1      (4) | 0.0  (5) | 1.0  (6) | 2.0  (7)
end_comment
begin_comment
comment|// v2      (8) | 0.1  (9) | 1.1 (10) | 2.1 (11)
end_comment
begin_comment
comment|// v3     (12) | 0.2 (13) | 1.2 (14) | 2.2 (15)
end_comment
begin_function
...
argument_list|)
expr_stmt|;
comment|// modification: inserting and removing rows/columns
name|tableView
operator|->
name|insertRow
argument_list|(
...
comment|// v1      (4) | 0.0  (5) | 1.0  (6) | 2.0  (7)
comment|// v2      (8) | 0.1  (9) | 1.1 (10) | 2.1 (11)
comment|// new    (12) |     (13) |     (14) |     (15)
comment|// v3     (16) | 0.2 (17) | 1.2 (18) | 2.2 (19)
name|QAccessibleInterface
modifier|*
name|cell00_new
init|=
...
argument_list|)
expr_stmt|;
comment|// Button  (0) | h1   (1) | h2   (2) |  (3) | h3   (4)
comment|// v1      (5) | 0.0  (6) | 1.0  (7) |  (8) | 2.0  (9)
comment|// v2     (10) | 0.1 (11) | 1.1 (12) | (13) | 2.1 (14)
comment|// new    (15) |     (16) |     (17) | (18) |     (19)
comment|// v3     (20) | 0.2 (21) | 1.2 (22) | (23) | 2.2 (24)
name|cell00_new
operator|=
name|table2
operator|->
...
expr_stmt|;
block|}
comment|// Dock widgets consist of
comment|// 0 contents
comment|// 1 close button
comment|// 2 float button
name|QVERIFY
argument_list|(
name|accDock1
argument_list|)
...
literal|""
argument_list|,
literal|"Dock Widget geometry on Mac seems broken."
argument_list|,
name|Continue
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// custom title bar widget
name|QDockWidget
modifier|*
name|dock3
init|=
...
name|h
decl_stmt|;
comment|// Do not crash on insane arguments.
name|varChild
operator|.
name|lVal
operator|=
...
argument_list|()
expr_stmt|;
comment|/***** Test IAccessibleRelation *****/
name|long
name|nRelations
init|=
literal|0
...
block|{
comment|// Get the second child (the accessible interface for the table widget)
name|varChild
operator|.
name|vt
operator|=
