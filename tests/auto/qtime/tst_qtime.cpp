...
parameter_list|()
block|{
comment|// Since we can't define an element of Qt::DateFormat, t1 will be the time
comment|// expected when we have a TextDate, and t2 will be the time expected when
...
parameter_list|()
block|{
comment|// Since we can't define an element of Qt::DateFormat, str1 will be the string
comment|// in TextDate format, and str2 will be the time in ISODate format.
name|QTest
operator|::
name|addColumn
argument_list|<
