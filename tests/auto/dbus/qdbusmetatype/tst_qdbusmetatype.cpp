...
struct|struct
name|Struct5
comment|// a{sa{sv}} - non-standard outer struct is used as a local
block|{
comment|// container, see marshalling operator below.
DECL|member|m1
name|QVariantMap
name|m1
decl_stmt|;
...
struct|struct
name|Struct6
comment|// av - non-standard outer struct is used as a local container,
block|{
comment|// see marshalling operator below.
DECL|member|v1
name|QVariant
name|v1
decl_stmt|;
