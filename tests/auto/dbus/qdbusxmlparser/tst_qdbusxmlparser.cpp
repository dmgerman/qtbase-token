...
function_decl|;
name|void
name|objectWithContent_data
parameter_list|()
function_decl|;
name|void
name|objectWithContent
parameter_list|()
function_decl|;
name|void
name|methods_data
...
argument_list|)
operator|<<
literal|"<node><node name=\"obj\"/></node>"
operator|<<
literal|"obj"
operator|<<
literal|0
...
name|newRow
argument_list|(
literal|"two-nodes-two-interfaces"
argument_list|)
operator|<<
name|xmlData
operator|<<
...
name|newRow
argument_list|(
literal|"two-nodes-one-interface"
argument_list|)
operator|<<
name|xmlData
operator|<<
...
argument_list|)
expr_stmt|;
comment|// verify the object names
name|int
name|i
init|=
literal|0
