...
name|qWarning
argument_list|(
literal|"%s: Cannot create temporary file: %s"
argument_list|,
name|Q_FUNC_INFO
argument_list|,
name|qPrintable
...
name|QtWarningMsg
argument_list|,
literal|"QDBusConnection: error: could not send signal to service \"\" path \"/foo\" interface \"local.interfaceName\" member \"signalName\": Marshalling failed: Invalid object path passed in arguments"
argument_list|)
expr_stmt|;
name|QVERIFY
argument_list|(
...
name|QtWarningMsg
argument_list|,
literal|"QDBusConnection: error: could not send signal to service \"\" path \"/foo\" interface \"local.interfaceName\" member \"signalName\": Marshalling failed: Invalid signature passed in arguments"
argument_list|)
expr_stmt|;
name|QVERIFY
argument_list|(
...
end_struct
begin_comment
comment|// mostly the same as qdbusintegrator.cpp:connectionCapabilies
end_comment
begin_function
