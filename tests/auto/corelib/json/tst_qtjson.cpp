...
function_decl|;
name|void
name|arrayInitializerList
parameter_list|()
function_decl|;
name|void
name|objectInitializerList
parameter_list|()
function_decl|;
private|private:
...
argument_list|)
expr_stmt|;
comment|// There is not way to check if internal temporary storage for QJsonValueRef is removed correctly by
comment|// remove, take or compaction but at least we should not crash
name|nullObject
index|[
literal|"foo"
index|]
...
argument_list|)
expr_stmt|;
comment|// check that an internal udefined doesn't show up
name|null
index|[
literal|"undefined"
index|]
...
argument_list|)
expr_stmt|;
comment|// check an empty object with an internal undefined
name|QJsonValueRef
name|unused
init|=
name|object
...
name|newRow
argument_list|(
literal|"the same object (1 vs 2)"
argument_list|)
operator|<<
name|object1
operator|<<
...
name|newRow
argument_list|(
literal|"the same object (3 vs 3)"
argument_list|)
operator|<<
name|object3
operator|<<
...
name|newRow
argument_list|(
literal|"different objects (2 vs 3)"
argument_list|)
operator|<<
name|object2
operator|<<
...
name|newRow
argument_list|(
literal|"referenced empty vs default"
argument_list|)
operator|<<
name|referencedEmpty
operator|<<
...
name|newRow
argument_list|(
literal|"referenced empty vs referenced empty"
argument_list|)
operator|<<
name|referencedEmpty
operator|<<
...
name|newRow
argument_list|(
literal|"referenced empty vs object"
argument_list|)
operator|<<
name|referencedEmpty
operator|<<
...
name|newRow
argument_list|(
literal|"referenced object vs default"
argument_list|)
operator|<<
name|referencedObject1
operator|<<
...
name|newRow
argument_list|(
literal|"referenced object vs referenced object"
argument_list|)
operator|<<
name|referencedObject1
operator|<<
...
name|newRow
argument_list|(
literal|"referenced object vs object (same)"
argument_list|)
operator|<<
name|referencedObject1
operator|<<
...
name|newRow
argument_list|(
literal|"referenced object vs object (different)"
argument_list|)
operator|<<
name|referencedObject1
operator|<<
...
name|newRow
argument_list|(
literal|"referenced object vs referenced object (same)"
argument_list|)
operator|<<
name|referencedObject1
operator|<<
...
argument_list|)
expr_stmt|;
comment|// The same but from QJsonValue perspective
name|QCOMPARE
argument_list|(
name|QJsonValue
argument_list|(
...
name|newRow
argument_list|(
literal|"different arrays (2 vs 3)"
argument_list|)
operator|<<
name|array2
operator|<<
...
name|QSKIP
argument_list|(
literal|"initializer_list is enabled only with c++11 support"
argument_list|)
expr_stmt|;
else|#
directive|else
