...
name|QSKIP
argument_list|(
literal|"Encoding IBM500 not available."
argument_list|)
expr_stmt|;
block|}
name|writer
...
argument_list|)
expr_stmt|;
comment|// convert the start of the XML
specifier|const
name|QString
name|expected
init|=
operator|(
literal|"<?xml version=\"1.0\" encoding=\"IBM500\"?>"
operator|)
decl_stmt|;
name|QTextDecoder
modifier|*
