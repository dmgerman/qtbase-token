...
function_decl|;
name|void
name|qprintable_data
parameter_list|()
function_decl|;
name|void
name|buildAbiEndianness
parameter_list|()
function_decl|;
name|void
name|testqOverload
...
argument_list|)
expr_stmt|;
comment|// index of utf8 string
comment|// Unicode: HIRAGANA LETTER A, I, U, E, O (U+3442, U+3444, U+3446, U+3448, U+344a)
specifier|static
specifier|const
name|char
modifier|*
...
name|utf8string
init|=
literal|"\xe3\x81\x82\xe3\x81\x84\xe3\x81\x86\xe3\x81\x88\xe3\x81\x8a"
decl_stmt|;
specifier|static
specifier|const
name|char
...
name|eucjpstring
init|=
literal|"\xa4\xa2\xa4\xa4\xa4\xa6\xa4\xa8\xa4\xaa"
decl_stmt|;
specifier|static
specifier|const
name|char
...
name|sjisstring
init|=
literal|"\x82\xa0\x82\xa2\x82\xa4\x82\xa6\x82\xa8"
decl_stmt|;
name|QList
argument_list|<
name|stringpair
argument_list|>
name|japanesestrings
decl_stmt|;
name|japanesestrings
operator|<<
name|stringpair
...
comment|// void returning free overloaded functions
name|QVERIFY
argument_list|(
name|QOverload
argument_list|<>
...
name|QVERIFY
argument_list|(
argument|(QOverload<QByteArray, const QString&>::of(&freeOverloaded)) ==              static_cast<void (*)(QByteArray, const QString&)>(&freeOverloaded)
argument_list|)
empty_stmt|;
...
argument_list|)
expr_stmt|;
comment|// void returning overloaded member functions
name|QVERIFY
argument_list|(
argument|QOverload<>::of(&Overloaded::foo) ==              static_cast<void (Overloaded::*)()>(&Overloaded::foo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|QOverload<QByteArray>::of(&Overloaded::foo) ==              static_cast<void (Overloaded::*)(QByteArray)>(&Overloaded::foo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|(QOverload<QByteArray, const QString&>::of(&Overloaded::foo)) ==              static_cast<void (Overloaded::*)(QByteArray, const QString&)>(&Overloaded::foo)
argument_list|)
empty_stmt|;
comment|// void returning overloaded const member functions
name|QVERIFY
argument_list|(
argument|QOverload<>::of(&Overloaded::constFoo) ==              static_cast<void (Overloaded::*)() const>(&Overloaded::constFoo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|QOverload<QByteArray>::of(&Overloaded::constFoo) ==              static_cast<void (Overloaded::*)(QByteArray) const>(&Overloaded::constFoo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|(QOverload<QByteArray, const QString&>::of(&Overloaded::constFoo)) ==              static_cast<void (Overloaded::*)(QByteArray, const QString&) const>(&Overloaded::constFoo)
argument_list|)
empty_stmt|;
comment|// void returning overloaded const AND non-const member functions
name|QVERIFY
argument_list|(
argument|QNonConstOverload<>::of(&Overloaded::mixedFoo) ==              static_cast<void (Overloaded::*)()>(&Overloaded::mixedFoo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|QConstOverload<QByteArray>::of(&Overloaded::mixedFoo) ==              static_cast<void (Overloaded::*)(QByteArray) const>(&Overloaded::mixedFoo)
argument_list|)
empty_stmt|;
if|#
directive|if
...
name|QVERIFY
argument_list|(
argument|qOverload<>(&Overloaded::foo) ==              static_cast<void (Overloaded::*)()>(&Overloaded::foo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|qOverload<QByteArray>(&Overloaded::foo) ==              static_cast<void (Overloaded::*)(QByteArray)>(&Overloaded::foo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|(qOverload<QByteArray, const QString&>(&Overloaded::foo)) ==              static_cast<void (Overloaded::*)(QByteArray, const QString&)>(&Overloaded::foo)
argument_list|)
empty_stmt|;
comment|// void returning overloaded const member functions
name|QVERIFY
argument_list|(
argument|qOverload<>(&Overloaded::constFoo) ==              static_cast<void (Overloaded::*)() const>(&Overloaded::constFoo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|qOverload<QByteArray>(&Overloaded::constFoo) ==              static_cast<void (Overloaded::*)(QByteArray) const>(&Overloaded::constFoo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|(qOverload<QByteArray, const QString&>(&Overloaded::constFoo)) ==              static_cast<void (Overloaded::*)(QByteArray, const QString&) const>(&Overloaded::constFoo)
argument_list|)
empty_stmt|;
comment|// void returning overloaded const AND non-const member functions
name|QVERIFY
argument_list|(
argument|qNonConstOverload<>(&Overloaded::mixedFoo) ==              static_cast<void (Overloaded::*)()>(&Overloaded::mixedFoo)
argument_list|)
empty_stmt|;
name|QVERIFY
argument_list|(
argument|qConstOverload<QByteArray>(&Overloaded::mixedFoo) ==              static_cast<void (Overloaded::*)(QByteArray) const>(&Overloaded::mixedFoo)
argument_list|)
empty_stmt|;
endif|#
directive|endif
