...
argument_list|()
expr_stmt|;
comment|// can't match anything, just test validity
name|QTest
operator|::
name|newRow
argument_list|(
...
argument_list|)
operator|<<
literal|"/%{time yyyy - MM - d}/%{time dd-MM-yy}/%{message}"
operator|<<
literal|true
operator|<<
operator|(
...
name|newRow
argument_list|(
literal|"skipped-time-shown-time"
argument_list|)
operator|<<
literal|"/%{if-warning}%{time yyyy - MM - d}%{endif}%{if-debug}%{time dd-MM-yy}%{endif}/%{message}"
operator|<<
literal|true
operator|<<
operator|(
...
name|format
init|=
literal|"[%{if-debug}D%{endif}%{if-info}I%{endif}%{if-warning}W%{endif}%{if-critical}C%{endif}%{if-fatal}F%{endif}] %{if-category}%{category}: %{endif}%{message}"
decl_stmt|;
name|QTest
operator|::
name|newRow
