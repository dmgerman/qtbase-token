...
function_decl|;
name|void
name|nestedTransactionsResult_data
parameter_list|()
function_decl|;
name|void
name|nestedTransactionsResult
parameter_list|()
function_decl|;
private|private:
name|void
...
argument_list|)
expr_stmt|;
comment|// test the previously latched error status is not affected by reading
name|MAP_TEST
argument_list|(
name|QByteArray
argument_list|(
...
name|QByteArray
argument_list|(
literal|"\x00\x00\x00\x01\x00\x00\x00\x00"
argument_list|,
literal|8
argument_list|)
argument_list|,
...
name|QByteArray
argument_list|(
literal|"\x00\x00\x00\x02\x00\x00\x00\x02\x00J"
literal|"\x00\x00\x00\x04\x00M\x00N"
argument_list|,
literal|18
argument_list|)
argument_list|,
...
name|QByteArray
argument_list|(
literal|"\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00"
argument_list|,
name|i
argument_list|)
argument_list|,
...
name|QByteArray
argument_list|(
literal|"\x00\x00\x00\x02\x00\x00\x00\x01\x00J"
literal|"\x00\x00\x00\x02\x00M\x00N"
argument_list|,
literal|18
argument_list|)
argument_list|,
...
expr_stmt|;
block|}
comment|// QTime() was serialized to (0, 0, 0, 0) in Qt3, not (0xFF, 0xFF, 0xFF, 0xFF)
comment|// This is because in Qt3 a null time was valid, and there was no support for deserializing a value of -1.
block|{
name|QByteArray
name|stream
decl_stmt|;
