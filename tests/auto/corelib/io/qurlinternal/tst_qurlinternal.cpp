...
name|ushortarray
argument_list|(
argument|unsigned short (&array)[N]
argument_list|)
block|{
name|memcpy
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// now try the full decode mode
name|output
operator|=
name|dataTag
expr_stmt|;
...
name|newRow
argument_list|(
literal|"encode-unicode-noncharacter"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"decode-unicode-noncharacter"
argument_list|)
operator|<<
name|QString
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// verify for security reasons that all bad UTF-8 data got replaced by QChar::ReplacementCharacter
name|output
operator|=
name|QTest
operator|::
...
name|QString
argument_list|(
literal|"Character at i == %1 was U+%2"
argument_list|)
operator|.
name|arg
argument_list|(
