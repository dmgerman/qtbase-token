...
function_decl|;
name|void
name|toString_PreferLocalFile_data
parameter_list|()
function_decl|;
name|void
name|toString_PreferLocalFile
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|fromLocalFileNormalize_data
parameter_list|()
function_decl|;
name|void
name|fromLocalFileNormalize
parameter_list|()
function_decl|;
name|void
name|macTypes
...
function_decl|;
name|void
name|fromUserInputWithCwd_data
parameter_list|()
function_decl|;
name|void
name|fromUserInputWithCwd
parameter_list|()
function_decl|;
name|void
name|fileName_data
...
name|fromLatin1
argument_list|(
literal|"mailto:test[at]gmail[dot]com"
argument_list|)
operator|<<
name|uint
argument_list|(
...
name|fromLatin1
argument_list|(
literal|"mailto:?to=test@example.com"
argument_list|)
operator|<<
name|uint
argument_list|(
...
name|fromLatin1
argument_list|(
literal|"file:///c:/windows/regedit.exe"
argument_list|)
argument_list|)
operator|<<
name|QString
...
name|fromLatin1
argument_list|(
literal|"webdavs://somewebdavhost/somedir/somefile"
argument_list|)
ifdef|#
directive|ifdef
name|Q_OS_WIN
...
name|fromLatin1
argument_list|(
literal|"//somewebdavhost@SSL/somedir/somefile"
argument_list|)
expr_stmt|;
else|#
directive|else
...
argument_list|)
expr_stmt|;
comment|// should support the fromLocalFile/toLocalFile roundtrip (so no //host or windows path)
name|QTest
operator|::
name|addColumn
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// works as well as long as we don't test windows paths
name|QCOMPARE
argument_list|(
name|url
operator|.
...
argument_list|)
operator|<<
literal|"mailto:smith@example.com"
operator|<<
literal|true
operator|<<
literal|"mailto"
...
name|newRow
argument_list|(
literal|"file-2slashes"
argument_list|)
operator|<<
literal|"file://server/etc/passwd"
operator|<<
literal|true
operator|<<
literal|"file"
...
name|newRow
argument_list|(
literal|"mailto+subject"
argument_list|)
operator|<<
literal|"mailto:smith@example.com?subject=Hello%20World"
operator|<<
literal|true
operator|<<
literal|"mailto"
...
argument_list|)
operator|<<
literal|"mailto://smtp.example.com/smith@example.com"
operator|<<
literal|true
operator|<<
literal|"mailto"
expr_stmt|;
comment|// valid, but unexpected
name|QTest
operator|::
name|newRow
argument_list|(
...
name|newRow
argument_list|(
literal|"mailto-nomail"
argument_list|)
operator|<<
literal|"mailto://smtp.example.com"
operator|<<
literal|true
operator|<<
literal|"mailto"
expr_stmt|;
comment|// schemes with numbers
name|QTest
operator|::
name|newRow
argument_list|(
...
literal|"proto2"
expr_stmt|;
comment|// schemes with dots, dashes, and pluses
name|QTest
operator|::
name|newRow
argument_list|(
...
argument_list|)
operator|<<
literal|"svn+ssh://svn.example.com"
operator|<<
literal|true
operator|<<
literal|"svn+ssh"
...
argument_list|)
operator|<<
literal|"org.qt-project://qt-project.org"
operator|<<
literal|true
operator|<<
literal|"org.qt-project"
expr_stmt|;
comment|// lowercasing
name|QTest
operator|::
...
name|newRow
argument_list|(
literal|"with-non-ascii"
argument_list|)
operator|<<
literal|"\304\245\305\243\305\245\321\200://example.com"
operator|<<
literal|false
operator|<<
literal|"\304\245\305\243\305\245\321\200"
expr_stmt|;
name|QTest
operator|::
name|newRow
argument_list|(
literal|"with-control1"
argument_list|)
operator|<<
literal|"http\1://example.com"
operator|<<
literal|false
operator|<<
literal|"http\1"
...
name|newRow
argument_list|(
literal|"with-control127"
argument_list|)
operator|<<
literal|"http\177://example.com"
operator|<<
literal|false
operator|<<
literal|"http\177"
...
argument_list|)
operator|<<
literal|"%68%74%%74%70://example.com"
operator|<<
literal|false
operator|<<
literal|"%68%74%%74%70"
...
argument_list|)
expr_stmt|;
comment|// reconstruct with just the scheme:
name|url
operator|.
name|setUrl
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// a couple more which wouldn't work in parsing a full URL
name|QTest
operator|::
name|newRow
argument_list|(
...
argument_list|>
argument_list|(
literal|"guessedUrlAssumeLocalFile"
argument_list|)
expr_stmt|;
comment|// Null
name|QTest
...
name|newRow
argument_list|(
literal|"windows-absolute"
argument_list|)
operator|<<
literal|"c:/doesnotexist.txt"
operator|<<
name|QDir
operator|::
name|currentPath
...
name|QUrl
argument_list|(
literal|"file:///c:/doesnotexist.txt"
argument_list|)
operator|<<
name|QUrl
argument_list|(
...
directive|endif
comment|// IPv4& IPv6
comment|// same as fromUserInput, but needs retesting
name|QTest
operator|::
name|newRow
argument_list|(
...
name|QUrl
argument_list|,
name|guessedUrlAssumeLocalFile
argument_list|)
expr_stmt|;
name|QUrl
name|url
...
name|fromEncoded
argument_list|(
literal|"http://anything.pagespeedmobilizer.com"
argument_list|)
operator|<<
literal|".pagespeedmobilizer.com"
expr_stmt|;
name|QTest
operator|::
name|newRow
...
name|fromEncoded
argument_list|(
literal|"http://anything.eu-central-1.compute.amazonaws.com"
argument_list|)
operator|<<
literal|".eu-central-1.compute.amazonaws.com"
expr_stmt|;
name|QTest
operator|::
name|newRow
