...
directive|endif
name|void
name|qtbug15421_hiddenDirs_hiddenFiles
parameter_list|()
function_decl|;
block|}
class|;
...
name|createDirectory
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles"
argument_list|)
expr_stmt|;
name|createFile
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/normalFile"
argument_list|)
expr_stmt|;
name|createFile
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/.hiddenFile"
argument_list|)
expr_stmt|;
name|createDirectory
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/normalDirectory"
argument_list|)
expr_stmt|;
name|createDirectory
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/.hiddenDirectory"
argument_list|)
expr_stmt|;
name|createFile
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/normalDirectory/normalFile"
argument_list|)
expr_stmt|;
name|createFile
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/normalDirectory/.hiddenFile"
argument_list|)
expr_stmt|;
name|createFile
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/.hiddenDirectory/normalFile"
argument_list|)
expr_stmt|;
name|createFile
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/.hiddenDirectory/.hiddenFile"
argument_list|)
expr_stmt|;
name|createDirectory
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/normalDirectory/normalDirectory"
argument_list|)
expr_stmt|;
name|createDirectory
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/normalDirectory/.hiddenDirectory"
argument_list|)
expr_stmt|;
name|createDirectory
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/.hiddenDirectory/normalDirectory"
argument_list|)
expr_stmt|;
name|createDirectory
argument_list|(
literal|"qtbug15421_hiddenDirs_hiddenFiles/.hiddenDirectory/.hiddenDirectory"
argument_list|)
expr_stmt|;
block|}
end_constructor
