...
function_decl|;
name|void
name|stringref_write_operator_ToDevice
parameter_list|()
function_decl|;
comment|// other
name|void
...
specifier|const
name|QString
name|m_rfc3261FilePath
decl_stmt|;
DECL|member|m_shiftJisFilePath
specifier|const
name|QString
name|m_shiftJisFilePath
decl_stmt|;
block|}
class|;
end_class
...
argument_list|)
operator|<<
literal|"This will try to use QTextCodec::codecForLocale"
operator|<<
name|endl
expr_stmt|;
block|}
...
init|=
block|{
literal|"QFile::readLine()"
block|,
literal|"QTextStream::readLine()"
block|,
literal|"QTextStream::readLine(QString *)"
block|}
decl_stmt|;
name|int
name|elapsed
...
name|qDebug
argument_list|(
literal|"%s used %.3f seconds to read the file"
argument_list|,
name|readMethods
index|[
name|i
...
name|qDebug
argument_list|(
literal|"Reading by %s is %.2fx faster than by %s"
argument_list|,
name|readMethods
index|[
name|i1
...
name|QByteArray
argument_list|(
literal|"9,223,372,036,854,775,807"
argument_list|)
expr_stmt|;
name|QTest
operator|::
...
name|QByteArray
argument_list|(
literal|"-9,223,372,036,854,775,808"
argument_list|)
expr_stmt|;
name|QTest
operator|::
...
name|QByteArray
argument_list|(
literal|"18,446,744,073,709,551,615"
argument_list|)
expr_stmt|;
name|QTest
operator|::
...
name|QByteArray
argument_list|(
literal|"9,223,372,036,854,775,809"
argument_list|)
expr_stmt|;
name|QTest
operator|::
...
parameter_list|)
define|\
value|void tst_QTextStream:: texttype##_write_operator_ToDevice_data() \     { generateRealNumbersDataWrite(); } \     void tst_QTextStream:: texttype##_write_operator_ToDevice() \     { \         QFETCH(double, number); \         QFETCH(QByteArray, data); \         QFETCH(QByteArray, dataWithSeparators); \         \         QBuffer buffer; \         buffer.open(QBuffer::WriteOnly); \         QTextStream stream(&buffer); \         stream.setLocale(QLocale::c()); \         float f = (float)number; \         stream<< f; \         stream.flush(); \         QCOMPARE(buffer.data().constData(), data.constData()); \         \         buffer.reset(); \         stream.setLocale(QLocale("en-US")); \         stream<< f; \         stream.flush(); \         QCOMPARE(buffer.data(), dataWithSeparators); \     }
end_define
begin_macro
name|IMPLEMENT_STREAM_LEFT_REAL_OPERATOR_TEST
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// Text mode flag cleared here
name|QVERIFY
argument_list|(
name|file
operator|.
