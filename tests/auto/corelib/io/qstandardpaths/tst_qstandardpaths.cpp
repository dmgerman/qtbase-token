...
end_endif
begin_comment
comment|// Update this when adding new enum values; update enumNames too
end_comment
begin_decl_stmt
...
block|,
literal|"AppDataLocation"
block|,
literal|"AppConfigLocation"
block|}
decl_stmt|;
end_decl_stmt
begin_function
...
parameter_list|()
block|{
comment|// On all platforms where applications are not sandboxed,
...
name|restorer
decl_stmt|;
comment|// When $XDG_RUNTIME_DIR points to a directory with wrong ownership, QStandardPaths should warn
name|qputenv
argument_list|(
literal|"XDG_RUNTIME_DIR"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// When $XDG_RUNTIME_DIR points to a non-existing directory, QStandardPaths should warn (QTBUG-48771)
name|qputenv
argument_list|(
literal|"XDG_RUNTIME_DIR"
argument_list|,
...
name|QtWarningMsg
argument_list|,
literal|"QStandardPaths: XDG_RUNTIME_DIR points to non-existing path 'does_not_exist', please create it with 0700 permissions."
argument_list|)
expr_stmt|;
specifier|const
name|QString
name|nonExistingRuntimeDir
init|=
name|QStandardPaths
operator|::
name|writableLocation
...
argument_list|)
expr_stmt|;
comment|// When $XDG_RUNTIME_DIR points to a file, QStandardPaths should warn
specifier|const
name|QString
name|file
init|=
...
name|fromLatin1
argument_list|(
literal|"QStandardPaths: XDG_RUNTIME_DIR points to '%1' which is not a directory"
argument_list|)
operator|.
name|arg
argument_list|(
