...
argument_list|)
expr_stmt|;
comment|// check that permissions are the same as for QFile
specifier|const
name|QString
name|otherFile
init|=
...
argument_list|()
expr_stmt|;
comment|//Check that the linkFile is still a link and still has the same canonical path
name|QFileInfo
name|info
argument_list|(
name|linkFile
...
expr_stmt|;
block|}
comment|// Save into a symbolic link that point to a removed file
name|someData
operator|=
literal|"more stuff"
expr_stmt|;
...
expr_stmt|;
block|}
comment|// link to a link in another directory
name|QTemporaryDir
name|dir2
decl_stmt|;
name|QVERIFY2
...
argument_list|()
expr_stmt|;
comment|// the explicit file becomes a file instead of a link
name|QVERIFY
argument_list|(
operator|!
name|QFileInfo
