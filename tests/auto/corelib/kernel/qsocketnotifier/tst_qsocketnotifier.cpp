...
condition|)
block|{
comment|// wait for the second datagram message.
name|QTest
operator|::
name|qSleep
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// wait a little to ensure that the datagrams we've just sent
