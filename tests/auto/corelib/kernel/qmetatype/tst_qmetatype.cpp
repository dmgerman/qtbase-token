...
parameter_list|)
define|\
value|QTest::newRow(RealTypeString)<< QMetaType::MetaTypeName<< #AliasType;
end_define
begin_function
...
parameter_list|)
define|\
value|QTest::newRow(#RealType)<< QMetaType::MetaTypeName<< int(QTypeInfo<RealType>::sizeOf);
name|FOR_EACH_CORE_METATYPE
argument_list|(
argument|ADD_METATYPE_TEST_ROW
argument_list|)
...
parameter_list|)
define|\
value|QTest::newRow(#RealType)<< MetaTypeId<< bool(!QTypeInfo<RealType>::isStatic)<< bool(QTypeInfo<RealType>::isComplex)<< bool(QtPrivate::IsPointerToTypeDerivedFromQObject<RealType>::Value);
