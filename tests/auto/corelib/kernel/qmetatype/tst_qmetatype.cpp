...
class|class
name|CustomGadget_NonDefaultConstructible
block|{
name|Q_GADGET
public|public:
...
argument_list|)
expr_stmt|;
comment|// cannot unregister built-in types
name|QVERIFY
argument_list|(
operator|!
name|QMetaType
...
argument_list|)
expr_stmt|;
comment|// cannot unregister declared types
name|QVERIFY
argument_list|(
operator|!
name|QMetaType
...
argument_list|)
expr_stmt|;
comment|// test unregistration of dynamic types (used by Qml)
name|int
name|unregId
init|=
name|QMetaType
...
argument_list|)
expr_stmt|;
comment|// re-registering should always return the lowest free index
name|QCOMPARE
argument_list|(
name|QMetaType
operator|::
