...
parameter_list|)
define|\
value|FOR_EACH_PRIMITIVE_METATYPE(F) \     FOR_EACH_COMPLEX_CORE_METATYPE(F) \  template<int ID>
end_define
begin_struct
...
define|#
directive|define
name|TEST_QSHAREDPOINTER
parameter_list|(
name|FULLTYPE
parameter_list|)
define|\
value|{ \         FULLTYPE sp = FULLTYPE::create(); \         QVariant v = QVariant::fromValue(sp); \         QCOMPARE(v.typeName(), #FULLTYPE); \     }
name|TEST_QSHAREDPOINTER
argument_list|(
argument|QSharedPointer<QObject>
argument_list|)
name|TEST_QSHAREDPOINTER
argument_list|(
argument|QSharedPointer<QFile>
argument_list|)
name|TEST_QSHAREDPOINTER
argument_list|(
argument|QSharedPointer<QTemporaryFile>
argument_list|)
name|TEST_QSHAREDPOINTER
argument_list|(
argument|QSharedPointer<MyObject>
argument_list|)
DECL|macro|TEST_QSHAREDPOINTER
undef|#
directive|undef
