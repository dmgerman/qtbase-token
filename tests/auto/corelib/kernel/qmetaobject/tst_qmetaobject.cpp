...
block|}
class|;
comment|// Test inherits
DECL|class|MyClassSubclass
class|class
name|MyClassSubclass
super|:
specifier|public
name|MyClass
block|{
...
name|QtDebugMsg
argument_list|,
literal|"Qt::WindowType(WindowTitleHint) Qt::WindowType(Window) Qt::WindowType(Desktop) Qt::WindowType(WindowSystemMenuHint)"
argument_list|)
expr_stmt|;
name|qDebug
argument_list|()
...
name|QtDebugMsg
argument_list|,
literal|"hello QFlags<MyNamespace::MyClass::MyFlags>(MyFlag1) world"
argument_list|)
expr_stmt|;
name|MyNamespace
operator|::
...
name|QtDebugMsg
argument_list|,
literal|"QFlags<MyNamespace::MyClass::MyFlags>(MyFlag1) QFlags<MyNamespace::MyClass::MyFlags>(MyFlag2|MyFlag3)"
argument_list|)
expr_stmt|;
name|qDebug
argument_list|()
...
name|newRow
argument_list|(
literal|"MyClass inherits QObject"
argument_list|)
operator|<<
operator|&
name|MyNamespace
...
name|newRow
argument_list|(
literal|"QObject inherits MyClass"
argument_list|)
operator|<<
operator|&
name|QObject
...
name|newRow
argument_list|(
literal|"MyClass inherits MyClass"
argument_list|)
operator|<<
operator|&
name|MyNamespace
...
name|newRow
argument_list|(
literal|"MyClassSubclass inherits QObject"
argument_list|)
operator|<<
operator|&
name|MyNamespace
...
name|newRow
argument_list|(
literal|"MyClassSubclass2 inherits QObject"
argument_list|)
operator|<<
operator|&
name|MyNamespace
...
name|newRow
argument_list|(
literal|"MyClassSubclass2 inherits MyClass2"
argument_list|)
operator|<<
operator|&
name|MyNamespace
