...
argument_list|)
expr_stmt|;
comment|// the connection list has been marked dirty, but not cleaned yet.
name|QCOMPARE
argument_list|(
name|countedStructObjectsCount
argument_list|,
...
expr_stmt|;
block|}
comment|// disconnect() dropped the reference that c had to the functor;
comment|// the sender has been destroyed. Therefore, the QObjectPrivate::Connection
comment|// refcount dropped to zero and destroyed the functor.
name|QCOMPARE
argument_list|(
name|countedStructObjectsCount
argument_list|,
...
expr_stmt|;
block|}
comment|// c2 still holds a reference; c1 has been cleaned up
name|QCOMPARE
argument_list|(
name|countedStructObjectsCount
argument_list|,
