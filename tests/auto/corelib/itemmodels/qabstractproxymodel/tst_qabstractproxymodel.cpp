...
end_function
begin_comment
comment|// This class only supports very simple table models
end_comment
begin_class
...
class|class
name|StandardItemModelWithCustomDragAndDrop
super|:
specifier|public
name|QStandardItemModel
block|{
