...
argument_list|)
decl_stmt|;
comment|// Verify that the GenericIconName is part of the equality test:
name|QCOMPARE
argument_list|(
name|instantiatedQMimeType
operator|.
...
argument_list|)
decl_stmt|;
comment|// Verify that the IconName is part of the equality test:
name|QCOMPARE
argument_list|(
name|instantiatedQMimeType
operator|.
...
argument_list|)
decl_stmt|;
comment|// Verify that the Suffixes are part of the equality test:
name|QCOMPARE
argument_list|(
name|instantiatedQMimeType
operator|.
