...
argument_list|(
name|SRCDIR
literal|"../../../src/mimetypes/mime/packages/freedesktop.org.xml"
argument_list|)
argument_list|)
decl_stmt|;
specifier|const
...
name|QLatin1String
argument_list|(
literal|"/packages/freedesktop.org.xml"
argument_list|)
argument_list|)
expr_stmt|;
name|m_dataHome
...
argument_list|)
expr_stmt|;
comment|//qDebug()<< "XDG_DATA_HOME="<< m_dataHome;
comment|// Make sure we start clean
...
name|fromLatin1
argument_list|(
literal|"mime/packages/yast2-metapackage-handler-mimetypes.xml"
argument_list|)
argument_list|)
expr_stmt|;
name|QDir
...
name|fromLatin1
argument_list|(
literal|"Please download the shared-mime-info test suite:\n"
literal|"cd tests/auto/corelib/mimetypes/qmimedatabase\n"
...
condition|)
block|{
comment|// Wait until the begining of the next second
while|while
condition|(
name|mimeCacheInfo
operator|.
...
argument_list|)
expr_stmt|;
comment|// Now test removing it again (note, this leaves a mostly-empty mime.cache file)
name|QFile
operator|::
name|remove
argument_list|(
