...
decl_stmt|;
block|{
comment|// Test that QBasicAtomicPointer also has operator= and cast operators
comment|// We've been using them for QAtomicPointer<T> elsewhere
name|QBasicAtomicPointer
argument_list|<
name|T
argument_list|>
