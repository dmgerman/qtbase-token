...
argument_list|()
expr_stmt|;
comment|// 32-bit are always supported:
name|warningFreeHelperTemplate
argument_list|<
name|int
argument_list|,
...
directive|endif
comment|// pointer-sized integers are always supported:
name|warningFreeHelperTemplate
argument_list|<
name|int
argument_list|,
...
argument_list|()
expr_stmt|;
comment|// long is always supported because it's either 32-bit or pointer-sized:
name|warningFreeHelperTemplate
argument_list|<
name|int
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// the new implementation has the version that loads the current value
block|{
name|QAtomicInt
name|atomic
init|=
...
block|{
block|{
comment|// Test that QBasicAtomicInt also has operator= and cast operators
comment|// We've been using them for QAtomicInt elsewhere
name|QBasicAtomicInt
name|atomic
init|=
name|Q_BASIC_ATOMIC_INITIALIZER
