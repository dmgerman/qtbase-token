...
include|#
directive|include
file|"../../../../../src/corelib/tools/qalgorithms.h"
end_include
begin_include
include|#
directive|include
...
name|void
name|popCount08_data
parameter_list|()
block|{
name|popCount_data_impl
argument_list|(
sizeof|sizeof
argument_list|(
name|quint8
...
expr_stmt|;
block|}
DECL|function|countTrailing08_data
name|void
name|countTrailing08_data
parameter_list|()
block|{
name|countTrailing_data_impl
argument_list|(
sizeof|sizeof
argument_list|(
name|quint8
...
expr_stmt|;
block|}
DECL|function|countTrailing16_data
name|void
name|countTrailing16_data
parameter_list|()
block|{
name|countTrailing_data_impl
argument_list|(
...
expr_stmt|;
block|}
DECL|function|countTrailing32_data
name|void
name|countTrailing32_data
parameter_list|()
block|{
name|countTrailing_data_impl
argument_list|(
...
expr_stmt|;
block|}
DECL|function|countTrailing64_data
name|void
name|countTrailing64_data
parameter_list|()
block|{
name|countTrailing_data_impl
argument_list|(
...
expr_stmt|;
block|}
DECL|function|countTrailing08
name|void
name|countTrailing08
parameter_list|()
block|{
name|countTrailing_impl
argument_list|<
name|quint8
argument_list|>
argument_list|()
expr_stmt|;
block|}
DECL|function|countTrailing16
name|void
name|countTrailing16
parameter_list|()
block|{
name|countTrailing_impl
argument_list|<
...
expr_stmt|;
block|}
DECL|function|countTrailing32
name|void
name|countTrailing32
parameter_list|()
block|{
name|countTrailing_impl
argument_list|<
...
expr_stmt|;
block|}
DECL|function|countTrailing64
name|void
name|countTrailing64
parameter_list|()
block|{
name|countTrailing_impl
argument_list|<
...
expr_stmt|;
block|}
DECL|function|countLeading08_data
name|void
name|countLeading08_data
parameter_list|()
block|{
name|countLeading_data_impl
argument_list|(
sizeof|sizeof
argument_list|(
name|quint8
...
expr_stmt|;
block|}
DECL|function|countLeading16_data
name|void
name|countLeading16_data
parameter_list|()
block|{
name|countLeading_data_impl
argument_list|(
...
expr_stmt|;
block|}
DECL|function|countLeading32_data
name|void
name|countLeading32_data
parameter_list|()
block|{
name|countLeading_data_impl
argument_list|(
...
expr_stmt|;
block|}
DECL|function|countLeading64_data
name|void
name|countLeading64_data
parameter_list|()
block|{
name|countLeading_data_impl
argument_list|(
...
expr_stmt|;
block|}
DECL|function|countLeading08
name|void
name|countLeading08
parameter_list|()
block|{
name|countLeading_impl
argument_list|<
name|quint8
argument_list|>
argument_list|()
...
end_function
begin_comment
comment|// alternative implementation of qPopulationCount for comparison:
end_comment
begin_decl_stmt
...
end_function
begin_function
DECL|function|countTrailing_data_impl
name|void
name|tst_QAlgorithms
operator|::
name|countTrailing_data_impl
...
name|T_Int
parameter_list|>
DECL|function|countTrailing_impl
name|void
name|tst_QAlgorithms
operator|::
name|countTrailing_impl
...
end_function
begin_function
DECL|function|countLeading_data_impl
name|void
name|tst_QAlgorithms
operator|::
name|countLeading_data_impl
...
name|T_Int
parameter_list|>
DECL|function|countLeading_impl
name|void
name|tst_QAlgorithms
operator|::
name|countLeading_impl
