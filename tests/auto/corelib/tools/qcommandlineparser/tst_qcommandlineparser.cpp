...
name|Q_DECLARE_METATYPE
argument_list|(
argument|QCommandLineParser::OptionsAfterPositionalArgumentsMode
argument_list|)
end_macro
begin_class
...
function_decl|;
name|void
name|testOptionsAndPositional_data
parameter_list|()
function_decl|;
name|void
name|testOptionsAndPositional
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|testCpp11StyleInitialization
parameter_list|()
function_decl|;
...
argument_list|>
argument_list|(
literal|"expectedPositionalArguments"
argument_list|)
expr_stmt|;
name|QTest
operator|::
...
name|newRow
argument_list|(
literal|"before_positional_default"
argument_list|)
operator|<<
operator|(
name|QStringList
...
name|newRow
argument_list|(
literal|"after_positional_default"
argument_list|)
operator|<<
operator|(
name|QStringList
...
name|newRow
argument_list|(
literal|"before_positional_parseAsArg"
argument_list|)
operator|<<
operator|(
name|QStringList
...
name|newRow
argument_list|(
literal|"after_positional_parseAsArg"
argument_list|)
operator|<<
operator|(
name|QStringList
...
name|QStringList
argument_list|,
name|expectedPositionalArguments
argument_list|)
expr_stmt|;
name|QFETCH
argument_list|(
...
name|parser
decl_stmt|;
comment|// primarily check that this compiles:
name|parser
operator|.
name|addOptions
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// but do a very basic functionality test, too:
name|QVERIFY
argument_list|(
name|parser
operator|.
...
name|QSKIP
argument_list|(
literal|"This test requires C++11 uniform initialization support in the compiler."
argument_list|)
expr_stmt|;
endif|#
directive|endif
