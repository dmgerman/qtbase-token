...
function_decl|;
name|void
name|assignmentMovable
parameter_list|()
specifier|const
function_decl|;
name|void
name|assignmentCustom
parameter_list|()
specifier|const
function_decl|;
name|void
...
function_decl|;
name|void
name|detachThreadSafetyInt
parameter_list|()
specifier|const
function_decl|;
name|void
name|detachThreadSafetyMovable
parameter_list|()
specifier|const
function_decl|;
name|void
name|detachThreadSafetyCustom
parameter_list|()
specifier|const
function_decl|;
private|private:
...
name|QSKIP
argument_list|(
literal|"This test requires that C++11 move semantics support is enabled in the compiler"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
argument_list|)
expr_stmt|;
comment|// insert from references to the same container:
name|myvec
operator|.
name|insert
argument_list|(
...
operator|)
expr_stmt|;
comment|// Check dtor - complex type
name|QVERIFY
argument_list|(
name|v
operator|.
...
argument_list|)
expr_stmt|;
comment|// Check if we do correct realloc
name|QVector
argument_list|<
name|int
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// Remove last with shared
name|QVector
argument_list|<
name|int
argument_list|>
...
argument_list|>
argument_list|>
name|detachThreadSafetyDataInt
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
argument_list|>
argument_list|>
name|detachThreadSafetyDataMovable
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
argument_list|>
argument_list|>
name|detachThreadSafetyDataCustom
decl_stmt|;
end_decl_stmt
begin_function_decl
template|template
...
argument_list|)
expr_stmt|;
comment|// destroy static original data
operator|delete
name|detachThreadSafetyData
argument_list|<
name|T
