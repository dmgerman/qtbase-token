...
function_decl|;
name|void
name|task262677remove
parameter_list|()
function_decl|;
name|void
name|QTBUG10404_compareRef
parameter_list|()
function_decl|;
name|void
name|QTBUG9281_arg_locale
parameter_list|()
function_decl|;
ifdef|#
directive|ifdef
...
end_function
begin_comment
comment|// This test crashes on HP-UX with aCC.
end_comment
begin_if
if|#
directive|if
...
end_include
begin_comment
comment|// Setting the locale is not supported on OS X (you can set the C locale,
end_comment
begin_comment
comment|// but that won't affect CFStringCompare which is used to compare strings).
end_comment
begin_comment
comment|// On Windows other than Win CE, we cannot set the system or user locale.
end_comment
begin_if
if|#
directive|if
...
end_function
begin_function
DECL|function|task262677remove
name|void
name|tst_QString
operator|::
name|task262677remove
...
name|QLatin1String
argument_list|(
literal|"V:\\blahblah\\more_blahblah\\"
argument_list|)
decl_stmt|;
name|driveName
operator|.
...
argument_list|)
expr_stmt|;
comment|// should be "V:" - instead, it's "V::\\blahblah\\more_blahblah\\"
name|QVERIFY
argument_list|(
name|driveName
operator|==
