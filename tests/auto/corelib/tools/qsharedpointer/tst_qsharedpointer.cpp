...
literal|"exit(forwardDeclaredDestructorRunCount);"
expr_stmt|;
name|QTest
operator|::
name|newRow
...
name|newRow
argument_list|(
literal|"shared-pointer-from-unmanaged-qobject"
argument_list|)
operator|<<
operator|&
name|QTest
...
name|tryRunFail
operator|<<
literal|"QObject *ptr = new QObject;\n"
literal|"QWeakPointer<QObject> weak = ptr;\n"
comment|// this makes the object unmanaged
literal|"QSharedPointer<QObject> shared(ptr);\n"
expr_stmt|;
name|QTest
operator|::
name|newRow
...
literal|"\n"
literal|"extern int forwardDeclaredDestructorRunCount;\n"
literal|"class ForwardDeclared;\n"
literal|"ForwardDeclared *forwardPointer();\n"
argument_list|)
expr_stmt|;
name|QFETCH
argument_list|(
