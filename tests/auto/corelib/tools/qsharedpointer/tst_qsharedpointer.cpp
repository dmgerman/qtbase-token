...
parameter_list|()
function_decl|;
comment|// let invalidConstructs be the last test, because it's the slowest;
comment|// add new tests above this block
public|public
name|slots
public|:
...
name|QSKIP
argument_list|(
literal|"This test requires C++11 rvalue/move semantics support in the compiler."
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
argument_list|)
expr_stmt|;
comment|// this is why op(shared_ptr, weak_ptr) is a bad idea (apart from MT races)...
name|QVERIFY
argument_list|(
name|sp
operator|==
