...
name|QSKIP
argument_list|(
literal|"This test requires rvalues refs"
argument_list|)
expr_stmt|;
else|#
directive|else
...
argument_list|)
expr_stmt|;
comment|// now p is in a "valid, but unspecified state". so the test must not crash.
comment|// we do actually know that this move should've been a noop.
name|QVERIFY
argument_list|(
operator|!
name|p
