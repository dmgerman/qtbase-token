...
end_function
begin_comment
comment|// global functions defined in qbytearray.cpp
end_comment
begin_function
...
argument_list|)
expr_stmt|;
comment|// overflow conditions
comment|// on 32-bit platforms, (1<< 16) * (1<< 16) = (1<< 32) which is zero
name|QCOMPARE
argument_list|(
name|qCalculateBlockSize
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// on 32-bit platforms, (1<< 30) * 3 + (1<< 30) would overflow to zero
name|QCOMPARE
argument_list|(
name|qCalculateBlockSize
argument_list|(
...
expr_stmt|;
block|}
comment|// growth should be limited
for|for
control|(
name|int
name|elementSize
...
condition|)
break|break;
comment|// no growth, we're at limit
name|alloc
operator|=
name|newAlloc
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// the next allocation should be invalid
name|QCOMPARE
argument_list|(
name|qCalculateGrowingBlockSize
argument_list|(
...
name|QByteArray
argument_list|(
literal|"Hello World, this is a STRING"
argument_list|)
operator|<<
name|QByteArray
argument_list|(
...
name|QByteArray
argument_list|(
literal|"R\311sum\351"
argument_list|)
operator|<<
name|QByteArray
argument_list|(
literal|"R\311SUM\311"
argument_list|)
operator|<<
name|QByteArray
argument_list|(
literal|"r\351sum\351"
argument_list|)
expr_stmt|;
name|QTest
operator|::
