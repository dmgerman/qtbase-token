...
end_function
begin_comment
comment|/*     Just making sure it doesn't crash on invalid data. */
end_comment
begin_function
...
name|QSKIP
argument_list|(
literal|"Corrupt data causes this tests to lock up on HP-UX / PA-RISC with gcc"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Corrupt data causes this tests to lock up on Solaris"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|QSKIP
argument_list|(
literal|"Corrupt data causes this test to lock up on QNX"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// make sure qAllocMore() doesn't loop infinitely on any input
for|for
control|(
name|int
name|i
...
argument_list|)
decl_stmt|;
comment|/*     QByteArray data = arr.toPercentEncoding();     QCOMPARE(QString(data), QString("Qt%20is%20great%21"));     QCOMPARE(QByteArray::fromPercentEncoding(data), arr); */
name|QByteArray
name|data
init|=
name|arr
