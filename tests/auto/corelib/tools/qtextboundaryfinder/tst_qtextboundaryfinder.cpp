...
expr_stmt|;
block|{
comment|// The Line Break tests use tailoring of numbers described in Example 7
comment|// of Section 8.2 Examples of Customization
name|QChar
name|s
index|[]
index|[
...
name|QSKIP
argument_list|(
literal|"QTextBoundaryFinder doesn't handle numerical expressions"
argument_list|)
expr_stmt|;
block|}
block|}
