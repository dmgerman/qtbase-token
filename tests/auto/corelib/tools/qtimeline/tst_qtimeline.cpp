...
end_function
begin_comment
comment|/* void tst_QTimeLine::toggle() {     QTimeLine timeLine;     QCOMPARE(timeLine.isReverse(), false);     timeLine.toggle();     QCOMPARE(timeLine.isReverse(), true);     timeLine.toggle();     QCOMPARE(timeLine.isReverse(), false); } */
end_comment
begin_comment
