...
expr_stmt|;
block|}
comment|/*         Verify that the 'sharable' flag is true in populated containers.     */
block|{
name|Container
name|c1
decl_stmt|;
...
comment|//    { QVERIFY_TYPE(typename Container::value_type); }
comment|//    { QVERIFY_TYPE(typename Container::const_iterator); }
comment|//    { QVERIFY_TYPE(typename Container::reference); }
comment|//    { QVERIFY_TYPE(typename Container::const_reference); }
comment|//    { QVERIFY_TYPE(typename Container::pointer); }
block|{
name|QVERIFY_TYPE
argument_list|(
typename|typename
...
block|}
comment|// TODO
comment|//    { QVERIFY_TYPE(typename Container::key_compare); }
comment|//    { QVERIFY_TYPE(typename Container::value_comare); }
block|}
end_function
begin_function
template|template
