...
argument_list|)
expr_stmt|;
comment|// +=: not provided, emulate
comment|//myvla += myvlatwo;
name|Q_FOREACH
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// QVarLengthArray(std::initializer_list<>)
name|QVarLengthArray
argument_list|<
name|T
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// operator=(std::initializer_list<>)
name|QVarLengthArray
argument_list|<
name|T
argument_list|>
...
block|}
expr_stmt|;
comment|// force allocation on heap
name|QCOMPARE
argument_list|(
name|v6
operator|.
...
name|QSKIP
argument_list|(
literal|"This tests requires a compiler that supports initializer lists."
argument_list|)
expr_stmt|;
endif|#
directive|endif
