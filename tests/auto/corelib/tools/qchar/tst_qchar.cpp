...
argument_list|)
expr_stmt|;
comment|/*     QVERIFY(!QChar::isPrint(0xe0000u));     QVERIFY(!QChar::isPrint(0xe0002u));     QVERIFY(!QChar::isPrint(0xe001fu));     QVERIFY(!QChar::isPrint(0xe0080u));     QVERIFY(!QChar::isPrint(0xe00ffu)); */
...
argument_list|)
expr_stmt|;
comment|/*     QVERIFY(QChar::isPrint(0xe0100u));     QVERIFY(QChar::isPrint(0xe01efu)); */
...
argument_list|)
expr_stmt|;
comment|/*     QVERIFY(!QChar::isPrint(0x1d173u)); */
name|QVERIFY
argument_list|(
name|QChar
argument_list|(
...
expr_stmt|;
comment|// assigned in 5.1
comment|/*     QVERIFY(!QChar::isPrint(0x1b000u)); // assigned in 6.0     QVERIFY(!QChar::isPrint(0x110d0u)); // assigned in 5.1 */
block|}
end_function
begin_function
...
argument_list|()
argument_list|,
literal|"NormalizationTest.txt not found!"
argument_list|)
expr_stmt|;
name|QFile
name|f
