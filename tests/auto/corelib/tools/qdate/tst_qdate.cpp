...
enum|;
name|bool
name|wasLastYearLong
init|=
literal|false
decl_stmt|;
comment|// 1999 was not a long (53-week) year
name|bool
name|isLongYear
decl_stmt|;
comment|// full 400-year cycle for Jan 1, 4 and Dec 28, 31
for|for
control|(
name|int
name|yr
...
argument_list|()
decl_stmt|;
comment|// the year is 53-week long if Jan 1 is Thursday or, if it's a leap year, a Wednesday
name|isLongYear
operator|=
operator|(
name|wday
...
operator|)
expr_stmt|;
comment|// Jan 4 is always on week 1
name|QTest
operator|::
name|newRow
argument_list|(
...
literal|4
expr_stmt|;
comment|// Dec 28 is always on the last week
name|QTest
operator|::
name|newRow
argument_list|(
...
literal|28
expr_stmt|;
comment|// Jan 1 is on either on week 1 or on the last week of the previous year
name|QTest
operator|::
name|newRow
argument_list|(
...
literal|1
expr_stmt|;
comment|// Dec 31 is either on the last week or week 1 of the next year
name|wday
operator|=
name|QDate
argument_list|(
...
comment|// Test Julian round trip around JD 0 and the c++ integer division rounding
comment|// problem point (eg. negative numbers) in the conversion functions.
name|QDate
name|testDate
decl_stmt|;
name|QDate
...
expr_stmt|;
block|}
comment|// Test Gregorian round trip at low end of conversion range
name|loopDate
operator|=
name|QDate
operator|::
