...
argument_list|)
expr_stmt|;
comment|// make sure result is independent of locale
name|QCOMPARE
argument_list|(
name|ok
argument_list|,
...
name|QString
argument_list|(
literal|"12456789012.000"
argument_list|)
operator|<<
literal|12456789012.0
operator|<<
literal|'f'
operator|<<
literal|3
...
name|newRow
argument_list|(
literal|"de_DE 12456789012 e 10"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|newRow
argument_list|(
literal|"de_DE 12456789012 g 11"
argument_list|)
operator|<<
name|QString
argument_list|(
...
name|QSKIP
argument_list|(
literal|"'Shortest' double conversion is not that short without libdouble-conversion"
argument_list|)
expr_stmt|;
endif|#
directive|endif
...
directive|endif
comment|// check that double-to-string conversion doesn't throw floating point exceptions when they are
comment|// enabled
ifdef|#
directive|ifdef
name|Q_OS_WIN
...
name|fromUtf8
argument_list|(
literal|"\xd1\x8f\xd0\xbd\xd0\xb2\xd0\xb0\xd1\x80\xd1\x8c"
argument_list|)
argument_list|)
expr_stmt|;
name|QCOMPARE
...
name|fromUtf8
argument_list|(
literal|"\xd1\x8f\xd0\xbd\xd0\xb2."
argument_list|)
argument_list|)
expr_stmt|;
name|QCOMPARE
...
condition|)
block|{
comment|// based on likelySubtags for RTL scripts
case|case
name|QLocale
operator|::
name|AncientGreek
