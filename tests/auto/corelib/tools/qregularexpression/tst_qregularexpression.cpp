...
argument_list|)
expr_stmt|;
comment|// offset<= 0 tested above; now also test stringrefs not spanning over
comment|// the entire subject. Note that the offset can be negative, hence the above
comment|// tests can't be merged into this one
for|for
control|(
name|int
name|i
