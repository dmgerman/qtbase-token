...
parameter_list|,
name|typename
name|QREMatchFuncForString
parameter_list|,
name|typename
name|QREMatchFuncForStringRef
parameter_list|,
name|typename
name|Result
parameter_list|>
...
parameter_list|,
name|QREMatchFuncForString
name|matchingMethodForString
parameter_list|,
name|QREMatchFuncForStringRef
name|matchingMethodForStringRef
parameter_list|,
specifier|const
name|QString
modifier|&
...
argument_list|()
expr_stmt|;
comment|// test with QString as subject type
name|testMatchImpl
argument_list|<
name|QREMatch
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// test with QStringRef as subject type
name|testMatchImpl
argument_list|<
name|QREMatch
argument_list|>
...
operator|::
modifier|*
name|QREGlobalMatchStringRefPMF
function_decl|)
parameter_list|(
specifier|const
name|QStringRef
