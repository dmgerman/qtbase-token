...
function_decl|;
name|void
name|QTBUG13877_crashOnExit
parameter_list|()
function_decl|;
name|void
name|QTBUG14579_leakInDestructor
parameter_list|()
function_decl|;
name|void
name|QTBUG14579_resetInDestructor
parameter_list|()
function_decl|;
name|void
name|valueBased
...
argument|QThreadStorage<SPointer *>
argument_list|,
argument|QTBUG14579_pointers2
argument_list|)
end_macro
begin_class
DECL|class|QTBUG14579_class
class|class
name|QTBUG14579_class
block|{
public|public:
DECL|member|member
name|SPointer
...
name|Q_GLOBAL_STATIC
argument_list|(
argument|QThreadStorage<QTBUG14579_reset *>
argument_list|,
argument|QTBUG14579_resetTls
argument_list|)
end_macro
begin_destructor
