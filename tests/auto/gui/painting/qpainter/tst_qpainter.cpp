...
function_decl|;
name|void
name|gradientPixelFormat_data
parameter_list|()
function_decl|;
name|void
name|gradientPixelFormat
parameter_list|()
function_decl|;
name|void
name|linearGradientRgb30_data
parameter_list|()
function_decl|;
name|void
name|linearGradientRgb30
parameter_list|()
function_decl|;
name|void
name|radialGradientRgb30_data
parameter_list|()
function_decl|;
name|void
name|radialGradientRgb30
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|QTBUG38781_NoBrushAndQBitmap
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|drawTextNoHinting
parameter_list|()
function_decl|;
name|void
name|drawPolyline_data
parameter_list|()
function_decl|;
name|void
name|drawPolyline
...
function_decl|;
name|void
name|QTBUG50153_drawImage_assert
parameter_list|()
function_decl|;
private|private:
name|void
...
argument_list|)
decl_stmt|;
comment|// Fill with CompositionMode_SourceOver tests blend_color
name|image
operator|.
name|fill
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Fill with CompositionMode_Source tests rectfill.
name|painter
operator|.
name|begin
argument_list|(
...
name|newRow
argument_list|(
literal|"Qimage::Format_A2RGB30_Premultiplied"
argument_list|)
operator|<<
name|QImage
operator|::
...
argument_list|)
expr_stmt|;
comment|// at horizontal line at y=1
name|p
operator|.
name|setBrush
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Check that the rect didn't overwrite the line
name|QCOMPARE
argument_list|(
name|image
operator|.
...
name|newRow
argument_list|(
literal|"ARGB_PM source-in RGB30"
argument_list|)
operator|<<
name|QImage
operator|::
...
expr_stmt|;
block|}
comment|// Testing for a crash when DirectWrite is used on Windows
name|QVERIFY
argument_list|(
literal|true
argument_list|)
...
name|Format_RGB32
block|,
comment|// fetchTransformedBilinearARGB32PM
name|QImage
operator|::
name|Format_ARGB32
comment|// fetchTransformedBilinear
block|}
decl_stmt|;
for|for
control|(
