...
end_function
begin_comment
comment|/* tests the clipping operations in qt_format_text, making sure    the clip rectangle after the call is the same as before */
end_comment
begin_function
...
end_function
begin_comment
comment|/* tests the bounding rect calculations in qt_format_text, making sure    the bounding rect has a reasonable value. */
end_comment
begin_function
...
literal|"a\n \nb"
block|,
literal|"this is a longer string"
block|,
literal|"\327\222\327\223\327\233\327\223\327\222\327\233\327\222\327\223\327\233"
block|,
literal|"aa\327\222\327\233aa"
block|,
literal|"\327\222\327\223\327\233\327\223\327\222\327\233\327\222\327\223\327\233"
block|,
literal|"\327\222\327\233aa"
block|,
literal|"linebreakatend\n"
block|,
literal|"some text longer than 30 chars with a line break at the end\n"
block|,
literal|"some text\nwith line breaks\nin the middle\nand at the end\n"
block|,
literal|"foo\n\n\nfoo"
...
directive|if
literal|0
block|{ 			QPrinter printer; 			printer.setOutputToFile(TRUE); 			printer.setOutputFileName("tmp.prn"); 			QPainter p(&printer); 			QRect pbr = p.fontMetrics().boundingRect( 0, 0, 2000, 100, *m, QString::fromUtf8( *str ) ); 			QCOMPARE(pbr, br); 		    }
endif|#
directive|endif
if|#
directive|if
...
literal|"this is a longer string"
block|,
comment|//	    "\327\222\327\223\327\233\327\223\327\222\327\233\327\222\327\223\327\233",
comment|//	    "aa\327\222\327\233aa",
comment|//	    "\327\222\327\223\327\233\327\223\327\222\327\233\327\222\327\223\327\233",
comment|//	    "\327\222\327\233aa",
comment|//	    "linebreakatend\n",
comment|//	    "some text longer than 30 chars with a line break at the end\n",
comment|//	    "some text\nwith line breaks\nin the middle\nand at the end\n",
literal|"foo\n\n\nfoo"
block|,
literal|"a\n\n\n\n\nb"
...
name|TextWordWrap
argument_list|,
literal|"A paragraph with gggggggggggggggggggggggggggggggggggg in the middle."
argument_list|)
decl_stmt|;
name|QVERIFY
argument_list|(
...
name|QSKIP
argument_list|(
literal|"Only Mac/Cocoa supports sub pixel positions in raster engine currently"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
