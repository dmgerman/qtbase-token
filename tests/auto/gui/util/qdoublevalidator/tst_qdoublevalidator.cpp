...
function_decl|;
name|void
name|zeroPaddedExponent_data
parameter_list|()
function_decl|;
name|void
name|zeroPaddedExponent
parameter_list|()
function_decl|;
name|void
...
argument_list|>
argument_list|(
literal|"rejectZeroPaddedExponent"
argument_list|)
expr_stmt|;
name|QTest
operator|::
