...
decl_stmt|;
name|QString
name|secondSearchPath
init|=
name|QLatin1String
argument_list|(
literal|":/second_icons"
argument_list|)
decl_stmt|;
name|QIcon
operator|::
...
argument_list|)
expr_stmt|;
comment|// Test fallback to less specific icon
name|QIcon
name|specificAppointmentIcon
init|=
name|QIcon
operator|::
name|fromTheme
argument_list|(
literal|"appointment-new-specific"
argument_list|)
decl_stmt|;
name|QVERIFY
argument_list|(
...
name|QLatin1String
argument_list|(
literal|"/testcache/16x16/actions"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
name|QLatin1String
argument_list|(
literal|"/testcache/16x16/actions/button-open.png"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// We just created a theme with that icon, it must exist
name|QVERIFY
argument_list|(
operator|!
name|QIcon
...
name|QLatin1String
argument_list|(
literal|"/testcache/icon-theme.cache"
argument_list|)
decl_stmt|;
comment|// An invalid cache should not prevent lookup
block|{
name|QFile
name|cacheFile
argument_list|(
...
argument_list|)
operator|<<
literal|"invalid corrupted stuff in there\n"
expr_stmt|;
block|}
name|QIcon
operator|::
...
argument_list|)
expr_stmt|;
comment|// An empty cache should prevent the lookup
block|{
name|QFile
name|cacheFile
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 4: hash offset / dir list offset
name|ds
operator|<<
name|quint32
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 20: list with one element
name|ds
operator|.
name|writeRawData
argument_list|(
literal|"16x16/actions"
argument_list|,
sizeof|sizeof
argument_list|(
literal|"16x16/actions"
...
argument_list|)
expr_stmt|;
comment|// The icon was not in the cache, it should not be found
comment|// Adding an icon should be changing the modification date of one sub directory which should make the cache ignored
name|QTest
operator|::
name|qWait
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// wait enough to have a different modification time in seconds
name|QVERIFY
argument_list|(
name|QFile
argument_list|(
...
name|QLatin1String
argument_list|(
literal|"/testcache/16x16/actions/button-save.png"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Try to run the actual gtk-update-icon-cache and make sure that icons are still found
specifier|const
name|QString
name|gtkUpdateIconCache
init|=
name|findGtkUpdateIconCache
argument_list|()
decl_stmt|;
...
name|QSKIP
argument_list|(
literal|"gtk-update-icon-cache not run (binary not found)"
argument_list|)
expr_stmt|;
block|}
name|QProcess
