...
function_decl|;
name|void
name|genericRgbConversion_data
parameter_list|()
function_decl|;
name|void
name|genericRgbConversion
parameter_list|()
function_decl|;
name|void
name|inplaceRgbConversion_data
parameter_list|()
function_decl|;
name|void
name|inplaceRgbConversion
parameter_list|()
function_decl|;
name|void
...
function_decl|;
name|void
name|exif_QTBUG45865
parameter_list|()
function_decl|;
name|void
name|exif_invalid_data_QTBUG46870
parameter_list|()
function_decl|;
name|void
...
name|qWarning
argument_list|(
literal|"Unhandled image format"
argument_list|)
expr_stmt|;
return|return
name|QStringLiteral
...
end_function
begin_comment
comment|// Tests smooth upscale is smooth
end_comment
begin_function
...
parameter_list|()
block|{
comment|// Test that all RGB conversions work and maintain at least 4bit of color accuracy.
name|QFETCH
argument_list|(
name|QImage
operator|::
...
name|m_prefix
operator|+
literal|"jpeg_exif_QTBUG-45865.jpg"
argument_list|)
decl_stmt|;
name|QVERIFY
argument_list|(
...
name|m_prefix
operator|+
literal|"jpeg_exif_invalid_data_QTBUG-46870.jpg"
argument_list|)
argument_list|)
expr_stmt|;
name|QVERIFY
