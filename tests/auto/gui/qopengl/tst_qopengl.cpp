...
name|QT_OPENGL_ES_2
argument_list|)
comment|// NVidia currently only supports RGB30 and RGB30_A2 in their Quadro drivers,
comment|// but they do provide an extension for querying the support. We use the query
comment|// in case they implement the required formats later.
if|if
condition|(
operator|!
name|ctx
...
name|QSKIP
argument_list|(
literal|"The required RGB30_A2 format is not supported by this driver"
argument_list|)
expr_stmt|;
block|}
block|}
