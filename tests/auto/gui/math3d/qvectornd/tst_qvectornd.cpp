...
end_function
begin_comment
comment|// Test component-wise vector division for 2D vectors.
end_comment
begin_function
...
end_function
begin_comment
comment|// Test component-wise vector division for 3D vectors.
end_comment
begin_function
...
end_function
begin_comment
comment|// Test component-wise vector division for 4D vectors.
end_comment
begin_function
...
parameter_list|()
block|{
comment|// Use the same test data as the multiplyFactor test.
name|multiplyFactor2_data
argument_list|()
expr_stmt|;
block|}
