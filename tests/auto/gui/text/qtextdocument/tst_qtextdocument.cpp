...
function_decl|;
name|void
name|findWithRegularExpression_data
parameter_list|()
function_decl|;
name|void
name|findWithRegularExpression
parameter_list|()
function_decl|;
name|void
name|findMultiple
...
function_decl|;
name|void
name|textCursorUsageWithinContentsChange
parameter_list|()
function_decl|;
name|void
name|cssInheritance
...
block|}
block|{
comment|// If no p tag is specified it should not be inheriting it
name|QTextDocument
name|td
decl_stmt|;
name|td
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">p { line-height: 200% }</style></head><body>Foo<ul><li>First</li></ul></body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head></head><body><p>Foo</p><ul><li>First</li></ul></body></html>"
argument_list|)
expr_stmt|;
name|QList
argument_list|<
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { margin-top: 85px; }</style></head><body><p>Foo</p><ul><li>First</li></ul></body></html>"
argument_list|)
expr_stmt|;
name|block
operator|=
...
parameter_list|()
block|{
comment|// force creation of layout
name|doc
operator|->
name|documentLayout
argument_list|()
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 200% }</style></head><body>"
literal|"<p>Foo</p><p>Bar</p><p>Baz</p></body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 200% } p { line-height: 300% }</style></head><body>"
literal|"<p style=\"line-height: 40px\">Foo</p><p>Bar</p><p>Baz</p></body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { font-weight: bold; background-color: #ff0000 }</style></head><body>"
literal|"<p>Foo</p><p>Bar</p><p>Baz</p></body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { font-style: italic; font-weight: normal; }</style></head><body>"
literal|"<table><tr><th>Foo</th></tr><tr><td>Bar</td></tr></table></body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">b { font-style: italic; font-weight: normal; }</style></head><body>"
literal|"<p>This should be<b>bold</b></p></body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
argument_list|()
decl_stmt|;
comment|// The non bold text is first
name|QTextFragment
...
argument_list|)
expr_stmt|;
comment|// Now check the "bold" text
name|currentFragment
operator|=
name|it
operator|.
...
name|setHtml
argument_list|(
literal|"<html><head><link rel=\"stylesheet\" type=\"text/css\" href=\"test.css\"></head><body>"
literal|"<p>This should be<b>bold</b></p></body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 40px; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 200%; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 200%; -qt-line-height-type: single; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 40px; -qt-line-height-type: proportional; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 10; -qt-line-height-type: fixed; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { line-height: 33; -qt-line-height-type: minimum; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { -qt-line-height-type: fixed; line-height: 200%; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
...
name|setHtml
argument_list|(
literal|"<html><head><style type=\"text/css\">body { -qt-line-height-type: fixed; line-height: 200px; }</style></head><body>Foobar</body></html>"
argument_list|)
expr_stmt|;
name|QTextBlock
name|block
