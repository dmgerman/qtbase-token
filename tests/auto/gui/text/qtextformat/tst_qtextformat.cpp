...
function_decl|;
name|void
name|setFont_collection_data
parameter_list|()
function_decl|;
name|void
name|setFont_collection
parameter_list|()
function_decl|;
block|}
class|;
...
name|QTextCharFormat
operator|::
name|FontPropertiesSpecifiedOnly
argument_list|)
expr_stmt|;
name|f
operator|.
