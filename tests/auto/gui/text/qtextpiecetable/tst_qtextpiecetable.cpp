...
directive|if
literal|0
block|QTextBlockFormat fmt1;     fmt1.setTopMargin(100);     QTextBlockFormat fmt2;     fmt2.setAlignment(Qt::AlignRight);     int idx1 = table->formatCollection()->indexForFormat(fmt1);     int idx2 = table->formatCollection()->indexForFormat(fmt2);      table->insert(0, "0123", charFormatIndex);     table->insertBlock(4, idx1, charFormatIndex);     table->insert(5, "5678", charFormatIndex);     table->insertBlock(9, idx2, charFormatIndex);     table->insert(10, "0123", charFormatIndex);      QCOMPARE(table->blocksFind(0).blockFormat(), QTextBlockFormat());     QCOMPARE(table->blocksFind(4).blockFormat(), QTextBlockFormat());     QCOMPARE(table->blocksFind(5).blockFormat(), fmt1);     QCOMPARE(table->blocksFind(10).blockFormat(), fmt2);     QCOMPARE(table->blocksFind(1).position(), 0);     QCOMPARE(table->blocksFind(6).position(), 5);     QCOMPARE(table->blocksFind(11).position(), 10);      table->remove(3, 7);     QCOMPARE(table->blocksFind(1).position(), 0);     QCOMPARE(table->blocksFind(5).position(), 0);     QCOMPARE(table->blocksFind(1).blockFormat(), QTextBlockFormat());     QCOMPARE(table->blocksFind(5).blockFormat(), QTextBlockFormat());      table->undo();      QCOMPARE(table->blocksFind(0).blockFormat(), QTextBlockFormat());     QCOMPARE(table->blocksFind(4).blockFormat(), QTextBlockFormat());     QCOMPARE(table->blocksFind(5).blockFormat(), fmt1);     QCOMPARE(table->blocksFind(10).blockFormat(), fmt2);     QCOMPARE(table->blocksFind(1).position(), 0);     QCOMPARE(table->blocksFind(6).position(), 5);     QCOMPARE(table->blocksFind(11).position(), 10);      table->redo();     QCOMPARE(table->blocksFind(1).position(), 0);     QCOMPARE(table->blocksFind(5).position(), 0);     QCOMPARE(table->blocksFind(1).blockFormat(), QTextBlockFormat());     QCOMPARE(table->blocksFind(5).blockFormat(), QTextBlockFormat());
endif|#
directive|endif
block|}
end_function
