...
block|if (!(font.family() == fontinfo.family()                                         || fontinfo.family().contains(font.family())                                         || fontinfo.family().isEmpty())) {                                 qDebug("Test about to fail for font: %s, fontinfo: %s",                                         font.family().latin1(), fontinfo.family().latin1());                             }                             QVERIFY(font.family() == fontinfo.family()                                     || fontinfo.family().contains(font.family())                                     || fontinfo.family().isEmpty());                             if (font.pointSize() != -1) {                                 QCOMPARE(font.pointSize(), fontinfo.pointSize());                             } else {                                 QCOMPARE(font.pixelSize(), fontinfo.pixelSize());                             }                             QCOMPARE(font.italic(), fontinfo.italic());                             QCOMPARE(font.weight(), fontinfo.weight());                         } else {                             font.setFixedPitch(!fontinfo.fixedPitch());                             QFontInfo fontinfo1(font, (QFont::Script) script);                             QVERIFY( !fontinfo1.exactMatch() );                              font.setFixedPitch(fontinfo.fixedPitch());                             QFontInfo fontinfo2(font, (QFont::Script) script);                             QVERIFY( fontinfo2.exactMatch() );                         }                     }                 }
endif|#
directive|endif
block|}
block|}
...
argument_list|)
expr_stmt|;
comment|// The version in which the tested feature was added.
name|QTest
operator|::
name|addColumn
argument_list|<
...
argument_list|>
argument_list|(
literal|"minimumStreamVersion"
argument_list|)
expr_stmt|;
name|QFont
name|basicFont
decl_stmt|;
comment|// Versions<= Qt 2.1 had broken point size serialization,
comment|// so we set an integer point size.
name|basicFont
operator|.
name|setPointSize
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// This fails for versions less than this, as ignorePitch is set to false
comment|// whenever setFixedPitch() is called, but ignorePitch is considered an
comment|// extended bit, which were apparently not available until 4.4.
name|QTest
operator|::
name|newRow
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Fails for 4.4 because letterSpacing wasn't read until 4.5.
name|QTest
operator|::
name|newRow
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// This wasn't read properly until 5.4.
name|QTest
operator|::
name|newRow
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// This wasn't read until 5.4.
name|QTest
operator|::
name|newRow
argument_list|(
...
name|setStyleName
argument_list|(
literal|"Regular Black Condensed"
argument_list|)
expr_stmt|;
comment|// This wasn't read until 5.4.
name|QTest
...
argument_list|)
expr_stmt|;
comment|// This wasn't read until 5.6.
name|QTest
operator|::
name|newRow
argument_list|(
...
name|fromLatin1
argument_list|(
literal|"Fonts do not compare equal for QDataStream version "
argument_list|)
operator|+
name|QString
operator|::
