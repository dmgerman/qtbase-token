...
name|QT_NO_RAWFONT
name|void
name|additionalFormatsCapitalizationWithRawFont_data
parameter_list|()
function_decl|;
name|void
name|additionalFormatsCapitalizationWithRawFont
parameter_list|()
function_decl|;
endif|#
directive|endif
...
name|FormatRange
argument_list|>
name|FormatRangeList
typedef|;
end_typedef
begin_macro
name|Q_DECLARE_METATYPE
argument_list|(
argument|FormatRangeList
argument_list|)
end_macro
begin_function
...
name|Q_FOREACH
argument_list|(
argument|const QTextLayout::FormatRange& range
argument_list|,
argument|additionalFormats
argument_list|)
block|{
if|if
condition|(
...
argument_list|()
expr_stmt|;
comment|// Can't assume anything about the order of the glyphs we get once they're split into several glyphRuns.
comment|// Let's just compare the sets:
name|QVector
argument_list|<
name|quint32
argument_list|>
...
name|Q_FOREACH
argument_list|(
argument|const QGlyphRun& run
argument_list|,
argument|layout.glyphRuns()
argument_list|)
block|{
name|Q_FOREACH
argument_list|(
argument|quint32 glyphIndex
argument_list|,
argument|run.glyphIndexes()
argument_list|)
name|sortedOutput
operator|.
name|append
