...
function_decl|;
name|void
name|justifyTrailingSpaces
parameter_list|()
function_decl|;
name|void
name|layoutWithCustomTabStops
parameter_list|()
function_decl|;
...
function_decl|;
name|void
name|noModificationOfInputString
parameter_list|()
function_decl|;
private|private:
...
name|QSKIP
argument_list|(
literal|"Test logic does not work when tabs are scaled by dpi"
argument_list|)
expr_stmt|;
name|layout
operator|.
...
argument_list|()
expr_stmt|;
comment|// The second line will be "finish"
name|QCOMPARE
argument_list|(
name|layout
operator|.
...
name|QStringLiteral
argument_list|(
literal|"\ta aa aa aa aa aa aa aa aa aa aa aa aa a"
argument_list|)
argument_list|)
expr_stmt|;
name|textLayout
