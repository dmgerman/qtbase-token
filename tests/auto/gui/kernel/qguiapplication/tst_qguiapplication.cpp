...
condition|)
block|{
comment|// Set env variables to disable input and cursor because eglfs is single fullscreen window
comment|// and trying to initialize input and cursor will crash test.
name|qputenv
argument_list|(
...
argument_list|(
literal|"io.qt.QGuiApplication.desktop"
argument_list|)
expr_stmt|;
name|QCOMPARE
argument_list|(
