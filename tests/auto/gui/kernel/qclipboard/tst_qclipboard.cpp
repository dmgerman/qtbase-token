...
end_comment
begin_comment
comment|// This test does not make sense on X11 and embedded, as copied data disappears
end_comment
begin_comment
comment|// from the clipboard when the application exits.  It's still possible to test
end_comment
begin_comment
comment|// copy/paste - just keep the apps running.
end_comment
begin_if
if|#
directive|if
