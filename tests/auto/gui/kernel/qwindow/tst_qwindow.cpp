...
function_decl|;
name|void
name|exposeEventOnShrink_QTBUG54040
parameter_list|()
function_decl|;
name|void
name|mapGlobal
...
function_decl|;
name|void
name|childWindowPositioning_data
parameter_list|()
function_decl|;
name|void
name|childWindowPositioning
parameter_list|()
function_decl|;
name|void
...
name|QT_NO_CURSOR
name|void
name|modalWindowEnterEventOnHide_QTBUG35109
parameter_list|()
function_decl|;
endif|#
directive|endif
...
argument_list|()
argument_list|,
literal|"QWindow should lazy init the platform window"
argument_list|)
expr_stmt|;
name|a
operator|.
...
argument_list|()
argument_list|,
literal|"Explicitly creating a platform window should never fail"
argument_list|)
expr_stmt|;
name|QWindow
name|b
...
argument_list|()
argument_list|,
literal|"Creating a parent window should not automatically create children"
argument_list|)
expr_stmt|;
name|QWindow
name|d
...
argument_list|()
argument_list|,
literal|"Creating a child window should automatically create parents"
argument_list|)
expr_stmt|;
name|QWindow
name|f
...
name|platformWindow
argument_list|,
literal|"Creating a child window should not affect parent if already created"
argument_list|)
expr_stmt|;
block|}
end_function
...
name|a
argument_list|,
literal|"Setting parent at construction time should work"
argument_list|)
expr_stmt|;
name|QVERIFY2
argument_list|(
...
argument_list|)
argument_list|,
literal|"Parent should have child in list of children"
argument_list|)
expr_stmt|;
name|QWindow
name|c
...
name|c
argument_list|,
literal|"Setting parent after construction should work"
argument_list|)
expr_stmt|;
name|QVERIFY2
argument_list|(
...
argument_list|()
argument_list|,
literal|"Making window top level shouild not automatically create it"
argument_list|)
expr_stmt|;
name|QWindow
name|e
...
argument_list|()
argument_list|,
literal|"Making window a child of a created window should not automatically create it"
argument_list|)
expr_stmt|;
name|QWindow
name|f
...
argument_list|()
argument_list|,
literal|"Making a created window a child of a non-created window should automatically create it"
argument_list|)
expr_stmt|;
block|}
end_function
...
argument_list|()
argument_list|,
literal|"Making a top level window visible doesn't create its children"
argument_list|)
expr_stmt|;
name|QVERIFY2
argument_list|(
...
argument_list|()
argument_list|,
literal|"Making a top level window visible doesn't make its children visible"
argument_list|)
expr_stmt|;
name|QVERIFY
argument_list|(
...
argument_list|()
argument_list|,
literal|"Making a child window visible doesn't create parent window if parent is hidden"
argument_list|)
expr_stmt|;
name|QVERIFY2
argument_list|(
...
argument_list|()
argument_list|,
literal|"Making a child window visible doesn't make its parent visible"
argument_list|)
expr_stmt|;
name|QVERIFY2
argument_list|(
...
argument_list|()
argument_list|,
literal|"Making a child window visible doesn't create platform window if parent is hidden"
argument_list|)
expr_stmt|;
name|c
operator|.
...
argument_list|()
argument_list|,
literal|"Creating a parent window should automatically create children if they are visible"
argument_list|)
expr_stmt|;
name|QVERIFY2
argument_list|(
...
argument_list|()
argument_list|,
literal|"Creating a parent window should not make it visible just because it has visible children"
argument_list|)
expr_stmt|;
name|QWindow
name|e
...
argument_list|()
argument_list|,
literal|"Making a visible but not created child window top level should create it"
argument_list|)
expr_stmt|;
name|QVERIFY
argument_list|(
...
argument_list|()
argument_list|,
literal|"Making a visible but not created child window child of a created window should create it"
argument_list|)
expr_stmt|;
name|QVERIFY
argument_list|(
...
name|setObjectName
argument_list|(
literal|"topLevelWindowAfter"
argument_list|)
expr_stmt|;
name|ColoredWindow
name|childWindowFirst
argument_list|(
name|Qt
operator|::
name|yellow
...
argument_list|)
expr_stmt|;
comment|// Creation order shouldn't affect the child ending up at 0,0
name|QCOMPARE
argument_list|(
name|childWindowFirst
operator|.
...
name|QSKIP
argument_list|(
literal|"This test fails on OS X on CI"
argument_list|)
expr_stmt|;
specifier|const
name|QPoint
...
argument_list|)
decl_stmt|;
comment|// Test whether tlw can receive the enter event
block|{
name|QCursor
operator|::
name|setPos
...
argument_list|)
expr_stmt|;
comment|// Move the mouse over the root window, but not over the modal window.
name|QCursor
operator|::
name|setPos
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Wait for the enter event. It must be delivered here, otherwise second
comment|// compare can PASS because of this event even after "resetCounters()".
name|QTRY_COMPARE
argument_list|(
name|root
operator|.
...
argument_list|()
expr_stmt|;
comment|// Check for the enter event
name|QTRY_COMPARE
argument_list|(
name|root
operator|.
...
expr_stmt|;
block|}
comment|// Test whether child window can receive the enter event
block|{
name|QCursor
operator|::
name|setPos
...
argument_list|)
expr_stmt|;
comment|// Move the mouse over the child window, but not over the modal window.
comment|// Be sure that the value is almost left-top of second child window for
comment|// checking proper position mapping.
name|QCursor
operator|::
name|setPos
argument_list|(
...
expr_stmt|;
block|}
comment|// Test whether tlw can receive the enter event if mouse is over the invisible child windnow
block|{
name|QCursor
operator|::
name|setPos
