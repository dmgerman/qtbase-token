...
expr_stmt|;
name|QString
name|referenceAsTextData
decl_stmt|;
name|QFile
name|referenceAsText
argument_list|(
name|referenceName
argument_list|)
decl_stmt|;
...
name|QString
argument_list|(
literal|"Reference file %1 has %2 as line ending and file size not matching - Git checkout issue !?!"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|QString
argument_list|(
literal|"Reference file %1 has %2 as line ending - Git checkout issue !?!"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|QSKIP
argument_list|(
literal|"SSL not enabled, cannot test"
argument_list|,
name|SkipAll
argument_list|)
expr_stmt|;
...
name|x
parameter_list|)
value|(QByteArray::fromRawData(x, -1 + sizeof(x)))
end_define
begin_function
