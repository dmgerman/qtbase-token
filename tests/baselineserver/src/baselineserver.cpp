...
argument_list|()
expr_stmt|;
comment|//### Temporarily override the client setting, for client compatibility:
if|if
condition|(
operator|!
name|clientInfo
...
condition|)
block|{
comment|// for CI runs, allow filtering of clients. TBD: different filters (settings file) per testCase
foreach|foreach
control|(
name|QString
name|filterKey
