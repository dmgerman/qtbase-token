...
condition|)
block|{
comment|// Not run by Pulse, i.e. ad hoc run: Ok.
block|}
elseif|else
if|if
condition|(
...
name|QLS
argument_list|(
literal|"Merge branch 'master' of scm.dev.nokia.troll.no:qt/qt-fire-staging into master-integration"
argument_list|)
argument_list|)
condition|)
block|{
...
argument_list|()
operator|<<
literal|"Did not pass branch/staging repo filter, disconnecting."
expr_stmt|;
name|proto
operator|.
name|sendBlock
...
name|QByteArray
argument_list|(
literal|"This branch/staging repo is not assigned to be tested."
argument_list|)
argument_list|)
expr_stmt|;
name|proto
