...
comment|/*!     \fn char *QTest::toString(const T&value)      Returns a textual representation of \a value. This function is used by     \l QCOMPARE() to output verbose information in case of a test failure.      You can add specializations of this function to your test to enable     verbose output.      \b {Note:} The caller of toString() must delete the returned data     using \c{delete[]}.  Your implementation should return a string     created with \c{new[]} or qstrdup().      Example:      \snippet doc/src/snippets/code/src_qtestlib_qtestcase.cpp 16      The example above defines a toString() specialization for a class     called \c MyPoint. Whenever a comparison of two instances of \c     MyPoint fails, \l QCOMPARE() will call this function to output the     contents of \c MyPoint to the test log.      \sa QCOMPARE() */
...
comment|/*! \fn bool QTest::qWaitForWindowShown(QWidget *window)     \since 4.6      Waits until the \a window is shown on the screen. This is mainly useful for     asynchronous systems like X11, where a window will be mapped to screen some     time after being asked to show itself on the screen. Returns true.      Example:     \snippet doc/src/snippets/code/src_qtestlib_qtestcase.cpp 24 */
comment|/*! \fn bool QTest::qWaitForWindowShown(QWindow *window, int timeout)     \since 5.0      Waits for \a timeout milliseconds or until the \a window is shown on the screen.     This is mainly useful for asynchronous systems like X11, where a window will be mapped to screen some     time after being asked to show itself on the screen.      Returns true if \c window is show in \a timout milliseconds, otherwise returns false.      \sa QTest::qWaitForWindowActive(), QTest::qWaitForWindowExposed() */
comment|/*! \fn bool QTest::qWaitForWindowActive(QWindow *window, int timeout)     \since 5.0      Waits for \a timeout milliseconds or until the \a window is active.      Returns true if \c window is active in \a timout milliseconds, otherwise returns false.      \sa QTest::qWaitForWindowActive(), QTest::qWaitForWindowShown(), QWindow::isActive() */
comment|/*! \fn bool QTest::qWaitForWindowExposed(QWindow *window, int timeout)     \since 5.0      Waits for \a timeout milliseconds or until the \a window is exposed.     Returns true if \c window is exposed in \a timout milliseconds, otherwise returns false.      \sa QTest::qWaitForWindowShown(), QTest::qWaitForWindowExposed(), QWindow::isExposed() */
...
end_function
begin_comment
comment|/*!     Appends a new row to the current test data. \a dataTag is the name of     the testdata that will appear in the test output. Returns a QTestData reference     that can be used to stream in data.      Example:     \snippet doc/src/snippets/code/src_qtestlib_qtestcase.cpp 20      \b {Note:} This macro can only be used in a test's data function     that is invoked by the test framework.      See \l {Chapter 2: Data Driven Testing}{Data Driven Testing} for     a more extensive example.      \sa addColumn(), QFETCH() */
end_comment
begin_function
