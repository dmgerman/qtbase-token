...
directive|endif
comment|// Warn if the elapsed time was more than 50% longer or more than 10% shorter than the
...
name|fromLatin1
argument_list|(
literal|"QTest::qSleep() should have taken %1ns, but actually took %2ns!"
argument_list|)
operator|.
name|arg
argument_list|(
