...
specifier|const
name|int
name|disableStackDump
init|=
name|qEnvironmentVariableIntValue
argument_list|(
literal|"QTEST_DISABLE_STACK_DUMP"
argument_list|,
operator|&
name|ok
argument_list|)
...
name|qEnvironmentVariableIntValue
argument_list|(
literal|"QTEST_FUNCTION_TIMEOUT"
argument_list|,
operator|&
name|ok
argument_list|)
...
name|qFatal
argument_list|(
literal|"Test function timed out"
argument_list|)
expr_stmt|;
block|}
block|}
...
end_if
begin_comment
comment|// Helper class for resolving symbol names by dynamically loading "dbghelp.dll".
end_comment
begin_class
DECL|class|DebugSymbolResolver
class|class
name|DebugSymbolResolver
block|{
name|Q_DISABLE_COPY
parameter_list|(
name|DebugSymbolResolver
...
name|name
decl_stmt|;
comment|// Must be freed by caller.
DECL|member|address
name|DWORD64
name|address
decl_stmt|;
...
function_decl|;
private|private:
comment|// typedefs from DbgHelp.h/.dll
DECL|struct|DBGHELP_SYMBOL_INFO
struct|struct
name|DBGHELP_SYMBOL_INFO
block|{
comment|// SYMBOL_INFO
DECL|member|SizeOfStruct
name|ULONG
name|SizeOfStruct
decl_stmt|;
DECL|member|TypeIndex
name|ULONG
name|TypeIndex
decl_stmt|;
comment|// Type Index of symbol
...
name|ModBase
decl_stmt|;
comment|// Base Address of module comtaining this symbol
DECL|member|Flags
name|ULONG
name|Flags
decl_stmt|;
...
name|Value
decl_stmt|;
comment|// Value of symbol, ValuePresent should be 1
DECL|member|Address
name|ULONG64
name|Address
decl_stmt|;
comment|// Address of symbol including base address of module
DECL|member|Register
name|ULONG
name|Register
decl_stmt|;
comment|// register holding value or pointer to value
DECL|member|Scope
name|ULONG
name|Scope
decl_stmt|;
comment|// scope of the symbol
DECL|member|Tag
name|ULONG
name|Tag
decl_stmt|;
comment|// pdb classification
DECL|member|NameLen
name|ULONG
name|NameLen
decl_stmt|;
comment|// Actual length of name
DECL|member|MaxNameLen
name|ULONG
name|MaxNameLen
decl_stmt|;
DECL|member|Name
...
block|}
struct|;
DECL|typedef|SymInitializeType
typedef|typedef
name|BOOL
function_decl|(
name|__stdcall
modifier|*
name|SymInitializeType
function_decl|)
parameter_list|(
name|HANDLE
parameter_list|,
...
parameter_list|)
function_decl|;
DECL|typedef|SymFromAddrType
typedef|typedef
name|BOOL
function_decl|(
name|__stdcall
modifier|*
name|SymFromAddrType
function_decl|)
parameter_list|(
name|HANDLE
parameter_list|,
...
name|m_process
decl_stmt|;
DECL|member|m_dbgHelpLib
name|HMODULE
name|m_dbgHelpLib
decl_stmt|;
DECL|member|m_symFromAddr
name|SymFromAddrType
name|m_symFromAddr
decl_stmt|;
block|}
...
specifier|const
block|{
comment|// reserve additional buffer where SymFromAddr() will store the name
struct|struct
name|NamedSymbolInfo
super|:
specifier|public
name|DBGHELP_SYMBOL_INFO
block|{
...
name|result
decl_stmt|;
comment|// null until success, then == tempDir
name|QSharedPointer
argument_list|<
name|QTemporaryDir
argument_list|>
