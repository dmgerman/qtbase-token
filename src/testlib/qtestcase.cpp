...
specifier|const
function_decl|;
DECL|member|m_initTestCaseMethod
name|QMetaMethod
name|m_initTestCaseMethod
decl_stmt|;
comment|// might not exist, check isValid().
DECL|member|m_initTestCaseDataMethod
name|QMetaMethod
name|m_initTestCaseDataMethod
decl_stmt|;
DECL|member|m_cleanupTestCaseMethod
name|QMetaMethod
name|m_cleanupTestCaseMethod
decl_stmt|;
DECL|member|m_initMethod
name|QMetaMethod
name|m_initMethod
decl_stmt|;
DECL|member|m_cleanupMethod
name|QMetaMethod
name|m_cleanupMethod
decl_stmt|;
DECL|member|m_methods
name|MetaMethods
name|m_methods
decl_stmt|;
block|}
class|;
DECL|function|TestMethods
name|TestMethods
operator|::
name|TestMethods
parameter_list|(
...
block|}
block|}
DECL|function|invokeTestOnData
name|void
name|TestMethods
operator|::
name|invokeTestOnData
