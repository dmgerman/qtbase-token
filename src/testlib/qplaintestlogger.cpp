...
name|msg
parameter_list|)
value|colored ? qWinColoredMsg(prefix, color, msg) : msg
else|#
directive|else
define|#
directive|define
...
name|msg
parameter_list|)
value|colored&& QAbstractTestLogger::isTtyOutput() ? "\033["#prefix";"#color"m" msg "\033[0m" : msg
endif|#
directive|endif
...
return|;
block|}
comment|//    static void printBenchmarkResult(const char *bmtag, int value, int iterations)
...
parameter_list|)
block|{
comment|//    QTest::printBenchmarkResult(QTest::benchmarkResult2String(), value, iterations);
name|QTest
operator|::
name|printBenchmarkResult
argument_list|(
