...
end_comment
begin_comment
comment|// In Symbian we have QTEST_NO_SPECIALIZATIONS defined, but still float related specialization
end_comment
begin_comment
comment|// should be used. If QTEST_NO_SPECIALIZATIONS is enabled we get ambiguous overload errors.
end_comment
begin_if
if|#
directive|if
