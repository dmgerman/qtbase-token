...
include|#
directive|include
file|<QtTest/private/qcsvbenchmarklogger_p.h>
end_include
begin_include
include|#
directive|include
...
literal|true
return|;
comment|// ignore an optional whitespace at the end of str
comment|// (the space was added automatically by ~QDebug() until Qt 5.3,
comment|//  so autotests still might expect it)
if|if
condition|(
name|expected
operator|.
...
name|QStringLiteral
argument_list|(
literal|"Did not receive message: \""
argument_list|)
operator|+
name|list
operator|->
...
name|QStringLiteral
argument_list|(
literal|"Did not receive any message matching: \""
argument_list|)
operator|+
name|list
operator|->
