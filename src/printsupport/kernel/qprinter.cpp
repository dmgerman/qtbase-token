...
end_function
begin_comment
comment|/// return the QSize from the specified in unit as millimeters
end_comment
begin_function
DECL|function|qt_SizeFromUnitToMillimeter
name|Q_PRINTSUPPORT_EXPORT
name|QSizeF
name|qt_SizeFromUnitToMillimeter
parameter_list|(
specifier|const
name|QSizeF
modifier|&
...
end_function
begin_comment
comment|/*!     \since 5.1      Sets the paper used by the printer to \a paperName.      \sa paperName() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.1      Returns the paper name of the paper set on the printer.      The default value for this is driver-dependent. */
end_comment
begin_function
