...
name|qErrnoWarning
argument_list|(
literal|"QWin32PrintEngine::end: EndPage failed (%p)"
argument_list|,
name|d
operator|->
name|hdc
...
name|qErrnoWarning
argument_list|(
literal|"QWin32PrintEngine::end: EndDoc failed"
argument_list|)
expr_stmt|;
block|}
name|d
...
name|qErrnoWarning
argument_list|(
literal|"Win32PrintEngine::newPage: StartPage failed (2)"
argument_list|)
expr_stmt|;
block|}
if|if
...
condition|)
block|{
comment|// pInfo->pDevMode == NULL for some printers and passing NULL
comment|// into CreateDC leads to the printer doing nothing.  In addition,
comment|// the framework assumes that devMode isn't NULL, such as in
comment|// QWin32PrintEngine::begin() and QPageSetupDialog::exec()
comment|// Attempt to get the DEVMODE a different way.
comment|// Allocate the required buffer
name|LONG
name|result
init|=
...
name|qErrnoWarning
argument_list|(
literal|"QWin32PrintEngine::initialize: Failed to obtain devMode"
argument_list|)
expr_stmt|;
name|free
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Check if devMode was allocated separately from pInfo / hMem.
if|if
condition|(
name|ownsDevMode
condition|)
