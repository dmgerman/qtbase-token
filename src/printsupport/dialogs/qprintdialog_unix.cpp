...
end_comment
begin_comment
comment|/*      QPPDOptionsModel      Holds the PPD Options for the printer.  */
end_comment
begin_if
if|#
directive|if
...
end_comment
begin_comment
comment|/*      QPPDOptionsEditor      Edits the PPD Options for the printer.  */
end_comment
begin_function
