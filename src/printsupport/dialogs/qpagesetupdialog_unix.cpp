...
condition|)
block|{
comment|// OutputFormat == NativeFormat, data is QString Cups paper name
name|QByteArray
name|cupsPageSize
init|=
name|val
...
block|{
comment|// OutputFormat == PdfFormat, data is QPrinter::PageSize
name|QPrinter
operator|::
name|PaperSize
name|size
...
condition|)
block|{
comment|// Convert input custom size Units to Points
name|m_paperSize
operator|=
name|QSizeF
argument_list|(
...
block|{
comment|// Display standard size Points as Units
name|widget
operator|.
name|paperWidth
operator|->
