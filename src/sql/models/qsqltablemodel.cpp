...
end_function
begin_comment
comment|/*! \internal     Set a record for OnFieldChange and OnRowChange. */
end_comment
begin_function
...
name|strategy
decl_stmt|;
comment|// FieldChange strategy makes no sense when setting an entire row
if|if
condition|(
name|strategy
operator|==
...
name|row
expr_stmt|;
comment|// ### apply dangling changes...
name|d
operator|->
name|clearEditBuffer
argument_list|()
