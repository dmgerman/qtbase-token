...
name|qWarning
argument_list|(
literal|"QMYSQLDriver: SSL_KEY, SSL_CERT and SSL_CA should be used instead of CLIENT_SSL."
argument_list|)
expr_stmt|;
else|else
name|qWarning
...
name|QLatin1String
argument_list|(
literal|"MYSQL_OPT_CONNECT_TIMEOUT"
argument_list|)
condition|)
block|{
name|connectTimeout
...
name|QLatin1String
argument_list|(
literal|"MYSQL_OPT_READ_TIMEOUT"
argument_list|)
condition|)
block|{
name|readTimeout
...
name|QLatin1String
argument_list|(
literal|"MYSQL_OPT_WRITE_TIMEOUT"
argument_list|)
condition|)
block|{
name|writeTimeout
...
name|tr
argument_list|(
literal|"Unable to allocate a MYSQL object"
argument_list|)
argument_list|,
name|QSqlError
operator|::
...
name|mysql
argument_list|,
name|MYSQL_OPT_CONNECT_TIMEOUT
argument_list|,
operator|&
name|connectTimeout
argument_list|)
