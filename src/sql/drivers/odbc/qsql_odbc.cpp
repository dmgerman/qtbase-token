...
block|{
name|SQLLEN
name|nNumericAttribute
init|=
literal|0
decl_stmt|;
comment|// Check for auto-increment
specifier|const
name|SQLRETURN
name|r
init|=
...
literal|1
argument_list|,
name|SQL_DESC_AUTO_UNIQUE_VALUE
argument_list|,
literal|0
argument_list|,
literal|0
...
name|QStringLiteral
argument_list|(
literal|"qMakeField: Unable to get autovalue attribute for column "
argument_list|)
operator|+
name|QString
operator|::
...
name|QStringLiteral
argument_list|(
literal|"qMakeField: Unable to describe column "
argument_list|)
operator|+
name|QString
operator|::
...
name|QStringLiteral
argument_list|(
literal|"qMakeField: Unable to get column attributes for column "
argument_list|)
operator|+
name|QString
operator|::
