...
end_function
begin_comment
comment|/*! \fn bool QSqlField::operator!=(const QSqlField&other) const     Returns \c true if the field is unequal to \a other; otherwise returns     false. */
end_comment
begin_comment
comment|/*!     Returns \c true if the field is equal to \a other; otherwise returns     false. */
end_comment
begin_function
DECL|function|operator ==
name|bool
...
end_function
begin_comment
comment|/*!     Returns \c true if the field's value is read-only; otherwise returns     false.      \sa setReadOnly(), type(), requiredStatus(), length(), precision(),         defaultValue(), isGenerated() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns \c true if the field's value is NULL; otherwise returns     false.      \sa value() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns \c true if this is a required field; otherwise returns \c false.     An \c INSERT will fail if a required field does not have a value.      \sa setRequiredStatus(), type(), length(), precision(), defaultValue(),         isGenerated() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns \c true if the field is generated; otherwise returns     false.      \sa setGenerated(), type(), requiredStatus(), length(), precision(),         defaultValue() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns \c true if the field's variant type is valid; otherwise     returns \c false. */
end_comment
begin_function
...
end_endif
begin_comment
comment|/*!     Returns \c true if the value is auto-generated by the database,     for example auto-increment primary key values.      \note When using the ODBC driver, due to limitations in the ODBC API,     the \c isAutoValue() field is only populated in a QSqlField resulting from a     QSqlRecord obtained by executing a \c SELECT query. It is \c false in a QSqlField     resulting from a QSqlRecord returned from QSqlDatabase::record() or     QSqlDatabase::primaryIndex().      \sa setAutoValue() */
end_comment
begin_function
