...
end_function
begin_comment
comment|/*!     Opens the database connection using the current connection     values. Returns true on success; otherwise returns false. Error     information can be retrieved using lastError().      \sa lastError() setDatabaseName() setUserName() setPassword()     \sa setHostName() setPort() setConnectOptions() */
end_comment
begin_function
DECL|function|open
name|bool
...
end_function
begin_comment
comment|/*!     Sets the connection's user name to \a name. To have effect, the     user name must be set \e{before} the connection is \l{open()}     {opened}.  Alternatively, you can close() the connection, set the     user name, and call open() again.      There is no default value.      \sa userName() setDatabaseName() setPassword() setHostName()     \sa setPort() setConnectOptions() open() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Sets the connection's host name to \a host. To have effect, the     host name must be set \e{before} the connection is \l{open()}     {opened}.  Alternatively, you can close() the connection, set the     host name, and call open() again.      There is no default value.      \sa hostName() setUserName() setPassword() setDatabaseName()     \sa setPort() setConnectOptions() open() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns true if the QSqlDatabase has a valid driver.      Example:     \snippet doc/src/snippets/code/src_sql_kernel_qsqldatabase.cpp 8 */
end_comment
begin_function
...
end_ifdef
begin_comment
comment|/*!     Use query.record() instead. */
end_comment
begin_function
DECL|function|record
name|QSqlRecord
...
end_function
begin_comment
comment|/*!     \fn QSqlRecord QSqlDatabase::recordInfo(const QString& tablename) const      Use record() instead. */
end_comment
begin_endif
endif|#
directive|endif
