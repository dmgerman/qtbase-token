...
end_function
begin_comment
comment|/*!     Returns whether \a identifier is escaped according to the database rules.     \a identifier can either be a table name or field name, dependent     on \a type.      \warning Because of binary compatibility constraints, this function is not virtual.     If you want to provide your own implementation in your QSqlDriver subclass,     reimplement the isIdentifierEscapedImplementation() slot in your subclass instead.     The isIdentifierEscapedFunction() will dynamically detect the slot and call it.      \sa stripDelimiters(), escapeIdentifier()  */
end_comment
begin_function
...
argument_list|)
argument_list|,
literal|"isIdentifierEscapedImplementation"
argument_list|,
name|Qt
operator|::
...
end_function
begin_comment
comment|/*!     Returns the \a identifier with the leading and trailing delimiters removed,     \a identifier can either be a table name or field name,     dependent on \a type.  If \a identifier does not have leading     and trailing delimiter characters, \a identifier is returned without     modification.      \warning Because of binary compatibility constraints, this function is not virtual,     If you want to provide your own implementation in your QSqlDriver subclass,     reimplement the stripDelimitersImplementation() slot in your subclass instead.     The stripDelimiters() function will dynamically detect the slot and call it.      \since 4.5     \sa isIdentifierEscaped()  */
end_comment
begin_function
...
argument_list|)
argument_list|,
literal|"stripDelimitersImplementation"
argument_list|,
name|Qt
operator|::
name|DirectConnection
...
argument_list|)
argument_list|,
literal|"subscribeToNotificationImplementation"
argument_list|,
name|Qt
operator|::
name|DirectConnection
...
argument_list|)
argument_list|,
literal|"unsubscribeFromNotificationImplementation"
argument_list|,
name|Qt
operator|::
name|DirectConnection
...
end_function
begin_comment
comment|/*!     Returns a list of the names of the event notifications that are currently subscribed to.      \warning Because of binary compatibility constraints, this function is not virtual.     If you want to provide event notification support in your own QSqlDriver subclass,     reimplement the subscribedToNotificationsImplementation() slot in your subclass instead.     The subscribedToNotifications() function will dynamically detect the slot and call it.      \since 4.4     \sa subscribeToNotification() unsubscribeFromNotification() */
end_comment
begin_function
...
argument_list|)
argument_list|,
literal|"subscribedToNotificationsImplementation"
argument_list|,
name|Qt
operator|::
name|DirectConnection
...
end_function
begin_comment
comment|/*!     Returns a list of the names of the event notifications that are currently subscribed to.      Reimplement this slot to provide your own QSqlDriver subclass with event notification     support; because of binary compatibility constraints, the subscribedToNotifications()     function (introduced in Qt 4.4) is not virtual. Instead, subscribedToNotifications()     will dynamically detect and call \e this slot. The default implementation simply     returns an empty QStringList.      \since 4.4     \sa subscribedToNotifications() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 4.6      This slot returns \a identifier with the leading and trailing delimiters removed,     \a identifier can either be a tablename or field name, dependent on \a type.     If \a identifier does not have leading and trailing delimiter characters, \a     identifier is returned without modification.      Because of binary compatibility constraints, the stripDelimiters() function     (introduced in Qt 4.5) is not virtual.  Instead, stripDelimiters() will     dynamically detect and call \e this slot.  It generally unnecessary     to reimplement this slot.      \sa stripDelimiters()  */
end_comment
begin_function
