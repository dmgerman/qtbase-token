...
end_ifdef
begin_comment
comment|/*!     \obsolete     Use field() instead */
end_comment
begin_function
...
end_ifdef
begin_comment
comment|/*!     Returns a list of all the record's field names as a string     separated by \a sep.      In the unlikely event that you used this function in Qt 3, you     can simulate it using the rest of the QSqlRecord public API. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns a list of all the record's field names, each having the     prefix \a prefix.      In the unlikely event that you used this function in Qt 3, you     can simulate it using the rest of the QSqlRecord public API. */
end_comment
begin_function
