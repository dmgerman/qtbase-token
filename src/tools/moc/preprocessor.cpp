...
case|:
block|{
comment|//             if (macros.contains(symbol()))
comment|//                 ;
block|}
comment|// we _could_ easily substitute macros by the following
comment|// four lines, but we choose not to.
comment|/*             if (macros.contains(sym.lexem())) {                 preprocessed += substitute(macros, symbols, i);                 continue;             }             */
break|break;
case|case
name|PP_HASH
case|:
