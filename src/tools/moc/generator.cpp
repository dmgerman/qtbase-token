...
end_comment
begin_comment
comment|// Functions used when generating QMetaObject directly
end_comment
begin_comment
comment|//
end_comment
begin_comment
comment|// Much of this code is copied from the corresponding
end_comment
begin_comment
comment|// C++ code-generating functions; we can change the
end_comment
begin_comment
comment|// two generators so that more of the code is shared.
end_comment
begin_comment
comment|// The key difference from the C++ code generator is
end_comment
begin_comment
comment|// that instead of calling fprintf(), we append bytes
end_comment
begin_comment
comment|// to a buffer.
end_comment
...
specifier|const
name|int
name|meta_object_offset
init|=
literal|0
decl_stmt|;
specifier|const
name|int
name|meta_object_size
init|=
sizeof|sizeof
argument_list|(
name|QMetaObject
...
literal|0
expr_stmt|;
comment|// we don't know the value itself
block|}
block|}
block|}
end_function
