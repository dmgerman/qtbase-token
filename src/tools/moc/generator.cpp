...
condition|)
block|{
comment|// Ideally, all the classes could have that flag. But this broke classes generated
comment|// by qdbusxml2cpp which generate code that require that we call qt_metacall for properties
name|flags
operator||=
...
argument_list|)
decl_stmt|;
comment|// The scope may be a namespace for example, so it's only safe to include scopes that are known QObjects (QTBUG-2151)
name|QHash
argument_list|<
name|QByteArray
argument_list|,
...
name|out
argument_list|,
literal|"if (_c == QMetaObject::ReadProperty || _c == QMetaObject::WriteProperty\n"
literal|"            || _c == QMetaObject::ResetProperty || _c == QMetaObject::RegisterPropertyMetaType) {\n"
literal|"        qt_static_metacall(this, _c, _id, _a);\n"
literal|"        _id -= %d;\n    }"
argument_list|,
name|cdef
...
name|out
argument_list|,
literal|"        %s *_t = reinterpret_cast<%s *>(_o);\n"
argument_list|,
name|cdef
operator|->
name|classname
...
argument_list|)
expr_stmt|;
comment|// Add -M args from the command line:
foreach|foreach
control|(
specifier|const
name|QString
