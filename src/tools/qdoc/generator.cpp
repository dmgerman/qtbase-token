...
ifdef|#
directive|ifdef
name|DEBUG_MULTIPLE_QDOCCONF_FILES
end_ifdef
begin_include
include|#
directive|include
...
end_function
begin_comment
comment|/*   Trims trailimng whitespace off the \a string and returns   the trimmed string.  */
end_comment
begin_function
...
block|if (!fn->qmlModuleIdentifier().isEmpty())             return fn->qmlModuleIdentifier() + QLatin1Char(' ') + fn->title();
endif|#
directive|endif
return|return
name|fn
...
end_function
begin_comment
comment|/*!   For generating the "New Classes... in 4.6" section on the   What's New in 4.6" page.  */
end_comment
begin_function
