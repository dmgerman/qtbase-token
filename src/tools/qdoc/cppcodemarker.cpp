...
end_function
begin_comment
comment|/*!   Returns the \a node name, or "()" if \a node is a   Node::Function node.  */
end_comment
begin_function
...
condition|)
block|{
comment|// ### this doesn't belong here; get rid of TargetNode hack
name|int
name|hashAt
init|=
name|target
...
name|tr
argument_list|(
literal|"Base class of QML class '%1' is ambgiguous"
argument_list|)
operator|.
name|arg
argument_list|(
