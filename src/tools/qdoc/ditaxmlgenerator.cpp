...
index|]
operator|+
literal|" PUBLIC \"-//NOKIA//DTD DITA QML API Type Reference v"
operator|+
name|version
operator|+
literal|"//EN\" \""
...
end_function
begin_comment
comment|/*!   Writes the<qmlDesc> tag and its contents for the \a node.   The \a marker is used for markeing up the text body.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   This generates an<apiDef> (actually<qmlDef>) in which the   QML module name and version number are specified.  */
end_comment
begin_function
...
literal|"outputclass"
argument_list|,
literal|"instantiates-cpp-class"
argument_list|)
expr_stmt|;
name|writeStartTag
argument_list|(
...
end_function
begin_comment
comment|/*!   Generate a<qmlDef> for the "since" version string, if there is one.  */
end_comment
begin_function
