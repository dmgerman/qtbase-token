...
comment|/*   The default indent for code is 4.   The default value for false is 0.   The default language is c++.   The default output format is html.   The default tab size is 8.   And those are all the default values for configuration variables.  */
specifier|static
specifier|const
expr|struct
block|{
...
name|tr
argument_list|(
literal|"qdoc will generate documentation for the modules found in the sourcemodules variable."
argument_list|)
argument_list|)
expr_stmt|;
foreach|foreach
...
name|qdocconf
operator|+=
literal|"/doc/config/module.qdocconf"
expr_stmt|;
name|QFile
name|f
argument_list|(
...
name|tr
argument_list|(
literal|"Can't find module's qdoc config file '%1'"
argument_list|)
operator|.
name|arg
argument_list|(
