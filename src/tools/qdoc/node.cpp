...
name|children
decl_stmt|;
comment|// `children` will be changed in ~Node()
name|qDeleteAll
argument_list|(
name|childrenCopy
argument_list|)
...
end_function
begin_comment
comment|/*!   Returns the number of member functions of a class such that   the functions are all named \a funcName.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   Returns the number of times this function name has been   overloaded, obtained from the parent.  */
end_comment
begin_function
DECL|function|numOverloads
name|int
...
end_function
begin_comment
comment|/*! Converts the \a boolean value to an enum representation   of the boolean type, which includes an enum  value for the   \e {default value} of the item, i.e. true, false, or default.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   Converts the enum \a troolean back to a boolean value.   If \a troolean is neither the true enum value nor the   false enum value, the boolean value returned is   \a defaultValue.    Note that runtimeDesignabilityFunction() should be called   first. If that function returns the name of a function, it   means the function must be called at runtime to determine   whether the property is Designable.  */
end_comment
begin_function
...
end_constructor
begin_comment
comment|/*!   I made this so I could print a debug message here.  */
end_comment
begin_destructor
DECL|function|~QmlClassNode
name|QmlClassNode
...
end_function
begin_comment
comment|/*!   The base file name for this kind of node has "qml_"   prepended to it.    But not yet. Still testing.  */
end_comment
begin_function
DECL|function|fileBase
name|QString
...
argument_list|()
operator|<<
literal|"QmlClassNode::addInheritedBy(): insert"
operator|<<
name|base
operator|<<
name|sub
...
argument_list|()
operator|<<
literal|"QmlClassNode::subclasses():"
operator|<<
name|inheritedBy
operator|.
name|count
...
end_function
begin_comment
comment|/*!   Most QML elements don't have an \\inherits command in their   \\qmlclass command. This leaves qdoc bereft, when it tries   to output the line in the documentation that specifies the   QML element that a QML element inherits.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   I don't know what this is either.  */
end_comment
begin_function
DECL|function|fromTrool
name|bool
...
name|tr
argument_list|(
literal|"Can't determine read-only status of QML property %1; writable assumed."
argument_list|)
operator|.
name|arg
argument_list|(
