...
name|tr
argument_list|(
literal|"Documentation expires today"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|tr
argument_list|(
literal|"Documentation expired yesterday"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|tr
argument_list|(
literal|"Documentation expired %1 days ago"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|tr
argument_list|(
literal|"Date '%1' not in YYYY-MM-DD format"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|tr
argument_list|(
literal|"Nonstandard wording in '\\%1' text for '%2' (expected 'The')"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|tr
argument_list|(
literal|"Nonstandard wording in '\\%1' text for '%2' (expected '%3')"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|tr
argument_list|(
literal|"Nonstandard wording in '\\%1' text for '%2' ("
literal|"expected 'class', 'function', 'macro', 'widget', "
literal|"'namespace' or 'header')"
argument_list|)
operator|.
name|arg
argument_list|(
...
name|tr
argument_list|(
literal|"Nonstandard wording in '\\%1' text for '%2' (expected more text)"
argument_list|)
operator|.
name|arg
argument_list|(
