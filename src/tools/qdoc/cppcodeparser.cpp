...
end_function
begin_comment
comment|/*!   Parse the next function parameter, if there is one, and   append it to parameter list \a p. Return true if a parameter   is parsed and appended to \a p. Otherwise return false.  */
end_comment
begin_function
