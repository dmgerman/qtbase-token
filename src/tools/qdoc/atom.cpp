...
end_constructor
begin_comment
comment|/*!   This function resolves the parameters that were enclosed in   square brackets. If the parameters have already been resolved,   it does nothing and returns immediately.  */
end_comment
begin_function
...
name|LinkAtom
operator|::
name|resolveSquareBracketParams
parameter_list|()
block|{
if|if
condition|(
