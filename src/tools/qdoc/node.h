...
parameter_list|)
function_decl|;
comment|//QString idForNode() const;
specifier|static
name|FlagValue
name|toFlagValue
parameter_list|(
...
name|role
argument_list|(
argument|const FunctionNode* fn
argument_list|)
specifier|const
block|;
name|bool
...
name|setLogicalModuleInfo
argument_list|(
argument|const QStringList& info
argument_list|)
name|Q_DECL_OVERRIDE
block|;
specifier|const
