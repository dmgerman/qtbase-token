...
name|QLatin1String
argument_list|(
literal|"Q3DataBrowser"
argument_list|)
argument_list|)
condition|)
block|{
name|initializeQ3SqlDataBrowser
argument_list|(
name|node
argument_list|)
expr_stmt|;
...
literal|true
expr_stmt|;
comment|// special case for group box
name|m_output
operator|<<
name|m_indent
operator|<<
name|parent
operator|<<
literal|"->setColumnLayout(0, Qt::Vertical);\n"
expr_stmt|;
name|QString
name|objectName
init|=
...
name|tempName
operator|<<
literal|" = qobject_cast<QBoxLayout *>("
operator|<<
name|m_driver
operator|->
name|findOrInsertWidget
...
name|varName
operator|<<
literal|"->setAlignment(Qt::AlignTop);\n"
expr_stmt|;
block|}
else|else
block|{
...
name|QLatin1String
argument_list|(
literal|"buttonGroupId"
argument_list|)
condition|)
block|{
comment|// Q3ButtonGroup support
if|if
condition|(
name|buttonGroupWidget
condition|)
...
name|m_indent
operator|<<
literal|"Q3IconViewItem *"
operator|<<
name|itemName
operator|<<
literal|" = new Q3IconViewItem("
operator|<<
name|varName
operator|<<
literal|");\n"
...
name|varName
operator|<<
literal|"->header()->setClickEnabled("
operator|<<
name|clickable
operator|->
name|elementBool
...
name|varName
operator|<<
literal|"->header()->setResizeEnabled("
operator|<<
name|resizable
operator|->
name|elementBool
...
literal|"->clear();\n"
expr_stmt|;
name|initializeQ3ListViewItems
argument_list|(
name|className
argument_list|,
name|varName
...
name|m_indent
operator|<<
literal|"Q3ListViewItem *"
operator|<<
name|itemName
operator|<<
literal|" = new Q3ListViewItem("
operator|<<
name|varName
operator|<<
literal|");\n"
...
name|varName
operator|<<
literal|"->horizontalHeader()->setLabel("
operator|<<
name|i
operator|<<
literal|", "
...
name|varName
operator|<<
literal|"->verticalHeader()->setLabel("
operator|<<
name|i
operator|<<
literal|", "
...
expr_stmt|;
block|}
comment|//initializeQ3TableItems(className, varName, w->elementItem());
block|}
DECL|function|initializeQ3TableItems
name|void
name|WriteInitialization
operator|::
name|initializeQ3TableItems
parameter_list|(
specifier|const
name|QString
modifier|&
...
condition|)
return|return;
comment|// Basic legacy Qt3 support, write out translatable text items, ignore pixmaps
specifier|const
name|QString
name|varName
init|=
...
name|varName
operator|<<
literal|"->insertStringList(QStringList()"
operator|<<
literal|'\n'
expr_stmt|;
specifier|const
...
name|QLatin1String
argument_list|(
literal|"QApplication::UnicodeUTF8"
argument_list|)
expr_stmt|;
block|}
name|result
...
name|stderr
argument_list|,
literal|"%s: Warning: Invalid database connection\n"
argument_list|,
name|qPrintable
argument_list|(
name|m_option
...
name|varName
operator|<<
literal|"->refresh(Q3DataTable::RefreshAll);\n"
expr_stmt|;
name|m_output
operator|<<
name|m_indent
