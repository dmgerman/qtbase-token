...
ifdef|#
directive|ifdef
name|QT_NO_QT3_SUPPORT
name|qWarning
argument_list|(
literal|"%s: Warning: The form file has external pixmaps or qPixmapFromMimeSource() set as a pixmap function. "
literal|"This requires Qt 3 support, which is disabled. The resulting code will not compile."
argument_list|,
name|qPrintable
argument_list|(
name|m_uic
