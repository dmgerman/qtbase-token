...
condition|)
block|{
comment|//Respect the file and index of the font config match
name|FcChar8
modifier|*
name|file_value
decl_stmt|;
...
condition|)
block|{
comment|// If antialiasing is not fully disabled, fontconfig may still disable it on a font match basis.
name|FcBool
name|fc_antialias
decl_stmt|;
if|if
