...
end_if
begin_comment
comment|// Newer FontConfig let's us sort out fonts that report certain scripts support,
end_comment
begin_comment
comment|// but no open type tables for handling them correctly.
end_comment
begin_comment
comment|// Check the reported script presence in the FC_CAPABILITY's "otlayout:" section.
end_comment
begin_decl_stmt
...
name|char
modifier|*
name|capabilityForWritingSystem
index|[]
init|=
block|{
literal|0
