...
argument_list|()
return|;
comment|// KDE, GNOME, UNITY, LXDE, MATE, XFCE...
comment|// Classic fallbacks
if|if
condition|(
operator|!
...
argument_list|)
return|;
comment|// Fallback to checking $DESKTOP_SESSION (unreliable)
specifier|const
name|QByteArray
name|desktopSession
init|=
...
name|qWarning
argument_list|(
literal|"openUrl() not supported on this platform"
argument_list|)
expr_stmt|;
return|return
literal|false
...
name|qWarning
argument_list|(
literal|"openDocument() not supported on this platform"
argument_list|)
expr_stmt|;
return|return
literal|false
