...
end_include
begin_comment
comment|// Defined in Windows headers which get included by qlockfile_p.h
end_comment
begin_undef
...
specifier|const
name|QString
name|KDEWatcherService
init|=
name|QStringLiteral
argument_list|(
literal|"org.kde.StatusNotifierWatcher"
argument_list|)
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
parameter_list|)
block|{
comment|// Hack for indicator-application, which doesn't handle icons sent across D-Bus:
comment|// save the icon to a temp file and set the icon name to that filename.
specifier|static
name|bool
name|necessity_checked
init|=
literal|false
decl_stmt|;
specifier|static
