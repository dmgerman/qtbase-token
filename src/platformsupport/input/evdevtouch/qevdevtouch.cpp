...
include|#
directive|include
file|<QtGui/private/qinputdevicemanager_p_p.h>
end_include
begin_include
include|#
directive|include
...
argument_list|)
expr_stmt|;
comment|// No monitoring of added/removed devices is done here, so for now just
comment|// increase the number of touch devices.
