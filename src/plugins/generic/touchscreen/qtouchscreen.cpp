...
block|}
block|}
comment|// ### TODO Add timestamps and remove points that stay unchanged for too long.
comment|// The user's finger may fall off the touchscreen, which means there will be
comment|// no released event sent ever for that particular point.
ifdef|#
directive|ifdef
name|POINT_DEBUG
name|qDebug
