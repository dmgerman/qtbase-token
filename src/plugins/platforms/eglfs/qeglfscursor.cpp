...
include|#
directive|include
file|<QtGui/private/qopenglvertexarrayobject_p.h>
end_include
begin_ifndef
ifndef|#
directive|ifndef
...
end_function
begin_comment
comment|// In order to prevent breaking code doing custom OpenGL rendering while
end_comment
begin_comment
comment|// expecting the state in the context unchanged, save and restore all the state
end_comment
begin_comment
comment|// we touch. The exception is Qt Quick where the scenegraph is known to be able
end_comment
begin_comment
comment|// to deal with the changes we make.
end_comment
begin_struct
