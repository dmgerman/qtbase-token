...
name|qWarning
argument_list|(
literal|"EGLFS: Failed to open %s to detect physical screen size."
argument_list|,
name|fbDeviceName
argument_list|()
argument_list|)
...
name|qWarning
argument_list|(
literal|"EGLFS: Failed to open %s to detect screen resolution."
argument_list|,
name|fbDeviceName
argument_list|()
argument_list|)
...
name|qWarning
argument_list|(
literal|"EGLFS: Failed to open %s to detect screen depth."
argument_list|,
name|fbDeviceName
argument_list|()
argument_list|)
