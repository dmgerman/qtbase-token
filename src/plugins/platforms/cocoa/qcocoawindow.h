...
argument_list|(
argument|QCocoaWindow
argument_list|)
end_macro
begin_decl_stmt
name|QT_BEGIN_NAMESPACE
name|class
name|QCocoaWindowPointer
block|{
name|public
label|:
name|void
...
specifier|static
name|QPoint
name|bottomLeftClippedByNSWindowOffsetStatic
argument_list|(
name|QWindow
operator|*
name|window
...
comment|// This object is tracked by QCocoaWindowPointer,
comment|// preventing the use of dangling pointers.
name|QObject
name|sentinel
block|; }
block|;
