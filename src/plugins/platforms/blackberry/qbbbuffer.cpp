...
name|defined
argument_list|(
name|QBBBUFFER_DEBUG
argument_list|)
name|qDebug
argument_list|()
operator|<<
literal|"QBBBuffer::QBBBuffer - empty"
expr_stmt|;
endif|#
directive|endif
block|}
...
argument_list|()
operator|<<
literal|"QBBBuffer::QBBBuffer - normal"
expr_stmt|;
endif|#
directive|endif
...
name|qFatal
argument_list|(
literal|"QBB: failed to query buffer size, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBB: failed to query buffer stride, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBB: failed to query buffer pointer, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBB: buffer pointer is NULL, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBB: failed to query buffer format, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBB: unsupported buffer format, format=%d"
argument_list|,
name|screenFormat
argument_list|)
expr_stmt|;
...
argument_list|()
operator|<<
literal|"QBBBuffer::QBBBuffer - copy"
expr_stmt|;
endif|#
directive|endif
block|}
...
argument_list|()
operator|<<
literal|"QBBBuffer::invalidateInCache"
expr_stmt|;
endif|#
directive|endif
...
name|qFatal
argument_list|(
literal|"QBB: can't invalidate cache for null buffer"
argument_list|)
expr_stmt|;
block|}
...
name|qFatal
argument_list|(
literal|"QBB: failed to invalidate cache, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
