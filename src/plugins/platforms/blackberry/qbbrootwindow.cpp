...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to create window, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window display, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window z-order, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window buffer usage, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window pixel format, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window buffer size, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBB: failed to create window buffer, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window size, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window colour, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window transparency, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window swap interval, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window source size, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window source position, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to query window buffer, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBB: failed to post window buffer, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to flush context, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to set window rotation, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QBBRootWindow: failed to create app window group, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
