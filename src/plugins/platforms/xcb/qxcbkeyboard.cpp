...
condition|)
block|{
comment|// Add a fall back key for layouts with non Latin-1 characters
if|if
condition|(
name|baseQtKey
operator|>
...
argument_list|)
expr_stmt|;
comment|// It is crucial the order of xkb_state_key_get_one_sym& xkb_state_update_key operations is not reversed!
name|xcb_keysym_t
name|sym
init|=
name|xkb_state_key_get_one_sym
