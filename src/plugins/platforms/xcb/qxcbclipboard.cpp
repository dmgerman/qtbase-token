...
expr_stmt|;
comment|//    } else {
comment|//        pending_selection_changed = true;
comment|//        if (! pending_timer_id)
comment|//            pending_timer_id = QApplication::clipboard()->startTimer(0);
comment|//    }
block|}
end_function
begin_function
