...
condition|)
block|{
comment|// We need to grab the touch event to prevent mouse emulation.
if|if
condition|(
name|xiEvent
operator|->
...
name|qDebug
argument_list|(
literal|"XI2 tablet event type %d seq %d detail %d pos %6.1f, %6.1f root pos %6.1f, %6.1f pressure %4.2lf tilt %d, %d rotation %6.2lf"
argument_list|,
name|ev
operator|->
name|type
