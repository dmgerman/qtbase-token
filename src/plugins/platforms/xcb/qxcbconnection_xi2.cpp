...
end_include
begin_comment
comment|//#define XI2_TOUCH_DEBUG
end_comment
begin_ifdef
ifdef|#
directive|ifdef
...
directive|ifndef
name|QT_NO_TABLETEVENT
comment|// Tablet support: Find the stylus-related devices.
...
comment|// Select touch events on all master devices indiscriminately.
name|bitMask
operator||=
...
name|qDebug
argument_list|(
literal|"registered new device %s with %d classes and %d max touch points"
argument_list|,
name|dev
operator|->
name|xiDeviceInfo
...
name|qDebug
argument_list|(
literal|"   valuator class label %d value %lf from range %lf -> %lf name %s"
argument_list|,
name|vci
operator|->
name|label
