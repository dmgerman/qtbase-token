...
directive|ifdef
name|MYX11_DEBUG
comment|//    qDebug()<< "QTestLiteWindow::paintEvent"<< shm_img.size()<< painted;
endif|#
directive|endif
if|if
condition|(
...
specifier|const
block|{
comment|// I have only tested this setup on a dodgy intel setup, where I didn't use standard libs,
comment|// so this might be not what we want to do :)
if|if
condition|(
operator|!
operator|(
