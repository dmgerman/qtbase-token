...
argument_list|)
expr_stmt|;
comment|// Check that the device properly supports depth/stencil rendering, and disable them if not
name|ComPtr
argument_list|<
name|ID3D11Device
argument_list|>
...
condition|)
block|{
comment|// The following GPUs do not render properly with depth/stencil
if|if
condition|(
operator|(
name|desc
...
directive|ifndef
name|Q_OS_WINPHONE
comment|// This handler is called from orientation changed, in which case we should always update the size
if|if
condition|(
name|d
operator|->
...
directive|ifdef
name|Q_OS_WINPHONE
comment|// Windows Phone can pass in a negative size to provide orientation information
name|width
operator|*=
operator|(
name|d
...
directive|ifdef
name|Q_OS_WINPHONE
comment|// The size changed handler is ignored in favor of this callback
name|onSizeChanged
argument_list|(
name|Q_NULLPTR
argument_list|,
