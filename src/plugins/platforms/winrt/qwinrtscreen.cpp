...
argument_list|,
operator|&
name|m_displayInformationFactory
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|hr
argument_list|,
literal|"Failed to get display information factory."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|hr
argument_list|,
literal|"Failed to get display information for the current view."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|hr
argument_list|,
literal|"Failed to get native orientation."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|hr
argument_list|,
literal|"Failed to add orientation change callback."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|hr
argument_list|,
literal|"Failed to add logical dpi change callback."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|hr
argument_list|,
literal|"Failed to get display resolution scale."
argument_list|)
expr_stmt|;
return|return
name|S_OK
...
end_endif
begin_comment
comment|// Correct the scale factor for integer window size
end_comment
begin_expr_stmt
name|m_devicePixelRatio
operator|=
