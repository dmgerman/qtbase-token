...
argument_list|)
expr_stmt|;
comment|// ANGLE requires that we query the adapter for its LUID. Later on, it may be useful
comment|// for checking feature level support, picking the best adapter on the system, etc.
name|IDXGIFactory1
modifier|*
name|dxgiFactory
decl_stmt|;
...
name|qCritical
argument_list|(
literal|"QWinRTBackingStore: failed to create DXGI factory."
argument_list|)
expr_stmt|;
return|return
name|QByteArray
...
name|qCritical
argument_list|(
literal|"QWinRTBackingStore:: failed to enumerate adapter."
argument_list|)
expr_stmt|;
name|dxgiFactory
operator|->
