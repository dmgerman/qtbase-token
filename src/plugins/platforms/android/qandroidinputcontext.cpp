...
name|m_composingTextStart
expr_stmt|;
comment|// Qt's idea of the cursor position is the start of the preedit area, so we have to maintain our own preedit cursor pos
name|int
...
argument_list|()
expr_stmt|;
comment|//### move cursor to newCursorPosition and call updateCursorPosition()
return|return
name|JNI_TRUE
return|;
block|}
