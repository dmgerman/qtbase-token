...
condition|)
block|{
comment|// make sure it also works with editors that have not been updated to the new API
name|QVariant
name|absolutePos
init|=
name|query
...
end_comment
begin_comment
comment|// * this function must not trigger updateSelection
end_comment
begin_comment
...
argument_list|)
expr_stmt|;
comment|//in the Qt text controls, the cursor position is the start of the preedit
name|int
name|relativeStart
init|=
name|localStart
