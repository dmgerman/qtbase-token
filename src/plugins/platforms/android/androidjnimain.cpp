...
specifier|static
name|sem_t
name|m_exitSemaphore
decl_stmt|,
name|m_terminateSemaphore
decl_stmt|;
end_decl_stmt
begin_struct
...
name|m_applicationClass
argument_list|,
literal|"setViewVisibility"
argument_list|,
literal|"(Landroid/view/View;Z)V"
argument_list|,
name|view
argument_list|,
name|visible
...
literal|"onNewIntent"
block|,
literal|"(Landroid/content/Intent;)V"
block|,
operator|(
name|void
operator|*
