...
specifier|static
name|jmethodID
name|m_setContentDescriptionMethodID
init|=
literal|0
decl_stmt|;
...
argument_list|()
argument_list|,
literal|"initializeAccessibility"
argument_list|)
expr_stmt|;
block|}
...
specifier|static
name|jstring
name|descriptionForAccessibleObject_helper
parameter_list|(
name|JNIEnv
modifier|*
name|env
...
comment|// Add ACTION_SCROLL_FORWARD
if|if
condition|(
name|hasIncreaseAction
condition|)
...
argument_list|)
expr_stmt|;
comment|// ACTION_SCROLL_FORWARD defined in AccessibilityNodeInfo
comment|// Add ACTION_SCROLL_BACKWARD
if|if
condition|(
name|hasDecreaseAction
condition|)
...
argument_list|)
expr_stmt|;
comment|// ACTION_SCROLL_BACKWARD defined in AccessibilityNodeInfo
...
parameter_list|)
define|\
value|VAR = env->GetMethodID(CLASS, METHOD_NAME, METHOD_SIGNATURE); \     if (!VAR) { \         __android_log_print(ANDROID_LOG_FATAL, QtAndroid::qtTagText(), QtAndroid::methodErrorMsgFmt(), METHOD_NAME, METHOD_SIGNATURE); \         return false; \     }
...
name|FindClass
argument_list|(
literal|"android/view/accessibility/AccessibilityNodeInfo"
argument_list|)
decl_stmt|;
name|GET_AND_CHECK_STATIC_METHOD
argument_list|(
