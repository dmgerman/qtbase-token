...
struct|struct
name|FakeNativeWindow
block|{
DECL|member|dummyNativeWindow
name|long
name|long
name|dummyNativeWindow
decl_stmt|;
comment|// force 64 bits alignment
block|}
struct|;
end_struct
begin_class
...
define|#
directive|define
name|ANDROID_VIEW_SURFACE_JNI_ID
value|"mSurface"
else|#
directive|else
define|#
