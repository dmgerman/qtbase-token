...
condition|)
block|{
comment|// Deactivate only if the window was the focus window.
comment|// Screen might send a keyboard focus event for a newly created
comment|// window on the secondary screen, with focus 0.
name|QWindowSystemInterface
operator|::
name|handleWindowActivated
argument_list|(
