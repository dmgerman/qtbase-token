...
argument_list|()
expr_stmt|;
comment|// Indices for selecting and setting highlight colors.
enum|enum
name|HighlightIndex
block|{
name|ActiveRegion
...
decl_stmt|;
comment|// The object that had focus when the last highlight color was set.
name|QObject
modifier|*
name|m_focusObject
decl_stmt|;
comment|// Indexed by HighlightIndex
name|QColor
