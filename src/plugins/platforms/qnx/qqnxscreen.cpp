...
name|qFatal
argument_list|(
literal|"QQnxScreen: failed to query display count, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
name|qFatal
argument_list|(
literal|"QQnxScreen: failed to query displays, errno=%d"
argument_list|,
name|errno
argument_list|)
expr_stmt|;
...
argument_list|()
operator|<<
literal|"QQnxScreen::Creating screen for display "
operator|<<
name|i
expr_stmt|;
endif|#
