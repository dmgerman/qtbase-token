...
condition|)
block|{
comment|//*iface = static_cast<IAccessibleHyperlink *>(this);
block|}
elseif|else
if|if
condition|(
...
condition|)
block|{
comment|//*iface = static_cast<IAccessibleHypertext *>(this);
block|}
elseif|else
if|if
condition|(
...
condition|)
block|{
comment|//*iface = static_cast<IAccessibleImage *>(this);
block|}
elseif|else
if|if
condition|(
...
condition|)
block|{
comment|//*iface = static_cast<IAccessibleTable *>(this); // not supported
block|}
elseif|else
if|if
condition|(
