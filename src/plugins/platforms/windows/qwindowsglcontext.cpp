...
expr_stmt|;
block|}
comment|// Check version. Known to fail for some drivers
if|if
condition|(
name|staticContext
operator|.
...
name|qErrnoWarning
argument_list|(
literal|"%s: wglGetPixelFormatAttribIVARB() failed for version."
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
block|}
block|}
comment|// Query flags from 3.2 onwards
if|if
condition|(
name|staticContext
operator|.
...
name|qErrnoWarning
argument_list|(
literal|"%s: wglGetPixelFormatAttribIVARB() failed for context flags."
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
block|}
block|}
comment|// Query profile from 3.2 onwards. Known to fail for some drivers
if|if
condition|(
operator|(
name|staticContext
...
name|qErrnoWarning
argument_list|(
literal|"%s: wglGetPixelFormatAttribIVARB() failed for profile mask."
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
...
end_function
begin_comment
comment|// Use ARB unless explicitly turned off on command line.
end_comment
begin_function
