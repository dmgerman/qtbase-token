...
directive|ifdef
name|Q_WS_QPA
comment|//QPlatformNativeInterface *platform = QGuiApplication::platformNativeInterface();
comment|//Q_ASSERT(platform);
comment|//*phwnd = (HWND)platform->nativeResourceForWindow("handle", window);
return|return
name|S_OK
return|;
else|#
