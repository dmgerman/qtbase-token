...
condition|)
block|{
comment|// Re-enable IME by associating default context saved on first disabling.
if|if
condition|(
name|platformWindow
operator|->
...
block|{
comment|// Disable IME by associating 0 context. Store context first time.
if|if
condition|(
operator|!
name|platformWindow
