...
comment|// matching Win32 API ORIENTATION_PREFERENCE
if|#
directive|if
name|defined
argument_list|(
...
end_function
begin_comment
comment|/*!     \brief Queries ClearType settings to check the pixel layout */
end_comment
begin_function
...
name|QLatin1String
argument_list|(
literal|"HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Avalon.Graphics\\DISPLAY1"
argument_list|)
argument_list|,
name|QSettings
operator|::
...
end_function
begin_comment
comment|// Move a window to a new virtual screen, accounting for varying sizes.
end_comment
begin_function
DECL|function|moveToVirtualScreen
specifier|static
name|void
name|moveToVirtualScreen
parameter_list|(
name|QWindow
modifier|*
name|w
...
comment|// QTBUG-39320: Windows does not automatically move WS_EX_TOOLWINDOW (dock) windows;
comment|// move those manually.
if|if
condition|(
name|screen
operator|!=
