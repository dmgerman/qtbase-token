...
end_ifndef
begin_comment
comment|// QTBUG-48823/Windows 10: SHGetFileInfo() (as called by item views on file system
end_comment
begin_comment
comment|// models has been observed to trigger a WM_PAINT on the mainwindow. Suppress the
end_comment
begin_comment
comment|// behavior by running it in a thread.
end_comment
begin_class
DECL|class|ShGetFileInfoFunction
class|class
name|ShGetFileInfoFunction
block|{
public|public:
...
argument_list|()
operator|<<
literal|"ShGetFileInfoBackground() timed out for "
operator|<<
name|QString
operator|::
name|fromWCharArray
