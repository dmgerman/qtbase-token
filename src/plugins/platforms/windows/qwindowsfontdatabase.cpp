...
end_ifndef
begin_comment
comment|// ### fixme: Consider direct linking of dwrite.dll once Windows Vista pre SP2 is dropped (QTBUG-49711)
end_comment
begin_typedef
...
specifier|inline
name|DWriteCreateFactoryType
name|resolveDWriteCreateFactory
parameter_list|()
block|{
if|if
condition|(
...
name|qWarning
argument_list|(
literal|"Unable to load dwrite.dll"
argument_list|)
expr_stmt|;
return|return
name|Q_NULLPTR
...
argument_list|()
operator|<<
literal|"DirectWrite: CreateFontFaceFromHDC() failed ("
operator|<<
name|errorString
operator|<<
literal|") for "
