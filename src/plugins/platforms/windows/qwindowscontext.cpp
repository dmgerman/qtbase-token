...
name|GenericWindowsEventFilter
block|,
DECL|enumerator|EventFilterTypeCount
name|EventFilterTypeCount
block|}
enum|;
name|QWindowsContextPrivate
parameter_list|()
...
end_function
begin_comment
comment|/*!      \brief Set event filter.       \sa QWindowsNativeInterface */
end_comment
begin_function
...
name|qWarning
argument_list|(
literal|"%s: Attempt to set unsupported event filter '%s'."
argument_list|,
name|__FUNCTION__
argument_list|,
name|eventType
...
block|}
block|}
comment|// Events without an associated QWindow or events we are not interested in.
switch|switch
condition|(
name|et
condition|)
