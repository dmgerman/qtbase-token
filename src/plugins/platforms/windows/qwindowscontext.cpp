...
name|resolve
argument_list|(
literal|"GetDisplayAutoRotationPreferences"
argument_list|)
expr_stmt|;
name|setDisplayAutoRotationPreferences
operator|=
...
name|resolve
argument_list|(
literal|"SetDisplayAutoRotationPreferences"
argument_list|)
expr_stmt|;
block|}
end_function
...
name|resolve
argument_list|(
literal|"SHGetKnownFolderIDList"
argument_list|)
argument_list|)
expr_stmt|;
name|sHGetStockIconInfo
...
name|resolve
argument_list|(
literal|"SHCreateItemFromIDList"
argument_list|)
expr_stmt|;
block|}
end_function
...
argument_list|()
decl_stmt|;
comment|// Disable IME assuming this is a special implementation hooking into keyboard input.
comment|// "Real" IME implementations should use a native event filter intercepting IME events.
if|if
condition|(
operator|!
name|windowsInputContext
