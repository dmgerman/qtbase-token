...
end_function
begin_comment
comment|// Overridden to return a QWindowsDirect2DWindow in Direct2D plugin.
end_comment
begin_function
...
name|lcQpaGl
argument_list|,
literal|"Unable to disable rotation."
argument_list|)
expr_stmt|;
block|}
return|return
...
name|lcQpaGl
argument_list|,
literal|"System OpenGL failed. Falling back to Software OpenGL."
argument_list|)
expr_stmt|;
return|return
name|QOpenGLStaticContext
