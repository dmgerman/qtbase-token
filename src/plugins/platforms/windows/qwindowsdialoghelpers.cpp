...
parameter_list|)
block|{
comment|// Cause the dialog to append the suffix of the current filter unless a default
comment|// suffix is set (Note: Qt 4.8 sets the selected filter's suffix before
comment|// calling GetSaveFileName()).
if|if
condition|(
operator|!
name|hasDefaultSuffix
