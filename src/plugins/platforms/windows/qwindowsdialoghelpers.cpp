...
end_comment
begin_comment
comment|// Find the owner which to use as a parent of a native dialog.
end_comment
begin_function
...
name|qDebug
argument_list|(
literal|"%s visible=%d, native=%d, modal=%d native=%p"
argument_list|,
name|__FUNCTION__
argument_list|,
name|visible
...
name|m_dialog
argument_list|,
literal|"_q_platformRunNativeAppModalPanel"
argument_list|,
name|Qt
operator|::
...
return|;
block|}
comment|// ### fixme: Remove once a dialog helper hierarchy is in place
DECL|function|defaultNameFilterDisables
specifier|virtual
name|bool
name|defaultNameFilterDisables
