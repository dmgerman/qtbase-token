...
name|DWRITE_RENDERING_MODE_CLEARTYPE_NATURAL
decl_stmt|;
...
literal|1
decl_stmt|;
comment|// -1 due to Qt's off-by-one definition of a QRect
specifier|const
name|int
name|height
init|=
...
condition|)
block|{
comment|// No colored runs, only outline
name|qErrnoWarning
argument_list|(
name|hr
argument_list|,
literal|"%s: IDWriteColorGlyphRunEnumerator::GetCurrentRun failed"
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
...
name|hr
argument_list|,
literal|"%s: CreateGlyphRunAnalysis failed for color run"
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
...
name|hr
argument_list|,
literal|"%s: IDWriteColorGlyphRunEnumerator::MoveNext failed"
argument_list|,
name|__FUNCTION__
argument_list|)
expr_stmt|;
