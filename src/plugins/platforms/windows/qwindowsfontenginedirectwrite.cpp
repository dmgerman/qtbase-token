...
argument_list|)
decl_stmt|;
comment|// This needs to be kept in sync with alphaMapBoundingBox
name|int
name|width
init|=
operator|(
...
end_function
begin_comment
comment|// Dynamically resolve GetUserDefaultLocaleName, which is available from Windows
end_comment
begin_comment
comment|// Vista onwards. ### fixme 5.7: Consider reverting to direct linking.
end_comment
begin_typedef
...
name|WINAPI
modifier|*
name|GetUserDefaultLocaleNamePtr
function_decl|)
parameter_list|(
name|LPWSTR
parameter_list|,
...
specifier|inline
name|GetUserDefaultLocaleNamePtr
name|resolveGetUserDefaultLocaleName
parameter_list|()
block|{
name|QSystemLibrary
name|library
...
name|resolve
argument_list|(
literal|"GetUserDefaultLocaleName"
argument_list|)
return|;
block|}
end_function
