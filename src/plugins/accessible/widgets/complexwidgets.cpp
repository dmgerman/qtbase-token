...
name|m_index
decl_stmt|;
comment|//    QString m_text;
comment|//    QAccessible::Role m_role;
comment|//    QRect m_rect;
block|}
class|;
end_class
begin_comment
...
argument_list|()
decl_stmt|;
comment|//    if (child> tb->count()) {
comment|//        QWidget *bt = button(child);
comment|//        if (!bt)
comment|//            return st;
comment|//        if (bt->isEnabled() == false)
comment|//            st |= Unavailable;
comment|//        if (bt->isVisible() == false)
comment|//            st |= Invisible;
comment|//        if (bt->focusPolicy() != Qt::NoFocus&& bt->isActiveWindow())
comment|//            st |= Focusable;
comment|//        if (bt->hasFocus())
comment|//            st |= Focused;
comment|//        return st;
comment|//    }
if|if
...
name|tr
argument_list|(
literal|"Opens the selection list of this combo box."
argument_list|)
return|;
block|}
end_function
