...
name|SignalMessage
case|:
comment|// only the service name can be empty here
if|if
condition|(
operator|!
name|d_ptr
...
name|msg
condition|?
name|q_dbus_message_get_reply_serial
argument_list|(
name|msg
argument_list|)
else|:
...
end_expr_stmt
begin_comment
comment|/*!     Returns the serial of the message or 0 if undefined.      The serial number is a unique identifier of a message coming from a     given connection.      The serial is set to a non zero value after the message has been sent     over a D-Bus connection. */
end_comment
begin_function
DECL|function|serial
name|uint
...
end_function
begin_comment
comment|/*!     Returns the serial of the message this is a reply to or 0 if undefined.      The serial number is a unique identifier of a message coming from a     given connection and D-Bus messages of 'method return' or 'error' type     use them to match the reply to the method call message. */
end_comment
begin_function
DECL|function|replySerial
name|uint
