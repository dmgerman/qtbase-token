...
name|QDBusSpyCallEvent
argument_list|(
argument|QDBusConnectionPrivate *cp
argument_list|,
argument|const QDBusConnection&c
argument_list|,
argument|const QDBusMessage&msg
argument_list|,
argument|const Hook *hooks
argument_list|,
argument|int count
argument_list|)
operator|:
...
end_decl_stmt
begin_comment
comment|// keeps the refcount in QDBusConnectionPrivate up
end_comment
begin_decl_stmt
name|QDBusMessage
name|msg
