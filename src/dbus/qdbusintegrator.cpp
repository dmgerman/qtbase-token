...
comment|// already quit. We need to make sure we disconnect exactly once per
comment|// object, because if we tried a second time, we might be hitting a
...
expr_stmt|;
block|}
comment|// now disconnect ourselves
name|QSet
argument_list|<
name|QObject
modifier|*
