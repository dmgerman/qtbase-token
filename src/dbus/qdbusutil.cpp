...
return|;
block|}
comment|/*!         \internal         \fn bool QDBusUtil::isValidPartOfObjectPath(const QStringRef&part)         See QDBusUtil::isValidObjectPath     */
...
return|;
block|}
comment|/*!         \internal         \fn bool QDBusUtil::isValidPartOfObjectPath(const QString&part)          \overload     */
...
return|;
block|}
comment|/*!         \fn bool QDBusUtil::isValidUniqueConnectionName(const QString&connName)          \overload     */
...
return|;
block|}
comment|/*!         \fn bool QDBusUtil::isValidMemberName(const QStringRef&memberName)         Returns \c true if \a memberName is a valid member name. A valid member name does not exceed         255 characters in length, is not empty, is composed only of ASCII letters, digits and         underscores, but does not start with a digit.     */
...
return|;
block|}
comment|/*!         \fn bool QDBusUtil::isValidMemberName(const QString&memberName)          \overload     */
...
literal|false
return|;
comment|// it starts with /, so we skip the empty first part
specifier|const
specifier|auto
name|parts
init|=
