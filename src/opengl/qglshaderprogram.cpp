...
end_function
begin_comment
comment|/*!     Removes \a shader from this shader program.  The object is not deleted.      \sa addShader(), link(), removeAllShaders() */
end_comment
begin_function
