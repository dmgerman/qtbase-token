...
end_function_decl
begin_comment
comment|/*!     \class QGLFramebufferObjectPool     \since 4.6      \brief The QGLFramebufferObject class provides a pool of framebuffer     objects for offscreen rendering purposes.      When requesting an FBO of a given size and format, an FBO of the same     format and a size at least as big as the requested size will be returned.      \internal */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     out-of-place conversion (inPlace == false) will always detach()  */
end_comment
begin_function
