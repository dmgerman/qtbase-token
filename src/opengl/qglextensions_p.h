...
end_ifndef
begin_comment
comment|// Needed for EGLImageKHR definition:
end_comment
begin_include
include|#
directive|include
...
end_ifndef
begin_comment
comment|// OES_EGL_image
end_comment
begin_comment
comment|// Note: We define these to take EGLImage whereas spec says they take a new GLeglImageOES
end_comment
begin_comment
comment|//       type, which the EGL image should be cast to.
end_comment
begin_typedef
...
name|APIENTRY
modifier|*
name|_glEGLImageTargetTexture2DOES
function_decl|)
parameter_list|(
name|GLenum
parameter_list|,
...
name|APIENTRY
modifier|*
name|_glEGLImageTargetRenderbufferStorageOES
function_decl|)
parameter_list|(
name|GLenum
parameter_list|,
...
name|QT_NO_EGL
comment|// OES_EGL_image
name|qt_glEGLImageTargetTexture2DOES
operator|=
literal|0
expr_stmt|;
name|qt_glEGLImageTargetRenderbufferStorageOES
operator|=
literal|0
expr_stmt|;
endif|#
...
value|QGLContextPrivate::extensionFuncs(ctx).qt_glEGLImageTargetTexture2DOES
end_define
begin_define
...
value|QGLContextPrivate::extensionFuncs(ctx).qt_glEGLImageTargetRenderbufferStorageOES
end_define
begin_endif
endif|#
directive|endif
