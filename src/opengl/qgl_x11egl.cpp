...
name|qFatal
argument_list|(
literal|"QGLContext::chooseVisual - this method must not be called as Qt is built with EGL support"
argument_list|)
expr_stmt|;
return|return
literal|0
...
name|qFatal
argument_list|(
literal|"QGLContext::tryVisual - this method must not be called as Qt is built with EGL support"
argument_list|)
expr_stmt|;
return|return
literal|0
