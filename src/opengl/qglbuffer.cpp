...
name|QT_OPENGL_ES_1
argument_list|)
comment|// OpenGL/ES 1.1 does not support GL_STREAM_DRAW, so use GL_STATIC_DRAW.
comment|// OpenGL/ES 2.0 does support GL_STREAM_DRAW.
name|d
operator|->
name|usagePattern
operator|=
...
condition|)
block|{
comment|// Switch to the original creating context to destroy it.
