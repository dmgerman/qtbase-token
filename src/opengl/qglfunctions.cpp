...
argument_list|(
argument|QGLContextGroupResource<QGLFunctionsPrivateEx>
argument_list|,
...
argument_list|(
argument|QGLContextResource
argument_list|,
argument|qt_gl_functions_resource
argument_list|,
argument|(qt_gl_functions_free)
argument_list|)
end_macro
begin_endif
endif|#
...
end_comment
begin_comment
comment|/*!     \fn void QGLFunctions::glBindFramebuffer(GLenum target, GLuint framebuffer)      Convenience function that calls glBindFramebuffer(\a target, \a framebuffer).      For more information, see the OpenGL/ES 2.0 documentation for     \l{http://www.khronos.org/opengles/sdk/docs/man/glBindFramebuffer.xml}{glBindFramebuffer()}. */
end_comment
begin_comment
