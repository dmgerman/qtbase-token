...
include|#
directive|include
file|<private/qglpixmapfilter_p.h>
end_include
begin_include
include|#
directive|include
...
name|drawTexture
argument_list|(
argument|const QGLRect& dest
argument_list|,
argument|const QGLRect& src
argument_list|,
...
name|drawVertexArrays
argument_list|(
argument|QGL2PEXVertexArray&vertexArray
argument_list|,
argument|GLenum primitive
argument_list|)
block|{
...
name|location
argument_list|(
argument|const QGLEngineShaderManager::Uniform uniform
argument_list|)
block|{
return|return
name|shaderManager
...
argument_list|(
argument|QGL2PaintEngineEx *engine
argument_list|)
block|{
return|return
name|engine
