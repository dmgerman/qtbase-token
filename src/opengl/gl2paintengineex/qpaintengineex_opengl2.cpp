...
argument_list|)
expr_stmt|;
comment|// flush the existing clip rectangle to the depth buffer
name|d
operator|->
name|writeClip
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// first clear the depth buffer in the extended region
name|d
operator|->
name|writeClip
argument_list|(
...
directive|endif
comment|// now write the clip path
name|d
operator|->
name|writeClip
argument_list|(
