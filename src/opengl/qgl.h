...
name|friend
name|class
name|QMacGLWindowChangeEvent
decl_stmt|;
name|friend
name|QGLContextPrivate
modifier|*
name|qt_phonon_get_dptr
parameter_list|(
specifier|const
name|QGLContext
modifier|*
...
argument|const QImage&image
argument_list|,
argument|QMacCompatGLenum = GL_TEXTURE_2D
argument_list|,
argument|QMacCompatGLint format = GL_RGBA
argument_list|)
block|;
name|GLuint
name|bindTexture
...
argument_list|,
argument|QMacCompatGLint format
argument_list|,
argument|QGLContext::BindOptions
argument_list|)
block|;
...
name|deleteTexture
argument_list|(
argument|QMacCompatGLuint tx_id
argument_list|)
block|;
name|void
name|drawTexture
