...
condition|)
block|{
comment|// If the widget is a QGraphicsView which will be re-drawing the entire
comment|// scene each frame anyway, we should use QGLWindowSurface as this may
comment|// provide proper buffer flipping, which should be faster than QX11GL's
comment|// blitting approach:
name|QGraphicsView
modifier|*
name|qgv
init|=
