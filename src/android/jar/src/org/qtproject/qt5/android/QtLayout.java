...
expr_stmt|;
block|}
comment|/**     * set the layout params on a child view.     *     * Note: This function adds the child view if it's not in the     *       layout already.     */
...
condition|)
return|return;
comment|// View is already in the layout and can therefore be updated
specifier|final
name|boolean
name|canUpdate
init|=
