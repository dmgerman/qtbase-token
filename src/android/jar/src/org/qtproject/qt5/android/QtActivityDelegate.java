...
decl_stmt|;
name|int
name|ui_flag_layout_hide_navigation
init|=
name|View
operator|.
name|class
...
decl_stmt|;
name|int
name|ui_flag_layout_fullscreen
init|=
name|View
operator|.
name|class
...
argument_list|)
expr_stmt|;
comment|// softInputIsHidden is true if SOFT_INPUT_STATE_HIDDEN or SOFT_INPUT_STATE_ALWAYS_HIDDEN is set.
specifier|final
name|boolean
name|softInputIsHidden
init|=
operator|(
name|m_softInputMode
operator|&
