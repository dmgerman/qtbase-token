...
specifier|private
name|Method
name|m_super_onWindowFocusChanged
init|=
literal|null
decl_stmt|;
...
specifier|final
name|String
name|EXTRACT_STYLE_MINIMAL_KEY
init|=
literal|"extract.android.style.option"
decl_stmt|;
...
name|getMethod
argument_list|(
literal|"super_onWindowFocusChanged"
argument_list|,
name|Boolean
operator|.
name|TYPE
...
name|containsKey
argument_list|(
literal|"android.app.splash_screen_sticky"
argument_list|)
operator|&&
name|info
operator|.
