...
specifier|static
name|Method
name|m_checkSelfPermissionMethod
init|=
literal|null
decl_stmt|;
...
specifier|final
name|Runnable
name|runPendingCppRunnablesRunnable
init|=
operator|new
name|Runnable
argument_list|()
...
specifier|static
name|void
name|runPendingCppRunnablesOnUiThread
parameter_list|()
block|{
synchronized|synchronized
init|(
...
condition|)
block|{
comment|// Avoid freezing if only service
specifier|final
name|Semaphore
name|semaphore
init|=
