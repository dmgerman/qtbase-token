...
end_function
begin_comment
comment|/*! \internal   Paints a transition state. The result will be a mix between the   initial and final state of the transition, depending on the time   difference between startTime and current time. */
end_comment
begin_function
DECL|function|paint
name|void
...
end_function
begin_comment
comment|/*! \internal   Paints a pulse. The result will be a mix between the primary and   secondary pulse images depending on the time difference between   startTime and current time. */
end_comment
begin_function
DECL|function|paint
name|void
