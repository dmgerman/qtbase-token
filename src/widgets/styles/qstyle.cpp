...
name|result
decl_stmt|;
comment|// ### Qt 4.1: invokeMethod should accept const functions, to avoid this dirty cast
name|QMetaObject
operator|::
name|invokeMethod
argument_list|(
...
argument_list|)
argument_list|,
literal|"standardIconImplementation"
argument_list|,
name|Qt
operator|::
...
end_function
begin_comment
comment|/*!     \since 4.1      Returns an icon for the given \a standardIcon.      Reimplement this slot to provide your own icons in a QStyle     subclass; because of binary compatibility constraints, the     standardIcon() function (introduced in Qt 4.1) is not     virtual. Instead, standardIcon() will dynamically detect and call     \e this slot.      The \a standardIcon is a standard pixmap which can follow some     existing GUI style or guideline. The \a option argument can be     used to pass extra information required when defining the     appropriate icon. The \a widget argument is optional and can also     be used to aid the determination of the icon.      \sa standardIcon() */
end_comment
begin_function
...
name|indexOfMethod
argument_list|(
literal|"layoutSpacingImplementation(QSizePolicy::ControlType,QSizePolicy::ControlType,"
literal|"Qt::Orientation,const QStyleOption*,const QWidget*)"
argument_list|)
expr_stmt|;
block|}
if|if
