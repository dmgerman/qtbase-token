...
literal|0
return|;
comment|// optimization: exactly one bit is set
if|if
condition|(
operator|(
name|controls
...
end_constructor
begin_comment
comment|/*!     \internal      Constructs a style object. */
end_comment
begin_constructor
DECL|function|QStyle
name|QStyle
...
end_constructor
begin_comment
comment|/*!     Destroys the style object. */
end_comment
begin_destructor
DECL|function|~QStyle
name|QStyle
...
end_function
begin_comment
comment|/*!     \fn void QStyle::polish(QApplication * application)     \overload      Late initialization of the given \a application object. */
end_comment
begin_function
DECL|function|polish
name|void
...
end_function
begin_comment
comment|/*!     \fn void QStyle::unpolish(QApplication * application)     \overload      Uninitialize the given \a application. */
end_comment
begin_function
DECL|function|unpolish
name|void
...
end_function
begin_comment
comment|/*!     \fn void QStyle::polish(QPalette& palette)     \overload      Changes the \a palette according to style specific requirements     for color palettes (if any).      \sa QPalette, QApplication::setPalette() */
end_comment
begin_function
DECL|function|polish
name|void
...
end_function
begin_comment
comment|/*!     \fn QRect QStyle::itemPixmapRect(const QRect&rectangle, int alignment, const QPixmap&pixmap) const      Returns the area within the given \a rectangle in which to draw     the specified \a pixmap according to the defined \a alignment. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn void QStyle::drawItemText(QPainter *painter, const QRect&rectangle, int alignment, const QPalette&palette, bool enabled, const QString& text, QPalette::ColorRole textRole) const      Draws the given \a text in the specified \a rectangle using the     provided \a painter and \a palette.      The text is drawn using the painter's pen, and aligned and wrapped     according to the specified \a alignment. If an explicit \a     textRole is specified, the text is drawn using the \a palette's     color for the given role. The \a enabled parameter indicates     whether or not the item is enabled; when reimplementing this     function, the \a enabled parameter should influence how the item is     drawn.      \sa Qt::Alignment, drawItemPixmap() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn void QStyle::drawItemPixmap(QPainter *painter, const QRect&rectangle, int alignment,                             const QPixmap&pixmap) const      Draws the given \a pixmap in the specified \a rectangle, according     to the specified \a alignment, using the provided \a painter.      \sa drawItemText() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn QPoint QStyle::visualPos(Qt::LayoutDirection direction, const QRect&boundingRectangle, const QPoint&logicalPosition)      Returns the given \a logicalPosition converted to screen     coordinates based on the specified \a direction.  The \a     boundingRectangle is used when performing the translation.      \sa QWidget::layoutDirection */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!      Returns a new rectangle of the specified \a size that is aligned to the given \a      rectangle according to the specified \a alignment and \a direction.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   Transforms an \a alignment of Qt::AlignLeft or Qt::AlignRight   without Qt::AlignAbsolute into Qt::AlignLeft or Qt::AlignRight with   Qt::AlignAbsolute according to the layout \a direction. The other   alignment flags are left untouched.    If no horizontal alignment was specified, the function returns the   default alignment for the given layout \a direction.    QWidget::layoutDirection */
end_comment
begin_function
...
return|;
block|}
comment|// equiv. to min + (pos*range)/span + 0.5
comment|// no overflow because of this implicit assumption:
comment|// pos<= span< sqrt(INT_MAX+0.0625)+0.25 ~ sqrt(INT_MAX)
block|}
end_function
begin_comment
...
end_function
begin_comment
comment|/*!     \since 4.1      \fn QIcon QStyle::standardIcon(StandardPixmap standardIcon, const QStyleOption *option = 0,                                    const QWidget *widget = 0) const = 0;      Returns an icon for the given \a standardIcon.      The \a standardIcon is a standard pixmap which can follow some     existing GUI style or guideline. The \a option argument can be     used to pass extra information required when defining the     appropriate icon. The \a widget argument is optional and can also     be used to aid the determination of the icon. */
end_comment
begin_comment
comment|/*!     \since 4.3      \fn int QStyle::layoutSpacing(QSizePolicy::ControlType control1,                                   QSizePolicy::ControlType control2, Qt::Orientation orientation,                                   const QStyleOption *option = 0, const QWidget *widget = 0) const      Returns the spacing that should be used between \a control1 and     \a control2 in a layout. \a orientation specifies whether the     controls are laid out side by side or stacked vertically. The \a     option parameter can be used to pass extra information about the     parent widget. The \a widget parameter is optional and can also     be used if \a option is 0.      This function is called by the layout system. It is used only if     PM_LayoutHorizontalSpacing or PM_LayoutVerticalSpacing returns a     negative value.      \sa combinedLayoutSpacing() */
end_comment
begin_comment
comment|/*!     \since 4.3      Returns the spacing that should be used between \a controls1 and     \a controls2 in a layout. \a orientation specifies whether the     controls are laid out side by side or stacked vertically. The \a     option parameter can be used to pass extra information about the     parent widget. The \a widget parameter is optional and can also     be used if \a option is 0.      \a controls1 and \a controls2 are OR-combination of zero or more     \l{QSizePolicy::ControlTypes}{control types}.      This function is called by the layout system. It is used only if     PM_LayoutHorizontalSpacing or PM_LayoutVerticalSpacing returns a     negative value.      \sa layoutSpacing() */
end_comment
begin_function
...
end_endif
begin_comment
comment|// QT_VERSION< QT_VERSION_CHECK(6,0,0)
end_comment
begin_comment
comment|/*!     \since 4.6      \fn const QStyle *QStyle::proxy() const      This function returns the current proxy for this style.     By default most styles will return themselves. However     when a proxy style is in use, it will allow the style to     call back into its proxy. */
end_comment
begin_function
DECL|function|proxy
specifier|const
...
end_function
begin_comment
comment|/* \internal      This function sets the base style that style calls will be     redirected to. Note that ownership is not transferred. */
end_comment
begin_function
