...
end_comment
begin_comment
comment|/*!     \variable QStyleOptionMenuItem::text     \brief the text for the menu item      Note that the text format is something like this "Menu     text\bold{\\t}Shortcut".      If the menu item doesn't have a shortcut, it will just contain the     menu item's text. The default value is an empty string. */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \class QStyleOptionQ3ListViewItem     \brief The QStyleOptionQ3ListViewItem class is used to describe an     item drawn in a Q3ListView.      \inmodule QtWidgets       This class is used for drawing the compatibility Q3ListView's     items. \bold {It is not recommended for new classes}.      QStyleOptionQ3ListViewItem contains all the information that     QStyle functions need to draw the Q3ListView items.      For performance reasons, the access to the member variables is     direct (i.e., using the \c . or \c -> operator). This low-level feel     makes the structures straightforward to use and emphasizes that     these are simply parameters used by the style functions.      For an example demonstrating how style options can be used, see     the \l {widgets/styles}{Styles} example.      \sa QStyleOption, QStyleOptionQ3ListView, Q3ListViewItem */
end_comment
begin_comment
comment|/*!     \enum QStyleOptionQ3ListViewItem::Q3ListViewItemFeature      This enum describes the features a list view item can have.      \value None A standard item.     \value Expandable The item has children that can be shown.     \value MultiLine The item is more than one line tall.     \value Visible The item is visible.     \value ParentControl The item's parent is a type of item control (Q3CheckListItem::Controller).      \sa features, Q3ListViewItem::isVisible(), Q3ListViewItem::multiLinesEnabled(),         Q3ListViewItem::isExpandable() */
end_comment
begin_comment
comment|/*!     Constructs a QStyleOptionQ3ListViewItem, initializing the members     variables to their default values. */
end_comment
begin_constructor
...
end_constructor
begin_comment
comment|/*!     \fn QStyleOptionQ3ListViewItem::QStyleOptionQ3ListViewItem(const QStyleOptionQ3ListViewItem&other)      Constructs a copy of the \a other style option. */
end_comment
begin_comment
comment|/*!     \enum QStyleOptionQ3ListViewItem::StyleOptionType      This enum is used to hold information about the type of the style option, and     is defined for each QStyleOption subclass.      \value Type The type of style option provided (\l{SO_Q3ListViewItem} for this class).      The type is used internally by QStyleOption, its subclasses, and     qstyleoption_cast() to determine the type of style option. In     general you do not need to worry about this unless you want to     create your own QStyleOption subclass and your own styles.      \sa StyleOptionVersion */
end_comment
begin_comment
comment|/*!     \enum QStyleOptionQ3ListViewItem::StyleOptionVersion      This enum is used to hold information about the version of the style option, and     is defined for each QStyleOption subclass.      \value Version 1      The version is used by QStyleOption subclasses to implement     extensions without breaking compatibility. If you use     qstyleoption_cast(), you normally do not need to check it.      \sa StyleOptionType */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListViewItem::features     \brief the features for this item      This variable is a bitwise OR of the features of the item. The deafult value is \l None.      \sa Q3ListViewItemFeature */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListViewItem::height     \brief the height of the item      This doesn't include the height of the item's children. The default height is 0.      \sa Q3ListViewItem::height() */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListViewItem::totalHeight     \brief the total height of the item, including its children      The default total height is 0.      \sa Q3ListViewItem::totalHeight() */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListViewItem::itemY     \brief the Y-coordinate for the item      The default value is 0.      \sa Q3ListViewItem::itemPos() */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListViewItem::childCount     \brief the number of children the item has */
end_comment
begin_comment
comment|/*!     \class QStyleOptionQ3ListView     \brief The QStyleOptionQ3ListView class is used to describe the     parameters for drawing a Q3ListView.      \inmodule QtWidgets       This class is used for drawing the compatibility Q3ListView. \bold     {It is not recommended for new classes}.      QStyleOptionQ3ListView contains all the information that QStyle     functions need to draw Q3ListView.      For performance reasons, the access to the member variables is     direct (i.e., using the \c . or \c -> operator). This low-level feel     makes the structures straightforward to use and emphasizes that     these are simply parameters used by the style functions.      For an example demonstrating how style options can be used, see     the \l {widgets/styles}{Styles} example.      \sa QStyleOptionComplex, Q3ListView, QStyleOptionQ3ListViewItem */
end_comment
begin_comment
comment|/*!     Creates a QStyleOptionQ3ListView, initializing the members     variables to their default values. */
end_comment
begin_constructor
...
end_constructor
begin_comment
comment|/*!     \fn QStyleOptionQ3ListView::QStyleOptionQ3ListView(const QStyleOptionQ3ListView&other)      Constructs a copy of the \a other style option. */
end_comment
begin_comment
comment|/*!     \enum QStyleOptionQ3ListView::StyleOptionType      This enum is used to hold information about the type of the style option, and     is defined for each QStyleOption subclass.      \value Type The type of style option provided (\l{SO_Q3ListView} for this class).      The type is used internally by QStyleOption, its subclasses, and     qstyleoption_cast() to determine the type of style option. In     general you do not need to worry about this unless you want to     create your own QStyleOption subclass and your own styles.      \sa StyleOptionVersion */
end_comment
begin_comment
comment|/*!     \enum QStyleOptionQ3ListView::StyleOptionVersion      This enum is used to hold information about the version of the style option, and     is defined for each QStyleOption subclass.      \value Version 1      The version is used by QStyleOption subclasses to implement     extensions without breaking compatibility. If you use     qstyleoption_cast(), you normally do not need to check it.      \sa StyleOptionType */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListView::items     \brief a list of items in the Q3ListView      This is a list of \l {QStyleOptionQ3ListViewItem}s. The first item     can be used for most of the calculation that are needed for     drawing a list view. Any additional items are the children of     this first item, which may be used for additional information.      \sa QStyleOptionQ3ListViewItem */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListView::viewportPalette     \brief the palette of Q3ListView's viewport      By default, the application's default palette is used. */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListView::viewportBGRole     \brief the background role of Q3ListView's viewport      The default value is QPalette::Base.      \sa QWidget::backgroundRole() */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListView::sortColumn     \brief the sort column of the list view      The default value is 0.      \sa Q3ListView::sortColumn() */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListView::itemMargin     \brief the margin for items in the list view      The default value is 0.      \sa Q3ListView::itemMargin() */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListView::treeStepSize     \brief the number of pixel to offset children items from their     parents      The default value is 0.      \sa Q3ListView::treeStepSize() */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3ListView::rootIsDecorated     \brief whether root items are decorated      The default value is false.      \sa Q3ListView::rootIsDecorated() */
end_comment
begin_comment
comment|/*!     \class QStyleOptionQ3DockWindow     \brief The QStyleOptionQ3DockWindow class is used to describe the     parameters for drawing various parts of a Q3DockWindow.      \inmodule QtWidgets       This class is used for drawing the old Q3DockWindow and its     parts. \bold {It is not recommended for new classes}.      QStyleOptionQ3DockWindow contains all the information that QStyle     functions need to draw Q3DockWindow and its parts.      For performance reasons, the access to the member variables is     direct (i.e., using the \c . or \c -> operator). This low-level feel     makes the structures straightforward to use and emphasizes that     these are simply parameters used by the style functions.      For an example demonstrating how style options can be used, see     the \l {widgets/styles}{Styles} example.      \sa QStyleOption,  Q3DockWindow */
end_comment
begin_comment
comment|/*!     Constructs a QStyleOptionQ3DockWindow, initializing the member     variables to their default values. */
end_comment
begin_constructor
...
end_constructor
begin_comment
comment|/*!     \fn QStyleOptionQ3DockWindow::QStyleOptionQ3DockWindow(const QStyleOptionQ3DockWindow&other)      Constructs a copy of the \a other style option. */
end_comment
begin_comment
comment|/*!     \enum QStyleOptionQ3DockWindow::StyleOptionType      This enum is used to hold information about the type of the style option, and     is defined for each QStyleOption subclass.      \value Type The type of style option provided (\l{SO_Q3DockWindow} for this class).      The type is used internally by QStyleOption, its subclasses, and     qstyleoption_cast() to determine the type of style option. In     general you do not need to worry about this unless you want to     create your own QStyleOption subclass and your own styles.      \sa StyleOptionVersion */
end_comment
begin_comment
comment|/*!     \enum QStyleOptionQ3DockWindow::StyleOptionVersion      This enum is used to hold information about the version of the style option, and     is defined for each QStyleOption subclass.      \value Version 1      The version is used by QStyleOption subclasses to implement     extensions without breaking compatibility. If you use     qstyleoption_cast(), you normally do not need to check it.      \sa StyleOptionType */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3DockWindow::docked     \brief whether the dock window is currently docked      The default value is false. */
end_comment
begin_comment
comment|/*!     \variable QStyleOptionQ3DockWindow::closeEnabled     \brief whether the dock window has a close button      The default value is false. */
end_comment
begin_comment
