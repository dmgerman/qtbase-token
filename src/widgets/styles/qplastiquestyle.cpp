...
condition|)
block|{
comment|// also draw the frame on the title bar
name|lines
index|[
literal|0
index|]
...
directive|ifdef
name|QT3_SUPPORT
comment|// Q3DockWindow doesn't need space for buttons
if|if
condition|(
name|widget
operator|&&
...
condition|)
block|{
comment|// Q3DockWindow has smaller title bars than QDockWidget
name|ret
operator|=
name|qMax
argument_list|(
