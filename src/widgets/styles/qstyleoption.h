...
argument_list|(
argument|QStyleOptionFrameV2::FrameFeatures
argument_list|)
end_macro
begin_decl_stmt
name|class
...
end_decl_stmt
begin_comment
comment|// Adds style info for vertical progress bars
end_comment
begin_decl_stmt
name|class
name|Q_WIDGETS_EXPORT
...
name|Q_DECLARE_FLAGS
argument_list|(
argument|Q3ListViewItemFeatures
argument_list|,
argument|Q3ListViewItemFeature
argument_list|)
name|Q3ListViewItemFeatures
name|features
block|;
name|int
name|height
...
name|Q_DECLARE_OPERATORS_FOR_FLAGS
argument_list|(
argument|QStyleOptionQ3ListViewItem::Q3ListViewItemFeatures
argument_list|)
end_macro
begin_decl_stmt
name|class
...
name|Q_DECLARE_OPERATORS_FOR_FLAGS
argument_list|(
argument|QStyleOptionViewItemV2::ViewItemFeatures
argument_list|)
end_macro
begin_decl_stmt
name|class
