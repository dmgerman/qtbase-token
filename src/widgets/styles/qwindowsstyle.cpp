...
end_function
begin_comment
comment|/*!     \class QWindowsStyle     \brief The QWindowsStyle class provides a Microsoft Windows-like look and feel.      \ingroup appearance      This style is Qt's default GUI style on Windows.      \img qwindowsstyle.png     \sa QWindowsXPStyle, QMacStyle, QPlastiqueStyle, QCDEStyle, QMotifStyle */
end_comment
begin_comment
...
directive|ifdef
name|QT3_SUPPORT
comment|// qt3 dockwindow height should be equal to tool windows
if|if
condition|(
name|widget
operator|&&
...
case|:
block|{
comment|// This is _way_ too similar to the common style.
specifier|static
specifier|const
name|int
...
literal|true
expr_stmt|;
comment|// make 128*1 and 1*128 bitmaps that can be used for
comment|// drawing the right sort of lines.
name|verticalLine
operator|->
name|clear
argument_list|()
...
control|)
block|{
comment|// assumptions here: lines are horizontal or vertical.
comment|// lines always start with the numerically lowest
comment|// coordinate.
comment|// point ... relevant coordinate of current point
comment|// end ..... same coordinate of the end of the current line
comment|// other ... the other coordinate of the current point/line
if|if
condition|(
name|dotlines
index|[
...
argument_list|)
expr_stmt|;
comment|//fetches small icon
name|QSHSTOCKICONINFO
name|iconInfo
decl_stmt|;
comment|//append large icon
name|memset
argument_list|(
operator|&
name|iconInfo
