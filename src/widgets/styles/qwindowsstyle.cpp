...
condition|)
block|{
comment|// Animation by timer for progress bars that have their min and
comment|// max values the same
if|if
condition|(
name|bar
operator|->
...
name|Hide
case|:
comment|// Do static_cast because there is no type info when getting
comment|// the destroy event. We know that it is a QProgressBar, since
comment|// we only install a widget event filter for QScrollBars.
name|d
operator|->
name|stopAnimation
argument_list|(
...
end_function
begin_comment
comment|/*!     \class QWindowsStyle     \brief The QWindowsStyle class provides a Microsoft Windows-like look and feel.      \ingroup appearance     \inmodule QtWidgets      This style is Qt's default GUI style on Windows.      \image qwindowsstyle.png     \sa QWindowsXPStyle, QMacStyle, QPlastiqueStyle, QCDEStyle, QMotifStyle */
end_comment
begin_comment
