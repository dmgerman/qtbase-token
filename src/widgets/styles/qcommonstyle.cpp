...
name|QStringLiteral
argument_list|(
literal|":/qt-project.org/styles/commonstyle/images/cleartext-32.png"
argument_list|)
argument_list|)
decl_stmt|;
name|Q_ASSERT
...
argument_list|)
expr_stmt|;
comment|// The 32x32 pixmap can also be used for 16x16/devicePixelRatio=2
name|icon
operator|.
name|addPixmap
argument_list|(
