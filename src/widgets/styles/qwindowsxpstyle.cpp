...
end_function
begin_comment
comment|// Returns whether base color is set for this widget
end_comment
begin_function
...
parameter_list|,
name|int
name|additionalDevicePixelRatio
parameter_list|)
block|{
name|QPainter
modifier|*
...
condition|)
break|break;
comment|// May fail due to too-large buffers for large widgets, fall back to Windows style.
name|theme
operator|.
name|rect
operator|=
