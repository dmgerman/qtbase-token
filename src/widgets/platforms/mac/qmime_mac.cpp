...
condition|)
block|{
comment|// Do it with a system call as I don't see much worth in
comment|// doing it with QDir since we have to chmod anyway.
name|bool
name|success
init|=
operator|::
...
condition|)
block|{
comment|// Create the file and chmod it so that everyone can write to it.
name|int
name|fd
init|=
operator|::
...
name|qWarning
argument_list|(
literal|"QMacPasteboardMimeAnyQt3Mime: Failure to open mime resources %s -- %s"
argument_list|,
name|library_file
operator|.
name|fileName
...
name|qWarning
argument_list|(
literal|"QMacPasteboardMimeAnyQt3Mime: Internal error"
argument_list|)
expr_stmt|;
return|return
literal|0
...
name|qWarning
argument_list|(
literal|"QMacPasteboardMimeAnyQt3Mime: Failure to open %s -- %s"
argument_list|,
name|library_file
operator|.
name|fileName
...
name|qWarning
argument_list|(
literal|"QMacPasteboardMimeAnyQt3Mime: Cannot write anything!"
argument_list|)
expr_stmt|;
return|return
name|QVariant
