...
end_function
begin_comment
comment|/*     Ideally, we should pass the widget in here, and use CGGetDisplaysWithRect() etc.     to support multiple displays correctly. */
end_comment
begin_function
...
argument_list|)
return|;
comment|// fall back on main display
block|}
if|if
condition|(
operator|(
