...
name|friend
name|void
name|qt_mac_display_change_callbk
argument_list|(
name|CGDirectDisplayID
argument_list|,
name|CGDisplayChangeSummaryFlags
argument_list|,
name|void
operator|*
argument_list|)
...
name|friend
name|void
name|qt_color_profile_changed
argument_list|(
argument|CFNotificationCenterRef center
argument_list|,
argument|void *
argument_list|,
