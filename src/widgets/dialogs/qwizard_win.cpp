...
end_function
begin_comment
comment|// The following hack ensures that the titlebar is updated correctly
end_comment
begin_comment
comment|// when the wizard style changes to and from AeroStyle. Specifically,
end_comment
begin_comment
comment|// this function causes a Windows message of type WM_NCCALCSIZE to
end_comment
begin_comment
comment|// be triggered.
end_comment
begin_function
...
end_function
begin_comment
comment|// The following hack allows any QWidget subclass to access
end_comment
begin_comment
comment|// QWidgetPrivate::topData() without being declared as a
end_comment
begin_comment
comment|// friend by QWidget.
end_comment
begin_class
