...
condition|)
block|{
comment|// cheap sibling operation: just adjust the column:
return|return
name|createIndex
argument_list|(
name|row
...
block|{
comment|// for anything else: call the default implementation
comment|// (this could probably be optimized, too):
return|return
name|QAbstractItemModel
operator|::
name|sibling
