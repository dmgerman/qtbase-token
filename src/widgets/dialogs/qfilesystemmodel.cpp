...
name|Q_OS_SYMBIAN
argument_list|)
comment|// Filename case must be exact in qBinaryFind below, so create a list of all lowercase names.
name|QStringList
name|newFiles
decl_stmt|;
for|for
