...
end_function
begin_comment
comment|/*!     Returns \c true if the font of the current format is underlined; otherwise returns     false.      \sa setFontUnderline() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns \c true if the font of the current format is italic; otherwise returns     false.      \sa setFontItalic() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.2      \property QTextEdit::placeholderText     \brief the editor placeholder text      Setting this property makes the editor display a grayed-out     placeholder text as long as the document() is empty.      By default, this property contains an empty string.      \sa document() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn bool QTextEdit::find(const QRegExp&exp, QTextDocument::FindFlags options)      \since 5.3     \overload      Finds the next occurrence, matching the regular expression, \a exp, using the given     \a options. The QTextDocument::FindCaseSensitively option is ignored for this overload,     use QRegExp::caseSensitivity instead.      Returns \c true if a match was found and changes the cursor to select the match;     otherwise returns \c false. */
end_comment
begin_ifndef
ifndef|#
directive|ifndef
