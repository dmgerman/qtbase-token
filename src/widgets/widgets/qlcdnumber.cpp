...
end_destructor
begin_comment
comment|/*!     \deprecated     \property QLCDNumber::numDigits     \brief the current number of digits displayed     \sa digitCount */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \property QLCDNumber::segmentStyle     \brief the style of the LCDNumber      \table     \header \i Style \i Result     \row \i \c Outline          \i Produces raised segments filled with the background color     \row \i \c Filled             (this is the default).          \i Produces raised segments filled with the foreground color.     \row \i \c Flat          \i Produces flat segments filled with the foreground color.     \endtable      \c Outline and \c Filled will additionally use     QPalette::light() and QPalette::dark() for shadow effects. */
end_comment
begin_function
