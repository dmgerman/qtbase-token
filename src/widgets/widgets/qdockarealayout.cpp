...
end_ifndef
begin_comment
comment|/*! \internal     reparent all the widgets contained in this layout portion to the     specified parent. This is used to reparent dock widgets and tabbars     to the floating window or the main window  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*! \internal     Try to fit the given rectangle \a rect on the screen which contains     the window \a widget.     Used to compute the geometry of a dragged a dock widget that should     be shown with \a rect, but needs to be visible on the screen  */
end_comment
begin_function
...
name|qWarning
argument_list|(
literal|"QMainWidget::resizeDocks: size of the lists are not the same"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|qWarning
argument_list|(
literal|"QMainWidget::resizeDocks: one QDockWidget is not part of the layout"
argument_list|)
expr_stmt|;
continue|continue;
block|}
...
name|qWarning
argument_list|(
literal|"QMainWidget::resizeDocks: all sizes need to be larger than 0"
argument_list|)
expr_stmt|;
name|size
operator|=
