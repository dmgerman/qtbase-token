...
end_function
begin_comment
comment|/*!     \since 5.3      \property QPlainTextEdit::placeholderText     \brief the editor placeholder text      Setting this property makes the editor display a grayed-out     placeholder text as long as the document() is empty.      By default, this property contains an empty string.      \sa document() */
end_comment
begin_function
...
end_endif
begin_comment
comment|/*!     \fn QPlainTextEdit::zoomIn(int range)      Zooms in on the text by making the base font size \a range     points larger and recalculating all font sizes to be the new size.     This does not change the size of any images.      \sa zoomOut() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn QPlainTextEdit::zoomOut(int range)      \overload      Zooms out on the text by making the base font size \a range points     smaller and recalculating all font sizes to be the new size. This     does not change the size of any images.      \sa zoomIn() */
end_comment
begin_function
