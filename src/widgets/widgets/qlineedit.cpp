...
end_function
begin_comment
comment|/*!     \overload      Creates a new action with the given \a icon at the \a position.      \since 5.2 */
end_comment
begin_function
DECL|function|addAction
name|QAction
...
end_function
begin_comment
comment|/*!     \property QLineEdit::clearButtonEnabled     \brief Whether the line edit displays a clear button when it is not empty.      If enabled, the line edit displays a trailing \e clear button when it contains     some text, otherwise the line edit does not show a clear button (the     default).      \sa addAction(), removeAction()     \since 5.2 */
end_comment
begin_decl_stmt
...
specifier|const
name|char
name|clearButtonActionNameC
index|[]
init|=
literal|"_q_qlineeditclearaction"
decl_stmt|;
end_decl_stmt
begin_function
