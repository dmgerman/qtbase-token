...
end_comment
begin_comment
comment|/*!     \fn void QSpinBox::valueChanged(const QString&text)      \overload      The new value is passed literally in \a text with no prefix() or     suffix(). */
end_comment
begin_comment
...
end_constructor
begin_comment
comment|/*!     \property QSpinBox::value     \brief the value of the spin box      setValue() will emit valueChanged() if the new value is different     from the old one. */
end_comment
begin_function
DECL|function|value
name|int
...
end_function
begin_comment
comment|/*!     Convenience function to set the \a minimum, and \a maximum values     with a single function call.      \snippet doc/src/snippets/code/src_gui_widgets_qspinbox.cpp 2     is equivalent to:     \snippet doc/src/snippets/code/src_gui_widgets_qspinbox.cpp 3      \sa minimum maximum */
end_comment
begin_function
...
end_comment
begin_comment
comment|/*!     \fn void QDoubleSpinBox::valueChanged(const QString&text);      \overload      The new value is passed literally in \a text with no prefix() or     suffix(). */
end_comment
begin_comment
...
end_constructor
begin_comment
comment|/*!     \property QDoubleSpinBox::value     \brief the value of the spin box      setValue() will emit valueChanged() if the new value is different     from the old one.      Note: The value will be rounded so it can be displayed with the     current setting of decimals.      \sa decimals */
end_comment
begin_function
DECL|function|value
name|double
...
end_function
begin_comment
comment|/*!     Convenience function to set the \a minimum and \a maximum values     with a single function call.      Note: The maximum and minimum values will be rounded to match the     decimals property.      \snippet doc/src/snippets/code/src_gui_widgets_qspinbox.cpp 6     is equivalent to:     \snippet doc/src/snippets/code/src_gui_widgets_qspinbox.cpp 7      \sa minimum maximum */
end_comment
begin_function
DECL|function|setRange
name|void
