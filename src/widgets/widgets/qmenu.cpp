...
directive|ifdef
name|QT3_SUPPORT
comment|//we store it here because the action might be deleted/changed by connected slots
specifier|const
name|int
name|id
init|=
...
argument_list|)
expr_stmt|;
comment|// Lets not touch to our internal softkey actions
if|if
condition|(
name|acts
index|[
...
end_function
begin_comment
comment|/*!     Use insertAction() or one of the addAction() overloads instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Use the insertSeparator() overload that takes a QAction *     parameter instead. */
end_comment
begin_function
DECL|function|insertSeparator
name|int
...
end_function
begin_comment
comment|/*!     Use QAction and actions() instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Use style()->pixelMetric(QStyle::PM_MenuPanelWidth, this) instead. */
end_comment
begin_function
...
end_comment
begin_comment
comment|/*!     \fn uint QMenu::count() const      Use actions().count() instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QString&text, const QObject *receiver, const char* member, const QKeySequence& shortcut, int id, int index)      Use insertAction() or one of the addAction() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QIcon& icon, const QString&text, const QObject *receiver, const char* member, const QKeySequence& shortcut, int id, int index)      Use insertAction() or one of the addAction() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QPixmap&pixmap, const QObject *receiver, const char* member, const QKeySequence& shortcut, int id, int index)      Use insertAction() or one of the addAction() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QString&text, int id, int index)      Use insertAction() or one of the addAction() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QIcon& icon, const QString&text, int id, int index)      Use insertAction() or one of the addAction() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QString&text, QMenu *popup, int id, int index)      Use insertMenu() or one of the addMenu() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QIcon& icon, const QString&text, QMenu *popup, int id, int index)      Use insertMenu() or one of the addMenu() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QPixmap&pixmap, int id, int index)      Use insertAction() or one of the addAction() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertItem(const QPixmap&pixmap, QMenu *popup, int id, int index)      Use insertMenu() or one of the addMenu() overloads instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::removeItem(int id)      Use removeAction() instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::removeItemAt(int index)      Use removeAction() instead. */
end_comment
begin_comment
comment|/*!     \fn QKeySequence QMenu::accel(int id) const      Use shortcut() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setAccel(const QKeySequence& key, int id)      Use setShortcut() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn QIcon QMenu::iconSet(int id) const      Use icon() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn QString QMenu::text(int id) const      Use text() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn QPixmap QMenu::pixmap(int id) const      Use QPixmap(icon()) on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setWhatsThis(int id, const QString&w)      Use setWhatsThis() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn QString QMenu::whatsThis(int id) const      Use whatsThis() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::changeItem(int id, const QString&text)      Use setText() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::changeItem(int id, const QPixmap&pixmap)      Use setText() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::changeItem(int id, const QIcon&icon, const QString&text)      Use setIcon() and setText() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn bool QMenu::isItemActive(int id) const      Use activeAction() instead. */
end_comment
begin_comment
comment|/*!     \fn bool QMenu::isItemEnabled(int id) const      Use isEnabled() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setItemEnabled(int id, bool enable)      Use setEnabled() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn bool QMenu::isItemChecked(int id) const      Use isChecked() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setItemChecked(int id, bool check)      Use setChecked() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn bool QMenu::isItemVisible(int id) const      Use isVisible() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setItemVisible(int id, bool visible)      Use setVisible() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn QRect QMenu::itemGeometry(int index)      Use actionGeometry() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn QFont QMenu::itemFont(int id) const      Use font() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setItemFont(int id, const QFont&font)      Use setFont() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::indexOf(int id) const      Use actions().indexOf(action) on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::idAt(int index) const      Use actions instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::activateItemAt(int index)      Use activate() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn bool QMenu::connectItem(int id, const QObject *receiver, const char* member)      Use connect() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn bool QMenu::disconnectItem(int id,const QObject *receiver, const char* member)     Use disconnect() on the relevant QAction instead.  */
end_comment
begin_comment
comment|/*!     \fn QMenuItem *QMenu::findItem(int id) const      Use actions instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::popup(const QPoint& pos, int indexAtPoint)      Use popup() on the relevant QAction instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::insertTearOffHandle(int a, int b)      Use setTearOffEnabled() instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::itemAtPos(const QPoint&p, bool ignoreSeparator)      Use actions instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::columns() const      Use columnCount() instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::itemHeight(int index)      Use actionGeometry(actions().value(index)).height() instead. */
end_comment
begin_comment
comment|/*!     \fn int QMenu::itemHeight(QMenuItem *mi)      Use actionGeometry() instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::activated(int itemId);      Use triggered() instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::highlighted(int itemId);      Use hovered() instead. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setCheckable(bool checkable)      Not necessary anymore. The \a checkable parameter is ignored. */
end_comment
begin_comment
comment|/*!     \fn bool QMenu::isCheckable() const      Not necessary anymore. Always returns true. */
end_comment
begin_comment
comment|/*!     \fn void QMenu::setActiveItem(int id)      Use setActiveAction() instead. */
end_comment
begin_macro
