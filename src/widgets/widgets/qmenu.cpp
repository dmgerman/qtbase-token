...
end_function
begin_comment
comment|/*!   When a menu is torn off a second menu is shown to display the menu   contents in a new window. When the menu is in this mode and the menu   is visible returns \c true; otherwise false.    \sa showTearOffMenu(), hideTearOffMenu(), isTearOffEnabled() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!    \since 5.7     This function will forcibly show the torn off menu making it    appear on the user's desktop at the specified \e global position \a pos.     \sa hideTearOffMenu(), isTearOffMenuVisible(), isTearOffEnabled() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!    \overload    \since 5.7     This function will forcibly show the torn off menu making it    appear on the user's desktop under the mouse currsor.     \sa hideTearOffMenu(), isTearOffMenuVisible(), isTearOffEnabled() */
end_comment
begin_function
DECL|function|showTearOffMenu
name|void
...
end_function
begin_comment
comment|/*!    This function will forcibly hide the torn off menu making it    disappear from the user's desktop.     \sa showTearOffMenu(), isTearOffMenuVisible(), isTearOffEnabled() */
end_comment
begin_function
...
argument_list|()
expr_stmt|;
comment|// QTornOffMenu sets WA_DeleteOnClose, so we
comment|// should consider the torn-off menu deleted.
comment|// This way showTearOffMenu() will not try to
comment|// reuse the dying torn-off menu.
name|d
operator|->
name|tornPopup
operator|=
