...
argument_list|()
decl_stmt|;
comment|// always report the right number of removed chars, but in lack of the real string use spaces
name|QString
name|oldText
init|=
name|QString
...
label|:
block|{
comment|// QTBUG-35734: ignore Ctrl/Ctrl+Shift; accept only AltGr (Alt+Ctrl) on German keyboards
if|if
condition|(
name|e
operator|->
