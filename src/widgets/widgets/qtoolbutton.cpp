...
argument_list|()
decl_stmt|;
comment|// If iconText() is generated from text(), we need to escape any '&'s so they
comment|// don't turn into shortcuts
if|if
condition|(
name|QActionPrivate
operator|::
