...
end_comment
begin_comment
comment|/*!     \fn QList<QAbstractButton*> QButtonGroup::buttons() const      Returns the button group's list of buttons. This may be empty.      \sa addButton(), removeButton() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn void QButtonGroup::setId(QAbstractButton *button, int id)     \since 4.1      Sets the \a id for the specified \a button. Note that \a id cannot     be -1.      \sa id() */
end_comment
begin_comment
