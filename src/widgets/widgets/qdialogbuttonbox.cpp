...
class|class
name|QDialogButtonEnabledProxy
super|:
specifier|public
name|QObject
block|{
...
directive|ifdef
name|QT_SOFTKEYS_ENABLED
comment|// Delete softkey actions as they have the buttons as parents
name|qDeleteAll
argument_list|(
name|d
operator|->
...
directive|ifdef
name|QT_SOFTKEYS_ENABLED
comment|// Delete softkey actions since they have the buttons as parents
name|qDeleteAll
argument_list|(
name|d
operator|->
...
break|break;
block|}
comment|// If the parent changes, then move the softkeys
for|for
control|(
name|QHash
argument_list|<
