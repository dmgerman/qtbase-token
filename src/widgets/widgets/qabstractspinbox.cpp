...
end_function
begin_comment
comment|/*!     \property QAbstractSpinBox::wrapping      \brief whether the spin box is circular.      If wrapping is true stepping up from maximum() value will take you     to the minimum() value and vica versa. Wrapping only make sense if     you have minimum() and maximum() values set.      \snippet doc/src/snippets/code/src_gui_widgets_qabstractspinbox.cpp 0      \sa QSpinBox::minimum(), QSpinBox::maximum() */
end_comment
begin_function
...
specifier|static
name|int
name|getKeyboardAutoRepeatRate
parameter_list|()
block|{
name|int
name|ret
...
argument_list|()
expr_stmt|;
comment|// minimumSizeHint doesn't care about min/max
name|reset
argument_list|()
expr_stmt|;
if|if
