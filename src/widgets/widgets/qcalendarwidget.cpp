...
end_function
begin_comment
comment|/*!     \property QCalendarWidget::maximumDate     \brief the maximum date of the currently specified date range.      The user will not be able to select a date which is after the     currently set maximum date.      \table     \row     \li \image qcalendarwidget-maximum.png     \row     \li     \snippet doc/src/snippets/code/src_gui_widgets_qcalendarwidget.cpp 2     \endtable      By default, the maximum date is the last day the QDate class can     handle.      When setting a maximum date, the minimumDate and selectedDate     properties are adjusted if the selection range becomes invalid. If     the provided date is not a valid QDate object, the     setMaximumDate() function does nothing.      \sa setDateRange() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Defines a date range by setting the minimumDate and maximumDate     properties.      The date range restricts the user selection, i.e. the user can     only select dates within the specified date range. Note that      \snippet doc/src/snippets/code/src_gui_widgets_qcalendarwidget.cpp 3      is analogous to      \snippet doc/src/snippets/code/src_gui_widgets_qcalendarwidget.cpp 4      If either the \a min or \a max parameters are not valid QDate     objects, this function does nothing.      \sa setMinimumDate(), setMaximumDate() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \property QCalendarWidget::gridVisible     \brief whether the table grid is displayed.      \table     \row         \li \inlineimage qcalendarwidget-grid.png     \row         \li         \snippet doc/src/snippets/code/src_gui_widgets_qcalendarwidget.cpp 5     \endtable      The default value is false. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \property QCalendarWidget::firstDayOfWeek     \brief a value identifying the day displayed in the first column.      By default, the day displayed in the first column is Sunday */
end_comment
begin_function
