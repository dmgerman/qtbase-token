...
end_function
begin_comment
comment|/*!     \fn void QTabBar::setCurrentTab(int index)      Use setCurrentIndex() instead. */
end_comment
begin_comment
comment|/*!     \fn void QTabBar::selected(int index);      Use currentChanged() instead. */
end_comment
begin_comment
