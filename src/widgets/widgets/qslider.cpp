...
end_ifdef
begin_comment
comment|/*!     Use QSlider() and QObject::setObjectName() instead.      \oldcode         QSlider *mySlider = new QSlider(parent, name);     \newcode         QSlider *mySlider = new QSlider(parent);         mySlider->setObjectName(name);     \endcode */
end_comment
begin_constructor
DECL|function|QSlider
name|QSlider
...
end_constructor
begin_comment
comment|/*!     Use QSlider() and QObject::setObjectName() instead.      \oldcode         QSlider *mySlider = new QSlider(orientation, parent, name);     \newcode         QSlider *mySlider = new QSlider(orientation, parent);         mySlider->setObjectName(name);     \endcode */
end_comment
begin_constructor
DECL|function|QSlider
name|QSlider
...
end_constructor
begin_comment
comment|/*!     Use QSlider(), QObject::setObjectName() and the functionality     inherited from QAbstractSlider instead.      \oldcode         QSlider *mySlider = new QSlider(minValue, maxValue, pageStep,                                         value, orientation, parent, name);     \newcode         QSlider *mySlider = new QSlider(orientation, parent);         mySlider->setObjectName(name);         mySlider->setMinimum(minValue);         mySlider->setMaximum(maxValue);         mySlider->setPageStep(pageStep);         mySlider->setValue(value);     \endcode */
end_comment
begin_constructor
DECL|function|QSlider
name|QSlider
