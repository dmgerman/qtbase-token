...
end_ifndef
begin_comment
comment|/*!     \property QMainWindow::unifiedTitleAndToolBarOnMac     \brief whether the window uses the unified title and toolbar look on Mac OS X     \since 5.2 */
end_comment
begin_function
...
argument_list|(
literal|"setContentBorderThickness"
argument_list|)
decl_stmt|;
if|if
condition|(
...
function_decl|(
modifier|*
name|SetContentBorderThicknessFunction
function_decl|)
parameter_list|(
name|QWindow
modifier|*
