...
argument_list|()
expr_stmt|;
comment|// Restore here/now to get the right restore size.
name|int
name|size
init|=
name|d
...
end_function
begin_comment
comment|/*!     \property QHeaderView::defaultSectionSize     \brief the default size of the header sections before resizing.      This property only affects sections that have \l Interactive or \l Fixed     as their resize mode.      By default, the value of this property is style dependent.     Thus, when the style changes, this property updates from it.     Calling setDefaultSectionSize() stops the updates, calling     resetDefaultSectionSize() will restore default behavior.      \sa setSectionResizeMode(), minimumSectionSize */
end_comment
begin_function
...
index|]
expr_stmt|;
comment|// We cannot call visualIndex since it executes executePostedLayout()
comment|// and it is likely to bypass initializeSections() and we may end up here again. Doing the insert twice.
if|if
condition|(
name|d
operator|->
...
name|insertCount
expr_stmt|;
comment|// We do not want to emit resize before we have fixed the count
block|}
name|QHeaderViewPrivate
operator|::
name|SectionItem
...
argument_list|)
expr_stmt|;
comment|// Just update the last log index.
name|doDelayedResizeSections
argument_list|()
expr_stmt|;
block|}
...
condition|)
block|{
comment|// If no reordered sections, skip redundant visual-to-logical transformations
for|for
control|(
specifier|const
specifier|auto
...
literal|1
expr_stmt|;
comment|// We do not want resize to catch it as the last section.
name|q
operator|->
name|resizeSection
argument_list|(
...
parameter_list|(
name|int
name|visualIndexForLastSection
parameter_list|)
block|{
name|Q_Q
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// pick size directly since ...
comment|//  q->sectionSize(lastSectionLogicalIdx) may do delayed resize and stretch it before we get the value.
block|}
end_function
begin_function
...
condition|)
return|return;
comment|// restore old last section.
name|restoreSizeOnPrevLastSection
argument_list|()
expr_stmt|;
name|setNewLastSection
...
argument_list|()
expr_stmt|;
comment|// Do stretch of last section soon (but not now).
block|}
end_function
begin_comment
...
decl_stmt|;
name|int
name|sortIndicatorSectionIn
decl_stmt|;
name|bool
name|sortIndicatorShownIn
decl_stmt|;
name|int
name|lengthIn
decl_stmt|;
...
name|int
argument_list|>
name|visualIndicesIn
decl_stmt|;
name|QVector
argument_list|<
name|int
argument_list|>
name|logicalIndicesIn
decl_stmt|;
name|QHash
argument_list|<
name|int
...
name|int
argument_list|>
name|hiddenSectionSizeIn
decl_stmt|;
name|bool
name|movableSectionsIn
decl_stmt|;
name|bool
name|clickableSectionsIn
decl_stmt|;
name|bool
name|highlightSelectedIn
decl_stmt|;
name|bool
name|stretchLastSectionIn
decl_stmt|;
name|bool
name|cascadingResizingIn
decl_stmt|;
name|int
name|stretchSectionsIn
decl_stmt|;
name|int
name|contentsSectionsIn
decl_stmt|;
name|int
name|defaultSectionSizeIn
decl_stmt|;
name|int
name|minimumSectionSizeIn
decl_stmt|;
name|QVector
argument_list|<
name|SectionItem
