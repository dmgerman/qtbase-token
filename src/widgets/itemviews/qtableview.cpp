...
end_function
begin_comment
comment|/*!   \internal   Get sizeHint width for single Index (providing existing hint and style option) */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   \internal   Get sizeHint height for single Index (providing existing hint and style option) */
end_comment
begin_function
