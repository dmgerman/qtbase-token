...
argument_list|()
return|;
comment|// Find the smallest available size whose area is still larger than the input
comment|// size. Otherwise, use the largest area available size. (We don't assume the
comment|// platform theme sizes are sorted, hence the extra logic.)
specifier|const
name|int
name|sizeArea
init|=
