...
end_function
begin_comment
comment|/*!     \since 5.2      This specifies that the tree structure should be placed at logical index \a index.     If \index is set to -1 then the tree will always follow visual index 0.      \sa treePosition(), QHeaderView::swapSections(), QHeaderView::moveSection() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.2      Return the logical index the tree is set on. If the return value is -1 then the     tree is placed on the visual index 0.      \sa setTreePosition() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   \internal   Get sizeHint width for single index (providing existing hint and style option) and index in viewIndex i. */
end_comment
begin_function
...
argument_list|()
expr_stmt|;
comment|// Make sure that viewItems are up to date.
if|if
condition|(
name|d
operator|->
...
argument_list|()
return|;
comment|// Get rect for last item
specifier|const
name|QRect
name|deepestRect
init|=
...
argument_list|)
expr_stmt|;
comment|// add size for scrollbars
name|result
operator|+=
name|QSize
argument_list|(
...
specifier|const
block|{
comment|// Note that this will include the header, even if its hidden.
return|return
operator|(
name|visualIndex
argument_list|(
