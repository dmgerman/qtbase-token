...
end_comment
begin_comment
comment|/*!   Creates a QAccessibleButton object for \a w. */
end_comment
begin_constructor
...
argument_list|)
expr_stmt|;
comment|// FIXME: The checkable state of the button is dynamic,
comment|// while we only update the controlling signal once :(
if|if
condition|(
name|button
argument_list|()
...
end_comment
begin_comment
comment|/*!   Creates a QAccessibleToolButton object for \a w. */
end_comment
begin_constructor
