...
name|qWarning
argument_list|(
literal|"QAccessibleWidget::rect: This implementation does not support subelements! "
literal|"(ID %d unknown for %s)"
argument_list|,
name|child
argument_list|,
name|widget
...
end_comment
begin_constructor
DECL|function|QAccessibleWidgetEx
