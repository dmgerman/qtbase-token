...
argument_list|()
condition|)
comment|// newline should have same format as preceding character
operator|--
name|iter
expr_stmt|;
name|format
...
argument_list|()
condition|)
comment|// underline could still be set in the default font
name|underlineStyle
operator|=
name|QTextCharFormat
operator|::
...
argument_list|)
expr_stmt|;
comment|// this is not correct, but provides good approximation at least
break|break;
default|default:
name|qWarning
argument_list|()
operator|<<
literal|"Unknown QTextCharFormat::âUnderlineStyle value "
operator|<<
name|underlineStyle
operator|<<
literal|" could not be translated to IAccessible2 value"
expr_stmt|;
break|break;
block|}
if|if
