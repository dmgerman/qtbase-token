...
end_function
begin_comment
comment|/*!     Returns \c true if this QGraphicsLayoutItem is a layout (e.g., is inherited     by an object that arranges other QGraphicsLayoutItem objects); otherwise     returns \c false.      \sa QGraphicsLayout */
end_comment
begin_function
