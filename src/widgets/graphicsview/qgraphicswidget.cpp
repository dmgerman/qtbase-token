...
end_function
begin_comment
comment|/*!     \reimp      Handles the \a event.  QGraphicsWidget handles the following     events:      \table   \o Event                 \o Usage     \row     \o Polish                     \o Delivered to the widget some time after it has been                         shown.     \row     \o GraphicsSceneMove                     \o Delivered to the widget after its local position has                         changed.     \row     \o GraphicsSceneResize                     \o Delivered to the widget after its size has changed.     \row     \o Show                     \o Delivered to the widget before it has been shown.     \row     \o Hide                     \o Delivered to the widget after it has been hidden.     \row     \o PaletteChange                     \o Delivered to the widget after its palette has changed.     \row     \o FontChange                     \o Delivered to the widget after its font has changed.     \row     \o EnabledChange                     \o Delivered to the widget after its enabled state has                         changed.     \row     \o StyleChange                     \o Delivered to the widget after its style has changed.     \row     \o LayoutDirectionChange                     \o Delivered to the widget after its layout direction has                         changed.     \row     \o ContentsRectChange                     \o Delivered to the widget after its contents margins/                         contents rect has changed.     \endtable */
end_comment
begin_function
DECL|function|event
name|bool
...
end_function
begin_comment
comment|/*!     This event handler, for \a event, can be reimplemented in a subclass to     receive notifications for Qt::GrabMouse events.      \sa grabMouse(), grabKeyboard() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     This event handler, for \a event, can be reimplemented in a subclass to     receive notifications for Qt::UngrabMouse events.      \sa ungrabMouse(), ungrabKeyboard() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     This event handler, for \a event, can be reimplemented in a subclass to     receive notifications for Qt::GrabKeyboard events.      \sa grabKeyboard(), grabMouse() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     This event handler, for \a event, can be reimplemented in a subclass to     receive notifications for Qt::UngrabKeyboard events.      \sa ungrabKeyboard(), ungrabMouse() */
end_comment
begin_function
