...
end_function
begin_comment
comment|/*!     \internal     Returns \c true if there are no arrangement that satisfies all constraints.     Otherwise returns \c false.      \sa addAnchor() */
end_comment
begin_function
