...
end_function
begin_comment
comment|/*!     \internal      Reimplemented from QGraphicsItemPrivate. ### Qt 5: Move impl to     reimplementation QGraphicsProxyWidget::inputMethodQuery(). */
end_comment
begin_function
...
case|:
block|{
comment|// Forward input method events if the focus widget enables
comment|// input methods.
comment|// ### Qt 4.5: this code must also go into a reimplementation
comment|// of inputMethodEvent().
name|QWidget
modifier|*
name|focusWidget
init|=
