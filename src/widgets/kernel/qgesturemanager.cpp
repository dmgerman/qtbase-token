...
argument_list|()
operator|<<
literal|"Ignoring invalid value of "
operator|<<
name|panTouchPointVariable
expr_stmt|;
block|}
comment|// Pan should use 1 finger on a touch screen and 2 fingers on touch pads etc.
comment|// where 1 finger movements are used for mouse event synthetization. For now,
comment|// default to 2 until all classes inheriting QScrollArea are fixed to handle it
comment|// correctly.
return|return
literal|2
return|;
