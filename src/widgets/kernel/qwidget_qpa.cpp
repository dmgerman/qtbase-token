...
end_function
begin_comment
comment|// Position top level windows at the center, avoid showing
end_comment
begin_comment
comment|// Windows at the default 0,0 position excluding the frame.
end_comment
begin_function
...
expr_stmt|;
block|}
comment|// emulate the new window state
if|if
condition|(
name|newEffectiveState
operator|==
