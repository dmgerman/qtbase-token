...
literal|false
expr_stmt|;
comment|// never draw it on OS X or QWS, as we get it for free
endif|#
directive|endif
name|QRect
name|r
...
end_ifdef
begin_comment
comment|/*!     \obsolete      Sets the What's This text \a s for the widget \a w.      Use QWidget::setWhatsThis() or QAction::setWhatsThis() instead. */
end_comment
begin_function
DECL|function|add
name|void
...
end_function
begin_comment
comment|/*!     \obsolete      Remove's the What's This text for the widget \a w.      Use QWidget::setWhatsThis() or QAction::setWhatsThis() instead. */
end_comment
begin_function
...
end_class
begin_comment
comment|/*!     Returns a new "What's This?" QToolButton with the given \a     parent. To do this now, create your own QToolButton and a     QWhatsThis object and call the QWhatsThis object's showText()     function when the QToolButton is invoked.      Use createAction() instead. */
end_comment
begin_function
