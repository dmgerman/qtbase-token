...
literal|0
return|;
comment|// Find the root widget, get a QScreen pointer from it and find
...
return|;
block|}
comment|// If the screen number cannot be obtained using QScreen pointer,
comment|// get it from window position using screen geometry.
name|QRect
name|frame
init|=
name|w
