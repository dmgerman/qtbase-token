...
comment|// If the change in scale for a single touch event is out of this range,
comment|// we consider it to be spurious.
DECL|variable|kSingleStepScaleMax
specifier|static
specifier|const
name|qreal
name|kSingleStepScaleMax
init|=
literal|2.0
decl_stmt|;
end_decl_stmt
