...
end_ifdef
begin_comment
comment|/*!     Use the QXmlInputSource(QIODevice *) constructor instead, with     the device used by \a stream.      \sa QTextStream::device() */
end_comment
begin_constructor
DECL|function|QXmlInputSource
name|QXmlInputSource
...
end_constructor
begin_comment
comment|/*!     Use QXmlInputSource(&\a file) instead. */
end_comment
begin_constructor
DECL|function|QXmlInputSource
name|QXmlInputSource
