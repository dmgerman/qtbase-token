...
define|#
directive|define
name|QNetworkSessionExport
value|Q_NETWORK_EXPORT
else|#
directive|else
include|#
directive|include
file|"qmobilityglobal.h"
name|QTM_BEGIN_NAMESPACE
define|#
directive|define
name|QNetworkSessionExport
value|Q_BEARER_EXPORT
endif|#
directive|endif
name|class
