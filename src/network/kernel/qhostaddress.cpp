...
end_comment
begin_comment
comment|/*! \enum QHostAddress::SpecialAddress      \value Null The null address object. Equivalent to QHostAddress().     \value LocalHost The IPv4 localhost address. Equivalent to QHostAddress("127.0.0.1").     \value LocalHostIPv6 The IPv6 localhost address. Equivalent to QHostAddress("::1").     \value Broadcast The IPv4 broadcast address. Equivalent to QHostAddress("255.255.255.255").     \value Any The IPv4 any-address. Equivalent to QHostAddress("0.0.0.0").     \value AnyIPv6 The IPv6 any-address. Equivalent to QHostAddress("::"). */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     Returns the IPv4 address as a number.      For example, if the address is 127.0.0.1, the returned value is     2130706433 (i.e. 0x7f000001).      This value is only valid if the Protocol() is     \l{QAbstractSocket::}{IPv4Protocol}.      \sa toString() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the IPv6 address as a Q_IPV6ADDR structure. The structure     consists of 16 unsigned characters.      \snippet doc/src/snippets/code/src_network_kernel_qhostaddress.cpp 0      This value is only valid if the protocol() is     \l{QAbstractSocket::}{IPv6Protocol}.      \sa toString() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the address as a string.      For example, if the address is the IPv4 address 127.0.0.1, the     returned string is "127.0.0.1". For IPv6 the string format will      follow the RFC5952 recommendation.      \sa toIPv4Address() */
end_comment
begin_function
