...
end_ifndef
begin_comment
comment|// This function has a special implementation for symbian right now in qhostinfo_symbian.cpp but not on other OS.
end_comment
begin_function
DECL|function|fromName
name|QHostInfo
...
end_destructor
begin_comment
comment|/*!     Returns the list of IP addresses associated with hostName(). This     list may be empty.      Example:      \snippet doc/src/snippets/code/src_network_kernel_qhostinfo.cpp 5      \sa hostName(), error() */
end_comment
begin_function
