...
block|}
decl_stmt|;
comment|// Transfer any postponed lookups that aren't currently running to the scheduled list, keeping already-running lookups:
name|postponedLookups
operator|.
name|erase
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Unschedule and postpone any that are currently running:
name|scheduledLookups
operator|.
name|erase
argument_list|(
