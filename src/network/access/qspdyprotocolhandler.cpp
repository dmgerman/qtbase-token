...
argument_list|,
literal|"server sent SYN_REPLY on an already closed stream"
argument_list|)
expr_stmt|;
break|break;
block|}
...
name|Q_FUNC_INFO
operator|<<
literal|"got data frame in unknown state"
expr_stmt|;
block|}
block|}
block|}
...
name|ProtocolFailure
argument_list|,
literal|"server sent data on an already closed stream"
argument_list|)
expr_stmt|;
break|break;
block|}
