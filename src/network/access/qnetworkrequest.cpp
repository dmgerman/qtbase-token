...
end_macro
begin_comment
comment|/*!     \class QNetworkRequest     \since 4.4     \ingroup network     \inmodule QtNetwork      \brief The QNetworkRequest class holds a request to be sent with QNetworkAccessManager.      QNetworkRequest is part of the Network Access API and is the class     holding the information necessary to send a request over the     network. It contains a URL and some ancillary information that can     be used to modify the request.      \sa QNetworkReply, QNetworkAccessManager */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \enum QNetworkRequest::LoadControl     \since 4.7      Indicates if an aspect of the request's loading mechanism has been     manually overridden, e.g. by QtWebKit.      \value Automatic            default value: indicates default behaviour.      \value Manual               indicates behaviour has been manually overridden. */
end_comment
begin_class
...
end_endif
begin_comment
comment|/*!     \since 4.6      Allows setting a reference to the \a object initiating     the request.      For example QtWebKit sets the originating object to the     QWebFrame that initiated the request.      \sa originatingObject() */
end_comment
begin_function
...
comment|// QtWebKit performance benchmarks to get an idea.
if|if
condition|(
name|pos
operator|==
