...
end_function
begin_comment
comment|/*!     \since 5.6      Returns the maximum number of redirects allowed to be followed for this     request.      \sa setMaximumRedirectsAllowed() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.6      Sets the maximum number of redirects allowed to be followed for this     request to \a maxRedirectsAllowed.      \sa maximumRedirectsAllowed() */
end_comment
begin_function
