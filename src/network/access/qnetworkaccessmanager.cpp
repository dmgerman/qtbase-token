...
name|Q_FOREACH
argument_list|(
argument|const QNetworkConfiguration&cfg
argument_list|,
argument|networkConfigurationManager.allConfigurations()
argument_list|)
block|{
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|//this one disconnected but another one is online,
comment|// close and create new session
name|_q_networkSessionClosed
argument_list|()
expr_stmt|;
name|createSession
...
condition|)
block|{
comment|//this one is disconnecting
name|onlineConfigurations
operator|.
name|remove
argument_list|(
