...
argument_list|(
literal|"QNativeSocketEngine::connectToHostByName: Could not create hostname."
argument_list|)
expr_stmt|;
specifier|const
name|QString
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"connectToHostByName: Could not register \"connectOp\" callback"
argument_list|)
expr_stmt|;
return|return
name|S_OK
...
name|hr
decl_stmt|;
comment|// runOnXamlThread may only return S_OK (will assert otherwise) so no need to check its result.
comment|// hr is set inside the lambda though. If an error occurred hr will point that out.
name|bool
name|specificErrorSet
init|=
literal|false
decl_stmt|;
name|QEventDispatcherWinRT
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::bind: Could not obtain hostname factory"
argument_list|)
expr_stmt|;
specifier|const
name|QString
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::bind: Could not create hostname."
argument_list|)
expr_stmt|;
block|}
end_function
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::bind: Could not create tcp listener"
argument_list|)
expr_stmt|;
block|}
name|hr
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::bind: Could not register client connection callback"
argument_list|)
expr_stmt|;
name|hr
operator|=
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::bind: Unable to bind socket"
argument_list|)
expr_stmt|;
end_expr_stmt
begin_expr_stmt
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::bind: Could not wait for bind to finish"
argument_list|)
expr_stmt|;
end_expr_stmt
begin_return
...
name|hr
decl_stmt|;
comment|// To close the connection properly (not with a hard reset) all pending read operation have to
comment|// be finished or cancelled. The API isn't available on Windows 8.1 though.
name|ComPtr
argument_list|<
name|IStreamSocket3
argument_list|>
...
name|RETURN_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::writeDatagram: Could not create hostname."
argument_list|,
argument|return -
literal|1
argument_list|)
...
name|tcpSocket
type|(
decl_stmt|)->get_InputStream(&stream
block|)
argument_list|;
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"establishRead(): Failed to get socket input stream"
argument_list|)
argument_list|;
name|ComPtr
argument_list|<
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"establishRead(): Failed to create buffer"
argument_list|)
argument_list|;
name|hr
operator|=
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"establishRead(): Failed to initiate socket read"
argument_list|)
argument_list|;
name|hr
operator|=
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"establishRead(): Failed to register read callback"
argument_list|)
...
name|RETURN_FALSE_IF_FAILED
argument_list|(
literal|"createNewSocket: Could not create socket instance"
argument_list|)
expr_stmt|;
name|socketDescriptor
operator|=
...
name|RETURN_OK_IF_FAILED
argument_list|(
literal|"createNewSocket: Could not add \"message received\" callback"
argument_list|)
return|return
name|S_OK
return|;
...
end_return
begin_expr_stmt
unit|}  QNativeSocketEnginePrivate
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"handleReadyRead(): Could not obtain input stream"
argument_list|)
argument_list|;
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"handleReadyRead(): Could not obtain buffer capacity"
argument_list|)
argument_list|;
name|hr
operator|=
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"handleReadyRead(): Could not set buffer length"
argument_list|)
argument_list|;
name|hr
operator|=
