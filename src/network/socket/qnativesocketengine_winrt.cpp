...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::establishRead: Failed to get socket input stream"
argument_list|)
argument_list|;
name|ComPtr
argument_list|<
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::establishRead: Failed to create buffer"
argument_list|)
argument_list|;
name|ComPtr
argument_list|<
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::establishRead: Failed to initiate socket read"
argument_list|)
argument_list|;
name|hr
operator|=
...
name|RETURN_HR_IF_FAILED
argument_list|(
literal|"QNativeSocketEngine::establishRead: Failed to register read callback"
argument_list|)
