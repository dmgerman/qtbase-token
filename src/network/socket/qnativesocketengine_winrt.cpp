...
name|hr
argument_list|,
literal|"Unable to set host connection callback."
argument_list|)
expr_stmt|;
return|return
literal|false
...
name|hr
argument_list|,
literal|"Failed to write to socket."
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|hr
argument_list|,
literal|"Failed to set socket write callback."
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|hr
argument_list|,
literal|"Failed to get written socket length."
argument_list|)
expr_stmt|;
return|return
operator|-
...
name|hr
argument_list|,
literal|"Failed to get ready read results."
argument_list|)
expr_stmt|;
return|return
name|S_OK
...
name|hr
argument_list|,
literal|"Failed to cast operation."
argument_list|)
expr_stmt|;
return|return
name|S_OK
...
name|hr
argument_list|,
literal|"Failed to get error code."
argument_list|)
expr_stmt|;
return|return
name|S_OK
...
name|errorCode
argument_list|,
literal|"A socket error occurred."
argument_list|)
expr_stmt|;
return|return
name|S_OK
