...
end_function
begin_comment
comment|/*!     \since 5.5      Returns the list of cryptographic ciphers supported by this     system. This list is set by the system's SSL libraries and may     vary from system to system.      \sa ciphers(), setCiphers() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      This function provides the CA certificate database     provided by the operating system. The CA certificate database     returned by this function is used to initialize the database     returned by caCertificates() on the default QSslConfiguration.      \sa caCertificates(), setCaCertificates(), defaultConfiguration() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      Returns the list of elliptic curves supported by this     system. This list is set by the system's SSL libraries and may     vary from system to system.      \sa ellipticCurves(), setEllipticCurves() */
end_comment
begin_function
