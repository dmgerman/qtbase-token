...
argument_list|)
expr_stmt|;
comment|// ### The right-hand encoding seems to allow hex (Regulierungsbeh\xC8orde)
comment|//entry.replace(QLatin1String("\\x"), QLatin1String("%"));
comment|//entry = QUrl::fromPercentEncoding(entry.toLatin1());
comment|// ### See RFC-4630 for more details!
name|QRegExp
name|rx
argument_list|(
name|QLatin1String
