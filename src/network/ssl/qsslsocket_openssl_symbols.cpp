...
argument|void
argument_list|,
argument|EVP_CIPHER_CTX_cleanup
argument_list|,
argument|EVP_CIPHER_CTX *a
argument_list|,
argument|a
argument_list|,
argument|return
...
argument|int
argument_list|,
argument|EVP_CIPHER_CTX_ctrl
argument_list|,
argument|EVP_CIPHER_CTX *ctx
argument_list|,
argument|ctx
argument_list|,
argument|int type
...
argument|int
argument_list|,
argument|EVP_CIPHER_CTX_set_key_length
argument_list|,
argument|EVP_CIPHER_CTX *ctx
argument_list|,
argument|ctx
...
argument|int
argument_list|,
argument|EVP_CipherInit
argument_list|,
argument|EVP_CIPHER_CTX *ctx
argument_list|,
argument|ctx
argument_list|,
argument|const EVP_CIPHER *type
argument_list|,
argument|type
argument_list|,
argument|const unsigned char *key
argument_list|,
argument|key
argument_list|,
...
argument|size_t
argument_list|,
argument|EC_get_builtin_curves
argument_list|,
argument|EC_builtin_curve * r
argument_list|,
argument|r
argument_list|,
argument|size_t nitems
argument_list|,
argument|nitems
argument_list|,
argument|return
...
argument_list|)
expr_stmt|;
comment|// note: checking rhs< lhs, the same as lhs> rhs
return|return
name|std
operator|::
