...
end_function
begin_comment
comment|/*!   \deprecated    Use the version with a single \l QAccessibleEvent paremeter instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \class QAccessibleEvent     \brief The QAccessibleEvent is use to notify about changes that are     relevant for accessibility in the application.      \ingroup accessibility     \inmodule QtGui      This class should be created on the stack and used as parameter for     \l QAccessible::updateAccessibility(). */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     Returns the meaningful relations to other widgets. Usually this will not return parent/child     relations, unless they are handled in a specific way such as in tree views.     It will typically return the labelled-by and label relations.     It should never return itself.      \sa relationTo(), parent(), child() */
end_comment
begin_function
name|QVector
argument_list|<
