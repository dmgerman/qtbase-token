...
end_ifdef
begin_comment
comment|/*!   \obsolete     Sets up the validator. The \a parent and \a name parameters are     passed on to the QObject constructor. */
end_comment
begin_constructor
DECL|function|QValidator
name|QValidator
...
end_ifdef
begin_comment
comment|/*!   \obsolete      Constructs a validator with a \a parent object and a \a name that     accepts all integers. */
end_comment
begin_constructor
DECL|function|QIntValidator
name|QIntValidator
...
end_constructor
begin_comment
comment|/*!   \obsolete      Constructs a validator called \a name with a \a parent, that     accepts integers from \a minimum to \a maximum inclusive. */
end_comment
begin_constructor
DECL|function|QIntValidator
name|QIntValidator
...
end_ifdef
begin_comment
comment|/*!   \obsolete      Constructs a validator object with a \a parent object and a \a name     that accepts any double. */
end_comment
begin_constructor
DECL|function|QDoubleValidator
name|QDoubleValidator
...
end_constructor
begin_comment
comment|/*!   \obsolete      Constructs a validator object with a \a parent object, called \a     name. This validator will accept doubles from \a bottom to \a top     inclusive, with up to \a decimals digits after the decimal point. */
end_comment
begin_constructor
DECL|function|QDoubleValidator
name|QDoubleValidator
...
end_constructor
begin_comment
comment|/*!     Constructs a validator with a \a parent object that     accepts all strings that match the regular expression \a rx.      The match is made against the entire string; e.g. if the regexp is     \bold{[A-Fa-f0-9]+} it will be treated as \bold{^[A-Fa-f0-9]+$}. */
end_comment
begin_constructor
DECL|function|QRegExpValidator
name|QRegExpValidator
...
end_ifdef
begin_comment
comment|/*!   \obsolete      Constructs a validator with a \a parent object and \a name that accepts     any string (including an empty one) as valid. */
end_comment
begin_constructor
DECL|function|QRegExpValidator
name|QRegExpValidator
...
end_constructor
begin_comment
comment|/*!   \obsolete      Constructs a validator with a \a parent object and a \a name that     accepts all strings that match the regular expression \a rx.      The match is made against the entire string; e.g. if the regexp is     \bold{[A-Fa-f0-9]+} it will be treated as \bold{^[A-Fa-f0-9]+$}. */
end_comment
begin_constructor
DECL|function|QRegExpValidator
name|QRegExpValidator
