...
end_ifdef
begin_comment
comment|/*! \obsolete     Constructs a QToolBar with the given \a parent and \a name. */
end_comment
begin_constructor
DECL|function|QToolBar
name|QToolBar
...
case|:
block|{
comment|// There's currently no way to invalidate the size and let
comment|// HIToolbar know about it. This forces a re-check.
name|int
name|earlyResult
init|=
operator|-
