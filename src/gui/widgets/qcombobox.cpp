...
condition|)
block|{
comment|// in portait, menu should be positioned above softkeys
name|listRect
operator|.
name|moveBottom
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//by default popup is centered on screen in landscape
name|listRect
operator|.
name|moveCenter
argument_list|(
...
condition|)
block|{
comment|// landscape without stacon, menu should be at the right
operator|(
name|opt
operator|.
name|direction
