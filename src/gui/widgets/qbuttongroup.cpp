...
end_comment
begin_comment
comment|/*!     \fn QList<QAbstractButton*> QButtonGroup::buttons() const      Returns the list of this groups's buttons. This may be empty.      \sa addButton(), removeButton() */
end_comment
begin_comment
comment|/*!     \fn QAbstractButton *QButtonGroup::checkedButton() const;      Returns the button group's checked button, or 0 if no buttons are     checked.      \sa buttonClicked() */
end_comment
begin_comment
comment|/*!     \fn QAbstractButton *QButtonGroup::button(int id) const;     \since 4.1      Returns the button with the specified \a id, or 0 if no such button     exists. */
end_comment
begin_comment
comment|/*!     \fn void QButtonGroup::setId(QAbstractButton *button, int id)     \since 4.1      Sets the \a id for the specified \a button. Note that \a id can     not be -1.      \sa id() */
end_comment
begin_comment
comment|/*!     \fn int QButtonGroup::id(QAbstractButton *button) const;     \since 4.1      Returns the id for the specified \a button, or -1 if no such button     exists.       \sa setId() */
end_comment
begin_comment
