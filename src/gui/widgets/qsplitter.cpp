...
end_constructor
begin_comment
comment|/*!     Use one of the constructors that don't take the \a name argument     and then use setObjectName() instead. */
end_comment
begin_constructor
DECL|function|QSplitter
name|QSplitter
...
end_ifdef
begin_comment
comment|/*!     \fn void QSplitter::moveToFirst(QWidget *widget)      Use insertWidget(0, \a widget) instead. */
end_comment
begin_comment
comment|/*!     \fn void QSplitter::moveToLast(QWidget *widget)      Use addWidget(\a widget) instead. */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn void QSplitter::setMargin(int margin)     Sets the width of the margin around the contents of the widget to \a margin.      Use QWidget::setContentsMargins() instead.     \sa margin(), QWidget::setContentsMargins() */
end_comment
begin_comment
comment|/*!     \fn int QSplitter::margin() const     Returns the width of the margin around the contents of the widget.      Use QWidget::getContentsMargins() instead.     \sa setMargin(), QWidget::getContentsMargins() */
end_comment
begin_endif
endif|#
directive|endif
