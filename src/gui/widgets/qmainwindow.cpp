...
end_ifdef
begin_comment
comment|/*!     \obsolete     Constructs a QMainWindow with the given \a parent, \a name, and     with the specified widget \a flags.  */
end_comment
begin_constructor
DECL|function|QMainWindow
name|QMainWindow
