...
end_ifdef
begin_comment
comment|/*! \obsolete     Constructs an empty label.      The \a parent, \a name and widget flag \a f, arguments are passed     to the QFrame constructor.      \sa setAlignment(), setFrameStyle(), setIndent() */
end_comment
begin_constructor
DECL|function|QLabel
name|QLabel
...
end_constructor
begin_comment
comment|/*! \obsolete     Constructs a label that displays the text, \a text.      The \a parent, \a name and widget flag \a f, arguments are passed     to the QFrame constructor.      \sa setText(), setAlignment(), setFrameStyle(), setIndent() */
end_comment
begin_constructor
DECL|function|QLabel
name|QLabel
...
end_ifdef
begin_comment
comment|/*!     Use setAlignment(Qt::Alignment) instead.      If \a alignment specifies text flags as well, use setTextFormat()     to set those. */
end_comment
begin_function
DECL|function|setAlignment
name|void
...
end_function
begin_comment
comment|/*!     \property QLabel::indent     \brief the label's text indent in pixels      If a label displays text, the indent applies to the left edge if     alignment() is Qt::AlignLeft, to the right edge if alignment() is     Qt::AlignRight, to the top edge if alignment() is Qt::AlignTop, and     to to the bottom edge if alignment() is Qt::AlignBottom.      If indent is negative, or if no indent has been set, the label     computes the effective indent as follows: If frameWidth() is 0,     the effective indent becomes 0. If frameWidth() is greater than 0,     the effective indent becomes half the width of the "x" character     of the widget's current font().      By default, the indent is -1, meaning that an effective indent is     calculating in the manner described above.      \sa alignment, margin, frameWidth(), font() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Selects text from position \a start and for \a length characters.      \sa selectedText()      \bold{Note:} The textInteractionFlags set on the label need to include     either TextSelectableByMouse or TextSelectableByKeyboard.      \since 4.7 */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \property QLabel::selectedText     \brief the selected text      If there is no selected text this property's value is     an empty string.      By default, this property contains an empty string.      \sa hasSelectedText()      \bold{Note:} The textInteractionFlags set on the label need to include     either TextSelectableByMouse or TextSelectableByKeyboard.      \since 4.7 */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     selectionStart() returns the index of the first selected character in the     label or -1 if no text is selected.      \sa selectedText()      \bold{Note:} The textInteractionFlags set on the label need to include     either TextSelectableByMouse or TextSelectableByKeyboard.      \since 4.7 */
end_comment
begin_function
