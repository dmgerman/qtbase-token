...
end_function
begin_comment
comment|// TODO: Qt 5: Merge with addButton(QAbstractButton *button, int id)
end_comment
begin_function
...
end_function
begin_comment
comment|/*! This virtual handler is called when setChecked() was called, unless it was called from within nextCheckState(). It allows subclasses to reset their intermediate button states.  \sa nextCheckState()  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Use QAbstractButton(QWidget *) instead.      Call setObjectName() if you want to specify an object name, and     setParent() if you want to set the window flags. */
end_comment
begin_constructor
DECL|function|QAbstractButton
name|QAbstractButton
...
end_constructor
begin_comment
comment|/*! \fn bool QAbstractButton::isOn() const      Use isChecked() instead. */
end_comment
begin_comment
comment|/*!     \fn QPixmap *QAbstractButton::pixmap() const      This compatibility function always returns 0.      Use icon() instead. */
end_comment
begin_comment
comment|/*! \fn void QAbstractButton::setPixmap(const QPixmap&p)      Use setIcon() instead. */
end_comment
begin_comment
comment|/*! \fn void QAbstractButton::setIconSet(const QIcon&icon)      Use setIcon() instead. */
end_comment
begin_comment
comment|/*! \fn void QAbstractButton::setOn(bool b)      Use setChecked() instead. */
end_comment
begin_comment
comment|/*! \fn bool QAbstractButton::isToggleButton() const      Use isCheckable() instead. */
end_comment
begin_comment
comment|/*!     \fn void QAbstractButton::setToggleButton(bool b)      Use setCheckable() instead. */
end_comment
begin_comment
comment|/*! \fn void QAbstractButton::setAccel(const QKeySequence&key)      Use setShortcut() instead. */
end_comment
begin_comment
comment|/*! \fn QKeySequence QAbstractButton::accel() const      Use shortcut() instead. */
end_comment
begin_endif
endif|#
directive|endif
