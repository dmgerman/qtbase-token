...
ifndef|#
directive|ifndef
name|QABSTRACTPLATFORMMENUBAR_P_H
end_ifndef
begin_define
...
value|"com.nokia.qt.QPlatformMenuBarFactoryInterface"
end_define
begin_macro
DECL|function|Q_DECLARE_INTERFACE
name|Q_DECLARE_INTERFACE
argument_list|(
argument|QPlatformMenuBarFactoryInterface
argument_list|,
argument|QPlatformMenuBarFactoryInterface_iid
argument_list|)
end_macro
begin_comment
...
end_endif
begin_comment
comment|// QABSTRACTPLATFORMMENUBAR_P_H
end_comment
end_unit
