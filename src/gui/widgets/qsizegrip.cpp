...
end_ifdef
begin_comment
comment|/*!     \obsolete      Constructs a resize corner with the given \a name, as a child     widget of the given \a parent. */
end_comment
begin_constructor
DECL|function|QSizeGrip
name|QSizeGrip
