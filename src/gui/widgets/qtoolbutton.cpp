...
end_ifdef
begin_comment
comment|/*!     Constructs an empty tool button called \a name, with parent \a     parent. */
end_comment
begin_constructor
DECL|function|QToolButton
name|QToolButton
...
end_constructor
begin_comment
comment|/*!     Constructs a tool button called \a name, that is a child of \a     parent.      The tool button will display the given \a icon, with its text     label and tool tip set to \a textLabel and its status bar message     set to \a statusTip. It will be connected to the \a slot in     object \a receiver. */
end_comment
begin_constructor
DECL|function|QToolButton
name|QToolButton
...
end_function
begin_comment
comment|/*!   \obsolete    Use setIcon() instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*! \overload     \obsolete    Since Qt 3.0, QIcon contains both the On and Off icons.    For ease of porting, this function ignores the \a on parameter and   returns the \l{QAbstractButton::icon} {icon} property. If you relied   on the \a on parameter, you probably want to update your code to use   the QIcon On/Off mechanism. */
end_comment
begin_function
...
end_ifdef
begin_comment
comment|/*!     \fn void QToolButton::setPopupDelay(int delay)      Use the style hint QStyle::SH_ToolButton_PopupDelay instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Use the style hint QStyle::SH_ToolButton_PopupDelay instead. */
end_comment
begin_function
