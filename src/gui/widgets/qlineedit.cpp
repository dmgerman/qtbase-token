...
end_ifdef
begin_comment
comment|/*!     Constructs a line edit with no text.      The maximum text length is set to 32767 characters.      The \a parent and \a name arguments are sent to the QWidget constructor.      \sa setText(), setMaxLength() */
end_comment
begin_constructor
DECL|function|QLineEdit
name|QLineEdit
...
end_constructor
begin_comment
comment|/*!     Constructs a line edit containing the text \a contents.      The cursor position is set to the end of the line and the maximum     text length to 32767 characters.      The \a parent and \a name arguments are sent to the QWidget     constructor.      \sa text(), setMaxLength() */
end_comment
begin_constructor
DECL|function|QLineEdit
name|QLineEdit
...
end_ifdef
begin_comment
comment|/*! \obsolete      Use setText(), setCursorPosition() and setSelection() instead. */
end_comment
begin_function
...
parameter_list|)
block|{
comment|// The suggested functions above in the docs don't seem to validate,
comment|// below code tries to mimic previous behaviour.
name|QString
name|oldText
init|=
name|text
...
expr_stmt|;
block|}
comment|//setSelection also set the position
name|setSelection
argument_list|(
name|selstart
argument_list|,
...
end_ifdef
begin_comment
comment|/*!     \fn void QLineEdit::lostFocus()      This signal is emitted when the line edit has lost focus.      Use editingFinished() instead     \sa editingFinished(), returnPressed() */
end_comment
begin_comment
comment|/*!     Use isModified() instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Use setModified()  or setText(). */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     There exists no equivalent functionality in Qt 4. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Use selectedText() and selectionStart() instead. */
end_comment
begin_function
