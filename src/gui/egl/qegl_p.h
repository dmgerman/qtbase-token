...
end_if
begin_comment
comment|// If<EGL/egl.h> included<X11/Xlib.h>, then the global namespace
end_comment
begin_comment
comment|// may have been polluted with X #define's.  The following makes sure
end_comment
begin_comment
comment|// the X11 headers were included properly and then cleans things up.
end_comment
begin_include
include|#
directive|include
...
warning|#
directive|warning
literal|"EGL_KHR_image is defined"
end_warning
begin_else
else|#
directive|else
...
warning|#
directive|warning
literal|"EGL_KHR_image is NOT defined"
end_warning
begin_endif
endif|#
directive|endif
...
warning|#
directive|warning
literal|"EGL_KHR_image_base is defined"
end_warning
begin_else
else|#
directive|else
...
warning|#
directive|warning
literal|"EGL_KHR_image_base is NOT defined"
end_warning
begin_endif
endif|#
directive|endif
...
warning|#
directive|warning
literal|"EGL_EGLEXT_PROTOTYPES is defined"
end_warning
begin_else
else|#
directive|else
...
warning|#
directive|warning
literal|"EGL_EGLEXT_PROTOTYPES NOT not defined"
end_warning
begin_endif
endif|#
directive|endif
...
end_ifdef
begin_comment
comment|//symbian version of eglext.h differs from the khronos reference
end_comment
begin_typedef
