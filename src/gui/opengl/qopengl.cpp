...
specifier|inline
name|QString
name|driverDescriptionKey
parameter_list|()
block|{
return|return
name|QStringLiteral
argument_list|(
literal|"driver_description"
argument_list|)
return|;
block|}
end_function
...
comment|// found in os.version and driver_version.
...
literal|false
return|;
comment|// release is a list of Windows versions where the rule should match
if|if
condition|(
operator|!
name|release
