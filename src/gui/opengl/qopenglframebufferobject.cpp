...
expr_stmt|;
block|}
comment|// On GLES 2.0 multisampled framebuffers are available through vendor-specific extensions
specifier|const
name|bool
name|msaaES2
init|=
...
directive|ifdef
name|GL_RGBA8_OES
comment|// Correct the internal format used by the render buffer when using ES with extensions
if|if
condition|(
name|msaaES2
operator|&&
