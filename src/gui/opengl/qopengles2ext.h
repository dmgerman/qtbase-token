...
end_endif
begin_comment
comment|/* $Revision: 20771 $ on $Date:: 2013-03-05 18:53:24 -0800 #$ */
end_comment
begin_ifdef
ifdef|#
directive|ifdef
...
value|0x81A5
comment|/* reuse GL_DEPTH_COMPONENT24_OES */
comment|/* reuse GL_DEPTH24_STENCIL8_OES */
comment|/* reuse GL_DEPTH_COMPONENT32_OES */
...
name|GL_RGB565_OES
value|0x8D62
comment|/* reuse GL_RGB8_OES */
comment|/* reuse GL_RGBA8_OES */
comment|/* reuse GL_RGB10_EXT */
comment|/* reuse GL_RGB10_A2_EXT */
endif|#
directive|endif
...
name|GL_QUERY
value|0x82E3
comment|/* PROGRAM_PIPELINE only in GL */
DECL|macro|GL_SAMPLER
define|#
directive|define
name|GL_SAMPLER
value|0x82E6
comment|/* DISPLAY_LIST only in GL */
...
directive|endif
comment|/*------------------------------------------------------------------------*  * KHR extension functions  *------------------------------------------------------------------------*/
ifndef|#
directive|ifndef
name|GL_KHR_debug
...
function_decl|(
name|GL_APIENTRYP
name|PFNGLDEBUGMESSAGECONTROLPROC
function_decl|)
parameter_list|(
name|GLenum
name|source
...
function_decl|(
name|GL_APIENTRYP
name|PFNGLDEBUGMESSAGEINSERTPROC
function_decl|)
parameter_list|(
name|GLenum
name|source
...
function_decl|(
name|GL_APIENTRYP
name|PFNGLDEBUGMESSAGECALLBACKPROC
function_decl|)
parameter_list|(
name|GLDEBUGPROC
name|callback
...
function_decl|(
name|GL_APIENTRYP
name|PFNGLGETDEBUGMESSAGELOGPROC
function_decl|)
parameter_list|(
name|GLuint
name|count
...
function_decl|(
name|GL_APIENTRYP
name|PFNGLGETOBJECTPTRLABELPROC
function_decl|)
parameter_list|(
specifier|const
name|void
...
function_decl|(
name|GL_APIENTRYP
name|PFNDRAWARRAYSINSTANCEDNVPROC
function_decl|)
parameter_list|(
name|GLenum
name|mode
...
function_decl|(
name|GL_APIENTRYP
name|PFNDRAWELEMENTSINSTANCEDNVPROC
function_decl|)
parameter_list|(
name|GLenum
name|mode
...
function_decl|(
name|GL_APIENTRYP
name|PFNRENDERBUFFERSTORAGEMULTISAMPLENVPROC
function_decl|)
parameter_list|(
name|GLenum
name|target
...
function_decl|(
name|GL_APIENTRYP
name|PFNVERTEXATTRIBDIVISORNVPROC
function_decl|)
parameter_list|(
name|GLuint
name|index
