...
name|ctx
decl_stmt|;
comment|// Draw pixmaps that are really images as images since drawImage has
comment|// better handling of non-default image formats.
if|if
condition|(
name|pixmap
operator|.
...
decl_stmt|;
comment|// Use specialized bind for formats we have specialized shaders for.
switch|switch
condition|(
name|image
operator|.
