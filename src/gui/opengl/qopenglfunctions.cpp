...
end_comment
begin_comment
comment|// Functions part of the OpenGL ES 3.0+ standard need special handling. These,
end_comment
begin_comment
comment|// just like the 2.0 functions, are not guaranteed to be resolvable via
end_comment
begin_comment
comment|// eglGetProcAddress or similar. Calling them directly is, unlike the 2.0
end_comment
begin_comment
comment|// functions, not feasible because one may build the binaries on a GLES3-capable
end_comment
begin_comment
comment|// system and then deploy on a GLES2-only system that does not have these
end_comment
begin_comment
comment|// symbols. Until ES3 gets universally available, they have to be dlsym'ed.
end_comment
begin_macro
name|Q_GLOBAL_STATIC
argument_list|(
...
name|qFatal
argument_list|(
literal|"OpenGL ES 3.0 entry points not found"
argument_list|)
expr_stmt|;
block|}
else|else
