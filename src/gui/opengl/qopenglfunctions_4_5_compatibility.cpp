...
end_macro
begin_comment
comment|/*!     \class QOpenGLFunctions_4_5_Compatibility     \inmodule QtGui     \since 5.5     \wrapper     \brief The QOpenGLFunctions_4_5_Compatibility class provides all functions for OpenGL 4.5 compatibility profile.      This class is a wrapper for functions from OpenGL 4.5 compatibility profile.     See reference pages on \l {http://www.opengl.org/sdk/docs/}{opengl.org}     for function documentation.      \sa QAbstractOpenGLFunctions */
end_comment
begin_constructor
DECL|function|QOpenGLFunctions_4_5_Compatibility
