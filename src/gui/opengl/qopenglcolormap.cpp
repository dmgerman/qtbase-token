...
end_decl_stmt
begin_comment
comment|/*!     Construct a QOpenGLColormap. */
end_comment
begin_constructor
DECL|function|QOpenGLColormap
name|QOpenGLColormap
operator|::
name|QOpenGLColormap
parameter_list|()
...
end_constructor
begin_comment
comment|/*!     Dereferences the QOpenGLColormap and deletes it if this was the last     reference to it. */
end_comment
begin_destructor
DECL|function|~QOpenGLColormap
name|QOpenGLColormap
...
end_function
begin_comment
comment|/*!     Assign a shallow copy of \a map to this QOpenGLColormap. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn void QOpenGLColormap::detach()     \internal      Detaches this QOpenGLColormap from the shared block. */
end_comment
begin_function
...
argument_list|()
argument_list|,
literal|"QOpenGLColormap::setEntries"
argument_list|,
...
end_function
begin_comment
comment|/*!     Returns true if the colormap is empty or it is not in use     by a QOpenGLWidget; otherwise returns false.      A colormap with no color values set is considered to be empty.     For historical reasons, a colormap that has color values set     but which is not in use by a QOpenGLWidget is also considered empty.      Compare size() with zero to determine if the colormap is empty     regardless of whether it is in use by a QOpenGLWidget or not.      \sa size() */
end_comment
begin_function
