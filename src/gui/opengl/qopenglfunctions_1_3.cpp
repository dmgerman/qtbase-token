...
end_macro
begin_comment
comment|/*!     \class QOpenGLFunctions_1_3     \inmodule QtGui     \since 5.1     \wrapper     \brief The QOpenGLFunctions_1_3 class provides all functions for OpenGL 1.3 specification.      This class is a wrapper for functions from OpenGL 1.3 specification.     See reference pages on \l {http://www.opengl.org/sdk/docs/}{opengl.org}     for function documentation.      \sa QAbstractOpenGLFunctions */
end_comment
begin_constructor
