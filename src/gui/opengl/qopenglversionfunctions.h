...
define|#
directive|define
name|QT_OPENGL_1_2_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, CopyTexSubImage3D, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)) \     F(void, TexSubImage3D, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels)) \     F(void, TexImage3D, (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels)) \     F(void, DrawRangeElements, (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices)) \     F(void, BlendEquation, (GLenum mode)) \     F(void, BlendColor, (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)) \      QT_OPENGL_DECLARE(QT_OPENGL_1_2_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
define|#
directive|define
name|QT_OPENGL_1_3_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, GetCompressedTexImage, (GLenum target, GLint level, GLvoid *img)) \     F(void, CompressedTexSubImage1D, (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data)) \     F(void, CompressedTexSubImage2D, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data)) \     F(void, CompressedTexSubImage3D, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data)) \     F(void, CompressedTexImage1D, (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data)) \     F(void, CompressedTexImage2D, (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data)) \     F(void, CompressedTexImage3D, (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data)) \     F(void, SampleCoverage, (GLfloat value, GLboolean invert)) \     F(void, ActiveTexture, (GLenum texture)) \      QT_OPENGL_DECLARE(QT_OPENGL_1_3_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
define|#
directive|define
name|QT_OPENGL_1_5_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, GetBufferPointerv, (GLenum target, GLenum pname, GLvoid* *params)) \     F(void, GetBufferParameteriv, (GLenum target, GLenum pname, GLint *params)) \     F(GLboolean, UnmapBuffer, (GLenum target)) \     F(GLvoid*, MapBuffer, (GLenum target, GLenum access)) \     F(void, GetBufferSubData, (GLenum target, GLintptr offset, GLsizeiptr size, GLvoid *data)) \     F(void, BufferSubData, (GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data)) \     F(void, BufferData, (GLenum target, GLsizeiptr size, const GLvoid *data, GLenum usage)) \     F(GLboolean, IsBuffer, (GLuint buffer)) \     F(void, GenBuffers, (GLsizei n, GLuint *buffers)) \     F(void, DeleteBuffers, (GLsizei n, const GLuint *buffers)) \     F(void, BindBuffer, (GLenum target, GLuint buffer)) \     F(void, GetQueryObjectuiv, (GLuint id, GLenum pname, GLuint *params)) \     F(void, GetQueryObjectiv, (GLuint id, GLenum pname, GLint *params)) \     F(void, GetQueryiv, (GLenum target, GLenum pname, GLint *params)) \     F(void, EndQuery, (GLenum target)) \     F(void, BeginQuery, (GLenum target, GLuint id)) \     F(GLboolean, IsQuery, (GLuint id)) \     F(void, DeleteQueries, (GLsizei n, const GLuint *ids)) \     F(void, GenQueries, (GLsizei n, GLuint *ids)) \      QT_OPENGL_DECLARE(QT_OPENGL_1_5_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
define|#
directive|define
name|QT_OPENGL_2_1_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, UniformMatrix4x3fv, (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)) \     F(void, UniformMatrix3x4fv, (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)) \     F(void, UniformMatrix4x2fv, (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)) \     F(void, UniformMatrix2x4fv, (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)) \     F(void, UniformMatrix3x2fv, (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)) \     F(void, UniformMatrix2x3fv, (GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)) \      QT_OPENGL_DECLARE(QT_OPENGL_2_1_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
define|#
directive|define
name|QT_OPENGL_4_4_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, BindVertexBuffers, (GLuint first, GLsizei count, const GLuint *buffers, const GLintptr *offsets, const GLsizei *strides)) \     F(void, BindImageTextures, (GLuint first, GLsizei count, const GLuint *textures)) \     F(void, BindSamplers, (GLuint first, GLsizei count, const GLuint *samplers)) \     F(void, BindTextures, (GLuint first, GLsizei count, const GLuint *textures)) \     F(void, BindBuffersRange, (GLenum target, GLuint first, GLsizei count, const GLuint *buffers, const GLintptr *offsets, const GLsizeiptr *sizes)) \     F(void, BindBuffersBase, (GLenum target, GLuint first, GLsizei count, const GLuint *buffers)) \     F(void, ClearTexSubImage, (GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *data)) \     F(void, ClearTexImage, (GLuint texture, GLint level, GLenum format, GLenum type, const void *data)) \     F(void, BufferStorage, (GLenum target, GLsizeiptr size, const void *data, GLbitfield flags)) \      QT_OPENGL_DECLARE(QT_OPENGL_4_4_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
define|#
directive|define
name|QT_OPENGL_2_0_DEPRECATED_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, VertexAttrib4usv, (GLuint index, const GLushort *v)) \     F(void, VertexAttrib4uiv, (GLuint index, const GLuint *v)) \     F(void, VertexAttrib4ubv, (GLuint index, const GLubyte *v)) \     F(void, VertexAttrib4sv, (GLuint index, const GLshort *v)) \     F(void, VertexAttrib4s, (GLuint index, GLshort x, GLshort y, GLshort z, GLshort w)) \     F(void, VertexAttrib4iv, (GLuint index, const GLint *v)) \     F(void, VertexAttrib4fv, (GLuint index, const GLfloat *v)) \     F(void, VertexAttrib4f, (GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w)) \     F(void, VertexAttrib4dv, (GLuint index, const GLdouble *v)) \     F(void, VertexAttrib4d, (GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w)) \     F(void, VertexAttrib4bv, (GLuint index, const GLbyte *v)) \     F(void, VertexAttrib4Nusv, (GLuint index, const GLushort *v)) \     F(void, VertexAttrib4Nuiv, (GLuint index, const GLuint *v)) \     F(void, VertexAttrib4Nubv, (GLuint index, const GLubyte *v)) \     F(void, VertexAttrib4Nub, (GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w)) \     F(void, VertexAttrib4Nsv, (GLuint index, const GLshort *v)) \     F(void, VertexAttrib4Niv, (GLuint index, const GLint *v)) \     F(void, VertexAttrib4Nbv, (GLuint index, const GLbyte *v)) \     F(void, VertexAttrib3sv, (GLuint index, const GLshort *v)) \     F(void, VertexAttrib3s, (GLuint index, GLshort x, GLshort y, GLshort z)) \     F(void, VertexAttrib3fv, (GLuint index, const GLfloat *v)) \     F(void, VertexAttrib3f, (GLuint index, GLfloat x, GLfloat y, GLfloat z)) \     F(void, VertexAttrib3dv, (GLuint index, const GLdouble *v)) \     F(void, VertexAttrib3d, (GLuint index, GLdouble x, GLdouble y, GLdouble z)) \     F(void, VertexAttrib2sv, (GLuint index, const GLshort *v)) \     F(void, VertexAttrib2s, (GLuint index, GLshort x, GLshort y)) \     F(void, VertexAttrib2fv, (GLuint index, const GLfloat *v)) \     F(void, VertexAttrib2f, (GLuint index, GLfloat x, GLfloat y)) \     F(void, VertexAttrib2dv, (GLuint index, const GLdouble *v)) \     F(void, VertexAttrib2d, (GLuint index, GLdouble x, GLdouble y)) \     F(void, VertexAttrib1sv, (GLuint index, const GLshort *v)) \     F(void, VertexAttrib1s, (GLuint index, GLshort x)) \     F(void, VertexAttrib1fv, (GLuint index, const GLfloat *v)) \     F(void, VertexAttrib1f, (GLuint index, GLfloat x)) \     F(void, VertexAttrib1dv, (GLuint index, const GLdouble *v)) \     F(void, VertexAttrib1d, (GLuint index, GLdouble x)) \      QT_OPENGL_DECLARE(QT_OPENGL_2_0_DEPRECATED_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
define|#
directive|define
name|QT_OPENGL_3_3_DEPRECATED_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, SecondaryColorP3uiv, (GLenum type, const GLuint *color)) \     F(void, SecondaryColorP3ui, (GLenum type, GLuint color)) \     F(void, ColorP4uiv, (GLenum type, const GLuint *color)) \     F(void, ColorP4ui, (GLenum type, GLuint color)) \     F(void, ColorP3uiv, (GLenum type, const GLuint *color)) \     F(void, ColorP3ui, (GLenum type, GLuint color)) \     F(void, NormalP3uiv, (GLenum type, const GLuint *coords)) \     F(void, NormalP3ui, (GLenum type, GLuint coords)) \     F(void, MultiTexCoordP4uiv, (GLenum texture, GLenum type, const GLuint *coords)) \     F(void, MultiTexCoordP4ui, (GLenum texture, GLenum type, GLuint coords)) \     F(void, MultiTexCoordP3uiv, (GLenum texture, GLenum type, const GLuint *coords)) \     F(void, MultiTexCoordP3ui, (GLenum texture, GLenum type, GLuint coords)) \     F(void, MultiTexCoordP2uiv, (GLenum texture, GLenum type, const GLuint *coords)) \     F(void, MultiTexCoordP2ui, (GLenum texture, GLenum type, GLuint coords)) \     F(void, MultiTexCoordP1uiv, (GLenum texture, GLenum type, const GLuint *coords)) \     F(void, MultiTexCoordP1ui, (GLenum texture, GLenum type, GLuint coords)) \     F(void, TexCoordP4uiv, (GLenum type, const GLuint *coords)) \     F(void, TexCoordP4ui, (GLenum type, GLuint coords)) \     F(void, TexCoordP3uiv, (GLenum type, const GLuint *coords)) \     F(void, TexCoordP3ui, (GLenum type, GLuint coords)) \     F(void, TexCoordP2uiv, (GLenum type, const GLuint *coords)) \     F(void, TexCoordP2ui, (GLenum type, GLuint coords)) \     F(void, TexCoordP1uiv, (GLenum type, const GLuint *coords)) \     F(void, TexCoordP1ui, (GLenum type, GLuint coords)) \     F(void, VertexP4uiv, (GLenum type, const GLuint *value)) \     F(void, VertexP4ui, (GLenum type, GLuint value)) \     F(void, VertexP3uiv, (GLenum type, const GLuint *value)) \     F(void, VertexP3ui, (GLenum type, GLuint value)) \     F(void, VertexP2uiv, (GLenum type, const GLuint *value)) \     F(void, VertexP2ui, (GLenum type, GLuint value)) \      QT_OPENGL_DECLARE(QT_OPENGL_3_3_DEPRECATED_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
define|#
directive|define
name|QT_OPENGL_4_5_DEPRECATED_FUNCTIONS
parameter_list|(
name|F
parameter_list|)
define|\
value|F(void, GetnMinmax, (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values)) \     F(void, GetnHistogram, (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values)) \     F(void, GetnSeparableFilter, (GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, GLvoid *row, GLsizei columnBufSize, GLvoid *column, GLvoid *span)) \     F(void, GetnConvolutionFilter, (GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *image)) \     F(void, GetnColorTable, (GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *table)) \     F(void, GetnPolygonStipple, (GLsizei bufSize, GLubyte *pattern)) \     F(void, GetnPixelMapusv, (GLenum map, GLsizei bufSize, GLushort *values)) \     F(void, GetnPixelMapuiv, (GLenum map, GLsizei bufSize, GLuint *values)) \     F(void, GetnPixelMapfv, (GLenum map, GLsizei bufSize, GLfloat *values)) \     F(void, GetnMapiv, (GLenum target, GLenum query, GLsizei bufSize, GLint *v)) \     F(void, GetnMapfv, (GLenum target, GLenum query, GLsizei bufSize, GLfloat *v)) \     F(void, GetnMapdv, (GLenum target, GLenum query, GLsizei bufSize, GLdouble *v)) \      QT_OPENGL_DECLARE(QT_OPENGL_4_5_DEPRECATED_FUNCTIONS);
block|}
decl_stmt|;
end_decl_stmt
begin_else
