...
literal|"void main() {"
literal|"   if (swizzle) {"
literal|"       fragcolor = texture(textureSampler, uv).bgra;"
literal|"   } else {"
literal|"       fragcolor = texture(textureSampler,uv);"
literal|"   }"
literal|"}"
decl_stmt|;
end_decl_stmt
...
literal|"void main() {"
literal|"   if (swizzle) {"
literal|"       gl_FragColor = texture2D(textureSampler, uv).bgra;"
literal|"   } else {"
literal|"       gl_FragColor = texture2D(textureSampler,uv);"
literal|"   }"
literal|"}"
decl_stmt|;
end_decl_stmt
