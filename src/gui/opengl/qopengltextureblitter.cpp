...
specifier|const
name|char
name|fragment_shader_external_oes
index|[]
init|=
literal|"#extension GL_OES_EGL_image_external : require\n"
literal|"varying highp vec2 uv;"
literal|"uniform samplerExternalOES textureSampler;\n"
literal|"uniform bool swizzle;"
literal|"uniform highp float opacity;"
literal|"void main() {"
literal|"   highp vec4 tmpFragColor = texture2D(textureSampler, uv);"
...
name|qWarning
argument_list|(
literal|"Unsupported texture target 0x%x"
argument_list|,
name|target
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|// Create and bind the VAO, if supported.
name|QOpenGLVertexArrayObject
operator|::
name|Binder
name|vaoBinder
