...
value|"com.trolltech.Qt.QWSMouseHandlerFactoryInterface"
end_define
begin_macro
DECL|function|Q_DECLARE_INTERFACE
name|Q_DECLARE_INTERFACE
argument_list|(
argument|QWSMouseHandlerFactoryInterface
argument_list|,
argument|QWSMouseHandlerFactoryInterface_iid
argument_list|)
end_macro
begin_decl_stmt
name|class
...
end_endif
begin_comment
comment|// QMOUSEDRIVERPLUGIN_QWS_H
end_comment
end_unit
