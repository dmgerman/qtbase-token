...
value|"com.trolltech.Qt.QWSKeyboardHandlerFactoryInterface"
end_define
begin_macro
...
argument_list|,
argument|QWSKeyboardHandlerFactoryInterface_iid
argument_list|)
end_macro
begin_decl_stmt
name|class
...
end_endif
begin_comment
comment|// QKBDDRIVERPLUGIN_QWS_H
end_comment
end_unit
