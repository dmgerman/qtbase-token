...
end_ifdef
begin_comment
comment|/*!     Constructs a new QBoxLayout with direction \a dir and main widget \a     parent. \a parent may not be 0.      The \a margin is the number of pixels between the edge of the     widget and its managed children. The \a spacing is the default     number of pixels between neighboring children. If \a spacing is -1     the value of \a margin is used for \a spacing.      \a name is the internal object name.      \sa direction() */
end_comment
begin_constructor
DECL|function|QBoxLayout
name|QBoxLayout
...
end_constructor
begin_comment
comment|/*!     Constructs a new QBoxLayout called \a name, with direction \a dir,     and inserts it into \a parentLayout.      The \a spacing is the default number of pixels between neighboring     children. If \a spacing is -1, the layout will inherit its     parent's spacing(). */
end_comment
begin_constructor
DECL|function|QBoxLayout
name|QBoxLayout
...
end_constructor
begin_comment
comment|/*!     Constructs a new QBoxLayout called \a name, with direction \a dir.      If \a spacing is -1, the layout will inherit its parent's     spacing(); otherwise \a spacing is used.      You must insert this box into another layout. */
end_comment
begin_constructor
DECL|function|QBoxLayout
name|QBoxLayout
...
end_ifdef
begin_comment
comment|/*!     Constructs a new top-level horizontal box called \a name, with     parent \a parent.      The \a margin is the number of pixels between the edge of the     widget and its managed children. The \a spacing is the default     number of pixels between neighboring children. If \a spacing is -1     the value of \a margin is used for \a spacing. */
end_comment
begin_constructor
DECL|function|QHBoxLayout
name|QHBoxLayout
...
end_constructor
begin_comment
comment|/*!     Constructs a new horizontal box called name \a name and adds it to     \a parentLayout.      The \a spacing is the default number of pixels between neighboring     children. If \a spacing is -1, this QHBoxLayout will inherit its     parent's spacing(). */
end_comment
begin_constructor
DECL|function|QHBoxLayout
name|QHBoxLayout
...
end_constructor
begin_comment
comment|/*!     Constructs a new horizontal box called name \a name. You must add     it to another layout.      The \a spacing is the default number of pixels between neighboring     children. If \a spacing is -1, this QHBoxLayout will inherit its     parent's spacing(). */
end_comment
begin_constructor
DECL|function|QHBoxLayout
name|QHBoxLayout
...
end_ifdef
begin_comment
comment|/*!     Constructs a new top-level vertical box called \a name, with     parent \a parent.      The \a margin is the number of pixels between the edge of the     widget and its managed children. The \a spacing is the default     number of pixels between neighboring children. If \a spacing is -1     the value of \a margin is used for \a spacing. */
end_comment
begin_constructor
DECL|function|QVBoxLayout
name|QVBoxLayout
...
end_constructor
begin_comment
comment|/*!     Constructs a new vertical box called name \a name and adds it to     \a parentLayout.      The \a spacing is the default number of pixels between neighboring     children. If \a spacing is -1, this QVBoxLayout will inherit its     parent's spacing(). */
end_comment
begin_constructor
DECL|function|QVBoxLayout
name|QVBoxLayout
...
end_constructor
begin_comment
comment|/*!     Constructs a new vertical box called name \a name. You must add     it to another layout.      The \a spacing is the default number of pixels between neighboring     children. If \a spacing is -1, this QVBoxLayout will inherit its     parent's spacing(). */
end_comment
begin_constructor
DECL|function|QVBoxLayout
name|QVBoxLayout
