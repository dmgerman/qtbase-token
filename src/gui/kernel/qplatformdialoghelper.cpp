...
end_function
begin_comment
comment|/*!     \since 5.7     \internal     The bool property useDefaultNameFilters indicates that no name filters have been     set or that they are equivalent to \gui{All Files (*)}. If it is true, the     platform can choose to hide the filter combo box.      \sa defaultNameFilterString(). */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.6     \internal     \return The translated default name filter string (\gui{All Files (*)}).     \sa defaultNameFilters(), nameFilters() */
end_comment
begin_function
...
end_function
begin_comment
comment|// Schemes supported by the application
end_comment
begin_function
...
end_function
begin_comment
comment|// Return true if the URL is supported by the filedialog implementation *and* by the application.
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \class QPlatformMessageDialogHelper     \since 5.0     \internal     \ingroup qpa      \brief The QPlatformMessageDialogHelper class allows for platform-specific customization of Message dialogs.  */
end_comment
begin_function
DECL|function|options
specifier|const
