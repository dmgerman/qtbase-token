...
end_ifdef
begin_comment
comment|//should this go somewhere else?
end_comment
begin_include
include|#
directive|include
file|<QtGui/qplatformwindowformat_qpa.h>
end_include
begin_endif
endif|#
directive|endif
...
name|friend
name|bool
name|qt_mac_sendMacEventToWidget
parameter_list|(
name|QWidget
modifier|*
name|widget
...
argument|d_func()
argument_list|,
argument|void _q_delayedDestroy(WId winId)
argument_list|)
endif|#
directive|endif
name|QWidgetData
