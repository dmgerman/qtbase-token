...
argument_list|)
block|;
comment|//    static void reportScreenCount(int count);
specifier|static
name|void
...
argument_list|)
block|;
comment|//    static void reportGeometryChange(int screenIndex);
specifier|static
name|void
...
argument_list|)
block|;
comment|//    static void reportAvailableGeometryChange(int screenIndex);
specifier|static
name|void
