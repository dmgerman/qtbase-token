...
argument_list|)
expr_stmt|;
comment|// FIXME This is an ugly hack if QVariantConstructor fails to build a value it constructs an invalid type
if|if
condition|(
name|Q_UNLIKELY
argument_list|(
...
condition|)
block|{
comment|// TODO we need to clean up variant handlers, so they are replacament, not extension
name|x
operator|->
name|type
operator|=
