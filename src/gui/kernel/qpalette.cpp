...
end_ifndef
begin_function
DECL|function|qt_stream_out_qcolorgroup
name|QDataStream
modifier|&
name|qt_stream_out_qcolorgroup
parameter_list|(
name|QDataStream
modifier|&
name|s
...
end_function
begin_function
DECL|function|qt_stream_in_qcolorgroup
name|QDataStream
modifier|&
name|qt_stream_in_qcolorgroup
parameter_list|(
name|QDataStream
modifier|&
name|s
...
end_comment
begin_comment
comment|/*!     Constructs a palette with the specified \a active, \a disabled and     \a inactive color groups. */
end_comment
begin_constructor
...
end_constructor
begin_function
DECL|function|createColorGroup
name|QColorGroup
name|QPalette
operator|::
...
end_function
begin_comment
comment|/*!    Returns the color group as a QVariant */
end_comment
begin_function
DECL|function|operator QVariant
name|QColorGroup
...
end_comment
begin_comment
comment|/*!     \fn QColorGroup QPalette::normal() const     \obsolete      Returns the active color group. Use active() instead.      Use createColorGroup(Active) instead. */
end_comment
begin_comment
comment|/*!     \fn void QPalette::setNormal(const QColorGroup&colorGroup)      Sets the normal color group to \a colorGroup.      \sa QColorGroup */
end_comment
begin_comment
comment|/*!     \fn QColorGroup QPalette::active() const      Returns the active color group.     \sa QColorGroup */
end_comment
begin_comment
comment|/*!     \fn QColorGroup QPalette::disabled() const      Returns the disabled color group.     \sa QColorGroup */
end_comment
begin_comment
comment|/*!     \fn QColorGroup QPalette::inactive() const      Returns the inactive color group.     \sa QColorGroup */
end_comment
begin_comment
comment|/*!     \fn void QPalette::setActive(const QColorGroup&colorGroup)      Sets the active color group to \a colorGroup.     \sa QColorGroup */
end_comment
begin_comment
comment|/*!     \fn void QPalette::setDisabled(const QColorGroup&colorGroup)      Sets the disabled color group to \a colorGroup.     \sa QColorGroup */
end_comment
begin_comment
comment|/*!     \fn void QPalette::setInactive(const QColorGroup&colorGroup)      Sets the inactive color group.     \sa QColorGroup */
end_comment
begin_comment
comment|/*! \class QColorGroup     \brief The QColorGroup class contains color groups for each widget state.     \compat */
end_comment
begin_comment
comment|/*! \fn QColorGroup::QColorGroup()      Use QPalette() instead. */
end_comment
begin_comment
comment|/*! \fn QColorGroup::QColorGroup(const QBrush&foreground, const QBrush&button, \                                  const QBrush&light, const QBrush&dark, const QBrush&mid, \                                  const QBrush&text, const QBrush&bright_text,                                  const QBrush&base, const QBrush&background)      Use QPalette(\a foreground, \a button, \a light, \a dark, \a mid,     \a text, \a bright_text, \a base, \a background) instead. */
end_comment
begin_comment
comment|/*! \fn QColorGroup::QColorGroup(const QColor&foreground, const QColor&background, \                                  const QColor&light, const QColor&dark, const QColor&mid, \                                  const QColor&text, const QColor&base)      Use QColorGroup(\a foreground, \a background, \a light, \a dark,     \a mid, \a text, \a base) instead. */
end_comment
begin_comment
comment|/*! \fn QColorGroup::QColorGroup(const QColorGroup&other)      Use QPalette(\a other) instead. */
end_comment
begin_comment
comment|/*! \fn QColorGroup::QColorGroup(const QPalette&pal)      Use QPalette(\a pal) instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::foreground() const      Use QPalette::windowText().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::button() const      Use QPalette::button().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::light() const      Use QPalette::light().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::dark() const      Use QPalette::dark().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::mid() const      Use QPalette::mid().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::text() const      Use QPalette::text().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::base() const      Use QPalette::base().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::background() const      Use QPalette::window().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::midlight() const      Use QPalette::midlight().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::brightText() const      Use QPalette::brightText().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::buttonText() const      Use QPalette::buttonText().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::shadow() const      Use QPalette::shadow().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::highlight() const      Use QPalette::highlight().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::highlightedText() const      Use QPalette::highlightedText().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::link() const      Use QPalette::link().color() instead. */
end_comment
begin_comment
comment|/*! \fn const QColor&QColorGroup::linkVisited() const      Use QPalette::linkVisited().color() instead. */
end_comment
begin_comment
comment|/*! \fn QDataStream&operator<<(QDataStream&ds, const QColorGroup&colorGroup)     \relates QColorGroup     \compat */
end_comment
begin_comment
comment|/*! \fn QDataStream&operator>>(QDataStream&ds, QColorGroup&colorGroup)     \relates QColorGroup     \compat */
end_comment
begin_comment
comment|/*! \fn bool QColorGroup::operator==(const QColorGroup&other) const      Returns true if this color group is equal to \a other; otherwise     returns false. */
end_comment
begin_comment
comment|/*! \fn bool QColorGroup::operator!=(const QColorGroup&other) const      Returns true if this color group is not equal to \a other;     otherwise returns false. */
end_comment
begin_macro
