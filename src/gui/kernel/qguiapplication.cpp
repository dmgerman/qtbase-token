...
include|#
directive|include
file|<QtGui/qplatforminputcontext_qpa.h>
end_include
begin_include
include|#
directive|include
...
name|qWarning
argument_list|(
literal|"No platform plugin argument was specified, defaulting to \"%s\"."
argument_list|,
name|qPrintable
argument_list|(
name|defaultPlatform
...
name|qFatal
argument_list|(
literal|"No platform plugin argument was specified and the default plugin \"%s\" is not available"
argument_list|,
name|qPrintable
argument_list|(
name|defaultPlatform
...
end_function
begin_comment
comment|/*!     Sets whether Qt should use the system's standard colors, fonts, etc., to     \a on. By default, this is true.      This function must be called before creating the QGuiApplication object, like     this:      \snippet doc/src/snippets/code/src_gui_kernel_qapplication.cpp 6      \sa desktopSettingsAware() */
end_comment
begin_function
