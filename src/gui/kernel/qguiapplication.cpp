...
block|}
block|}
comment|// If the window is not found on primary virtual desktop, find it on all screens
comment|// except the first which was for sure in the previous loop. Some other screens
comment|// may repeat. Find only when there is more than one virtual desktop.
if|if
condition|(
operator|!
name|windowScreen
