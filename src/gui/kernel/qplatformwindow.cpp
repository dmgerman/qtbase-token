...
end_function
begin_comment
comment|/*!     Returns a size with both dimensions bounded to [0, QWINDOWSIZE_MAX] */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the QWindow minimum size. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the QWindow maximum size. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the QWindow base size. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the QWindow size increment. */
end_comment
begin_function
...
name|increment
return|;
comment|// Normalize the increment. If not set the increment can be
comment|// (-1, -1) or (0, 0). Make that (1, 1) which is scalable.
if|if
condition|(
name|increment
operator|.
...
end_function
begin_comment
comment|/*!     Returns the QWindow geometry. */
end_comment
begin_function
