...
end_constructor
begin_comment
comment|/*!   Constructs a new QOpenGLWindow with the given \a parent and \a updateBehavior. The QOpenGLWindow's context will share with \a shareContext.    \sa QOpenGLWindow::UpdateBehavior shareContext */
end_comment
begin_constructor
DECL|function|QOpenGLWindow
name|QOpenGLWindow
...
end_function
begin_comment
comment|/*!   \return The QOpenGLContext requested to be shared with this window's QOpenGLContext. */
end_comment
begin_function
