...
namespace|namespace
block|{
comment|// Make protected QObject::staticQtMetaObject accessible for formatting enums.
...
name|char
modifier|*
name|nativeGestureTypeToString
parameter_list|(
name|Qt
operator|::
name|NativeGestureType
...
name|indexOfEnumerator
argument_list|(
literal|"TabletDevice"
argument_list|)
decl_stmt|;
specifier|static
specifier|const
name|int
name|pointerTypeEnumIdx
init|=
name|QTabletEvent
operator|::
name|staticMetaObject
