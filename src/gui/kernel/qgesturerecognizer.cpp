...
end_function
begin_comment
comment|/*!     Destroys the gesture recognizer. */
end_comment
begin_destructor
DECL|function|~QGestureRecognizer
name|QGestureRecognizer
...
end_destructor
begin_comment
comment|/*!     This function is called by Qt to create a new QGesture object for the     given \a target (QWidget or QGraphicsObject).      Reimplement this function to create a custom QGesture-derived gesture     object if necessary.      The application takes ownership of the created gesture object. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     This function is called by the framework to reset a given \a gesture.      Reimplement this function to implement additional requirements for custom QGesture     objects. This may be necessary if you implement a custom QGesture whose properties     need special handling when the gesture is reset. */
end_comment
begin_function
DECL|function|reset
name|void
...
end_function
begin_comment
comment|/*!     Unregisters all gesture recognizers of the specified \a type.      \sa registerRecognizer() */
end_comment
begin_function
