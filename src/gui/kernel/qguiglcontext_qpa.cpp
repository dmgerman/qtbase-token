...
end_function
begin_comment
comment|/*!   Attempts to create the GL context with the desired parameters.    Returns true if the native context was successfully created and is ready to be used.d */
end_comment
begin_function
