...
comment|/*!     \fn QVector2D::QVector2D()      Constructs a null vector, i.e. with coordinates (0, 0). */
comment|/*!     \fn QVector2D::QVector2D(Qt::Initialization)     \since 5.5     \internal      Constructs a vector without initializing the contents. */
...
end_function
begin_comment
comment|/*!     \since 5.1      Returns the distance from this vertex to a point defined by     the vertex \a point.      \sa distanceToLine() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.1      Returns the distance that this vertex is from a line defined     by \a point and the unit vector \a direction.      If \a direction is a null vector, then it does not define a line.     In that case, the distance from \a point to this vertex is returned.      \sa distanceToPoint() */
end_comment
begin_function
