...
end_comment
begin_comment
comment|/*!     \fn QVector3D&QVector3D::operator/=(const QVector3D&vector)     \since 5.5      Divides the components of this vector by the corresponding     components in \a vector.      \sa operator*=() */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     \since 5.5      Returns the window coordinates of this vector initially in object/model     coordinates using the model view matrix \a modelView, the projection matrix     \a projection and the viewport dimensions \a viewport.      When transforming from clip to normalized space, a division by the w     component on the vector components takes place. To prevent dividing by 0 if     w equals to 0, it is set to 1.      \note the returned y coordinates are in OpenGL orientation. OpenGL expects     the bottom to be 0 whereas for Qt top is 0.      \sa unproject()  */
end_comment
begin_function
...
end_comment
begin_comment
comment|/*!     \fn const QVector3D operator/(const QVector3D&vector, const QVector3D&divisor)     \relates QVector3D     \since 5.5      Returns the QVector3D object formed by dividing components of the given     \a vector by a respective components of the given \a divisor.      \sa QVector3D::operator/=() */
end_comment
begin_comment
