...
comment|/*!     \fn bool QGenericMatrix::isIdentity() const      Returns \c true if this matrix is the identity; false otherwise.      \sa setToIdentity() */
...
comment|/*!     \fn bool QGenericMatrix::operator==(const QGenericMatrix<N, M, T>& other) const      Returns \c true if this matrix is identical to \a other; false otherwise. */
comment|/*!     \fn bool QGenericMatrix::operator!=(const QGenericMatrix<N, M, T>& other) const      Returns \c true if this matrix is not identical to \a other; false otherwise. */
