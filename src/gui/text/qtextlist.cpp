...
end_comment
begin_comment
comment|/*!     \fn bool QTextList::isEmpty() const     \obsolete      Returns \c true if the list has no items; otherwise returns \c false.      \b{Note:} Empty lists are automatically deleted by the QTextDocument that owns     them.      \sa count() */
end_comment
begin_comment
comment|/*! \internal  */
end_comment
