...
name|QT_NO_FREETYPE
argument_list|)
comment|// What's behind QFontEngine::FaceData::user_data isn't compatible between CoreText and
comment|// FreeType font engines - specifically functions in hb-coretext.cc would run into undefined
comment|// behavior with data from the FreeType engine. The OpenType shaper works with that engine.
if|if
condition|(
name|actualFontEngine
operator|->
