...
argument_list|(
argument|QVector<QRgb>
argument_list|,
argument|qt_grayPalette
argument_list|)
end_macro
begin_function
...
condition|)
return|return;
comment|// If there are other references to the engine, keep it around and keep the reference
if|if
condition|(
name|fontEngine
operator|->
