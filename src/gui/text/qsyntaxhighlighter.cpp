...
end_comment
begin_comment
comment|/*!     Constructs a QSyntaxHighlighter with the given \a parent. */
end_comment
begin_constructor
...
end_constructor
begin_comment
comment|/*!     Constructs a QSyntaxHighlighter and installs it on \a parent 's     QTextDocument. The specified QTextEdit also becomes the owner of     the QSyntaxHighlighter. */
end_comment
begin_constructor
DECL|function|QSyntaxHighlighter
name|QSyntaxHighlighter
