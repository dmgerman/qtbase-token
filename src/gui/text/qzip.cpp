...
literal|0x10
block|,
comment|// FILE_ATTRIBUTE_DIRECTORY
DECL|enumerator|File
name|File
init|=
literal|0x80
block|,
comment|// FILE_ATTRIBUTE_NORMAL
...
literal|0x01
block|,
comment|// FILE_ATTRIBUTE_READONLY
...
case|:
default|default:
comment|// ### just for the case; should we warn?
name|fileInfo
operator|.
name|isFile
operator|=
