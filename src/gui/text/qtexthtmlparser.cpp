...
block|}
block|}
comment|// Only override line height type if specified in same node
if|if
condition|(
name|hasOwnLineHeightType
condition|)
...
condition|)
break|break;
comment|// Delibrate fall through
case|case
name|Html_big
case|:
case|case
...
literal|"link"
expr_stmt|;
comment|// Ensure that our own style is taken into consideration
name|decls
operator|=
name|standardDeclarationForNode
argument_list|(
