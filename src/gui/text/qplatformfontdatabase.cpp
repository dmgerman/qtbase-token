...
end_function
begin_comment
comment|/*!     \fn QStringList QPlatformFontDatabase::fallbacksForFamily(const QString&family, QFont::Style style, QFont::StyleHint styleHint, QChar::Script script) const      Returns a list of alternative fonts for the specified \a family and     \a style and \a script using the \a styleHint given.      Default implementation returns a list of fonts for which \a style and \a script support     has been reported during the font database population. */
end_comment
begin_comment
comment|// implemented in qfontdatabase.cpp
end_comment
begin_comment
