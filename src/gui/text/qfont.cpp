...
directive|endif
comment|// Q_WS_X11 || Q_WS_WIN || Q_WS_MAC
block|}
end_destructor
begin_comment
...
end_function
begin_comment
comment|/*!     Constructs a font object that uses the application's default font.      \sa QApplication::setFont(), QApplication::font() */
end_comment
begin_constructor
DECL|function|QFont
name|QFont
...
parameter_list|)
block|{
comment|/* This could be optimized but the code becomes much more complex if we want to handle multi      * font engines and it is probably not worth it. Therefore we just clear the entire font cache.      */
name|Q_UNUSED
argument_list|(
name|_fontName
argument_list|)
...
name|FC_DEBUG
argument_list|(
literal|"QFontCache::cleanupPrinterFonts"
argument_list|)
expr_stmt|;
block|{
name|FC_DEBUG
