...
argument_list|)
expr_stmt|;
comment|// Prevent clipping the left side of the list decorator (on left to
comment|// right layouts) and clipping the right side of the list
comment|// decorator (on right to left layouts).
if|if
condition|(
operator|(
name|r
