...
literal|nullptr
decl_stmt|;
comment|// work-around for (at least) MSVC 2012 emitting
comment|// warning C4100 for its own header<algorithm>
comment|// when passing nullptr directly to std::remove
name|fd
operator|->
name|floats
operator|.
