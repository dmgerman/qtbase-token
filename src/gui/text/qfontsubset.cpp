...
literal|'.'
condition|)
comment|// fix broken PS fonts returning .notdef for many glyphs
name|name
index|[
literal|0
index|]
...
end_function
begin_comment
comment|// ------------------ Type 1 generation ---------------------------
end_comment
begin_comment
comment|// needs at least 6 bytes of space in tmp
end_comment
begin_function
...
literal|0
expr_stmt|;
comment|//     qDebug("encodeNumber: %d -> '%s'", num, ret);
return|return
name|ret
return|;
block|}
...
parameter_list|)
block|{
comment|// the charstring commands we need
specifier|const
name|char
modifier|*
name|hsbw
...
argument_list|)
decl_stmt|;
comment|//     qDebug("--- charstring");
comment|// first of all add lsb and width to the charstring using the hsbw command
name|QByteArray
name|charstring
decl_stmt|;
name|charstring
...
condition|)
block|{
comment|//             qDebug("closepath %s", closepath);
name|charstring
operator|+=
name|closepath
expr_stmt|;
...
name|vertical
expr_stmt|;
comment|//                 qDebug("vertical");
block|}
comment|//             qDebug("moveto/lineto %s", (elm.type == QPainterPath::MoveToElement ? moveto[type] : lineto[type]));
name|charstring
operator|+=
operator|(
name|elm
...
operator|<<
literal|" findfont\n"
literal|"0 dict copy dup /NumGlyphs 0 put dup /CMap 256 array put def\n"
expr_stmt|;
block|}
else|else
block|{
...
literal|"/FontType 1\n"
literal|"/PaintType 0\n"
literal|"/FontMatrix [.001 0 0 .001 0 0]\n"
literal|"/FontBBox { 0 0 0 0 }\n"
literal|"/Private<<\n"
literal|"/password 5839\n"
literal|"/MinFeature {16 16}\n"
literal|"/BlueValues []\n"
literal|"/lenIV -1\n"
literal|">>\n"
literal|"/CharStrings<<>>\n"
literal|"/NumGlyphs 0\n"
literal|"/CMap 256 array\n"
literal|">> def\n"
expr_stmt|;
block|}
name|s
