...
name|Holder
block|{
comment|// replace by std::unique_ptr once available
name|void
modifier|*
name|ptr
decl_stmt|;
...
name|font_
decl_stmt|;
comment|// \ NOTE: Declared before m_glyphCaches, so font_, face_
name|mutable
name|Holder
name|face_
decl_stmt|;
comment|// / are destroyed _after_ m_glyphCaches is destroyed.
struct|struct
name|FaceData
block|{
name|void
