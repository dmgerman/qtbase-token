...
end_comment
begin_comment
comment|/*!     \fn void QTextBlockFormat::setLineHeight(qreal height, int heightType)     \since 4.8      This sets the line height for the paragraph to the value in height     which is dependant on heightType, described by the LineHeightTypes enum.      \sa LineHeightTypes, lineHeight(), lineHeightType() */
end_comment
begin_comment
comment|/*!     \fn qreal QTextBlockFormat::lineHeight(qreal scriptLineHeight, qreal scaling) const     \since 4.8      This returns what the height of the lines in the paragraph will be depending     on the given height of the script line and the scaling. The value that is returned     is also dependant on the given LineHeightType of the paragraph as well as the LineHeight     setting that has been set for the paragraph. The scaling is needed for the heights     that include a fixed number of pixels, to scale them appropriately for printing.      \sa LineHeightTypes, setLineHeight(), lineHeightType() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn void QTextListFormat::setNumberPrefix(const QString&numberPrefix)     \since 4.8      Sets the list format's number prefix. This can be used with all     sorted list types. It does not have any effect on unsorted list types.      \sa numberPrefix() */
end_comment
begin_comment
comment|/*!     \fn int QTextListFormat::numberPrefix() const     \since 4.8      Returns the list format's number prefix.      \sa setNumberPrefix() */
end_comment
begin_comment
comment|/*!     \fn void QTextListFormat::setNumberSuffix(const QString&numberSuffix)     \since 4.8      Sets the list format's number suffix. This can be used with all     sorted list types. It does not have any effect on unsorted list types.     The default suffix is ".".      \sa numberSuffix() */
end_comment
begin_comment
