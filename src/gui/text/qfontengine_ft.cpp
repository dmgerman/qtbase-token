...
argument_list|)
decl_stmt|;
comment|// apply our matrix to this, but note that the metrics will not be affected by this.
name|FT_Face
name|face
init|=
name|lockFace
...
condition|)
block|{
comment|// freetype doesn't apply the transformation on the metrics
name|int
name|l
decl_stmt|,
name|r
