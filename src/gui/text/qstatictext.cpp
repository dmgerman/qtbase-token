...
end_comment
begin_comment
comment|/*!     Compares \a other to this QStaticText. Returns \c true if the texts, fonts and text widths     are equal. */
end_comment
begin_function
DECL|function|operator ==
name|bool
...
end_function
begin_comment
comment|/*!     Compares \a other to this QStaticText. Returns \c true if the texts, fonts or maximum sizes     are different. */
end_comment
begin_function
DECL|function|operator !=
name|bool
