...
end_function
begin_comment
comment|/*!     \class QTextLayout::FormatRange     \reentrant      \brief The QTextLayout::FormatRange structure is used to apply extra formatting information     for a specified area in the text layout's content.      \sa QTextLayout::setAdditionalFormats(), QTextLayout::draw() */
end_comment
begin_comment
...
condition|)
break|break;
comment|//             qDebug("at pos %d (in run: %d)", si.position + j, j);
return|return
name|si
operator|.
name|position
