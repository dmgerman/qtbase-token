...
directive|ifndef
name|Q_WS_S60
comment|// Removed the title due to lack of screen estate in small S60 screen.
comment|// The effects are descriptive without a title (strikeout, underline).
name|effects
operator|->
name|setTitle
argument_list|(
...
end_ifdef
begin_comment
comment|// can only have one Cocoa font panel active
end_comment
begin_decl_stmt
