...
argument_list|)
decl_stmt|;
comment|// In S60 layout data, error messages seem to be one third of the screen height (in portrait) minus two.
return|return
name|QSize
argument_list|(
name|smallerDimension
