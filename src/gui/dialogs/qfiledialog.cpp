...
begin_comment
DECL|variable|qt_use_native_dialogs
comment|// for the benefit of testing tools, until we have a proper API
end_comment
begin_endif
endif|#
directive|endif
...
end_destructor
begin_comment
comment|/*!     \since 4.3     Sets the \a urls that are located in the sidebar.      For instance:      \snippet doc/src/snippets/filedialogurls.cpp 0      The file dialog will then look like this:      \image filedialogurls.png      \sa sidebarUrls() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 4.4      Sets the \a filters used in the file dialog.      \snippet doc/src/snippets/code/src_gui_dialogs_qfiledialog.cpp 7 */
end_comment
begin_function
...
end_endif
begin_comment
comment|/*     For Symbian file dialogs */
end_comment
begin_if
if|#
directive|if
...
end_ifdef
begin_comment
comment|/*!     Use selectedFiles() instead.      \oldcode        QString selected = dialog->selectedFile();     \newcode         QStringList files = dialog->selectedFiles();         QString selected;         if (!files.isEmpty())             selected = files[0];     \endcode */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \typedef QFileDialog::Mode      Use QFileDialog::FileMode instead. */
end_comment
begin_comment
comment|/*!     \fn void QFileDialog::setMode(FileMode m)      Use setFileMode() instead. */
end_comment
begin_comment
comment|/*!     \fn FileMode QFileDialog::mode() const      Use fileMode() instead. */
end_comment
begin_comment
comment|/*!     \fn void QFileDialog::setDir(const QString&directory)      Use setDirectory() instead. */
end_comment
begin_comment
comment|/*!     \fn void QFileDialog::setDir( const QDir&directory )      Use setDirectory() instead. */
end_comment
begin_comment
comment|/*!     \fn QStringList QFileDialog::getOpenFileNames(const QString&filter,         const QString&dir, QWidget *parent, const char* name,         const QString&caption, QString *selectedFilter, bool resolveSymlinks)      Use the getOpenFileNames() overload that takes \a parent as the first     argument instead. */
end_comment
begin_comment
comment|/*!     \fn QString QFileDialog::getOpenFileName(const QString&dir,         const QString&filter, QWidget *parent = 0, const char *name,         const QString&caption, QString *selectedFilter, bool resolveSymlinks)      Use the getOpenFileName() overload that takes \a parent as the first     argument instead. */
end_comment
begin_comment
comment|/*!     \fn QString QFileDialog::getSaveFileName(const QString&dir,         const QString&filter, QWidget *parent, const char *name,         const QString&caption, QString *selectedFilter, bool resolveSymlinks)      Use the getSaveFileName() overload that takes \a parent as the first     argument instead. */
end_comment
begin_comment
comment|/*!     \fn QString QFileDialog::getExistingDirectory(const QString&dir,         QWidget *parent, const char *name, const QString&caption,         bool dirOnly, bool resolveSymlinks)      Use the getExistingDirectory() overload that takes \a parent as     the first argument instead. */
end_comment
begin_endif
endif|#
directive|endif
