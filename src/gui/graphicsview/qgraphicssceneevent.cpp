...
end_comment
begin_comment
comment|/*!     \class QGraphicsSceneResizeEvent     \brief The QGraphicsSceneResizeEvent class provides events for widget     resizing in the graphics view framework.     \since 4.4     \ingroup graphicsview-api      A QGraphicsWidget sends itself a QGraphicsSceneResizeEvent immediately     when its geometry changes.      It's similar to QResizeEvent, but its sizes, oldSize() and newSize(), use     QSizeF instead of QSize.      \sa QGraphicsWidget::setGeometry(), QGraphicsWidget::resize() */
end_comment
begin_comment
