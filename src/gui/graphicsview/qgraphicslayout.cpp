...
comment|// ### bug, should be parentItem ?
name|parentLayoutItem
argument_list|()
operator|->
name|updateGeometry
argument_list|()
expr_stmt|;
comment|// bubble up; will set activated to false
comment|// ### too many resizes? maybe we should walk up the chain to the
comment|// ### top-level layouted layoutItem and call activate there.
block|}
end_function
begin_comment
