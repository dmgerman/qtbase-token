...
include|#
directive|include
file|<QtGui/QStyleOptionTitleBar>
end_include
begin_include
include|#
directive|include
file|<QtGui/QGraphicsSceneMouseEvent>
end_include
begin_if
if|#
directive|if
...
expr_stmt|;
block|}
comment|// update tabFocusFirst for oldScene if the item is going to be removed from oldScene
if|if
condition|(
name|newParent
condition|)
...
name|focusPrev
decl_stmt|;
comment|// link last with new chain
name|last
operator|->
name|d_func
argument_list|()
...
name|last
expr_stmt|;
comment|// link last in chain with
name|topLevel
operator|->
name|d_func
argument_list|()
...
block|{
comment|// q is the start of the focus chain
name|n
operator|->
name|d_func
argument_list|()
