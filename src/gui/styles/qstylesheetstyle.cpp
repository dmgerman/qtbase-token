...
name|x
parameter_list|)
value|(static_cast<QWidget *>(x.ptr))
end_define
begin_function
...
name|qWarning
argument_list|(
literal|"Could not parse stylesheet of widget %p"
argument_list|,
name|wid
argument_list|)
expr_stmt|;
...
specifier|static
name|void
name|qt_check_if_internal_widget
parameter_list|(
specifier|const
name|QWidget
modifier|*
...
argument_list|)
decl_stmt|;
comment|// run through the declarations in order
for|for
control|(
name|int
name|i
