...
argument_list|(
argument|QGtkStyleUpdateScheduler
argument_list|,
argument|styleScheduler
argument_list|)
end_macro
begin_decl_stmt
...
name|resolve
argument_list|(
literal|"gdk_drawable_get_depth"
argument_list|)
expr_stmt|;
name|gdk_color_free
operator|=
...
name|resolve
argument_list|(
literal|"gtk_progress_configure"
argument_list|)
expr_stmt|;
name|gtk_range_get_adjustment
operator|=
...
condition|)
block|{
comment|// Due to namespace conflicts with Qt3 and obvious recursion with Qt4,
comment|// we cannot support the GTK_Qt Gtk engine
name|qWarning
argument_list|(
literal|"QGtkStyle cannot be used together with the GTK_Qt engine."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|themeName
decl_stmt|;
comment|// We try to parse the gtkrc file first
comment|// primarily to avoid resolving Gtk functions if
comment|// the KDE 3 "Qt" style is currently in use
name|QString
name|rcPaths
init|=
name|QString
...
name|QLS
argument_list|(
literal|"/desktop/gnome/interface/gtk_theme"
argument_list|)
argument_list|)
expr_stmt|;
return|return
