...
end_function
begin_comment
comment|/*!     \since 5.5      This is an image format-specific function which sets the \a optimize flags when     writing images. For image formats that do not support setting an \a optimize flag,     this value is ignored.      The default is false.      \sa optimizedWrite() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      Returns whether optimization has been turned on for writing the image.      \sa setOptimizedWrite() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      This is an image format-specific function which turns on \a progressive scanning     when writing images. For image formats that do not support setting a \a progressive     scan flag, this value is ignored.      The default is false.      \sa progressiveScanWrite() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      Returns whether the image should be written as a progressive image.      \sa setProgressiveScanWrite() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      Returns the transformation and orientation the image has been set to written with.      \sa setTransformation() */
end_comment
begin_function
