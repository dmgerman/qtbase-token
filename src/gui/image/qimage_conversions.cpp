...
parameter_list|)
block|{
comment|// Twice as fast autovectorized due to SSE4.1 PMULLD instructions.
name|convert_ARGB_to_ARGB_PM
argument_list|(
name|dest
argument_list|,
...
specifier|static
name|void
name|convert_ARGB_to_RGBA_PM_sse4
parameter_list|(
name|QImageData
modifier|*
name|dest
...
specifier|static
name|void
name|convert_A2RGB30_PM_to_RGB
parameter_list|(
name|QImageData
modifier|*
name|dest
