...
end_function
begin_comment
comment|/*!     \since 4.2      Returns the quality setting of the image format.      \sa setQuality() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.4      Returns the subtype of the image. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      Returns the transformation metadata of the image, including image orientation. If the format     does not support transformation metadata \c QImageIOHandler::Transformation_None is returned.      \sa setAutoTransform(), autoTransform() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      Determines that images returned by read() should have transformation metadata automatically     applied if \a enabled is \c true.      \sa autoTransform(), transformation(), read() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.5      Returns \c true if the image handler will apply transformation metadata on read().      \sa setAutoTransform(), transformation(), read() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.6      This is an image format specific function that forces images with     gamma information to be gamma corrected to \a gamma. For image formats     that do not support gamma correction, this value is ignored.      To gamma correct to a standard PC color-space, set gamma to \c 1/2.2.      \sa gamma() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.6      Returns the gamma level of the decoded image. If setGamma() has been     called and gamma correction is supported it will return the gamma set.     If gamma level is not supported by the image format, \c 0.0 is returned.      \sa setGamma() */
end_comment
begin_function
DECL|function|gamma
name|float
...
end_function
begin_comment
comment|/*!     Returns the list of MIME types supported by QImageReader.      Note that the QApplication instance must be created before this function is     called.      \sa supportedImageFormats(), QImageWriter::supportedMimeTypes() */
end_comment
begin_function
