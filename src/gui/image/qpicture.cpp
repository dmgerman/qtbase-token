...
end_function
begin_comment
comment|/*!     Loads a picture from the file specified by \a fileName and returns     true if successful; otherwise returns false.      Please note that the \a format parameter has been deprecated and     will have no effect.      \sa save() */
end_comment
begin_function
DECL|function|load
name|bool
...
argument_list|,
argument|factoryLoader
argument_list|,
argument|(QPictureFormatInterface_iid,                            QLatin1String(
