...
end_class
begin_comment
comment|/*     \class QTreeModel     \brief The QTreeModel class manages the items stored in a tree view.      \ingroup model-view  */
end_comment
begin_comment
