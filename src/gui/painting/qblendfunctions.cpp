...
struct|struct
name|Blend_ARGB24_on_RGB16_SourceAlpha
block|{
DECL|function|write
specifier|inline
name|void
...
struct|struct
name|Blend_ARGB24_on_RGB16_SourceAndConstAlpha
block|{
...
name|void
name|qt_scale_image_argb24_on_rgb16
parameter_list|(
name|uchar
modifier|*
name|destPixels
...
name|printf
argument_list|(
literal|"qt_scale_argb24_on_rgb16: dst=(%p, %d), src=(%p, %d), target=(%d, %d), [%d x %d], src=(%d, %d) [%d x %d] alpha=%d\n"
argument_list|,
name|destPixels
argument_list|,
name|dbpl
...
argument_list|)
decl_stmt|;
comment|// expects the 0-256 range
name|quint16
modifier|*
name|d
init|=
...
argument_list|)
operator|)
comment|// non-16-bit aligned memory access is not possible on PowerPC,
comment|// ARM<v6 (QT_ARCH_ARMV5)& SH& AVR32& SPARC w/GCC
name|quint16
name|spix
init|=
operator|(
...
name|printf
argument_list|(
literal|"qt_blend_argb24_on_rgb16: dst=(%p, %d), src=(%p, %d), dim=(%d, %d) alpha=%d\n"
argument_list|,
name|destPixels
argument_list|,
name|dbpl
...
name|void
name|qt_transform_image_argb24_on_rgb16
parameter_list|(
name|uchar
modifier|*
name|destPixels
