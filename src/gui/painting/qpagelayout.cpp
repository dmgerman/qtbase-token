...
end_comment
begin_comment
comment|/*!     Returns \c true if this page layout is equal to the \a other page layout,     i.e. if all the attributes are exactly equal.      Note that this is a strict equality, especially for page size where the     QPageSize ID, name and size must exactly match, and the margins where the     units must match.      \sa isEquivalentTo() */
end_comment
begin_function
DECL|function|operator ==
name|bool
