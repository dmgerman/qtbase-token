...
argument_list|,
argument|{                                      qAddPostRoutine(qt_cleanup_brush_pattern_image_cache);                                  }
argument_list|)
end_macro
begin_function
...
end_ifndef
begin_comment
comment|// Special deleter that only deletes if the ref-count goes to zero
end_comment
begin_class
template|template
parameter_list|<>
...
argument|QBrushData
argument_list|,
argument|nullBrushInstance
argument_list|,
argument|{                                      x->ref =
literal|1
argument|;                                      x->style = Qt::BrushStyle(
literal|0
argument|);                                      x->color = Qt::black;                                  }
argument_list|)
end_macro
begin_function
...
end_ifdef
begin_comment
comment|/*!     \fn void QBrush::setPixmap(const QPixmap&pixmap)      \compat      Sets a custom pattern for this brush.      Use setTexture() instead. */
end_comment
begin_comment
comment|/*!     \fn QPixmap *QBrush::pixmap() const      Returns a pointer to the custom brush pattern.      Use texture() instead. */
end_comment
begin_function
DECL|function|pixmap
name|QPixmap
...
end_function
begin_comment
comment|/*!     Returns true if the brush is fully opaque otherwise false. A brush     is considered opaque if:      \list     \i The alpha component of the color() is 255.     \i Its texture() does not have an alpha channel and is not a QBitmap.     \i The colors in the gradient() all have an alpha component that is 255.     \endlist */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Constructs a radial gradient with the given \a center, \a     radius and \a focalPoint.      \sa QGradient::setColorAt(), QGradient::setStops() */
end_comment
begin_constructor
...
end_constructor
begin_comment
comment|/*!     Constructs a radial gradient with the given \a center, \a     radius and the focal point in the circle center.      \sa QGradient::setColorAt(), QGradient::setStops() */
end_comment
begin_constructor
DECL|function|QRadialGradient
name|QRadialGradient
...
end_constructor
begin_comment
comment|/*!     Constructs a radial gradient with the given center (\a cx, \a cy),     \a radius and focal point (\a fx, \a fy).      \sa QGradient::setColorAt(), QGradient::setStops() */
end_comment
begin_constructor
DECL|function|QRadialGradient
name|QRadialGradient
...
end_constructor
begin_comment
comment|/*!     Constructs a radial gradient with the center at (\a cx, \a cy) and the     specified \a radius. The focal point lies at the center of the circle.      \sa QGradient::setColorAt(), QGradient::setStops()  */
end_comment
begin_constructor
DECL|function|QRadialGradient
name|QRadialGradient
...
end_constructor
begin_comment
comment|/*!     Constructs a radial gradient with the center and focal point at     (0, 0) with a radius of 1. */
end_comment
begin_constructor
DECL|function|QRadialGradient
name|QRadialGradient
...
end_function
begin_comment
comment|/*!     Returns the radius of this radial gradient in logical coordinates.      \sa QGradient::stops() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 4.2      Sets the radius of this radial gradient in logical coordinates     to \a radius */
end_comment
begin_function
