...
end_function
begin_comment
comment|/*!     Static convenience function that returns a QColor constructed from the RGB     color values, \a r (red), \a g (green), \a b (blue), and \a a     (alpha-channel, i.e. transparency).      All the values must be in the range 0-255.      \sa toRgb(), fromRgba64(), fromRgbF(), isValid() */
end_comment
begin_function
DECL|function|fromRgb
name|QColor
...
end_function
begin_comment
comment|/*!     Static convenience function that returns a QColor constructed from the RGB     color values, \a r (red), \a g (green), \a b (blue), and \a a     (alpha-channel, i.e. transparency).      All the values must be in the range 0.0-1.0.      \sa fromRgb(), fromRgba64(), toRgb(), isValid() */
end_comment
begin_function
...
end_comment
begin_comment
comment|// A table of precalculated results of 0x00ff00ff/alpha use by qUnpremultiply:
end_comment
begin_decl_stmt
...
end_comment
begin_comment
comment|/*!     \fn QRgb qPremultiply(QRgb rgb)     \since 5.3     \relates QColor      Converts an unpremultiplied ARGB quadruplet \a rgb into a premultiplied ARGB quadruplet.      \sa qUnpremultiply() */
end_comment
begin_comment
comment|/*!     \fn QRgb qUnpremultiply(QRgb rgb)     \since 5.3     \relates QColor      Converts a premultiplied ARGB quadruplet \a rgb into an unpremultiplied ARGB quadruplet.      \sa qPremultiply() */
end_comment
begin_comment
