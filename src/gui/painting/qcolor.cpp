...
end_ifdef
begin_comment
comment|/*!     Returns the pixel value used by the underlying window system to refer to a     color.      Use QColormap::pixel() instead.      \oldcode         QColor myColor;         uint pixel = myColor.pixel(screen);     \newcode         QColormap cmap = QColormap::instance(screen);         uint pixel  = cmap.pixel(*this);     \endcode */
end_comment
begin_function
DECL|function|pixel
name|uint
