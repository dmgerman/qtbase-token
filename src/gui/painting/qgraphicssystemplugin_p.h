...
value|"com.trolltech.Qt.QGraphicsSystemFactoryInterface"
end_define
begin_macro
DECL|function|Q_DECLARE_INTERFACE
name|Q_DECLARE_INTERFACE
argument_list|(
argument|QGraphicsSystemFactoryInterface
argument_list|,
argument|QGraphicsSystemFactoryInterface_iid
argument_list|)
end_macro
begin_decl_stmt
name|class
...
end_endif
begin_comment
comment|// QGRAPHICSSYSTEMEPLUGIN_H
end_comment
end_unit
