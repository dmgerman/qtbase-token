...
end_function
begin_comment
comment|/*!     \fn bool QMatrix::isIdentity() const      Returns \c true if the matrix is the identity matrix, otherwise     returns \c false.      \sa reset() */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     \fn bool QMatrix::isInvertible() const      Returns \c true if the matrix is invertible, otherwise returns \c false.      \sa inverted() */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     \fn bool QMatrix::operator==(const QMatrix&matrix) const      Returns \c true if this matrix is equal to the given \a matrix,     otherwise returns \c false. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.6     \relates QMatrix      Returns the hash value for \a key, using     \a seed to seed the calculation. */
end_comment
begin_function
name|uint
name|qHash
...
end_function
begin_comment
comment|/*!     \fn bool QMatrix::operator!=(const QMatrix&matrix) const      Returns \c true if this matrix is not equal to the given \a matrix,     otherwise returns \c false. */
end_comment
begin_function
DECL|function|operator !=
name|bool
...
end_endif
begin_comment
comment|/*!     \fn bool qFuzzyCompare(const QMatrix& m1, const QMatrix& m2)      \relates QMatrix     \since 4.6      \brief The qFuzzyCompare function is for comparing two matrices     using a fuzziness factor.      Returns \c true if \a m1 and \a m2 are equal, allowing for a small     fuzziness factor for floating-point comparisons; false otherwise. */
end_comment
begin_macro
