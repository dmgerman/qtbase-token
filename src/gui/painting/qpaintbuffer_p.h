...
argument_list|(
argument|const QPaintBufferPrivate *buffer
argument_list|)
block|{
name|emit
name|aboutToDestroy
...
end_decl_stmt
begin_comment
comment|// One resource per paint buffer and vice versa.
end_comment
begin_decl_stmt
name|class
name|Q_GUI_EXPORT
...
end_expr_stmt
begin_comment
comment|// Set resource 'value' for 'key'.
end_comment
begin_function_decl
name|void
name|insert
...
end_function_decl
begin_comment
comment|// Return resource for 'key'.
end_comment
begin_function_decl
name|void
modifier|*
...
name|slots
range|:
comment|// Remove entry 'key' from cache and delete resource.
name|void
name|remove
argument_list|(
specifier|const
