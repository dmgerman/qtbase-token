...
end_ifndef
begin_comment
comment|// motif arrows look the same whether they are used or not
end_comment
begin_comment
...
literal|0x0000
decl_stmt|;
comment|// color specification array
if|if
condition|(
name|dim
operator|<
...
argument_list|)
expr_stmt|;
comment|// set transformation matrix
name|p
operator|->
name|drawPolygon
argument_list|(
...
name|qWarning
argument_list|(
literal|"qDrawArrow: Requested unsupported GUI style"
argument_list|)
expr_stmt|;
block|}
block|}
...
argument_list|()
condition|)
comment|// Qt::AlignAuto&& rightToLeft
name|x
operator|+=
name|w
operator|-
...
condition|)
block|{
comment|// monochrome pixmap, no mask
empty_stmt|;
ifndef|#
directive|ifndef
