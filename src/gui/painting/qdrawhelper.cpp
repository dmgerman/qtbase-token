...
define|#
directive|define
name|Q_IRIX_GCC3_3_WORKAROUND
comment|//
comment|// work around http://gcc.gnu.org/bugzilla/show_bug.cgi?id=14484
comment|//
specifier|static
name|uint
name|gccBug
...
define|#
directive|define
name|SPANFUNC_POINTER_DESTFETCH
parameter_list|(
name|Arg
parameter_list|)
value|destFetch<Arg>
...
define|#
directive|define
name|SPANFUNC_POINTER_DESTSTORE
parameter_list|(
name|DEST
parameter_list|)
value|destStore<DEST>
end_define
begin_decl_stmt
...
define|#
directive|define
name|SPANFUNC_POINTER_FETCHPIXEL
parameter_list|(
name|Arg
parameter_list|)
value|qt_fetchPixel<QImage::Arg>
end_define
begin_decl_stmt
...
name|SPANFUNC_POINTER_FETCHPIXEL
argument_list|(
argument|Format_ARGB4444_Premultiplied
argument_list|)
block|}
decl_stmt|;
end_decl_stmt
...
define|#
directive|define
name|SPANFUNC_POINTER_FETCHHUNTRANSFORMED
parameter_list|(
name|Arg
parameter_list|)
value|qt_fetchUntransformed<QImage::Arg>
end_define
begin_decl_stmt
...
argument_list|)
decl_stmt|;
comment|// calculate the actual offset.
if|if
condition|(
name|ipos
operator|<
...
end_function
begin_comment
comment|// function to evaluate real roots
end_comment
begin_function
...
name|m23
decl_stmt|;
comment|//qreal r  = data->gradient.radial.radius;
specifier|const
name|uint
modifier|*
name|end
...
specifier|static
name|void
name|blend_color_generic_callback
parameter_list|(
name|int
name|count
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|//     QSpanData *data = reinterpret_cast<QSpanData*>(userData);
comment|//     data->rasterEngine->drawColorSpans(spans, count, data->solid.color);
block|}
end_function
begin_endif
endif|#
...
define|#
directive|define
name|SPANFUNC_POINTER_BLENDCOLOR
parameter_list|(
name|DST
parameter_list|)
value|blendColor<DST>
end_define
begin_function
...
specifier|inline
name|void
name|interpolate_pixel_unaligned_2
parameter_list|(
name|DST
modifier|*
name|dest
...
index|]
decl_stmt|;
comment|// array of quint32 to get correct alignment
name|qt_memconvert
argument_list|(
operator|(
name|DST
...
name|void
name|QT_FASTCALL
name|blendUntransformed_unaligned
parameter_list|(
name|DST
modifier|*
name|dest
...
name|void
name|QT_FASTCALL
name|blendUntransformed_dest16
parameter_list|(
name|DST
modifier|*
name|dest
...
name|void
name|QT_FASTCALL
name|blendUntransformed_dest24
parameter_list|(
name|DST
modifier|*
name|dest
...
specifier|static
name|void
name|blend_untransformed_rgb888
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_untransformed_argb6666
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_untransformed_rgb666
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_untransformed_argb8565
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_untransformed_argb8555
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_untransformed_rgb555
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_untransformed_argb4444
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_untransformed_rgb444
parameter_list|(
name|int
name|count
parameter_list|,
...
directive|if
literal|0
block|if (x1 == x2) {                         if (y1 == y2) {                             *b = ((SRC*)data->texture.scanLine(y1))[x1];                         } else {                             *b = ((SRC*)data->texture.scanLine(y1))[x1];                             const SRC t = data->texture.scanLine(y2)[x1];                             interpolate_pixel(*b, SRC::ialpha(disty),                                               t, SRC::alpha(disty));                         }                     } else if (y1 == y2) {                         *b = ((SRC*)data->texture.scanLine(y1))[x1];                         const SRC t = ((SRC*)data->texture.scanLine(y1))[x2];                         interpolate_pixel(*b, SRC::ialpha(distx),                                           t, SRC::alpha(distx));                     } else
endif|#
directive|endif
block|{
specifier|const
...
specifier|static
name|void
name|blend_transformed_bilinear_rgb888
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_bilinear_argb6666
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_bilinear_rgb666
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_bilinear_argb8565
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_bilinear_argb8555
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_bilinear_rgb555
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_bilinear_argb4444
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_bilinear_rgb444
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_argb6666
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_argb8565
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_argb8555
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_argb4444
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_rgb888
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_argb6666
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_rgb666
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_argb8565
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_argb8555
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_rgb555
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_argb4444
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|static
name|void
name|blend_transformed_tiled_rgb444
parameter_list|(
name|int
name|count
parameter_list|,
...
specifier|const
name|ProcessSpans
name|processTextureSpansCallback
index|[
name|NBlendTypes
index|]
index|[
...
directive|ifdef
name|Q_WS_MAC
comment|// decided by testing a few things on an iMac, should probably get this from the
comment|// system...
name|smoothing
operator|=
name|qreal
...
name|Q_WS_WIN
argument_list|)
comment|// Work around GDI messing up alpha channel
operator|&&
name|qRed
argument_list|(
operator|*
...
parameter_list|)
define|\
value|inline static void qt_rectfill_##T(QRasterBuffer *rasterBuffer,     \                                        int x, int y, int width, int height, \                                        quint32 color)                   \     {                                                                   \         qt_rectfill_template<T>(rasterBuffer, x, y, width, height, color); \     }
end_define
begin_macro
name|QT_RECTFILL
argument_list|(
...
name|qt_memfill_quint16
expr_stmt|;
comment|//qt_memfill_template<quint16, quint16>;
name|CompositionFunction
modifier|*
