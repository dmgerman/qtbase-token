...
modifier|*
name|QT_FASTCALL
name|convertARGBPMFromARGB32PM
parameter_list|(
name|uint
modifier|*
name|buffer
...
modifier|*
name|QT_FASTCALL
name|convertRGBA8888PMToARGB32PM
parameter_list|(
name|uint
modifier|*
name|buffer
...
modifier|*
name|QT_FASTCALL
name|convertRGBA8888PMFromARGB32PM
parameter_list|(
name|uint
modifier|*
name|buffer
...
modifier|*
name|QT_FASTCALL
name|convertRGBA8888FromARGB32PM
parameter_list|(
name|uint
modifier|*
name|buffer
...
modifier|*
name|QT_FASTCALL
name|convertAlpha8FromARGB32PM
parameter_list|(
name|uint
modifier|*
name|buffer
...
modifier|*
name|QT_FASTCALL
name|convertGrayscale8FromRGB32
parameter_list|(
name|uint
modifier|*
name|buffer
...
modifier|*
name|QT_FASTCALL
name|convertGrayscale8FromARGB32PM
parameter_list|(
name|uint
modifier|*
name|buffer
...
comment|// Technically using convertPassThrough to convert from ARGB32PM to RGB32 is wrong,
comment|// but everywhere this generic conversion would be wrong is currently overloaded.
block|{
literal|8
block|,
literal|16
...
block|}
block|,
comment|// Format_RGBA8888 (ABGR32)
block|{
literal|8
block|,
literal|0
...
comment|//idistx * idisty = (16-distx) * (16-disty) = 16*16 - 16*distx -16*disty + distxy
name|uint
name|tlrb
init|=
operator|(
...
parameter_list|)
block|{
comment|// First interpolate right and left pixels in parallel.
name|__m128i
name|vl
init|=
...
argument_list|)
expr_stmt|;
comment|// vtb now contains the result of the first two interpolate calls vtb = unpacked((xbot<< 64) | xtop)
comment|// Now the last interpolate between top and bottom interpolations.
specifier|const
name|__m128i
name|vidisty
init|=
...
argument_list|)
expr_stmt|;
comment|// vtb now contains the colors of top and bottom interleaved { ta, ba, tr, br, tg, bg, tb, bb }
name|vtb
operator|=
name|_mm_madd_epi16
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Multiply and horizontal add.
name|vtb
operator|=
name|_mm_srli_epi32
argument_list|(
...
define|#
directive|define
name|BILINEAR_ROTATE_BOUNDS_PROLOG
define|\
value|while (b< end) { \                         int x1 = (fx>> 16); \                         int x2; \                         int y1 = (fy>> 16); \                         int y2; \                         fetchTransformedBilinear_pixelBounds<blendType>(image_width, image_x1, image_x2, x1, x2); \                         fetchTransformedBilinear_pixelBounds<blendType>(image_height, image_y1, image_y2, y1, y2); \                         if (x1 != x2&& y1 != y2) \                             break; \                         const uint *s1 = (const uint *)data->texture.scanLine(y1); \                         const uint *s2 = (const uint *)data->texture.scanLine(y2); \                         uint tl = s1[x1]; \                         uint tr = s1[x2]; \                         uint bl = s2[x1]; \                         uint br = s2[x2]; \                         int distx = (fx& 0x0000ffff)>> 8; \                         int disty = (fy& 0x0000ffff)>> 8; \                         *b = interpolate_4_pixels(tl, tr, bl, br, distx, disty); \                         fx += fdx; \                         fy += fdy; \                         ++b; \                     } \                     uint *boundedEnd = end - 3; \                     boundedEnd -= 3;
if|#
directive|if
name|defined
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// 4x16bit * 4x16bit -> 4x32bit
name|__m128i
name|offset
init|=
name|_mm_unpacklo_epi16
...
name|__SSE2__
argument_list|)
comment|// The SSE2 optimized interpolate_4_pixels is faster than interpolate_4_pixels_16.
name|int
name|distx
init|=
operator|(
...
literal|0
expr_stmt|;
comment|//qt_fetch_radial_gradient_rgb64;
break|break;
case|case
name|QSpanData
operator|::
...
literal|0
expr_stmt|;
comment|//qt_fetch_conical_gradient_rgb64;
break|break;
case|case
name|QSpanData
operator|::
...
case|:
comment|// don't clear destFetch as it sets up the pointer correctly to save one copy
break|break;
default|default:
block|{
if|if
...
name|qDebug
argument_list|(
literal|"blend_src_generic_rgb64: unsupported 64-bit blend attempted"
argument_list|)
expr_stmt|;
name|BlendSrcGeneric
name|blend32
...
name|qDebug
argument_list|(
literal|"unsupported rgb64 blend"
argument_list|)
expr_stmt|;
return|return
name|blend_tiled_generic
...
specifier|static
name|void
name|qt_rectfill_nonpremul_argb32
parameter_list|(
name|QRasterBuffer
modifier|*
name|rasterBuffer
...
specifier|static
name|void
name|qt_rectfill_nonpremul_rgba
parameter_list|(
name|QRasterBuffer
modifier|*
name|rasterBuffer
...
block|}
block|,
comment|// Format_RGB8888_Premultiplied
block|{
name|blend_color_generic
block|,
name|blend_src_generic
...
condition|)
block|{
comment|// Composition functions are all DSP r1
name|functionForMode_C
index|[
name|QPainter
operator|::
