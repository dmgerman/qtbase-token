...
control|)
block|{
comment|// Repremultiplying is really expensive and hard to do in SIMD without AVX2,
comment|// so we try to avoid it by checking if it is needed 16 samples at a time.
name|__m128i
name|vOr
init|=
name|_mm_set1_epi32
