...
end_comment
begin_comment
comment|/*!     \fn void QWindowSurface::flush(QWidget *widget, const QRegion&region,                                   const QPoint&offset)      Flushes the given \a region from the specified \a widget onto the     screen.      Note that the \a offset parameter is currently unused. */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     Returns a QImage pointer which represents the actual buffer the \a widget     is drawn into or 0 if this is unavailable.      You must call beginPaint() before you call this function and the returned     pointer is only valid until endPaint() is called. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   Returns the offset of \a widget in the coordinates of this   window surface.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!   \fn QRect QWindowSurface::rect(const QWidget *widget) const    Returns the rectangle for \a widget in the coordinates of this   window surface. */
end_comment
begin_function
