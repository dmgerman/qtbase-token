...
end_function
begin_comment
comment|/*!     \fn bool QTransform::operator==(const QTransform&matrix) const     Returns \c true if this matrix is equal to the given \a matrix,     otherwise returns \c false. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 5.6     \relates QTransform      Returns the hash value for \a key, using     \a seed to seed the calculation. */
end_comment
begin_function
name|uint
name|qHash
...
end_function
begin_comment
comment|/*!     \fn bool QTransform::operator!=(const QTransform&matrix) const     Returns \c true if this matrix is not equal to the given \a matrix,     otherwise returns \c false. */
end_comment
begin_function
DECL|function|operator !=
name|bool
...
end_function
begin_comment
comment|/*!     Creates a transformation matrix, \a trans, that maps a unit square     to a four-sided polygon, \a quad. Returns \c true if the transformation     is constructed or false if such a transformation does not exist.      \sa quadToSquare(), quadToQuad() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn bool QTransform::quadToSquare(const QPolygonF&quad, QTransform&trans)      Creates a transformation matrix, \a trans, that maps a four-sided polygon,     \a quad, to a unit square. Returns \c true if the transformation is constructed     or false if such a transformation does not exist.      \sa squareToQuad(), quadToQuad() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Creates a transformation matrix, \a trans, that maps a four-sided     polygon, \a one, to another four-sided polygon, \a two.     Returns \c true if the transformation is possible; otherwise returns     false.      This is a convenience method combining quadToSquare() and     squareToQuad() methods. It allows the input quad to be     transformed into any other quad.      \sa squareToQuad(), quadToSquare() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn bool QTransform::isInvertible() const      Returns \c true if the matrix is invertible, otherwise returns \c false.      \sa inverted() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn bool QTransform::isIdentity() const      Returns \c true if the matrix is the identity matrix, otherwise     returns \c false.      \sa reset() */
end_comment
begin_comment
comment|/*!     \fn bool QTransform::isAffine() const      Returns \c true if the matrix represent an affine transformation,     otherwise returns \c false. */
end_comment
begin_comment
comment|/*!     \fn bool QTransform::isScaling() const      Returns \c true if the matrix represents a scaling     transformation, otherwise returns \c false.      \sa reset() */
end_comment
begin_comment
comment|/*!     \fn bool QTransform::isRotating() const      Returns \c true if the matrix represents some kind of a     rotating transformation, otherwise returns \c false.      \note A rotation transformation of 180 degrees and/or 360 degrees is treated as a scaling transformation.      \sa reset() */
end_comment
begin_comment
comment|/*!     \fn bool QTransform::isTranslating() const      Returns \c true if the matrix represents a translating     transformation, otherwise returns \c false.      \sa reset() */
end_comment
begin_comment
comment|/*!     \fn bool qFuzzyCompare(const QTransform& t1, const QTransform& t2)      \relates QTransform     \since 4.6      Returns \c true if \a t1 and \a t2 are equal, allowing for a small     fuzziness factor for floating-point comparisons; false otherwise. */
end_comment
begin_comment
