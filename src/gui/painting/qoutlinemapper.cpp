...
literal|false
decl_stmt|;
comment|// Test one point first before doing a full intersection test.
if|if
condition|(
operator|!
name|QRectF
...
condition|)
block|{
comment|// The curve is entirely outside the clip rect, so just
comment|// approximate it with a line that closes the path.
name|lineTo
argument_list|(
name|ep
argument_list|)
