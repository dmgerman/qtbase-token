...
end_ifndef
begin_comment
comment|// for X11 there is a separate implementation of a constructor.
end_comment
begin_comment
...
end_ifdef
begin_comment
comment|/*!     \fn QMimeSource *QClipboard::data(Mode mode) const     \compat      Use mimeData() instead. */
end_comment
begin_function
DECL|function|data
name|QMimeSource
...
end_function
begin_comment
comment|/*!     \fn void QClipboard::setData(QMimeSource *src, Mode mode)     \compat      Use setMimeData() instead. */
end_comment
begin_function
