...
name|qWarning
argument_list|(
literal|"Eventloop integration is not supported by the glib event dispatcher"
argument_list|)
expr_stmt|;
name|qWarning
argument_list|(
literal|"Use the UNIX event dispatcher by defining environment variable QT_NO_GLIB=1"
argument_list|)
expr_stmt|;
block|}
name|init
