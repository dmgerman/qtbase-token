...
end_endif
begin_comment
comment|/*!     \fn void QGuiApplication::setOverrideCursor(const QCursor&cursor, bool replace)      Use changeOverrideCursor(\a cursor) (if \a replace is true) or     setOverrideCursor(\a cursor) (if \a replace is false). */
end_comment
begin_ifndef
ifndef|#
directive|ifndef
...
end_function
begin_comment
comment|/*!     \since 4.2      Returns the current keyboard input direction. */
end_comment
begin_function
...
name|checkInstance
argument_list|(
literal|"keyboardInputDirection"
argument_list|)
condition|)
return|return
name|Qt
...
literal|"X        c #FFFFFF"
block|,
comment|// Windows cursor is traditionally white
else|#
directive|else
literal|"a        c #FFFFFF"
block|,
