...
operator|(
literal|"0:\n"
literal|"ldrex %[tempValue], [%[_q_value]]\n"
literal|"eors %[result], %[tempValue], %[expectedValue]\n"
literal|"itt eq\n"
literal|"strexeq %[result], %[newValue], [%[_q_value]]\n"
literal|"teqeq %[result], #1\n"
literal|"beq 0b\n"
...
end_define
begin_comment
comment|// note: if T is signed, parameters are passed sign-extended in the
end_comment
begin_comment
comment|// registers. However, our 8- and 16-bit operations don't do sign
end_comment
begin_comment
comment|// extension. So we need to clear out the input on entry and sign-extend again
end_comment
begin_comment
comment|// on exit.
end_comment
...
end_expr_stmt
begin_comment
comment|// unsigned, ABI will zero extend
end_comment
begin_if
if|if
condition|(
...
asm|asm
specifier|volatile
asm|("and %0, %0, %1" : "+r" (value) : "I" (0xff));
else|else
asm|asm
specifier|volatile
asm|("and %0, %0, %1" : "+r" (value) : "r" (0xffff));
end_if
begin_return
return|return
name|value
...
asm|asm
specifier|volatile
asm|("sxtb %0, %0" : "+r" (value));
else|else
asm|asm
specifier|volatile
asm|("sxth %0, %0" : "+r" (value));
end_if
begin_return
return|return
name|value
...
operator|(
literal|"0:\n"
literal|"ldrexb %[tempValue], [%[_q_value]]\n"
literal|"eors %[result], %[tempValue], %[expectedValue]\n"
literal|"itt eq\n"
literal|"strexbeq %[result], %[newValue], [%[_q_value]]\n"
literal|"teqeq %[result], #1\n"
...
operator|(
literal|"0:\n"
literal|"ldrexh %[tempValue], [%[_q_value]]\n"
literal|"eors %[result], %[tempValue], %[expectedValue]\n"
literal|"itt eq\n"
literal|"strexheq %[result], %[newValue], [%[_q_value]]\n"
literal|"teqeq %[result], #1\n"
...
operator|(
literal|"0:\n"
literal|"ldrexd %[tempValue], %H[tempValue], [%[_q_value]]\n"
literal|"eor %[result], %[tempValue], %[expectedValue]\n"
literal|"eor %H[result], %H[tempValue], %H[expectedValue]\n"
literal|"orrs %[result], %[result], %H[result]\n"
literal|"itt eq\n"
literal|"strexdeq %[result], %[newValue], %H[newValue], [%[_q_value]]\n"
literal|"teqeq %[result], #1\n"
