...
DECL|function|fetchAndAddRelaxed
literal|4
argument|>::fetchAndAddRelaxed(T&_q_value, typename QAtomicAdditiveType<T>::AdditiveT valueToAdd) {     return T(q_atomic_fetch_and_add_int((int *)&_q_value, valueToAdd * QAtomicAdditiveType<T>::AddScale)); }
endif|#
directive|endif
