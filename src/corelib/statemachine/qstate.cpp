...
end_comment
begin_comment
comment|/*!   \fn QState::childModeChanged()   \since 5.4    This signal is emitted when the childMode property is changed.    \sa QState::childMode */
end_comment
begin_comment
comment|/*!   \fn QState::initialStateChanged()   \since 5.4    This signal is emitted when the initialState property is changed.    \sa QState::initialState */
end_comment
begin_comment
comment|/*!   \fn QState::errorStateChanged()   \since 5.4    This signal is emitted when the errorState property is changed.    \sa QState::errorState */
end_comment
begin_macro
