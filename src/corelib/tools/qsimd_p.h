...
end_define
begin_comment
comment|// these defines are copied from qendian.h
end_comment
begin_comment
comment|// in Qt 5.7, they have been moved to qglobal.h
end_comment
begin_comment
comment|// drop them when merging this to 5.7
end_comment
begin_ifdef
ifdef|#
directive|ifdef
