...
end_comment
begin_comment
comment|/*! \fn void QVector::insert(int i, int count, const T&value)      \overload      Inserts \a count copies of \a value at index position \a i in the     vector.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 10 */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*! \fn QVector&QVector::fill(const T&value, int size = -1)      Assigns \a value to all items in the vector. If \a size is     different from -1 (the default), the vector is resized to size \a     size beforehand.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 11      \sa resize() */
end_comment
begin_comment
comment|/*! \fn int QVector::indexOf(const T&value, int from = 0) const      Returns the index position of the first occurrence of \a value in     the vector, searching forward from index position \a from.     Returns -1 if no item matched.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 12      This function requires the value type to have an implementation of     \c operator==().      \sa lastIndexOf(), contains() */
end_comment
begin_comment
comment|/*! \fn int QVector::lastIndexOf(const T&value, int from = -1) const      Returns the index position of the last occurrence of the value \a     value in the vector, searching backward from index position \a     from. If \a from is -1 (the default), the search starts at the     last item. Returns -1 if no item matched.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 13      This function requires the value type to have an implementation of     \c operator==().      \sa indexOf() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*! \fn QList<T> QVector<T>::toList() const      Returns a QList object with the data contained in this QVector.      Example:      \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 14      \sa fromList(), QList::fromVector() */
end_comment
begin_comment
comment|/*! \fn QVector<T> QVector<T>::fromList(const QList<T>&list)      Returns a QVector object with the data contained in \a list.      Example:      \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 15      \sa toList(), QList::toVector() */
end_comment
begin_comment
comment|/*! \fn QVector<T> QVector<T>::fromStdVector(const std::vector<T>&vector)      Returns a QVector object with the data contained in \a vector. The     order of the elements in the QVector is the same as in \a vector.      Example:      \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 16      \sa toStdVector(), QList::fromStdList() */
end_comment
begin_comment
comment|/*! \fn std::vector<T> QVector<T>::toStdVector() const      Returns a std::vector object with the data contained in this QVector.     Example:      \snippet doc/src/snippets/code/src_corelib_tools_qvector.cpp 17      \sa fromStdVector(), QList::toStdList() */
end_comment
begin_comment
