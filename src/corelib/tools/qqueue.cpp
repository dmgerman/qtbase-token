...
end_comment
begin_comment
comment|/*!     \fn void QQueue::enqueue(const T& t)      Adds value \a t to the tail of the queue.      This is the same as QList::append().      \sa dequeue(), head() */
end_comment
begin_comment
comment|/*!     \fn T&QQueue::head()      Returns a reference to the queue's head item. This function     assumes that the queue isn't empty.      This is the same as QList::first().      \sa dequeue(), enqueue(), isEmpty() */
end_comment
begin_comment
comment|/*!     \fn const T&QQueue::head() const      \overload */
end_comment
begin_comment
comment|/*!     \fn T QQueue::dequeue()      Removes the head item in the queue and returns it. This function     assumes that the queue isn't empty.      This is the same as QList::takeFirst().      \sa head(), enqueue(), isEmpty() */
end_comment
end_unit
