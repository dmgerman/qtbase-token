...
condition|)
block|{
comment|// we can't use memcmp because it interprets the data as unsigned bytes
specifier|const
name|qint8
modifier|*
name|ptr1
...
argument_list|()
return|;
comment|// try to use the one with inline segments, if there's one
name|QVersionNumber
name|result
argument_list|(
operator|!
