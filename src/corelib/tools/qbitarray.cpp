...
end_function
begin_comment
comment|/*!     \class QBitRef     \reentrant     \brief The QBitRef class is an internal class, used with QBitArray.      \internal      The QBitRef is required by the indexing [] operator on bit arrays.     It is not for use in any other context. */
end_comment
begin_comment
