...
init|=
block|{
comment|//    Other      CR       LF    Newline   Format  Katakana ALetter MidNumLet MidLetter MidNum  Numeric  ExtendNumLet
block|{
name|Break
block|,
name|Break
...
init|=
block|{
comment|//     Other     CR       LF      Sep     Format     Sp      Lower   Upper    OLetter  Numeric  ATerm   SContinue STerm     Close
block|{
name|Initial
block|,
name|BAfterC
