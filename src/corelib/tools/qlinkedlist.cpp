...
end_comment
begin_comment
comment|/*! \fn void QLinkedList::append(const T&value)      Inserts \a value at the end of the list.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qlinkedlist.cpp 3      This is the same as list.insert(end(), \a value).      \sa operator<<(), prepend(), insert() */
end_comment
begin_comment
comment|/*! \fn void QLinkedList::prepend(const T&value)      Inserts \a value at the beginning of the list.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qlinkedlist.cpp 4      This is the same as list.insert(begin(), \a value).      \sa append(), insert() */
end_comment
begin_comment
comment|/*! \fn int QLinkedList::removeAll(const T&value)      Removes all occurrences of \a value in the list.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qlinkedlist.cpp 5      This function requires the value type to have an implementation of     \c operator==().      \sa insert() */
end_comment
begin_comment
comment|/*!     \fn bool QLinkedList::removeOne(const T&value)     \since 4.4      Removes the first occurrences of \a value in the list. Returns true on     success; otherwise returns false.      Example:     \snippet doc/src/snippets/code/src_corelib_tools_qlinkedlist.cpp 6      This function requires the value type to have an implementation of     \c operator==().      \sa insert() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*! \fn T&QLinkedList::iterator::operator*() const      Returns a modifiable reference to the current item.      You can change the value of an item by using operator*() on the     left side of an assignment, for example:      \snippet doc/src/snippets/code/src_corelib_tools_qlinkedlist.cpp 13      \sa operator->() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \since 4.1     \fn std::list<T> QLinkedList<T>::toStdList() const      Returns a std::list object with the data contained in this     QLinkedList. Example:      \snippet doc/src/snippets/code/src_corelib_tools_qlinkedlist.cpp 17      \sa fromStdList() */
end_comment
begin_macro
