...
parameter_list|)
block|{
comment|// The standard POSIX clock calls only have 1ms accuracy on QNX.  To get
comment|// higher accuracy, this platform-specific function must be used instead
name|quint64
name|cycles_per_sec
init|=
name|SYSPAGE_ENTRY
