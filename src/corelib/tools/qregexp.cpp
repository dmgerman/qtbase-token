...
name|insert
argument_list|(
literal|"IsSpacingModifierLetters"
argument_list|,
name|qMakePair
argument_list|(
literal|0x02B0
...
name|insert
argument_list|(
literal|"IsCombiningDiacriticalMarks"
argument_list|,
name|qMakePair
argument_list|(
literal|0x0300
...
name|insert
argument_list|(
literal|"IsUnifiedCanadianAboriginalSyllabics"
argument_list|,
name|qMakePair
argument_list|(
literal|0x1400
...
name|insert
argument_list|(
literal|"IsPhoneticExtensionsSupplement"
argument_list|,
name|qMakePair
argument_list|(
literal|0x1D80
...
name|insert
argument_list|(
literal|"IsCombiningDiacriticalMarksSupplement"
argument_list|,
name|qMakePair
argument_list|(
literal|0x1DC0
...
name|insert
argument_list|(
literal|"IsLatinExtendedAdditional"
argument_list|,
name|qMakePair
argument_list|(
literal|0x1E00
...
name|insert
argument_list|(
literal|"IsSuperscriptsandSubscripts"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2070
...
name|insert
argument_list|(
literal|"IsCombiningMarksforSymbols"
argument_list|,
name|qMakePair
argument_list|(
literal|0x20D0
...
name|insert
argument_list|(
literal|"IsMathematicalOperators"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2200
...
name|insert
argument_list|(
literal|"IsMiscellaneousTechnical"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2300
...
name|insert
argument_list|(
literal|"IsOpticalCharacterRecognition"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2440
...
name|insert
argument_list|(
literal|"IsEnclosedAlphanumerics"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2460
...
name|insert
argument_list|(
literal|"IsMiscellaneousSymbols"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2600
...
name|insert
argument_list|(
literal|"IsMiscellaneousMathematicalSymbols-A"
argument_list|,
name|qMakePair
argument_list|(
literal|0x27C0
...
name|insert
argument_list|(
literal|"IsSupplementalArrows-A"
argument_list|,
name|qMakePair
argument_list|(
literal|0x27F0
...
name|insert
argument_list|(
literal|"IsSupplementalArrows-B"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2900
...
name|insert
argument_list|(
literal|"IsMiscellaneousMathematicalSymbols-B"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2980
...
name|insert
argument_list|(
literal|"IsSupplementalMathematicalOperators"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2A00
...
name|insert
argument_list|(
literal|"IsMiscellaneousSymbolsandArrows"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2B00
...
name|insert
argument_list|(
literal|"IsSupplementalPunctuation"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2E00
...
name|insert
argument_list|(
literal|"IsCJKRadicalsSupplement"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2E80
...
name|insert
argument_list|(
literal|"IsIdeographicDescriptionCharacters"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2FF0
...
name|insert
argument_list|(
literal|"IsCJKSymbolsandPunctuation"
argument_list|,
name|qMakePair
argument_list|(
literal|0x3000
...
name|insert
argument_list|(
literal|"IsHangulCompatibilityJamo"
argument_list|,
name|qMakePair
argument_list|(
literal|0x3130
...
name|insert
argument_list|(
literal|"IsKatakanaPhoneticExtensions"
argument_list|,
name|qMakePair
argument_list|(
literal|0x31F0
...
name|insert
argument_list|(
literal|"IsEnclosedCJKLettersandMonths"
argument_list|,
name|qMakePair
argument_list|(
literal|0x3200
...
name|insert
argument_list|(
literal|"IsCJKUnifiedIdeographsExtensionA"
argument_list|,
name|qMakePair
argument_list|(
literal|0x3400
...
name|insert
argument_list|(
literal|"IsYijingHexagramSymbols"
argument_list|,
name|qMakePair
argument_list|(
literal|0x4DC0
...
name|insert
argument_list|(
literal|"IsCJKUnifiedIdeographs"
argument_list|,
name|qMakePair
argument_list|(
literal|0x4E00
...
name|insert
argument_list|(
literal|"IsCJKCompatibilityIdeographs"
argument_list|,
name|qMakePair
argument_list|(
literal|0xF900
...
name|insert
argument_list|(
literal|"IsAlphabeticPresentationForms"
argument_list|,
name|qMakePair
argument_list|(
literal|0xFB00
...
name|insert
argument_list|(
literal|"IsArabicPresentationForms-A"
argument_list|,
name|qMakePair
argument_list|(
literal|0xFB50
...
name|insert
argument_list|(
literal|"IsCJKCompatibilityForms"
argument_list|,
name|qMakePair
argument_list|(
literal|0xFE30
...
name|insert
argument_list|(
literal|"IsArabicPresentationForms-B"
argument_list|,
name|qMakePair
argument_list|(
literal|0xFE70
...
name|insert
argument_list|(
literal|"IsHalfwidthandFullwidthForms"
argument_list|,
name|qMakePair
argument_list|(
literal|0xFF00
...
name|insert
argument_list|(
literal|"IsByzantineMusicalSymbols"
argument_list|,
name|qMakePair
argument_list|(
literal|0x1D000
...
name|insert
argument_list|(
literal|"IsAncientGreekMusicalNotation"
argument_list|,
name|qMakePair
argument_list|(
literal|0x1D200
...
name|insert
argument_list|(
literal|"IsMathematicalAlphanumericSymbols"
argument_list|,
name|qMakePair
argument_list|(
literal|0x1D400
...
name|insert
argument_list|(
literal|"IsCJKUnifiedIdeographsExtensionB"
argument_list|,
name|qMakePair
argument_list|(
literal|0x20000
...
name|insert
argument_list|(
literal|"IsCJKCompatibilityIdeographsSupplement"
argument_list|,
name|qMakePair
argument_list|(
literal|0x2F800
...
name|insert
argument_list|(
literal|"IsVariationSelectorsSupplement"
argument_list|,
name|qMakePair
argument_list|(
literal|0xE0100
...
name|insert
argument_list|(
literal|"IsSupplementaryPrivateUseArea-A"
argument_list|,
name|qMakePair
argument_list|(
literal|0xF0000
...
name|insert
argument_list|(
literal|"IsSupplementaryPrivateUseArea-B"
argument_list|,
name|qMakePair
argument_list|(
literal|0x100000
