...
return|;
block|}
comment|// Android uses the following deprecated codes
if|if
condition|(
name|uc1
operator|==
...
name|DFDecimal
condition|)
comment|// optimize for numbers between -512k and 512k
name|bufSize
operator|+=
operator|(
operator|(
...
name|precision
decl_stmt|;
comment|// Find out which representation is shorter
if|if
condition|(
name|precision
operator|==
...
name|cutoff
expr_stmt|;
comment|// decpt shown in exponent form, but not in decimal form
block|}
if|if
condition|(
name|decpt
...
literal|1
expr_stmt|;
comment|// leading digit is not 0, forget exponent_idx
elseif|else
if|if
condition|(
name|out
...
return|;
block|}
comment|// The only non-digit character after the 'e' can be '+' or '-'.
comment|// If a zero is directly after that, then the exponent is zero-padded.
if|if
condition|(
operator|(
name|number_options
