...
comment|// ### Qt 5: see tests/benchmarks/corelib/tools/qhash/qhash_string.cpp
comment|// Hashing of the whole string is a waste of cycles.
comment|/*     These functions are based on Peter J. Weinberger's hash function     (from the Dragon Book). The constant 24 in the original function     was replaced with 23 to produce fewer collisions on input such as     "a", "aa", "aaa", "aaaa", ... */
DECL|function|hash
specifier|static
name|uint
name|hash
...
end_comment
begin_comment
comment|/*! \fn T&QHash::iterator::value() const      Returns a modifiable reference to the current item's value.      You can change the value of an item by using value() on     the left side of an assignment, for example:      \snippet doc/src/snippets/code/src_corelib_tools_qhash.cpp 22      \sa key(), operator*() */
end_comment
begin_comment
