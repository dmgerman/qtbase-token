...
end_endif
begin_comment
comment|// Windows Runtime and CE use a QHash to fake environment variables. To avoid
end_comment
begin_comment
comment|// deadlock, disable reading the QT_HASH_SEED environment variable within
end_comment
begin_comment
comment|// QHash.
end_comment
