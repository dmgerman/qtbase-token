...
end_comment
begin_comment
comment|/*! \fn QList::QList(const QList<T>&other)      Constructs a copy of \a other.      This operation takes \l{Algorithmic Complexity}{constant time},     because QList is \l{implicitly shared}. This makes returning a     QList from a function very fast. If a shared instance is modified,     it will be copied (copy-on-write), and that takes     \l{Algorithmic Complexity}{linear time}.      \sa operator=() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*! \fn const T&QList::at(int i) const      Returns the item at index position \a i in the list. \a i must be     a valid index position in the list (i.e., 0<= \a i< size()).      This function is very fast (\l{Algorithmic Complexity}{constant time}).      \sa value(), operator[]() */
end_comment
begin_comment
comment|/*! \fn T&QList::operator[](int i)      Returns the item at index position \a i as a modifiable reference.     \a i must be a valid index position in the list (i.e., 0<= \a i<     size()).      If this function is called on a list that is currently being shared, it     will trigger a copy of all elements. Otherwise, this function runs in     \l{Algorithmic Complexity}{constant time}. If you do not want to modify     the list you should use QList::at().      \sa at(), value() */
end_comment
begin_comment
comment|/*! \fn const T&QList::operator[](int i) const      \overload      Same as at(). This function runs in \l{Algorithmic Complexity}{constant time}. */
end_comment
begin_comment
