...
comment|/*!     Returns true if the character is a printable character; otherwise     returns false. This is any character not of category Other_*.      Note that this gives no indication of whether the character is     available in a particular font. */
...
end_function
begin_comment
comment|/*!     Returns true if the character is a mark (Mark_* categories);     otherwise returns false.      See QChar::Category for more information regarding marks. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns true if the character is a punctuation mark (Punctuation_*     categories); otherwise returns false. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns true if the character is a symbol (Symbol_* categories);     otherwise returns false. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the numeric value of the digit, specified by the UCS-2-encoded     character, \a ucs2, or -1 if the character is not a digit. */
end_comment
begin_function
DECL|function|digitValue
name|int
...
end_function
begin_comment
comment|/*!     Returns the character's category. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the category of the UCS-2-encoded character specified by \a ucs2. */
end_comment
begin_function
DECL|function|category
name|QChar
...
end_function
begin_comment
comment|/*!     Returns the character's direction. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the direction of the UCS-2-encoded character specified by \a ucs2. */
end_comment
begin_function
DECL|function|direction
name|QChar
...
end_function
begin_comment
comment|/*!     Returns information about the joining properties of the character     (needed for certain languages such as Arabic). */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns true if the character should be reversed if the text     direction is reversed; otherwise returns false.      Same as (ch.mirroredChar() != ch).      \sa mirroredChar() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn bool QChar::isLower() const      Returns true if the character is a lowercase letter, i.e.     category() is Letter_Lowercase.      \sa isUpper(), toLower(), toUpper() */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     \overload     Returns the mirrored character if the UCS-2-encoded character specified     by \a ucs2 is a mirrored character; otherwise returns the character itself.      \sa hasMirrored() */
end_comment
begin_function
DECL|function|mirroredChar
name|ushort
...
end_function
begin_comment
comment|/*!     Returns the tag defining the composition of the character. Returns     QChar::NoDecomposition if no decomposition exists. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the combining class for the character as defined in the     Unicode standard. This is mainly useful as a positioning hint for     marks attached to a base character.      The Qt text rendering engine uses this information to correctly     position non-spacing marks around a base character. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the combining class for the UCS-2-encoded character specified by     \a ucs2, as defined in the Unicode standard. */
end_comment
begin_function
DECL|function|combiningClass
name|unsigned
...
end_function
begin_comment
comment|/*!     Returns the Unicode version that introduced this character. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the Unicode version that introduced the character specified in     its UCS-2-encoded form as \a ucs2. */
end_comment
begin_function
DECL|function|unicodeVersion
name|QChar
...
end_function
begin_comment
comment|/*!     Returns the lowercase equivalent if the character is uppercase or titlecase;     otherwise returns the character itself. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the lowercase equivalent of the UCS-2-encoded character specified     by \a ucs2 if the character is uppercase or titlecase; otherwise returns     the character itself. */
end_comment
begin_function
DECL|function|toLower
name|ushort
...
end_function
begin_comment
comment|/*!     Returns the uppercase equivalent if the character is lowercase or titlecase;     otherwise returns the character itself. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the uppercase equivalent of the UCS-2-encoded character specified     by \a ucs2 if the character is lowercase or titlecase; otherwise returns     the character itself. */
end_comment
begin_function
DECL|function|toUpper
name|ushort
...
end_function
begin_comment
comment|/*!     Returns the title case equivalent if the character is lowercase or uppercase;     otherwise returns the character itself. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the title case equivalent of the UCS-2-encoded character specified     by \a ucs2 if the character is lowercase or uppercase; otherwise returns     the character itself. */
end_comment
begin_function
DECL|function|toTitleCase
name|ushort
...
end_function
begin_comment
comment|/*!     Returns the case folded equivalent of the character. For most Unicode characters this     is the same as toLowerCase(). */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the case folded equivalent of the UCS-2-encoded character specified     by \a ucs2. For most Unicode characters this is the same as toLowerCase(). */
end_comment
begin_function
DECL|function|toCaseFolded
name|ushort
...
argument_list|)
expr_stmt|;
comment|// since the insert invalidates the pointers and we do decomposition recursive
name|utf16
operator|=
cast|reinterpret_cast
argument_list|<
...
condition|)
return|return;
comment|// the loop can partly ignore high Unicode as all ligatures are in the BMP
name|int
name|starter
init|=
literal|0
...
literal|1
expr_stmt|;
comment|// to prevent starter == pos - 1
name|lastCombining
operator|=
literal|0
expr_stmt|;
