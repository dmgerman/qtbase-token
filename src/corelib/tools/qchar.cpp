...
end_comment
begin_comment
comment|/*!     Returns true if the character is a printable character; otherwise     returns false. This is any character not of category Cc or Cn.      Note that this gives no indication of whether the character is     available in a particular font. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns true if the character is a letter (Letter_* categories);     otherwise returns false. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns the tag defining the composition of the character. Returns     QChar::Single if no decomposition exists. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload     Returns the tag defining the composition of the UCS-4-encoded character     specified by \a ucs4. Returns QChar::Single if no decomposition exists. */
end_comment
begin_function
DECL|function|decompositionTag
name|QChar
