...
name|QSharedPointer
argument_list|(
argument|QSharedPointer<X>&&other
argument_list|)
name|Q_DECL_NOTHROW
operator|:
name|value
...
name|enableSharedFromThis
argument_list|(
argument|const QEnableSharedFromThis<X> *ptr
argument_list|)
block|{
name|ptr
operator|->
...
name|QWeakPointer
argument_list|(
argument|const QWeakPointer&other
argument_list|)
end_macro
begin_label
name|Q_DECL_NOTHROW
...
name|QEnableSharedFromThis
argument_list|(
argument|const QEnableSharedFromThis&
argument_list|)
block|{}
name|QEnableSharedFromThis
operator|&
...
name|initializeFromSharedPointer
argument_list|(
argument|const QSharedPointer<X>&ptr
argument_list|)
specifier|const
block|{
name|weakPointer
