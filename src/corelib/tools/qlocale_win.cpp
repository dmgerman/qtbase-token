...
name|languageList
decl_stmt|;
comment|// Languages is a ranked list of "long names" (e.g. en-US) of preferred languages, which matches
comment|// languages from the manifest with languages from the user's system.
name|HRESULT
name|hr
init|=
name|appLanguagesStatics
...
expr_stmt|;
block|}
comment|// ManifestLanguages covers all languages given in the manifest and uses short names (like "en").
name|hr
operator|=
name|appLanguagesStatics
operator|->
...
argument_list|)
decl_stmt|;
comment|// There will not be any long name after the first short name was found, so we can stop.
if|if
condition|(
name|dashIndex
operator|==
