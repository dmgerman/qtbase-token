...
directive|else
comment|// see http://graphics.stanford.edu/~seander/bithacks.html#ZerosOnRightParallel
name|unsigned
name|int
name|c
init|=
literal|32
decl_stmt|;
comment|// c will be the number of zero bits on the right
name|v
operator|&=
operator|-
name|signed
...
directive|else
comment|// Hacker's Delight, 2nd ed. Fig 5-16, p. 102
name|v
operator|=
name|v
operator||
