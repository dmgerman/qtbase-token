...
name|str
parameter_list|)
value|([]() -> QStaticStringDataPtr<sizeof(QT_UNICODE_LITERAL(str))/2 - 1> { \         enum { Size = sizeof(QT_UNICODE_LITERAL(str))/2 - 1 }; \         static const QStaticStringData<Size> qstring_literal = \         { { Q_REFCOUNT_INITIALIZE_STATIC, Size, 0, 0, sizeof(QStringData) }, QT_UNICODE_LITERAL(str) }; \         QStaticStringDataPtr<Size> holder = {&qstring_literal }; \     return holder; }())
end_define
begin_elif
elif|#
directive|elif
...
parameter_list|)
define|\
value|__extension__ ({ \         enum { Size = sizeof(QT_UNICODE_LITERAL(str))/2 - 1 }; \         static const QStaticStringData<Size> qstring_literal = \         { { Q_REFCOUNT_INITIALIZE_STATIC, Size, 0, 0, sizeof(QStringData) }, QT_UNICODE_LITERAL(str) }; \         QStaticStringDataPtr<Size> holder = {&qstring_literal }; \         holder; })
end_define
begin_endif
endif|#
directive|endif
...
name|d
argument_list|(
argument|const_cast<Data *>(&shared_null.str)
argument_list|)
block|{}
specifier|inline
name|QString
