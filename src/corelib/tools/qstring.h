...
directive|endif
comment|// !defined(QT_NO_CAST_FROM_ASCII)&& !defined(QT_RESTRICTED_CAST_FROM_ASCII)
name|private
label|:
name|int
name|m_size
...
name|ap
parameter_list|)
function_decl|Q_ATTRIBUTE_FORMAT_PRINTF
parameter_list|(
function_decl|2
operator|,
function_decl|0
...
end_function_decl
begin_comment
comment|// ### Qt6: make inline except for the long long versions
end_comment
begin_decl_stmt
name|short
name|toShort
...
name|d
argument_list|(
argument|fromAscii_helper(ch, N -
literal|1
argument|)
argument_list|)
block|{}
...
name|d
argument_list|(
argument|fromAscii_helper(a.constData(), a.size())
argument_list|)
block|{}
specifier|inline
name|QT_ASCII_CAST_WARN
...
end_typedef
begin_comment
comment|// we select the right overload by casting size() to int or uint
end_comment
begin_decl_stmt
name|Int64
name|val
...
name|fromStdU16String
argument_list|(
argument|const std::u16string&s
argument_list|)
block|{
return|return
name|fromUtf16
...
name|fromStdU32String
argument_list|(
argument|const std::u32string&s
argument_list|)
block|{
return|return
name|fromUcs4
...
literal|0
argument_list|)
comment|// ### Qt 6: remove all of these, the implicit ones are fine
name|QStringRef
argument_list|(
argument|const QStringRef&other
argument_list|)
name|Q_DECL_NOTHROW
label|:
name|m_string
