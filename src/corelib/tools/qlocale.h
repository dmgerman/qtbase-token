...
name|Q_CORE_EXPORT
name|QSystemLocale
decl_stmt|{ public:     QSystemLocale(
end_function
begin_empty_stmt
unit|)
empty_stmt|;
...
decl|const
decl_stmt|;
comment|//private:                        // this should be private, but can't be
struct|struct
name|Data
block|{
name|quint16
...
name|QLocalePrivate
struct_decl|;
comment|// ### We now use this field to pack an index into locale_data and NumberOptions.
comment|// ### Qt 5: change to a QLocaleData *d; uint numberOptions.
union|union
block|{
name|void
modifier|*
