...
end_comment
begin_comment
comment|/*!     \variable QByteArray::MaxSize     \internal     \since 5.4      The maximum size of a QByteArray, in bytes. Also applies to a the maximum     storage size of QString and QVector, though not the number of elements. */
end_comment
begin_comment
