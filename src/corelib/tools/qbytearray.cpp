...
end_comment
begin_comment
comment|/*!     \variable QByteArray::MaxSize     \internal     \since 5.4      The maximum size of a QByteArray (including a '\0' terminator), in bytes.     Also applies to the maximum storage size of QString and QVector, though     not the number of elements. */
end_comment
begin_comment
