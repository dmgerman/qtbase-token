...
literal|16
argument_list|>
name|argPosToNumberMap
decl_stmt|;
comment|// maps from argument position to number
public|public:
DECL|function|found
name|void
name|found
...
name|AssignmentResult
name|assignArgumentNumberToEachOfTheNs
parameter_list|(
name|int
name|numArgs
parameter_list|)
...
literal|0
decl_stmt|;
comment|// populate the arg-mapper with the %n's that actually occur in the string
while|while
condition|(
name|i
operator|<
