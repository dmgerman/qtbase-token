...
end_comment
begin_comment
comment|/*! \fn QString::QString(const char *str)      Constructs a string initialized with the 8-bit string \a str. The     given const char pointer is converted to Unicode using the     fromAscii() function.      You can disable this constructor by defining \c     QT_NO_CAST_FROM_ASCII when you compile your applications. This     can be useful if you want to ensure that all user-visible strings     go through QObject::tr(), for example.      \sa fromAscii(), fromLatin1(), fromLocal8Bit(), fromUtf8() */
end_comment
begin_comment
comment|/*! \fn QString QString::fromStdString(const std::string&str)      Returns a copy of the \a str string. The given string is converted     to Unicode using the fromAscii() function.      This constructor is only available if Qt is configured with STL     compatibility enabled.      \sa  fromAscii(), fromLatin1(), fromLocal8Bit(), fromUtf8() */
end_comment
begin_comment
comment|/*! \fn QString QString::fromStdWString(const std::wstring&str)      Returns a copy of the \a str string. The given string is assumed     to be encoded in utf16 if the size of wchar_t is 2 bytes (e.g. on     windows) and ucs4 if the size of wchar_t is 4 bytes (most Unix     systems).      This method is only available if Qt is configured with STL     compatibility enabled.      \sa fromUtf16(), fromLatin1(), fromLocal8Bit(), fromUtf8(), fromUcs4() */
end_comment
begin_comment
comment|/*!     \since 4.2      Returns a copy of the \a string, where the encoding of \a string depends on     the size of wchar. If wchar is 4 bytes, the \a string is interpreted as ucs-4,     if wchar is 2 bytes it is interpreted as ucs-2.      If \a size is -1 (default), the \a string has to be 0 terminated.      \sa fromUtf16(), fromLatin1(), fromLocal8Bit(), fromUtf8(), fromUcs4(), fromStdWString() */
end_comment
begin_function
...
end_comment
begin_comment
comment|/*!     Constructs a string initialized with the first \a size characters     of the QChar array \a unicode.      QString makes a deep copy of the string data. The unicode data is copied as     is and the Byte Order Mark is preserved if present. */
end_comment
begin_constructor
...
end_constructor
begin_comment
comment|/*!     \since 4.7      Constructs a string initialized with the characters of the QChar array     \a unicode, which must be terminated with a 0.      QString makes a deep copy of the string data. The unicode data is copied as     is and the Byte Order Mark is preserved if present. */
end_comment
begin_constructor
DECL|function|QString
name|QString
...
end_comment
begin_comment
comment|// ### Qt 5: rename freeData() to avoid confusion. See task 197625.
end_comment
begin_function
DECL|function|free
name|void
...
end_comment
begin_comment
comment|/*! \fn QString&QString::operator=(const char *str)      \overload operator=()      Assigns \a str to this string. The const char pointer is converted     to Unicode using the fromAscii() function.      You can disable this operator by defining \c     QT_NO_CAST_FROM_ASCII when you compile your applications. This     can be useful if you want to ensure that all user-visible strings     go through QObject::tr(), for example. */
end_comment
begin_comment
comment|/*! \fn QString&QString::operator=(char ch)      \overload operator=()      Assigns character \a ch to this string. The character is converted     to Unicode using the fromAscii() function.      You can disable this operator by defining \c     QT_NO_CAST_FROM_ASCII when you compile your applications. This     can be useful if you want to ensure that all user-visible strings     go through QObject::tr(), for example. */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*! \fn QString&QString::append(const char *str)      \overload append()      Appends the string \a str to this string. The given const char     pointer is converted to Unicode using the fromAscii() function.      You can disable this function by defining \c QT_NO_CAST_FROM_ASCII     when you compile your applications. This can be useful if you want     to ensure that all user-visible strings go through QObject::tr(),     for example. */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*! \fn QString&QString::prepend(const char *str)      \overload prepend()      Prepends the string \a str to this string. The const char pointer     is converted to Unicode using the fromAscii() function.      You can disable this function by defining \c     QT_NO_CAST_FROM_ASCII when you compile your applications. This     can be useful if you want to ensure that all user-visible strings     go through QObject::tr(), for example. */
end_comment
begin_comment
...
end_struct
begin_comment
comment|/*!   \overload replace()    Replaces every occurrence of the regular expression \a rx in the   string with \a after. Returns a reference to the string. For   example:    \snippet doc/src/snippets/qstring/main.cpp 42    For regular expressions containing \l{capturing parentheses},   occurrences of \bold{\\1}, \bold{\\2}, ..., in \a after are replaced   with \a{rx}.cap(1), cap(2), ...    \snippet doc/src/snippets/qstring/main.cpp 43    \sa indexOf(), lastIndexOf(), remove(), QRegExp::cap() */
end_comment
begin_function
DECL|function|replace
name|QString
...
expr_stmt|;
block|{
comment|// each 16 bit is equal to 0xFF if the source is outside latin 1 (>0xff)
specifier|const
name|__m128i
name|signedChunk
init|=
...
expr_stmt|;
block|{
comment|// exactly the same operations as for the previous chunk of data
specifier|const
name|__m128i
name|signedChunk
init|=
...
end_function
begin_comment
comment|/*!     Returns a Latin-1 representation of the string as a QByteArray.      The returned byte array is undefined if the string contains non-Latin1     characters. Those characters may be suppressed or replaced with a     question mark.      \sa fromLatin1(), toAscii(), toUtf8(), toLocal8Bit(), QTextCodec */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \since 4.2      Returns a UCS-4/UTF-32 representation of the string as a QVector<uint>.      UCS-4 is a Unicode codec and is lossless. All characters from this string     can be encoded in UCS-4. The vector is not null terminated.      \sa fromUtf8(), toAscii(), toLatin1(), toLocal8Bit(), QTextCodec, fromUcs4(), toWCharArray() */
end_comment
begin_function
...
end_comment
begin_comment
comment|/*! \fn QString&QString::operator+=(char ch)      \overload operator+=()      Appends the character \a ch to this string. The character is     converted to Unicode using the fromAscii() function.      You can disable this function by defining \c QT_NO_CAST_FROM_ASCII     when you compile your applications. This can be useful if you want     to ensure that all user-visible strings go through QObject::tr(),     for example. */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn const QString operator+(const QString&s1, const char *s2)     \relates QString      Returns a string which is the result of concatenating \a s1 and \a     s2 (\a s2 is converted to Unicode using the QString::fromAscii()     function).      \sa QString::fromAscii() */
end_comment
begin_comment
comment|/*!     \fn const QString operator+(const char *s1, const QString&s2)     \relates QString      Returns a string which is the result of concatenating \a s1 and \a     s2 (\a s1 is converted to Unicode using the QString::fromAscii()     function).      \sa QString::fromAscii() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \overload compare()      Lexically compares this string with the \a other string and     returns an integer less than, equal to, or greater than zero if     this string is less than, equal to, or greater than the other     string.      Equivalent to \c {compare(*this, other)}. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns a lowercase copy of the string.      \snippet doc/src/snippets/qstring/main.cpp 75      \sa toUpper() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Returns an uppercase copy of the string.      \snippet doc/src/snippets/qstring/main.cpp 81      \sa toLower() */
end_comment
begin_function
...
end_function
begin_comment
comment|// ### Qt 5: Consider whether this function shouldn't be removed See task 202871.
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn QString QString::normalized(NormalizationForm mode) const     Returns the string in the given Unicode normalization \a mode. */
end_comment
begin_function
...
end_function_decl
begin_comment
comment|/*!     \overload     \fn QString QString::normalized(NormalizationForm mode, QChar::UnicodeVersion version) const      Returns the string in the given Unicode normalization \a mode,     according to the given \a version of the Unicode standard. */
end_comment
begin_function
DECL|function|normalized
name|QString
...
end_comment
begin_comment
comment|/*!     \fn bool QLatin1String::operator==(const char *other) const     \since 4.3     \overload      The \a other const char pointer is converted to a QString using     the QString::fromAscii() function.      You can disable this operator by defining \c     QT_NO_CAST_FROM_ASCII when you compile your applications. This     can be useful if you want to ensure that all user-visible strings     go through QObject::tr(), for example. */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn bool QLatin1String::operator!=(const char *other) const     \since 4.3     \overload operator!=()      The \a other const char pointer is converted to a QString using     the QString::fromAscii() function.      You can disable this operator by defining \c     QT_NO_CAST_FROM_ASCII when you compile your applications. This     can be useful if you want to ensure that all user-visible strings     go through QObject::tr(), for example. */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     Returns a Latin-1 representation of the string reference as a QByteArray.      The returned byte array is undefined if the string reference contains     non-Latin1 characters. Those characters may be suppressed or replaced with a     question mark.      \sa QString::toLatin1(), toUtf8()     \since 4.8 */
end_comment
begin_function
DECL|function|toLatin1
name|QByteArray
...
end_function
begin_comment
comment|/*!     \since 4.8      Returns a Latin-1 representation of the string as a QByteArray.      The returned byte array is undefined if the string contains non-Latin1     characters. Those characters may be suppressed or replaced with a     question mark.      \sa toAscii(), toUtf8(), toLocal8Bit(), QTextCodec */
end_comment
begin_function
DECL|function|toLatin1
name|QByteArray
...
end_function
begin_comment
comment|/*!     \since 4.8      Returns an 8-bit representation of the string as a QByteArray.      If a codec has been set using QTextCodec::setCodecForCStrings(),     it is used to convert Unicode to 8-bit char; otherwise this     function does the same as toLatin1().      Note that, despite the name, this function does not necessarily return an US-ASCII     (ANSI X3.4-1986) string and its result may not be US-ASCII compatible.      \sa toLatin1(), toUtf8(), toLocal8Bit(), QTextCodec */
end_comment
begin_function
DECL|function|toAscii
name|QByteArray
