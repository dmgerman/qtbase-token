...
argument_list|(
argument|qFromUnaligned<long long>(c + offset)
argument_list|)
decl_stmt|;
name|__m128i
name|secondHalf
...
end_function
begin_comment
comment|/*!     \overload     \since 5.7      Unlike \l {QString::}{resize(int)}, this overload     initializes the new characters to \a fillChar:      \snippet qstring/main.cpp 46 */
end_comment
begin_function
DECL|function|resize
name|void
...
condition|)
block|{
comment|// assumes d->alloc == 0 â !isDetached() (sharedNull)
name|d
operator|->
name|size
operator|=
...
block|{
comment|// assumes d->alloc == 0 â !isDetached() (sharedNull)
comment|// re-use existing capacity:
name|ushort
modifier|*
name|dat
init|=
...
condition|)
block|{
comment|// so far, case convertion never changes planes (guaranteed by the qunicodetables generator)
name|pp
operator|++
expr_stmt|;
operator|*
...
argument_list|)
condition|)
comment|// preserve Qt 5.5 behavior of consuming all digits, no matter how many
operator|++
name|c
expr_stmt|;
return|return
...
name|c
expr_stmt|;
comment|// don't consume *c - it wasn't a flag
return|return
name|lm_none
return|;
block|}
...
condition|)
block|{
comment|// can't parse this in another function, not portably, at least
name|width
operator|=
name|va_arg
argument_list|(
...
end_comment
begin_comment
comment|/*! \fn QLatin1String::QLatin1String()     \since 5.6      Constructs a QLatin1String object that stores a nullptr. */
end_comment
begin_comment
comment|/*! \fn QLatin1String::QLatin1String(const char *str)      Constructs a QLatin1String object that stores \a str.      The string data is \e not copied. The caller must be able to     guarantee that \a str will not be deleted or modified as long as     the QLatin1String object exists.      \sa latin1() */
end_comment
begin_comment
comment|/*! \fn QLatin1String::QLatin1String(const char *str, int size)      Constructs a QLatin1String object that stores \a str with \a size.      The string data is \e not copied. The caller must be able to     guarantee that \a str will not be deleted or modified as long as     the QLatin1String object exists.      \sa latin1() */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \typedef QStringRef::const_iterator     \since 5.4      This typedef provides an STL-style const iterator for QStringRef.      \sa QStringRef::const_reverse_iterator */
end_comment
begin_comment
comment|/*!     \typedef QStringRef::const_reverse_iterator     \since 5.7      This typedef provides an STL-style const reverse iterator for QStringRef.      \sa QStringRef::const_iterator */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \fn QStringRef::const_iterator QStringRef::begin() const     \since 5.4      Returns a const \l{STL-style iterators}{STL-style iterator} pointing to the first character in     the string.      \sa cbegin(), end(), rbegin(), rend() */
end_comment
begin_comment
comment|/*!     \fn QStringRef::const_iterator QStringRef::cbegin() const     \since 5.4      Same as begin().      \sa begin(), cend(), rbegin(), rend() */
end_comment
begin_comment
comment|/*!     \fn QStringRef::const_iterator QStringRef::end() const     \since 5.4      Returns a const \l{STL-style iterators}{STL-style iterator} pointing to the imaginary     character after the last character in the list.      \sa cbegin(), end(), rbegin(), rend() */
end_comment
begin_comment
comment|/*! \fn QStringRef::const_iterator QStringRef::cend() const     \since 5.4      Same as end().      \sa end(), cbegin(), rbegin(), rend() */
end_comment
begin_comment
comment|/*!     \fn QStringRef::const_reverse_iterator QStringRef::rbegin() const     \since 5.7      Returns a const \l{STL-style iterators}{STL-style} reverse iterator pointing to the first     character in the string, in reverse order.      \sa begin(), crbegin(), rend() */
end_comment
begin_comment
comment|/*!     \fn QStringRef::const_reverse_iterator QStringRef::crbegin() const     \since 5.7      Same as rbegin().      \sa begin(), rbegin(), rend() */
end_comment
begin_comment
comment|/*!     \fn QStringRef::const_reverse_iterator QStringRef::rend() const     \since 5.7      Returns a \l{STL-style iterators}{STL-style} reverse iterator pointing to one past     the last character in the string, in reverse order.      \sa end(), crend(), rbegin() */
end_comment
begin_comment
comment|/*!     \fn QStringRef::const_reverse_iterator QStringRef::crend() const     \since 5.7      Same as rend().      \sa end(), rend(), rbegin() */
end_comment
begin_comment
