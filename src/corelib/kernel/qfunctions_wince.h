...
comment|// reimplented. Other projects do this as well and to not fill the
comment|// global namespace with this implementation, prepend qt_wince* and use
comment|// these versions inside of Qt.
...
name|d
parameter_list|)
value|qt_wince_getenv_s(a,b,c,d)
...
name|b
parameter_list|)
value|qt_wince__putenv_s(a,b)
DECL|macro|_getpid
define|#
directive|define
name|_getpid
parameter_list|()
value|qt_wince__getpid()
...
name|a
parameter_list|)
value|qt_wince_time_tToFt(a)
DECL|macro|_getdrive
define|#
directive|define
name|_getdrive
parameter_list|()
value|qt_wince__getdrive()
DECL|macro|_waccess
define|#
directive|define
name|_waccess
...
name|a
parameter_list|)
value|qt_wince_rewind(a)
DECL|macro|tmpfile
define|#
directive|define
name|tmpfile
parameter_list|()
value|qt_wince_tmpfile()
DECL|macro|_rename
define|#
directive|define
name|_rename
...
name|g
parameter_list|)
value|qt_wince_CreateFileA(a,b,c,d,e,f,g)
...
name|d
parameter_list|)
value|qt_wince_SetWindowOrgEx(a,b,c,d)
DECL|macro|calloc
define|#
directive|define
name|calloc
...
name|b
parameter_list|)
value|qt_wince_calloc(a,b)
DECL|macro|GetThreadLocale
define|#
directive|define
name|GetThreadLocale
parameter_list|()
value|qt_wince_GetThreadLocale()
...
name|c
parameter_list|)
value|qt_wince__beginthread(a,b,c)
...
name|f
parameter_list|)
value|qt_wince__beginthreadex(a,b,c,d,e,f)
...
name|e
parameter_list|)
value|qt_wince_bsearch(a,b,c,d,e)
ifdef|#
directive|ifdef
name|__cplusplus
block|}
