...
end_ifdef
begin_comment
comment|/*!     \obsolete      Use the QSocketNotifier() constructor combined with the     QObject::setObjectName() function instead.      \oldcode         QSocketNotifier *notifier = new QSocketNotifier(socket, type, parent, name);     \newcode         QSocketNotifier *notifier = new QSocketNotifier(socket, type, parent);         notifier->setObjectName(name);     \endcode */
end_comment
begin_constructor
DECL|function|QSocketNotifier
name|QSocketNotifier
...
end_comment
begin_comment
comment|/*!     \fn int QSocketNotifier::socket() const      Returns the socket identifier specified to the constructor.      \sa type() */
end_comment
begin_comment
comment|/*!     \fn Type QSocketNotifier::type() const      Returns the socket event type specified to the constructor.      \sa socket() */
end_comment
begin_comment
comment|/*!     \fn bool QSocketNotifier::isEnabled() const      Returns true if the notifier is enabled; otherwise returns false.      \sa setEnabled() */
end_comment
begin_comment
