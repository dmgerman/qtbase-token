...
end_function
begin_comment
comment|/*!     Returns a QVariant storing a QImage if the object can return an     image; otherwise returns a null variant.      A QVariant is used because QMimeData belongs to the \l QtCore     library, whereas QImage belongs to \l QtGui. To convert the     QVariant to a QImage, simply use qvariant_cast(). For example:      \snippet doc/src/snippets/code/src_corelib_kernel_qmimedata.cpp 5      \sa hasImage() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Sets the data in the object to the given \a image.      A QVariant is used because QMimeData belongs to the \l QtCore     library, whereas QImage belongs to \l QtGui. The conversion     from QImage to QVariant is implicit. For example:      \snippet doc/src/snippets/code/src_corelib_kernel_qmimedata.cpp 6      \sa hasImage(), setData() */
end_comment
begin_function
