...
end_comment
begin_comment
comment|/*!     \typedef QCoreApplication::EventFilter      A function with the following signature that can be used as an     event filter:      \snippet code/src_corelib_kernel_qcoreapplication.cpp 3      \sa setEventFilter() */
end_comment
begin_comment
