...
name|value
decl_stmt|;
comment|// reverse iterate to ensure values like Qt::Dialog=0x2|Qt::Window are processed first.
for|for
control|(
name|int
name|i
...
end_function
begin_comment
comment|/*!     \fn QMetaEnum QMetaEnum::fromType()     \since 5.5      Returns the QMetaEnum corresponding to the type in the template parameter.     The enum needs to be declared with Q_ENUM. */
end_comment
begin_function
