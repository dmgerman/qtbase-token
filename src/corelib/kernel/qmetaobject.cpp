...
end_function
begin_comment
comment|/*! \internal     Returns the signal for the given \a metaObject at \a signal_index.      It it different from QMetaObject::method(); the index should not include     non-signal methods.      The index must correspond to a signal defined in \ a metaObject itself;     it should not be an inherited signal. */
end_comment
begin_function
