...
name|signalOffset
expr_stmt|;
comment|// duplicated from QMetaObjectPrivate::connect
name|QObject
modifier|*
name|s
init|=
...
argument_list|()
operator|<<
literal|"QObject::connect: Qt::UniqueConnection not supported when connecting function pointers"
expr_stmt|;
name|type
operator|=
cast|static_cast
...
end_destructor
begin_comment
comment|/*!     \fn bool QMetaObject::Connection::operator bool()      Returns true if the connection is valid.      The connection is valid if the call to QObject::connect succeeded.     The connection is invalid if QObject::connect was not able to find     the signal or the slot, or if the arguments do not match.  */
end_comment
begin_destructor
