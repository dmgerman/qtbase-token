...
condition|)
block|{
comment|// The possible declarative connection is done, and nothing else is connected, so:
return|return;
block|}
name|void
modifier|*
