...
end_comment
begin_comment
comment|/*!     \fn void QPointer::swap(QPointer&other)     \since 5.6      Swaps the contents of this QPointer with the contents of \a other.     This operation is very fast and never fails. */
end_comment
begin_comment
