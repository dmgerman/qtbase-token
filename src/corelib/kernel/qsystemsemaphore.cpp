...
name|initialValue
expr_stmt|;
comment|// cache the file name so it doesn't have to be generated all the time.
name|d
operator|->
name|fileName
operator|=
...
end_function
begin_comment
comment|/*!   Returns the key assigned to this system semaphore. The key is the   name by which the semaphore can be accessed from other processes.    \sa setKey()  */
end_comment
begin_function
DECL|function|key
name|QString
...
name|qWarning
argument_list|(
literal|"QSystemSemaphore::release: n is negative."
argument_list|)
expr_stmt|;
return|return
literal|false
