...
condition|)
block|{
comment|// We got an env. pointer (We expect this to be the right env. and call FindClass())
name|QWriteLocker
name|locker
argument_list|(
name|cachedClassesLock
...
literal|0
condition|)
comment|// We didn't get an env. pointer or we got one with the WRONG class loader...
name|clazz
operator|=
name|loadClassDotEnc
argument_list|(
