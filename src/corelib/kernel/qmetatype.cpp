...
argument_list|)
block|,
comment|// let QMetaTypeId2 figure out the type at compile time
name|QT_ADD_STATIC_METATYPE
argument_list|(
literal|"qreal"
argument_list|,
...
end_function
begin_comment
comment|/*! \internal      Registers a user type for marshalling, with \a typeName, a \a     destructor, and a \a constructor. Returns the type's handle,     or -1 if the type could not be registered.  */
end_comment
begin_function
