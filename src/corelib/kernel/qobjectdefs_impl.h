...
end_if
begin_comment
comment|/*        Find the maximum number of arguments a functor object can take and be still compatible with        the arguments from the signal.        Value is the number of arguments, or -1 if nothing matches.      */
end_comment
begin_expr_stmt
name|template
operator|<
...
operator|>
expr|struct
name|ComputeFunctorArgumentCountHelper
block|{ enum
block|{
name|Value
operator|=
...
name|int
argument_list|(
argument|ComputeFunctorArgumentCountHelper<Functor
argument_list|,
...
end_expr_stmt
begin_comment
comment|/* get the return type of a functor, given the signal argument list  */
end_comment
begin_expr_stmt
name|template
operator|<
...
name|decltype
argument_list|(
argument|dummy<Functor>().operator()((dummy<ArgList>())...)
argument_list|)
name|Value
expr_stmt|;
block|}
