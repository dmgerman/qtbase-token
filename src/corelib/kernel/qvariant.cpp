...
end_namespace
begin_comment
comment|// annonymous used to hide TypeDefiniton
end_comment
begin_namespace
namespace|namespace
block|{
...
end_function
begin_comment
comment|/*!   \fn convert(const int type, void *ptr) const   \internal   Created for qvariant_cast() usage */
end_comment
begin_function
DECL|function|convert
name|bool
