...
name|destroy
argument_list|(
argument|AbstractConverterFunction *_this
argument_list|)
block|{
name|delete
name|static_cast
...
argument_list|(
argument|new QtPrivate::ConverterMemberFunction<From
argument_list|,
...
name|registerConverterFunction
argument_list|(
argument|new QtPrivate::ConverterMemberFunctionOk<From
argument_list|,
argument|To>(function)
argument_list|,
argument|fromTypeId
...
name|registerConverterFunction
argument_list|(
argument|new QtPrivate::ConverterFunctor<From
argument_list|,
argument|To
argument_list|,
argument|UnaryFunction>(function)
...
name|registerConverterFunction
argument_list|(
argument|new QtPrivate::ConverterFunctor<T
argument_list|,
argument|QtMetaTypePrivate::QSequentialIterableImpl
argument_list|,
argument|QtMetaTypePrivate::QSequentialIterableConvertFunctor<T>>(f)
argument_list|,
argument|id
argument_list|,
argument|toId
