...
operator|>
expr|struct
name|BuiltInEqualsComparatorFunction
operator|:
name|public
name|AbstractComparatorFunction
block|{
...
operator|)
argument_list|,
literal|"QMetaType::registerEqualsComparator: The type must be a custom type."
argument_list|)
block|;
specifier|const
name|int
...
directive|endif
comment|// ### Qt6: FIXME: Remove the special Q_CC_MSVC handling, it was introduced to maintain BC.
if|#
directive|if
operator|!
name|defined
