...
end_decl_stmt
begin_comment
comment|// GetModuleFileName only exists for MSVC2015 and upwards for WinRT, meaning
end_comment
begin_comment
comment|// Windows 10 (Mobile). Hence take the first argument passed to the
end_comment
begin_comment
comment|// QCoreApplication contructor for older versions as a fallback on older platforms.
end_comment
begin_if
if|#
directive|if
...
end_else
begin_comment
comment|// !(defined(Q_OS_WINRT)&& _MSC_VER< 1900)
end_comment
begin_function
DECL|function|qAppFileName
name|Q_CORE_EXPORT
