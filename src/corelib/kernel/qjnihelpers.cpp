...
specifier|static
name|jmethodID
name|g_hideSplashScreenMethodID
init|=
name|Q_NULLPTR
decl_stmt|;
end_decl_stmt
...
block|,
block|{
literal|"setNativeService"
block|,
literal|"(Landroid/app/Service;)V"
block|,
expr|reinterpret_cast
operator|<
name|void
