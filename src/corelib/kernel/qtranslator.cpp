...
name|prefix
expr_stmt|;
comment|// using += in the hope for some reserve capacity
specifier|const
name|int
name|realNameBaseSize
init|=
name|realname
operator|.
name|size
...
specifier|const
name|int
name|realNameBaseSizeFallbacks
init|=
name|path
operator|.
name|size
...
argument_list|()
decl_stmt|;
comment|// realname == path + filename + prefix;
if|if
condition|(
operator|!
name|suffix
...
argument_list|)
expr_stmt|;
comment|// realname == path + filename;
if|if
condition|(
name|is_readable_file
argument_list|(
