...
condition|)
block|{
comment|// In case the application is launched via activation
comment|// there might not be a main view (eg ShareTarget).
comment|// Hence iterate through the available views and try to find
comment|// a dispatcher in there
name|ComPtr
argument_list|<
name|IVectorView
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// ### FIXME: iterate over hash directly? But unregisterTimer() modifies the hash!
for|for
control|(
name|int
name|id
