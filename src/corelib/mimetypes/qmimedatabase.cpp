...
name|bool
name|qt_isQMimeDatabaseDebuggingActivated
argument_list|(
literal|false
argument_list|)
decl_stmt|;
...
name|DBG
parameter_list|()
value|if (qt_isQMimeDatabaseDebuggingActivated) qDebug()<< static_cast<const void *>(this)<< Q_FUNC_INFO
end_define
begin_else
else|#
directive|else
