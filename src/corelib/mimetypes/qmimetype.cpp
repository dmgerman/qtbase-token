...
end_function
begin_comment
comment|/*!     \since 5.6     \relates QMimeType      Returns the hash value for \a key, using     \a seed to seed the calculation.  */
end_comment
begin_function
name|uint
name|qHash
