...
name|bool
name|qt_isQMimeTypeDebuggingActivated
argument_list|(
literal|false
argument_list|)
decl_stmt|;
...
name|DBG
parameter_list|()
value|if (qt_isQMimeTypeDebuggingActivated) qDebug()<< static_cast<const void *>(this)<< Q_FUNC_INFO
end_define
begin_else
else|#
directive|else
...
name|DBG
parameter_list|()
value|if (0) qDebug()<< static_cast<const void *>(this)<< Q_FUNC_INFO
end_define
begin_endif
endif|#
directive|endif
...
operator|)
expr_stmt|;
comment|//DBG()<< comment<< other.comment<< (comment == other.comment);
name|DBG
argument_list|()
operator|<<
name|localeComments
...
argument_list|()
expr_stmt|;
comment|//DBG()<< "aliases():"<< aliases();
comment|//DBG()<< "comment():"<< comment();
name|DBG
argument_list|()
operator|<<
literal|"genericIconName():"
operator|<<
name|genericIconName
argument_list|()
expr_stmt|;
...
end_ifdef
begin_comment
comment|/*!     \fn QMimeType::QMimeType(QMimeType&&other);     Constructs this QMimeType object by moving the data of the rvalue reference \a other.  */
end_comment
begin_constructor
DECL|function|QMimeType
name|QMimeType
