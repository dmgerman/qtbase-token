...
parameter_list|)
block|{
comment|// we test all possibilities so that we report whether a file is a binary or not
specifier|const
name|fat_header
modifier|*
name|fat
...
name|tr
argument_list|(
literal|"'%1' is not a Mach-O binary (%2)"
argument_list|)
operator|.
name|arg
argument_list|(
...
condition|)
block|{
comment|// fat binaries must contain at least two architectures
return|return
name|ns
argument_list|(
name|QLibrary
