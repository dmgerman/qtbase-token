...
parameter_list|)
define|\
value|static QT_PREPEND_NAMESPACE(QObject) *qt_plugin_instance() \     Q_PLUGIN_INSTANCE(PLUGINCLASS) \     static const char *qt_plugin_query_metadata() { return (const char *)qt_pluginMetaData; } \     const QT_PREPEND_NAMESPACE(QStaticPlugin) qt_static_plugin_##PLUGINCLASS() { \         QT_PREPEND_NAMESPACE(QStaticPlugin) plugin = { qt_plugin_instance, qt_plugin_query_metadata }; \         return plugin; \     }
end_define
begin_else
else|#
directive|else
...
parameter_list|)
define|\
value|static QT_PREPEND_NAMESPACE(QObject) *qt_plugin_instance() \     Q_PLUGIN_INSTANCE(PLUGINCLASS) \     const QT_PREPEND_NAMESPACE(QStaticPlugin) qt_static_plugin_##PLUGIN() { \         QT_PREPEND_NAMESPACE(QStaticPlugin) plugin = { qt_plugin_instance, 0 }; \         return plugin; \     }
end_define
begin_else
else|#
directive|else
...
parameter_list|)
define|\
value|QT_PLUGIN_VERIFICATION_SECTION Q_PLUGIN_VERIFICATION_DATA \             Q_EXTERN_C Q_DECL_EXPORT \             const char * qt_plugin_query_verification_data() \             { return qt_plugin_verification_data; } \             Q_EXTERN_C Q_DECL_EXPORT QT_PREPEND_NAMESPACE(QObject) * qt_plugin_instance() \             Q_PLUGIN_INSTANCE(PLUGINCLASS)
end_define
begin_define
DECL|macro|Q_EXPORT_STATIC_PLUGIN2
define|#
