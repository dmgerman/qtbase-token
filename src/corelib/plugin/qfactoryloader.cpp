...
namespace|namespace
block|{
comment|// avoid duplicate QStringLiteral data:
...
argument_list|(
argument|QList<QFactoryLoader *>
argument_list|,
argument|qt_factory_loaders
argument_list|)
end_macro
begin_macro
...
argument|QMutex
argument_list|,
argument|qt_factoryloader_mutex
argument_list|,
