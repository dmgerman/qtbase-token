...
parameter_list|)
block|{
comment|//in the case of consistent timing we make sure the orders in which events come is always the same
...
name|qWarning
argument_list|(
literal|"QUnifiedTimer: Cannot change animation driver while animations are running"
argument_list|)
expr_stmt|;
return|return;
block|}
