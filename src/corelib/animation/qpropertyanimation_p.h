...
name|target
block|;
comment|//we use targetValue to be able to unregister the target from the global hash
name|QObject
operator|*
name|targetValue
block|;
comment|//for the QProperty
name|int
name|propertyType
block|;
name|int
...
end_endif
begin_comment
comment|//QPROPERTYANIMATION_P_H
end_comment
end_unit
