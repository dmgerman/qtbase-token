...
end_endif
begin_comment
comment|// !QT_NO_DEBUG&& Q_CC_MSVC&& !Q_OS_WINCE&& !Q_OS_WINRT
end_comment
begin_comment
...
return|return;
block|}
comment|// Calling ExitThread() in setTerminationEnabled is all we can do on WinRT
ifndef|#
directive|ifndef
name|Q_OS_WINRT
