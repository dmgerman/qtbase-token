...
name|qWarning
argument_list|(
literal|"QThread::terminate: Terminate is not supported on WinRT"
argument_list|)
expr_stmt|;
name|CloseHandle
argument_list|(
...
name|qErrnoWarning
argument_list|(
literal|"QThread::wait: WaitForSingleObjectEx() failed"
argument_list|)
expr_stmt|;
break|break;
case|case
...
name|qWarning
argument_list|(
literal|"QThread::setPriority: Failed to set thread priority (not implemented)"
argument_list|)
expr_stmt|;
return|return;
block|}
