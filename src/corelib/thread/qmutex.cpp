...
end_function
begin_comment
comment|/*!     \overload     \since 5.7      Returns \c true if the mutex is recursive */
end_comment
begin_function
name|bool
name|QBasicMutex
...
name|FreeList
typedef|;
comment|// We cannot use Q_GLOBAL_STATIC because it uses QMutex
if|#
directive|if
name|defined
argument_list|(
