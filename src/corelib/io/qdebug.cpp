...
end_destructor
begin_comment
comment|/*!     \internal      Specialization of the primary template in qdebug.h to out-of-line     the common case of QFlags<T>::Int being int.      Just call the generic version so the two don't get out of sync. */
end_comment
begin_function
