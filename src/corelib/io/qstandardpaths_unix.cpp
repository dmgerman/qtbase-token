...
name|qWarning
argument_list|(
literal|"QStandardPaths: XDG_RUNTIME_DIR points to non-existing path '%s', "
literal|"please create it with 0700 permissions."
argument_list|,
name|qPrintable
argument_list|(
name|xdgRuntimeDir
...
name|qWarning
argument_list|(
literal|"QStandardPaths: XDG_RUNTIME_DIR points to '%s' which is not a directory"
argument_list|,
name|qPrintable
argument_list|(
name|xdgRuntimeDir
...
argument_list|)
expr_stmt|;
comment|// Normalize paths, skip relative paths
