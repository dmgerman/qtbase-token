...
end_destructor
begin_comment
comment|/*!     \fn bool QFileInfo::operator!=(const QFileInfo&fileinfo)      Returns true if this QFileInfo object refers to a different file     than the one specified by \a fileinfo; otherwise returns false.      \sa operator==() */
end_comment
begin_comment
...
end_ifdef
begin_comment
comment|/*!     Use absoluteDir() or the dir() overload that takes no parameters     instead. */
end_comment
begin_function
DECL|function|dir
name|QDir
