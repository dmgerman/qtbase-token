...
end_comment
begin_comment
comment|/*!     \fn bool QLoggingCategory::isEnabled() const      Returns true if a message of the template \c QtMsgType argument should be     shown. Returns false otherwise.      \note The qCDebug, qCWarning, qCCritical macros already do this check before     executing any code. However, calling this method may be useful to avoid     expensive generation of data that is only used for debug output. */
end_comment
begin_comment
comment|/*!     Returns true if a message of type \a msgtype for the category should be     shown. Returns false otherwise.      \note The templated, inline version of this method, \l isEnabled(), is     optimized for the common case that no configuration is set, and should     generally be preferred. */
end_comment
begin_function
