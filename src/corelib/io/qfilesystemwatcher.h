...
argument|d_func()
argument_list|,
argument|void _q_fileChanged(const QString&path, bool removed)
argument_list|)
name|Q_PRIVATE_SLOT
argument_list|(
argument|d_func()
argument_list|,
argument|void _q_directoryChanged(const QString&path, bool removed)
argument_list|)
block|}
decl_stmt|;
end_decl_stmt
