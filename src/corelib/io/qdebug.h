...
end_include
begin_comment
comment|// all these have already been included by various headers above, but don't rely on indirect includes:
end_comment
begin_include
include|#
directive|include
...
operator|<
name|typename
name|SequentialContainer
operator|>
specifier|inline
name|QDebug
name|printSequentialContainer
argument_list|(
argument|QDebug debug
argument_list|,
argument|const char *which
argument_list|,
argument|const SequentialContainer&c
argument_list|)
block|{
specifier|const
name|bool
...
argument_list|)
return|;
comment|// yes, sequential: *it is std::pair
block|}
end_expr_stmt
begin_expr_stmt
DECL|variable|Key
...
argument|sizeof(T)
argument_list|,
argument|typename QFlags<T>::Int(flags)
argument_list|)
block|;
return|return
name|debug
...
name|QT_FOR_EACH_CORE_FOUNDATION_TYPE
argument_list|(
argument|QT_FORWARD_DECLARE_CF_TYPE
argument_list|)
end_macro
begin_macro
name|QT_FOR_EACH_MUTABLE_CORE_FOUNDATION_TYPE
argument_list|(
argument|QT_FORWARD_DECLARE_MUTABLE_CF_TYPE
argument_list|)
end_macro
begin_macro
name|QT_FOR_EACH_CORE_GRAPHICS_TYPE
argument_list|(
argument|QT_FORWARD_DECLARE_CG_TYPE
argument_list|)
end_macro
begin_macro
name|QT_FOR_EACH_MUTABLE_CORE_GRAPHICS_TYPE
argument_list|(
argument|QT_FORWARD_DECLARE_MUTABLE_CG_TYPE
argument_list|)
end_macro
begin_expr_stmt
name|QT_BEGIN_NAMESPACE
...
name|QT_FOR_EACH_CORE_FOUNDATION_TYPE
argument_list|(
argument|QT_FORWARD_DECLARE_QDEBUG_OPERATOR_FOR_CF_TYPE
argument_list|)
end_macro
begin_macro
name|QT_FOR_EACH_MUTABLE_CORE_FOUNDATION_TYPE
