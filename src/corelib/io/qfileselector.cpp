...
argument_list|)
comment|// we don't want "linux" for Android or "qnx" for Blackberry here
name|ret
operator|<<
name|QSysInfo
operator|::
...
name|productName
expr_stmt|;
comment|// "opensuse", "fedora", "osx", "ios", "blackberry", "android"
endif|#
directive|endif
return|return
name|ret
