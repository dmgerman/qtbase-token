...
end_ifdef
begin_comment
comment|// not marked as QT3_SUPPORT to avoid double compiler warnings, as
end_comment
begin_comment
comment|// they are used in the QT3_SUPPORT functions below.
end_comment
begin_expr_stmt
specifier|inline
name|QT3_SUPPORT
...
literal|0x0001
block|,
comment|// skip whitespace on input
name|left
init|=
literal|0x0002
block|,
comment|// left-adjust output
name|right
init|=
literal|0x0004
block|,
comment|// right-adjust output
name|internal
init|=
literal|0x0008
block|,
comment|// pad after sign
name|bin
init|=
literal|0x0010
block|,
comment|// binary format integer
name|oct
init|=
literal|0x0020
block|,
comment|// octal format integer
name|dec
init|=
literal|0x0040
block|,
comment|// decimal format integer
name|hex
init|=
literal|0x0080
block|,
comment|// hex format integer
name|showbase
init|=
literal|0x0100
block|,
comment|// show base indicator
name|showpoint
init|=
literal|0x0200
block|,
comment|// force decimal point (float)
name|uppercase
init|=
literal|0x0400
block|,
comment|// upper-case hex output
name|showpos
init|=
literal|0x0800
block|,
comment|// add '+' to positive integers
name|scientific
init|=
literal|0x1000
block|,
comment|// scientific float output
name|fixed
init|=
literal|0x2000
comment|// fixed float output
block|}
enum|;
end_enum
begin_enum
...
name|QTextStream
argument_list|(
argument|const_cast<QString *>(s)
argument_list|,
argument|QIODevice::ReadOnly
argument_list|)
block|{}
specifier|inline
name|explicit
