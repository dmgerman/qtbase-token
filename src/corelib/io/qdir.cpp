...
end_ifndef
begin_comment
comment|/*!     \obsolete      Use QDir::toNativeSeparators() instead. */
end_comment
begin_macro
unit|QString
...
end_ifdef
begin_comment
comment|/*!     \fn bool QDir::matchAllDirs() const      Use filter()& AllDirs instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn void QDir::setMatchAllDirs(bool on)      Use setFilter() instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Use nameFilters() instead. */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn QString QDir::absPath() const      Use absolutePath() instead. */
end_comment
begin_comment
comment|/*!     \fn QString QDir::absFilePath(const QString&fileName, bool acceptAbsPath) const      Use absoluteFilePath(\a fileName) instead.      The \a acceptAbsPath parameter is ignored. */
end_comment
begin_comment
comment|/*!     \fn bool QDir::mkdir(const QString&dirName, bool acceptAbsPath) const      Use mkdir(\a dirName) instead.      The \a acceptAbsPath parameter is ignored. */
end_comment
begin_comment
comment|/*!     \fn bool QDir::rmdir(const QString&dirName, bool acceptAbsPath) const      Use rmdir(\a dirName) instead.      The \a acceptAbsPath parameter is ignored. */
end_comment
begin_comment
comment|/*!     \fn QStringList QDir::entryList(const QString&nameFilter, Filters filters,                                     SortFlags sort) const     \overload      Use the overload that takes a name filter string list as first     argument instead of a combination of attribute filter flags. */
end_comment
begin_comment
comment|/*!     \fn QFileInfoList QDir::entryInfoList(const QString&nameFilter, Filters filters,                                           SortFlags sort) const     \overload      Use the overload that takes a name filter string list as first     argument instead of a combination of attribute filter flags. */
end_comment
begin_comment
comment|/*!     \fn void QDir::convertToAbs()      Use makeAbsolute() instead. */
end_comment
begin_comment
comment|/*!     \fn QString QDir::cleanDirPath(const QString&name)      Use cleanPath() instead. */
end_comment
begin_comment
comment|/*!     \typedef QDir::FilterSpec      Use QDir::Filters instead. */
end_comment
begin_comment
comment|/*!     \typedef QDir::SortSpec      Use QDir::SortFlags instead. */
end_comment
begin_endif
endif|#
directive|endif
