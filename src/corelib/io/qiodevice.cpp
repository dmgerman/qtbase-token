...
name|Q_OS_SYMBIAN
argument_list|)
comment|// Open C fgets strips '\r' but readSoFar gets returned as if it was still there
if|if
condition|(
operator|(
name|d
...
literal|8
comment|/* IO_UnspecifiedError */
return|;
block|}
end_function
begin_comment
comment|/*!     For device specific error handling, please refer to the     individual device documentation.      \sa qobject_cast() */
end_comment
begin_function
