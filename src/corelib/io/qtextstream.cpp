...
end_constructor
begin_comment
comment|/*!     Constructs a QTextStream that operates on \a array, using \a     openMode to define the open mode. The array is accessed as     read-only, regardless of the values in \a openMode.      This constructor is convenient for working on constant     strings. Example:      \snippet doc/src/snippets/code/src_corelib_io_qtextstream.cpp 3 */
end_comment
begin_constructor
DECL|function|QTextStream
name|QTextStream
...
end_constructor
begin_comment
comment|/*!     Constructs a QTextStream that operates on \a fileHandle, using \a     openMode to define the open mode. Internally, a QFile is created     to handle the FILE pointer.      This constructor is useful for working directly with the common     FILE based input and output streams: stdin, stdout and stderr. Example:      \snippet doc/src/snippets/code/src_corelib_io_qtextstream.cpp 4 */
end_comment
begin_constructor
DECL|function|QTextStream
name|QTextStream
...
end_function
begin_comment
comment|/*!     Sets the pad character to \a ch. The default value is the ASCII     space character (' '), or QChar(0x20). This character is used to     fill in the space in fields when generating text.      Example:      \snippet doc/src/snippets/code/src_corelib_io_qtextstream.cpp 5      The string \c s contains:      \snippet doc/src/snippets/code/src_corelib_io_qtextstream.cpp 6      \sa padChar(), setFieldWidth() */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Reads a character from the stream and stores it in \a c. Returns a     reference to the QTextStream, so several operators can be     nested. Example:      \snippet doc/src/snippets/code/src_corelib_io_qtextstream.cpp 7      Whitespace is \e not skipped. */
end_comment
begin_function
...
end_ifdef
begin_comment
comment|/*!     \class QTextIStream     \brief The QTextIStream class is a convenience class for input streams.      \compat     \reentrant      Use QTextStream instead. */
end_comment
begin_comment
comment|/*!     \fn QTextIStream::QTextIStream(const QString *string)      Use QTextStream(&\a{string}, QIODevice::ReadOnly) instead. */
end_comment
begin_comment
comment|/*!     \fn QTextIStream::QTextIStream(QByteArray *byteArray)      Use QTextStream(&\a{byteArray}, QIODevice::ReadOnly) instead. */
end_comment
begin_comment
comment|/*!     \fn QTextIStream::QTextIStream(FILE *file)      Use QTextStream(\a{file}, QIODevice::ReadOnly) instead. */
end_comment
begin_comment
comment|/*!     \class QTextOStream     \brief The QTextOStream class is a convenience class for output streams.      \compat     \reentrant      Use QTextStream instead. */
end_comment
begin_comment
comment|/*!     \fn QTextOStream::QTextOStream(QString *string)      Use QTextStream(&\a{string}, QIODevice::WriteOnly) instead. */
end_comment
begin_comment
comment|/*!     \fn QTextOStream::QTextOStream(QByteArray *byteArray)      Use QTextStream(&\a{byteArray}, QIODevice::WriteOnly) instead. */
end_comment
begin_comment
comment|/*!     \fn QTextOStream::QTextOStream(FILE *file)      Use QTextStream(\a{file}, QIODevice::WriteOnly) instead. */
end_comment
begin_comment
comment|/*! \internal */
end_comment
...
end_ifndef
begin_comment
comment|/*!     Use setCodec() and setAutoDetectUnicode() instead. */
end_comment
begin_function
...
end_endif
begin_comment
comment|/*!     \enum QTextStream::Encoding     \compat      \value Latin1  Use setCodec(QTextCodec::codecForName("ISO-8859-1")) instead.     \value Locale  Use setCodec(QTextCodec::codecForLocale()) instead.     \value RawUnicode  Use setCodec(QTextCodec::codecForName("UTF-16")) instead.     \value Unicode  Use setCodec(QTextCodec::codecForName("UTF-16")) instead.     \value UnicodeNetworkOrder  Use setCodec(QTextCodec::codecForName("UTF-16BE")) instead.     \value UnicodeReverse  Use setCodec(QTextCodec::codecForName("UTF-16LE")) instead.     \value UnicodeUTF8  Use setCodec(QTextCodec::codecForName("UTF-8")) instead.      Also, for all encodings except QTextStream::Latin1 and     QTextStream::UTF8, you need to call setAutoDetectUnicode(false)     to obtain the Qt 3 behavior in addition to the setCodec() call.      \sa setCodec(), setAutoDetectUnicode() */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::flags() const      Use fieldAlignment(), padChar(), fieldWidth(), numberFlags(),     integerBase(), realNumberNotation(), and realNumberNotation     instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::flags(int)      Use setFieldAlignment(), setPadChar(), setFieldWidth(),     setNumberFlags(), setIntegerBase(), setRealNumberNotation(), and     setRealNumberNotation instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::setf(int)      Use setFieldAlignment(), setPadChar(), setFieldWidth(),     setNumberFlags(), setIntegerBase(), setRealNumberNotation(), and     setRealNumberNotation instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::setf(int, int)      Use setFieldAlignment(), setPadChar(), setFieldWidth(),     setNumberFlags(), setIntegerBase(), setRealNumberNotation(), and     setRealNumberNotation instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::unsetf(int)      Use setFieldAlignment(), setPadChar(), setFieldWidth(),     setNumberFlags(), setIntegerBase(), setRealNumberNotation(), and     setRealNumberNotation instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::width(int)      Use setFieldWidth() instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::fill(int)      Use setPadChar() instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::precision(int)      Use setRealNumberPrecision() instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::read()      Use readAll() or readLine() instead. */
end_comment
begin_comment
comment|/*!     \fn int QTextStream::unsetDevice()      Use setDevice(0) instead. */
end_comment
begin_comment
comment|/*!     \variable QTextStream::skipws     \variable QTextStream::left     \variable QTextStream::right     \variable QTextStream::internal     \variable QTextStream::bin     \variable QTextStream::oct     \variable QTextStream::dec     \variable QTextStream::hex     \variable QTextStream::showbase     \variable QTextStream::showpoint     \variable QTextStream::uppercase     \variable QTextStream::showpos     \variable QTextStream::scientific     \variable QTextStream::fixed     \variable QTextStream::basefield     \variable QTextStream::adjustfield     \variable QTextStream::floatfield     \compat      Use the new \l{QTextStream manipulators} instead. */
end_comment
begin_endif
endif|#
directive|endif
