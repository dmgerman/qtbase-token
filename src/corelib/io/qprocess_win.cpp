...
end_function
begin_comment
comment|// Use ShellExecuteEx() to trigger an UAC prompt when CreateProcess()fails
end_comment
begin_comment
comment|// with ERROR_ELEVATION_REQUIRED.
end_comment
begin_function
DECL|function|startDetachedUacPrompt
specifier|static
name|bool
name|startDetachedUacPrompt
parameter_list|(
specifier|const
name|QString
modifier|&
...
name|shellExecuteEx
init|=
comment|// XP ServicePack 1 onwards.
...
argument_list|)
decl_stmt|;
comment|// needs arguments only
name|SHELLEXECUTEINFOW
name|shellExecuteExInfo
decl_stmt|;
name|memset
argument_list|(
operator|&
...
name|fMask
operator|=
name|SEE_MASK_NOCLOSEPROCESS
operator||
name|SEE_MASK_UNICODE
operator||
