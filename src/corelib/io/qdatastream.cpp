...
end_ifdef
begin_comment
comment|/*!     \fn QDataStream::QDataStream(QByteArray *array, int mode)     \compat      Constructs a data stream that operates on the given \a array. The     \a mode specifies how the byte array is to be used, and is     usually either QIODevice::ReadOnly or QIODevice::WriteOnly. */
end_comment
begin_constructor
DECL|function|QDataStream
name|QDataStream
...
end_function
begin_comment
comment|/*!\fn bool QDataStream::eof() const      Use atEnd() instead. */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     \fn bool QDataStream::isPrintableData() const      In Qt 4, this function always returns false.      \sa setPrintableData() */
end_comment
begin_comment
comment|/*!     \fn void QDataStream::setPrintableData(bool enable)      In Qt 3, this function enabled output in a human-readable     format if \a enable was false.      In Qt 4, QDataStream no longer provides a human-readable output.     This function does nothing. */
end_comment
begin_comment
comment|/*!     \enum QDataStream::Version      This enum provides symbolic synonyms for the data serialization     format version numbers.      \value Qt_1_0 Version 1 (Qt 1.x)     \value Qt_2_0 Version 2 (Qt 2.0)     \value Qt_2_1 Version 3 (Qt 2.1, 2.2, 2.3)     \value Qt_3_0 Version 4 (Qt 3.0)     \value Qt_3_1 Version 5 (Qt 3.1, 3.2)     \value Qt_3_3 Version 6 (Qt 3.3)     \value Qt_4_0 Version 7 (Qt 4.0, Qt 4.1)     \value Qt_4_1 Version 7 (Qt 4.0, Qt 4.1)     \value Qt_4_2 Version 8 (Qt 4.2)     \value Qt_4_3 Version 9 (Qt 4.3)     \value Qt_4_4 Version 10 (Qt 4.4)     \value Qt_4_5 Version 11 (Qt 4.5)     \value Qt_4_6 Version 12 (Qt 4.6, Qt 4.7, Qt 4.8)     \value Qt_4_7 Same as Qt_4_6.     \value Qt_4_8 Same as Qt_4_6.      \sa setVersion(), version() */
end_comment
begin_comment
...
directive|else
comment|//non-standard floating point format
union|union
block|{
name|double
name|val1
...
end_ifdef
begin_comment
comment|/*!     \fn QDataStream&QDataStream::readRawBytes(char *str, uint len)      Use readRawData() instead. */
end_comment
begin_comment
comment|/*!     \fn QDataStream&QDataStream::writeRawBytes(const char *str, uint len)      Use writeRawData() instead. */
end_comment
begin_endif
endif|#
directive|endif
