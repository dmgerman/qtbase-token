...
end_function
begin_comment
comment|/*!     Stops the asynchronous read sequence.     If the read sequence is running then the I/O operation is canceled.  */
end_comment
begin_function
DECL|function|stop
name|void
...
break|break;
block|}
comment|// After the reader was stopped, the only reason why this function can be called is the
comment|// completion of a cancellation. No signals should be emitted, and no new read sequence should
...
end_function
begin_comment
comment|/*!     \internal     Reads data from the pipe into the readbuffer.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \internal     Called when ReadFileEx finished the read operation.  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Waits for the completion of the asynchronous read operation.     Returns \c true, if we've emitted the readyRead signal (non-recursive case)     or readyRead will be emitted by the event loop (recursive case).  */
end_comment
begin_function
