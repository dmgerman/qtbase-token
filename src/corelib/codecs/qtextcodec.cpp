...
end_ifdef
begin_comment
comment|/*!     Returns a string representing the current language and     sublanguage, e.g. "pt" for Portuguese, or "pt_br" for Portuguese/Brazil.      \sa QLocale */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \overload      \a a contains the source characters; \a len contains the number of     characters in \a a to use. */
end_comment
begin_function
DECL|function|toUnicode
name|QString
...
end_ifdef
begin_comment
comment|/*!   \overload    Converts \a lenInOut characters (not bytes) from \a uc, and returns the   result in a QByteArray. The number of characters read is returned in   the \a lenInOut parameter. */
end_comment
begin_function
DECL|function|fromUnicode
name|QByteArray
