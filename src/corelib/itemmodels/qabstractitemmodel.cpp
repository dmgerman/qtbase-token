...
end_comment
begin_comment
comment|/*!     \enum QAbstractItemModel::LayoutChangeHint      This enum describes the way the model changes layout.      \value NoLayoutChangeHint   No hint is available.     \value VerticalSortHint     Rows are being sorted.     \value HorizontalSortHint   Columns are being sorted. */
end_comment
begin_comment
