...
literal|0
argument_list|)
comment|// ### Qt 6: remove them all, the compiler-generated ones are fine
specifier|inline
name|QItemSelectionRange
argument_list|(
specifier|const
...
name|QItemSelectionRange
argument_list|(
argument|QItemSelectionRange&&other
argument_list|)
name|Q_DECL_NOTHROW
operator|:
name|tl
...
name|Q_PROPERTY
argument_list|(
argument|QModelIndexList selectedIndexes READ selectedIndexes NOTIFY selectionChanged STORED false DESIGNABLE false
argument_list|)
