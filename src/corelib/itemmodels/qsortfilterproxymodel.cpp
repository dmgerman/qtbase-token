...
function_decl|;
name|void
name|filter_about_to_be_changed
parameter_list|(
specifier|const
name|QModelIndex
modifier|&
...
end_function
begin_comment
comment|/*!   \internal    Updates the source_index mapping in case it's invalid and we   need it because we have a valid filter */
end_comment
begin_function
...
operator|)
decl_stmt|;
comment|// Duplicated in QStandardItem::operator<()
if|if
condition|(
name|l
operator|.
