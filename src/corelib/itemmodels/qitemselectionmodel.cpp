...
end_comment
begin_comment
comment|/*!     \fn void QItemSelectionModel::modelChanged(QAbstractItemModel *model)     \since 5.5      This signal is emitted when the model is successfully set with setModel().      \sa model(), setModel() */
end_comment
begin_comment
