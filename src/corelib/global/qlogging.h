...
directive|define
name|qDebug
value|QMessageLogger(QT_MESSAGELOG_FILE, QT_MESSAGELOG_LINE, QT_MESSAGELOG_FUNC).debug
end_define
begin_define
DECL|macro|qInfo
define|#
directive|define
name|qInfo
value|QMessageLogger(QT_MESSAGELOG_FILE, QT_MESSAGELOG_LINE, QT_MESSAGELOG_FUNC).info
end_define
begin_define
DECL|macro|qWarning
define|#
directive|define
name|qWarning
value|QMessageLogger(QT_MESSAGELOG_FILE, QT_MESSAGELOG_LINE, QT_MESSAGELOG_FUNC).warning
end_define
begin_define
...
directive|define
name|qCritical
value|QMessageLogger(QT_MESSAGELOG_FILE, QT_MESSAGELOG_LINE, QT_MESSAGELOG_FUNC).critical
end_define
begin_define
DECL|macro|qFatal
define|#
directive|define
name|qFatal
value|QMessageLogger(QT_MESSAGELOG_FILE, QT_MESSAGELOG_LINE, QT_MESSAGELOG_FUNC).fatal
end_define
begin_define
