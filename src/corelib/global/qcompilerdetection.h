...
end_endif
begin_comment
comment|/* C++1y features, see http://clang.llvm.org/cxx_status.html and  * http://clang.llvm.org/docs/LanguageExtensions.html#checks-for-standard-language-features */
end_comment
begin_if
if|#
directive|if
...
end_if
begin_comment
comment|/* C++1y features in GCC 4.9 */
end_comment
begin_comment
