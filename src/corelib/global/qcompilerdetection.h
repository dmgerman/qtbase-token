...
name|x
parameter_list|)
value|stdext::make_unchecked_array_iterator(x)
end_define
begin_endif
endif|#
directive|endif
...
name|N
parameter_list|)
value|stdext::make_checked_array_iterator(x, size_t(N))
end_define
begin_endif
endif|#
directive|endif
...
end_define
begin_comment
comment|/* From the EDG documentation (does not seem to apply to Compaq C++ or GHS C):    _BOOL         Defined in C++ mode when bool is a keyword. The name of this         predefined macro is specified by a configuration flag. _BOOL         is the default.    __BOOL_DEFINED         Defined in Microsoft C++ mode when bool is a keyword. */
end_comment
begin_if
if|#
directive|if
...
end_if
begin_comment
comment|//       the bug mentioned above is fixed in 15.0.1
end_comment
begin_define
DECL|macro|Q_COMPILER_CONSTEXPR
define|#
...
end_if
begin_comment
comment|//<initializer_list> is missing with MSVC 2012 (it's present in 2010, 2013 and up)
end_comment
begin_undef
DECL|macro|Q_COMPILER_INITIALIZER_LISTS
undef|#
...
end_if
begin_comment
comment|//       ICC disables unicode string support when compatibility mode with MSVC 2013 or lower is active
end_comment
begin_undef
DECL|macro|Q_COMPILER_UNICODE_STRINGS
undef|#
...
end_if
begin_comment
comment|/* FreeBSD clang fails on __cxa_thread_atexit */
end_comment
begin_define
DECL|macro|Q_COMPILER_THREAD_LOCAL
define|#
...
end_if
begin_comment
comment|/* C++11 features in VC14 = VC2015 */
end_comment
begin_define
DECL|macro|Q_COMPILER_ALIGNAS
define|#
...
end_define
begin_comment
comment|// Partial support, insufficient for Qt
end_comment
begin_comment
comment|//#      define Q_COMPILER_CONSTEXPR
end_comment
...
end_define
begin_comment
comment|// Uniform initialization is not working yet -- build errors with QUuid
end_comment
begin_comment
comment|//#      define Q_COMPILER_UNIFORM_INIT
end_comment
...
end_define
begin_comment
comment|// Almost working, see https://connect.microsoft.com/VisualStudio/feedback/details/2011648
end_comment
begin_comment
comment|//#      define Q_COMPILER_CONSTEXPR
end_comment
...
end_endif
begin_comment
comment|/*  * SG10's SD-6 feature detection and some useful extensions from Clang and GCC  * https://isocpp.org/std/standing-documents/sd-6-sg10-feature-test-recommendations  * http://clang.llvm.org/docs/LanguageExtensions.html#feature-checking-macros  */
end_comment
begin_ifdef
ifdef|#
directive|ifdef
...
define|#
directive|define
name|QT_HAS_CPP_ATTRIBUTE
parameter_list|(
name|x
parameter_list|)
value|__has_cpp_attribute(x)
end_define
begin_else
else|#
directive|else
...
define|#
directive|define
name|QT_HAS_INCLUDE_NEXT
parameter_list|(
name|x
parameter_list|)
value|__has_include_next(x)
end_define
begin_else
else|#
directive|else
...
end_if
begin_comment
comment|/* icl.exe: Intel compiler on Windows */
end_comment
begin_undef
DECL|macro|QT_DO_PRAGMA
undef|#
...
end_elif
begin_comment
comment|/* icc: Intel compiler on Linux or OS X */
end_comment
begin_define
DECL|macro|QT_WARNING_PUSH
define|#
