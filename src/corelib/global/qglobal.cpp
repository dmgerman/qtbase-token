...
end_ifndef
begin_comment
comment|// Determine Windows versions>= 8 by querying the version of kernel32.dll.
end_comment
begin_function
...
specifier|inline
name|bool
name|determineWinOsVersionPost8
parameter_list|(
name|OSVERSIONINFO
modifier|*
name|result
...
name|WINAPI
modifier|*
name|PtrGetFileVersionInfoSizeW
function_decl|)
parameter_list|(
name|LPCWSTR
parameter_list|,
...
name|resolve
argument_list|(
literal|"GetFileVersionInfoSizeW"
argument_list|)
decl_stmt|;
name|PtrVerQueryValueW
name|verQueryValueW
...
end_function
begin_comment
comment|// Fallback for determining Windows versions>= 8 by looping using the
end_comment
begin_comment
comment|// version check macros. Note that it will return build number=0 to avoid
end_comment
begin_comment
comment|// inefficient looping.
end_comment
begin_function
...
specifier|inline
name|void
name|determineWinOsVersionFallbackPost8
parameter_list|(
name|OSVERSIONINFO
modifier|*
name|result
