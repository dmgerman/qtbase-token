...
literal|1
expr_stmt|;
comment|// note: we're doing a binary search here, so comparison
comment|// must always be sorted
name|int
name|cmp
init|=
name|strncmp
