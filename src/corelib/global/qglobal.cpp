...
end_comment
begin_comment
comment|/*!     \fn QFlags QFlags::setFlag(Enum flag, bool on) const     \since 5.7      Sets the indicated \a flag if \a on is \c true or unsets it if     \a on is \c false. Returns a reference to this object. */
end_comment
begin_comment
