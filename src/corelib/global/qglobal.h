...
end_if
begin_comment
comment|/* disable Qt3 support as well */
end_comment
begin_undef
DECL|macro|QT3_SUPPORT_WARNINGS
undef|#
directive|undef
name|QT3_SUPPORT_WARNINGS
end_undef
begin_undef
...
end_ifdef
begin_comment
comment|/* enable Qt3 support warnings as well */
end_comment
begin_undef
undef|#
directive|undef
...
name|defined
argument_list|(
name|QT_COMPAT_WARNINGS
argument_list|)
end_if
begin_comment
comment|/* also enable compat */
end_comment
begin_define
...
end_elif
begin_comment
comment|/* define back to nothing */
end_comment
begin_if
if|#
directive|if
...
end_if
begin_comment
comment|/* also enable qt3 support */
end_comment
begin_define
define|#
directive|define
...
begin_comment
DECL|typedef|Q_LONG
comment|/* word up to 64 bit signed */
end_comment
begin_typedef
...
begin_comment
DECL|typedef|Q_ULONG
comment|/* word up to 64 bit unsigned */
end_comment
begin_else
else|#
directive|else
...
end_endif
begin_comment
comment|// ### Qt 5: remove Win9x support macros QT_WA and QT_WA_INLINE.
end_comment
begin_define
DECL|macro|QT_WA
define|#
...
name|QT3_SUPPORT
name|void
name|qSuppressObsoleteWarnings
parameter_list|(
name|bool
init|=
name|true
...
parameter_list|)
define|\
value|inline QFlags<Flags::enum_type> operator|(Flags::enum_type f1, Flags::enum_type f2) \ { return QFlags<Flags::enum_type>(f1) | f2; } \ inline QFlags<Flags::enum_type> operator|(Flags::enum_type f1, QFlags<Flags::enum_type> f2) \ { return f2 | f1; } Q_DECLARE_INCOMPATIBLE_FLAGS(Flags)
end_define
begin_else
else|#
directive|else
...
end_function_decl
begin_comment
comment|/*    Compat functions that were generated by configure */
end_comment
begin_ifdef
ifdef|#
directive|ifdef
...
directive|define
name|QT_PRODUCT_LICENSE
value|QLibraryInfo::licensedProducts()
end_define
begin_endif
endif|#
directive|endif
...
define|#
directive|define
name|QT_MODULE_QT3SUPPORTLIGHT
value|0x000040
end_define
begin_define
...
value|(QT_MODULE_CORE \                                  | QT_MODULE_GUI \                                  | QT_MODULE_QT3SUPPORTLIGHT \                                  | QT_MODULE_TEST \                                  | QT_MODULE_DBUS)
end_define
begin_define
