...
end_expr_stmt
begin_comment
comment|// defined in qobject.h (which can't be included here)
end_comment
begin_define
...
parameter_list|)
define|\
value|inline const QMetaObject *qt_getEnumMetaObject(ENUM) Q_DECL_NOEXCEPT { return qt_getQtMetaObject(); } \     inline Q_DECL_CONSTEXPR const char *qt_getEnumName(ENUM) Q_DECL_NOEXCEPT { return #ENUM; }
end_define
begin_define
...
name|ReturnKeySend
block|,
name|ReturnKeySearch
block|,
name|ReturnKeyNext
block|,
name|ReturnKeyPrevious
block|}
expr_stmt|;
enum|enum
...
directive|ifndef
name|Q_QDOC
comment|// NOTE: Generally, do not add QT_Q_ENUM if a corresponding Q_Q_FLAG exists.
name|QT_Q_ENUM
argument_list|(
argument|ScrollBarPolicy
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|FocusPolicy
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|ContextMenuPolicy
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|ArrowType
...
name|QT_Q_ENUM
argument_list|(
argument|PenCapStyle
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|PenJoinStyle
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|BrushStyle
...
name|QT_Q_FLAG
argument_list|(
argument|Orientations
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|DropActions
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|Edges
...
name|QT_Q_FLAG
argument_list|(
argument|DockWidgetAreas
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|ToolBarAreas
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|DockWidgetArea
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|ToolBarArea
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|TextFormat
...
name|QT_Q_ENUM
argument_list|(
argument|CursorShape
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|GlobalColor
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|AspectRatioMode
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|TransformationMode
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|ImageConversionFlags
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|Key
...
name|QT_Q_ENUM
argument_list|(
argument|ShortcutContext
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|TextInteractionFlag
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|TextInteractionFlags
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|ItemSelectionMode
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|ItemSelectionOperation
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|ItemFlags
...
name|QT_Q_FLAG
argument_list|(
argument|KeyboardModifiers
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|MouseButtons
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|WindowType
...
name|QT_Q_ENUM
argument_list|(
argument|WidgetAttribute
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|ApplicationAttribute
argument_list|)
name|QT_Q_FLAG
argument_list|(
...
name|QT_Q_FLAG
argument_list|(
argument|WindowStates
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|FocusReason
argument_list|)
name|QT_Q_ENUM
argument_list|(
...
name|QT_Q_ENUM
argument_list|(
argument|InputMethodQuery
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|InputMethodHints
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|ReturnKeyType
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|InputMethodQueries
argument_list|)
name|QT_Q_FLAG
argument_list|(
argument|TouchPointStates
argument_list|)
name|QT_Q_ENUM
argument_list|(
...
name|QT_Q_ENUM
argument_list|(
argument|GestureState
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|GestureType
argument_list|)
name|QT_Q_ENUM
argument_list|(
argument|NativeGestureType
argument_list|)
endif|#
directive|endif
name|QT_Q_ENUM
