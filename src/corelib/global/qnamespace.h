...
name|Q_ENUMS
argument_list|(
argument|ArrowType ToolButtonStyle PenStyle PenCapStyle PenJoinStyle BrushStyle
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
argument_list|(
argument|FillRule MaskMode BGMode ClipOperation SizeMode
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
argument_list|(
argument|BackgroundMode
argument_list|)
end_macro
begin_comment
comment|// Qt3
...
name|Q_ENUMS
argument_list|(
argument|Axis Corner LayoutDirection SizeHint Orientation DropAction
argument_list|)
end_macro
begin_macro
name|Q_FLAGS
argument_list|(
argument|Alignment Orientations DropActions
argument_list|)
end_macro
begin_macro
name|Q_FLAGS
argument_list|(
argument|DockWidgetAreas ToolBarAreas
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
argument_list|(
argument|DockWidgetArea ToolBarArea
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
...
name|Q_ENUMS
argument_list|(
argument|DateFormat TimeSpec DayOfWeek
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
argument_list|(
argument|CursorShape GlobalColor
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
argument_list|(
argument|AspectRatioMode TransformationMode
argument_list|)
end_macro
begin_macro
name|Q_FLAGS
...
name|Q_ENUMS
argument_list|(
argument|SortOrder CaseSensitivity
argument_list|)
end_macro
begin_macro
name|Q_FLAGS
...
name|Q_FLAGS
argument_list|(
argument|KeyboardModifiers MouseButtons
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
argument_list|(
argument|WindowType WindowState WindowModality WidgetAttribute ApplicationAttribute
argument_list|)
end_macro
begin_macro
name|Q_ENUMS
...
literal|0x00040000
block|,
comment|// reserved for Qt3Support:
comment|// WMouseNoMask = 0x00080000,
comment|// WDestructiveClose = 0x00100000,
comment|// WStaticContents = 0x00200000,
comment|// WGroupLeader = 0x00400000,
comment|// WShowModal = 0x00800000,
comment|// WNoMousePropagation = 0x01000000,
...
name|WindowSystemMenuHint
block|,
name|WStyle_Minimize
init|=
name|WindowMinimizeButtonHint
block|,
name|WStyle_Maximize
init|=
name|WindowMaximizeButtonHint
block|,
name|WStyle_MinMax
...
name|Tool
block|,
name|WStyle_StaysOnTop
init|=
name|WindowStaysOnTopHint
block|,
name|WStyle_ContextHelp
init|=
name|WindowContextHelpButtonHint
block|,
comment|// misc flags
...
enum|enum
block|{
DECL|enumerator|QCOORD_MAX
name|QCOORD_MAX
init|=
literal|2147483647
block|,
DECL|enumerator|QCOORD_MIN
name|QCOORD_MIN
init|=
operator|-
name|QCOORD_MAX
