...
parameter_list|()
block|{
comment|// If we get any settings here, those won't change when the application shows up.
name|settings
operator|.
name|reset
argument_list|(
...
directive|define
name|ICC_VERSION
value|QT_STRINGIFY(__INTEL_COMPILER)
end_define
begin_endif
endif|#
directive|endif
...
value|"Intel(R) C++ " ICC_VERSION "." QT_STRINGIFY(__INTEL_COMPILER_UPDATE) \                             " build " QT_STRINGIFY(__INTEL_COMPILER_BUILD_DATE) " [" \                             ICC_COMPAT " compatibility]"
end_define
begin_else
else|#
directive|else
...
directive|define
name|COMPILER_STRING
value|"Intel(R) C++ " ICC_VERSION \                             " build " QT_STRINGIFY(__INTEL_COMPILER_BUILD_DATE) " [" \                             ICC_COMPAT " compatibility]"
end_define
begin_endif
endif|#
directive|endif
...
end_ifdef
begin_comment
comment|// Apple clang has other version numbers
end_comment
begin_define
DECL|macro|COMPILER_STRING
define|#
...
operator|)
operator|&&
name|QT_CONFIGURE_SYSROOTIFY_PREFIX
condition|)
block|{
name|QString
name|sysroot
...
name|path
operator|=
name|QT_CONFIGURE_HOST_PREFIX_PATH
expr_stmt|;
endif|#
directive|endif
block|}
