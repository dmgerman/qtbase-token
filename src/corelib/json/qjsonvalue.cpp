...
end_constructor
begin_comment
comment|/*!     \fn QJsonValue::QJsonValue(const char *s)      Creates a value of type String with value \a s, assuming     UTF-8 encoding of the input.      You can disable this constructor by defining \c     QT_NO_CAST_FROM_ASCII when you compile your applications.      \since 5.3  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn bool QJsonValue::isNull() const      Returns \c true if the value is null. */
end_comment
begin_comment
comment|/*!     \fn bool QJsonValue::isBool() const      Returns \c true if the value contains a boolean.      \sa toBool()  */
end_comment
begin_comment
comment|/*!     \fn bool QJsonValue::isDouble() const      Returns \c true if the value contains a double.      \sa toDouble()  */
end_comment
begin_comment
comment|/*!     \fn bool QJsonValue::isString() const      Returns \c true if the value contains a string.      \sa toString()  */
end_comment
begin_comment
comment|/*!     \fn bool QJsonValue::isArray() const      Returns \c true if the value contains an array.      \sa toArray()  */
end_comment
begin_comment
comment|/*!     \fn bool QJsonValue::isObject() const      Returns \c true if the value contains an object.      \sa toObject()  */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     Converts the value to an int and returns it.      If type() is not Double or the value is not a whole number,     the \a defaultValue will be returned.  */
end_comment
begin_function
DECL|function|toInt
name|int
...
end_function
begin_comment
comment|/*!     Returns \c true if the value is equal to \a other.  */
end_comment
begin_function
DECL|function|operator ==
name|bool
...
end_function
begin_comment
comment|/*!     Returns \c true if the value is not equal to \a other.  */
end_comment
begin_function
DECL|function|operator !=
name|bool
