...
end_function
begin_comment
comment|/*!     Converts \a variant to a QJsonValue and returns it.      The conversion will convert QVariant types as follows:      \list     \o QVariant::Bool to Bool     \o QVariant::Int     \o QVariant::Double     \o QVariant::LongLong     \o QVariant::ULongLong     \o QVariant::UInt to Double     \o QVariant::String to String     \o QVariant::StringList     \o QVariant::VariantList to Array     \o QVariant::VariantMap to Object     \endlist      For all other QVariant types a conversion to a QString will be attempted. If the returned string     is empty, a Null QJsonValue will be stored, otherwise a String value using the returned QString.      \sa toVariant()  */
end_comment
begin_function
