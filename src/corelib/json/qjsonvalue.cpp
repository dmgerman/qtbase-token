...
end_function
begin_comment
comment|/*!     Converts the value to a \l {QVariant::}{QVariant()}.      The QJsonValue types will be converted as follows:      \value Null     \l {QVariant::}{QVariant()}     \value Bool     QMetaType::Bool     \value Double   QMetaType::Double     \value String   QString     \value Array    QVariantList     \value Object   QVariantMap     \value Undefined \l {QVariant::}{QVariant()}      \sa fromVariant()  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Converts the value to a QString and returns it.      If type() is not String, a null QString will be returned.      \sa QString::isNull()  */
end_comment
begin_function
DECL|function|toString
name|QString
