...
end_function
begin_comment
comment|/*!     Converts the variant map \a map to a QJsonObject.      The keys in \a map will be used as the keys in the JSON object,     and the QVariant values will be converted to JSON values.      \sa fromVariantHash(), toVariantMap(), QJsonValue::fromVariant()  */
end_comment
begin_function
...
argument_list|)
expr_stmt|;
comment|// the map is already sorted, so we can simply append one entry after the other and
comment|// write the offset table at the end
for|for
control|(
name|QVariantMap
operator|::
...
end_function
begin_comment
comment|/*!     Converts this object to a QVariantMap.      Returns the created map.      \sa toVariantHash()  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Converts the variant hash \a hash to a QJsonObject.     \since 5.5      The keys in \a hash will be used as the keys in the JSON object,     and the QVariant values will be converted to JSON values.      \sa fromVariantMap(), toVariantHash(), QJsonValue::fromVariant()  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     Converts this object to a QVariantHash.     \since 5.5      Returns the created hash.      \sa toVariantMap()  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!     \fn QJsonValue QJsonObject::operator [](QLatin1String key) const      \overload     \since 5.7 */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*! \fn QJsonObject::const_iterator QJsonObject::find(QLatin1String key) const      \overload     \since 5.7 */
end_comment
begin_comment
