...
comment|/*!     \class QJsonParseError     \inmodule QtCore     \ingroup json     \ingroup shared     \reentrant     \since 5.0      \brief The QJsonParseError class is used to report errors during JSON parsing.      \sa {JSON Support in Qt}, {JSON Save Game Example} */
...
condition|)
block|{
comment|// decoding error, backtrack the character we read above
operator|--
name|json
expr_stmt|;
return|return
