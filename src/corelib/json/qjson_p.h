...
begin_expr_stmt
unit|struct
DECL|struct|UnionHelper
name|QJsonValueRef
operator|::
name|UnionHelper
block|{
DECL|function|untaggedPointer
specifier|static
specifier|inline
name|QJsonObject
operator|*
name|untaggedPointer
argument_list|(
...
begin_comment
unit|};
comment|/*!     \internal     Constructor that creates reference to an undefined value in \a object. */
end_comment
begin_expr_stmt
DECL|function|QJsonValueRef
specifier|inline
name|QJsonValueRef
operator|::
name|QJsonValueRef
