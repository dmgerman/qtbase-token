...
comment|/*!   \class QXmlStreamEntityResolver   \reentrant   \since 4.4    \brief The QXmlStreamEntityResolver class provides an entity   resolver for a QXmlStreamReader.    \ingroup xml-tools  */
...
end_comment
begin_comment
comment|/*!     \class QXmlStreamAttribute     \since 4.3     \reentrant     \brief The QXmlStreamAttribute class represents a single XML attribute      \ingroup xml-tools      An attribute consists of an optionally empty namespaceUri(), a     name(), a value(), and an isDefault() attribute.      The raw XML attribute name is returned as qualifiedName(). */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!     \class QXmlStreamAttributes     \since 4.3     \reentrant     \brief The QXmlStreamAttributes class represents a vector of QXmlStreamAttribute.      Attributes are returned by a QXmlStreamReader in     \l{QXmlStreamReader::attributes()} {attributes()} when the reader     reports a \l {QXmlStreamReader::StartElement}{start element}. The     class can also be used with a QXmlStreamWriter as an argument to     \l {QXmlStreamWriter::writeAttributes()}{writeAttributes()}.      The convenience function value() loops over the vector and returns     an attribute value for a given namespaceUri and an attribute's     name.      New attributes can be added with append().      \ingroup xml-tools */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \class QXmlStreamNotationDeclaration     \since 4.3     \reentrant     \brief The QXmlStreamNotationDeclaration class represents a DTD notation declaration.      \ingroup xml-tools      An notation declaration consists of a name(), a systemId(), and a publicId(). */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \class QXmlStreamNamespaceDeclaration     \since 4.3     \reentrant     \brief The QXmlStreamNamespaceDeclaration class represents a namespace declaration.      \ingroup xml-tools      An namespace declaration consists of a prefix() and a namespaceUri(). */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*!     \class QXmlStreamStringRef     \since 4.3     \internal */
end_comment
begin_comment
comment|/*!     \class QXmlStreamEntityDeclaration     \since 4.3     \reentrant     \brief The QXmlStreamEntityDeclaration class represents a DTD entity declaration.      \ingroup xml-tools      An entity declaration consists of a name(), a notationName(), a     systemId(), a publicId(), and a value(). */
end_comment
begin_comment
...
end_function
begin_comment
comment|/*!\overload   Writes a text element with \a qualifiedName and \a text.     This is a convenience function equivalent to:   \snippet doc/src/snippets/code/src_corelib_xml_qxmlstream.cpp 1  */
end_comment
begin_function
...
end_function
begin_comment
comment|/*!  Writes a text element with \a name, prefixed for the specified \a      namespaceUri, and \a text. If the namespace has not been      declared, QXmlStreamWriter will generate a namespace declaration      for it.     This is a convenience function equivalent to:   \snippet doc/src/snippets/code/src_corelib_xml_qxmlstream.cpp 2  */
end_comment
begin_function
DECL|function|writeTextElement
name|void
