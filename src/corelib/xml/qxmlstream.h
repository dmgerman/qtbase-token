...
argument_list|()
block|{}
comment|// ### this prevents (or deprecates) all the move/copy special member functions,
comment|// ### that's why we need to provide them by hand above. We can't remove it in
comment|// ### Qt 5, since that would change the way its passed to functions. In Qt 6, remove all.
endif|#
directive|endif
comment|// Qt< 6.0
name|void
...
name|QXmlStreamNamespaceDeclaration
argument_list|(
argument|QXmlStreamNamespaceDeclaration&&other
argument_list|)
name|Q_DECL_NOTHROW
comment|// = default
label|:
...
name|QXmlStreamNotationDeclaration
argument_list|(
argument|QXmlStreamNotationDeclaration&&other
argument_list|)
name|Q_DECL_NOTHROW
comment|// = default
label|:
...
name|QXmlStreamEntityDeclaration
argument_list|(
argument|QXmlStreamEntityDeclaration&&other
argument_list|)
name|Q_DECL_NOTHROW
comment|// = default
label|:
