...
directive|endif
comment|/**  * AtspiLocaleType:  * @ATSPI_LOCALE_TYPE_MESSAGES: For localizable natural-language messages.  * @ATSPI_LOCALE_TYPE_COLLATE: For regular expression matching and string   * collation.   * @ATSPI_LOCALE_TYPE_CTYPE: For regular expression matching, character   * classification, conversion, case-sensitive comparison, and wide character   * functions.   * @ATSPI_LOCALE_TYPE_MONETARY: For monetary formatting.  * @ATSPI_LOCALE_TYPE_NUMERIC: For number formatting (such as the decimal   * point and the thousands separator).  * @ATSPI_LOCALE_TYPE_TIME: For time and date formatting.  *  * Used by interfaces #AtspiText and #AtspiDocument, this  * enumeration corresponds to the POSIX 'setlocale' enum values.  *  **/
typedef|typedef
enum|enum
block|{
DECL|enumerator|ATSPI_LOCALE_TYPE_MESSAGES
name|ATSPI_LOCALE_TYPE_MESSAGES
block|,
DECL|enumerator|ATSPI_LOCALE_TYPE_COLLATE
name|ATSPI_LOCALE_TYPE_COLLATE
block|,
DECL|enumerator|ATSPI_LOCALE_TYPE_CTYPE
name|ATSPI_LOCALE_TYPE_CTYPE
block|,
DECL|enumerator|ATSPI_LOCALE_TYPE_MONETARY
name|ATSPI_LOCALE_TYPE_MONETARY
block|,
DECL|enumerator|ATSPI_LOCALE_TYPE_NUMERIC
name|ATSPI_LOCALE_TYPE_NUMERIC
block|,
DECL|enumerator|ATSPI_LOCALE_TYPE_TIME
name|ATSPI_LOCALE_TYPE_TIME
block|, }
DECL|typedef|AtspiLocaleType
name|AtspiLocaleType
typedef|;
comment|/**  * ATSPI_LOCALE_TYPE_COUNT:  *  * One higher than the highest valid value of #AtspiLocaleType.  **/
DECL|macro|ATSPI_LOCALE_TYPE
define|#
directive|define
name|ATSPI_LOCALE_TYPE
value|_COUNT(5+1)
comment|/**  * AtspiCoordType:  * @ATSPI_COORD_TYPE_SCREEN: Specifies xy coordinates relative to the screen.  * @ATSPI_COORD_TYPE_WINDOW: Specifies xy coordinates relative to the widget's   * top-level window.  *  * Enumeration used by #AtspiComponent, #AtspiImage, and #AtspiText interfaces  * to specify whether coordinates are relative to the window or the screen.  *  **/
typedef|typedef
enum|enum
block|{
...
name|ATSPI_STATE_HORIZONTAL
block|,
DECL|enumerator|ATSPI_STATE_ICONIFIED
name|ATSPI_STATE_ICONIFIED
block|,
...
name|ATSPI_ROLE_ACCELERATOR_LABEL
block|,
...
name|ATSPI_CACHE_ALL
init|=
literal|0x3fffffff
block|,
DECL|enumerator|ATSPI_CACHE_DEFAULT
name|ATSPI_CACHE_DEFAULT
init|=
name|ATSPI_CACHE_PARENT
operator||
name|ATSPI_CACHE_CHILDREN
...
define|#
directive|define
name|ATSPI_DBUS_INTERFACE_TABLE_CELL
