...
end_comment
begin_comment
comment|/*  ftoption.h (for development)                                           */
end_comment
begin_comment
comment|/*                                                                         */
end_comment
...
comment|/*    * This variable is defined if either unpatented or native TrueType    * hinting is requested by the definitions above.    */
ifdef|#
directive|ifdef
name|TT_CONFIG_OPTION_BYTECODE_INTERPRETER
