...
end_comment
begin_comment
comment|/*  Copyright 1996-2003, 2006, 2008-2010, 2012, 2013 by                    */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    How to add, upgrade, remove, and control modules from FreeType.    */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    Additionally, some module properties can be controlled also.       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    Here is a list of possible values of the `module_name' field in    */
end_comment
begin_comment
comment|/*    the @FT_Module_Class structure.                                    */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*      raster1, raster5                                                 */
end_comment
begin_comment
comment|/*      sfnt                                                             */
end_comment
begin_comment
comment|/*      smooth, smooth-lcd, smooth-lcdv                                  */
end_comment
begin_comment
comment|/*      truetype                                                         */
end_comment
...
end_comment
begin_comment
comment|/*    Note that the FreeType Cache sub-system is not a FreeType module.  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    FT_Property_Set                                                    */
end_comment
begin_comment
comment|/*    FT_Property_Get                                                    */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    module :: The module to be searched.                               */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_empty_stmt
begin_comment
comment|/**********************************************************************    *    * @function:    *    FT_Property_Set    *    * @description:    *    Set a property for a given module.    *    * @input:    *    library ::    *       A handle to the library the module is part of.    *    *    module_name ::    *       The module name.    *    *    property_name ::    *       The property name.  Properties are described in the `Synopsis'    *       subsection of the module's documentation.    *    *       Note that only a few modules have properties.    *    *    value ::    *       A generic pointer to a variable or structure that gives the new    *       value of the property.  The exact definition of `value' is    *       dependent on the property; see the `Synopsis' subsection of the    *       module's documentation.    *    * @return:    *   FreeType error code.  0~means success.    *    * @note:    *    If `module_name' isn't a valid module name, or `property_name'    *    doesn't specify a valid property, or if `value' doesn't represent a    *    valid value for the given property, an error is returned.    *    *    The following example sets property `bar' (a simple integer) in    *    module `foo' to value~1.    *    *    {    *      FT_UInt  bar;    *    *    *      bar = 1;    *      FT_Property_Set( library, "foo", "bar",&bar );    *    }    *    *    Note that the FreeType Cache sub-system doesn't recognize module    *    property changes.  To avoid glyph lookup confusion within the cache    *    you should call @FTC_Manager_Reset to completely flush the cache if    *    a module property gets changed after @FTC_Manager_New has been    *    called.    *    *    It is not possible to set properties of the FreeType Cache    *    sub-system itself with FT_Property_Set; use @FTC_Property_Set    *    instead.    *    *  @since:    *    2.4.11    *    */
end_comment
begin_macro
name|FT_EXPORT
argument_list|(
...
end_empty_stmt
begin_comment
comment|/**********************************************************************    *    * @function:    *    FT_Property_Get    *    * @description:    *    Get a module's property value.    *    * @input:    *    library ::    *       A handle to the library the module is part of.    *    *    module_name ::    *       The module name.    *    *    property_name ::    *       The property name.  Properties are described in the `Synopsis'    *       subsection of the module's documentation.    *    * @inout:    *    value ::    *       A generic pointer to a variable or structure that gives the    *       value of the property.  The exact definition of `value' is    *       dependent on the property; see the `Synopsis' subsection of the    *       module's documentation.    *    * @return:    *   FreeType error code.  0~means success.    *    * @note:    *    If `module_name' isn't a valid module name, or `property_name'    *    doesn't specify a valid property, or if `value' doesn't represent a    *    valid value for the given property, an error is returned.    *    *    The following example gets property `baz' (a range) in module `foo'.    *    *    {    *      typedef  range_    *      {    *        FT_Int32  min;    *        FT_Int32  max;    *    *      } range;    *    *      range  baz;    *    *    *      FT_Property_Get( library, "foo", "baz",&baz );    *    }    *    *    It is not possible to retrieve properties of the FreeType Cache    *    sub-system with FT_Property_Get; use @FTC_Property_Get instead.    *    *  @since:    *    2.4.11    *    */
end_comment
begin_macro
name|FT_EXPORT
argument_list|(
...
end_comment
begin_comment
comment|/*    A counter gets initialized to~1 at the time an @FT_Library         */
end_comment
begin_comment
comment|/*    structure is created.  This function increments the counter.       */
end_comment
begin_comment
comment|/*    @FT_Done_Library then only destroys a library if the counter is~1, */
end_comment
begin_comment
comment|/*    otherwise it simply decrements the counter.                        */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    reference @FT_Library objects.                                     */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    library :: A handle to a target library object.                    */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    Don't use @FT_Done_FreeType but @FT_Done_Library to destroy a      */
end_comment
begin_comment
comment|/*    library instance.                                                  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
