...
end_comment
begin_comment
comment|/*  Copyright 1996-2003, 2006, 2008, 2009, 2011, 2013, 2014 by             */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    advance width in 16.16 fixed-point format.                         */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    that contains B̩zier outside arcs).                                */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    mode  :: The mode that indicates how to interpret the returned     */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    If the font is tricky and the glyph has been loaded with           */
end_comment
begin_comment
comment|/*    @FT_LOAD_NO_SCALE, the resulting CBox is meaningless.  To get      */
end_comment
begin_comment
comment|/*    reasonable values for the CBox it is necessary to load the glyph   */
end_comment
begin_comment
comment|/*    at a large ppem value (so that the hinting instructions can        */
end_comment
begin_comment
comment|/*    properly shift and scale the subglyphs), then extracting the CBox, */
end_comment
begin_comment
comment|/*    which can be eventually converted back to font units.              */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
