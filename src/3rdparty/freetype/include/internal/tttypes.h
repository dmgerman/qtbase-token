...
end_comment
begin_comment
comment|/*  Copyright 1996-2002, 2004-2008, 2012-2013 by                           */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    WOFF file format header.                                           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*      http://www.w3.org/TR/WOFF/#WOFFHeader                            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    This structure describes a given table of a WOFF font.             */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    Offset     :: The offset of the table from the start of the WOFF   */
end_comment
begin_comment
comment|/*                  font in its resource.                                */
end_comment
...
end_comment
begin_comment
comment|/*    CompLength :: Compressed table length (in bytes).                  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    OrigLength :: Unompressed table length (in bytes).                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    OrigOffset :: The uncompressed table file offset.  This value gets */
end_comment
begin_comment
comment|/*                  computed while constructing the (uncompressed) SFNT  */
end_comment
begin_comment
comment|/*                  header.  It is not contained in the WOFF file.       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
name|CompLength
decl_stmt|;
comment|/* compressed table length   */
DECL|member|OrigLength
name|FT_ULong
name|OrigLength
decl_stmt|;
comment|/* uncompressed table length */
DECL|member|CheckSum
name|FT_ULong
name|CheckSum
decl_stmt|;
comment|/* uncompressed checksum     */
DECL|member|OrigOffset
name|FT_ULong
name|OrigOffset
decl_stmt|;
comment|/* uncompressed table file offset */
comment|/* (not in the WOFF file)         */
block|}
...
name|TT_SBIT_TABLE_TYPE_MAX
block|}
DECL|typedef|TT_SbitTableType
name|TT_SbitTableType
typedef|;
end_typedef
begin_comment
comment|/*************************************************************************/
...
comment|/* since 2.4.12 */
DECL|member|sph_found_func_flags
name|FT_ULong
name|sph_found_func_flags
decl_stmt|;
comment|/* special functions found */
comment|/* for this face           */
...
end_comment
begin_comment
comment|/*     max_points   :: The maximum size in points of the zone.           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
