...
end_comment
begin_comment
comment|/*  Copyright 1996-2006, 2008, 2010, 2012-2013 by                          */
end_comment
begin_comment
...
end_define
begin_comment
comment|/*    *  Approximate sqrt(x*x+y*y) using the `alpha max plus beta min'    *  algorithm.  We use alpha = 1, beta = 3/8, giving us results with a    *  largest error less than 7% compared to the exact value.    */
end_comment
begin_define
DECL|macro|FT_HYPOT
define|#
...
parameter_list|)
define|\
value|( x = FT_ABS( x ),             \             y = FT_ABS( y ),             \             x> y ? x + ( 3 * y>> 3 )   \                   : y + ( 3 * x>> 3 ) )
end_define
begin_define
...
end_comment
begin_comment
comment|/*      The maximum number of points used to store the vectorial outline */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*      The maximum number of contours used to store the vectorial       */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*      A counter initialized to~1 at the time an @FT_Face structure is  */
end_comment
begin_comment
comment|/*      created.  @FT_Reference_Face increments this counter, and        */
end_comment
begin_comment
comment|/*      @FT_Done_Face only destroys a face if the counter is~1,          */
end_comment
begin_comment
comment|/*      otherwise it simply decrements it.                               */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_typedef
begin_comment
comment|/* typecast an object to an FT_Module */
end_comment
begin_define
...
end_comment
begin_comment
comment|/****   F A C E,   S I Z E&   G L Y P H   S L O T   O B J E C T S  ****/
end_comment
begin_comment
comment|/****                                                                 ****/
end_comment
...
end_comment
begin_comment
comment|/*    lcd_filter       :: If subpixel rendering is activated, the        */
end_comment
begin_comment
comment|/*                        selected LCD filter mode.                      */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    lcd_extra        :: If subpixel rendering is activated, the number */
end_comment
begin_comment
comment|/*                        of extra pixels needed for the LCD filter.     */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    lcd_weights      :: If subpixel rendering is activated, the LCD    */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    lcd_filter_func  :: If subpixel rendering is activated, the LCD    */
end_comment
begin_comment
comment|/*                        filtering callback function.                   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    refcount         :: A counter initialized to~1 at the time an      */
end_comment
begin_comment
comment|/*                        @FT_Library structure is created.              */
end_comment
begin_comment
comment|/*                        @FT_Reference_Library increments this counter, */
end_comment
begin_comment
comment|/*                        and @FT_Done_Library only destroys a library   */
end_comment
begin_comment
comment|/*                        if the counter is~1, otherwise it simply       */
end_comment
begin_comment
comment|/*                        decrements it.                                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    be called with a pre-allocated structure to be filled.             */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    be called with a pre-allocated stcture to be filled.               */
end_comment
begin_comment
comment|/*    When FT_CONFIG_OPTION_PIC is not defined the struct will be        */
end_comment
...
end_comment
begin_comment
comment|/*    FT_Renderer_Class struct instance.                                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    to be called with a pointer where the allocated structure is       */
end_comment
begin_comment
comment|/*    returned.  And when it is no longer needed a `destroy' function    */
end_comment
begin_comment
comment|/*    needs to be called to release that allocation.                     */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    by the renderer definition calling `FT_DEFINE_RENDERER' in the     */
end_comment
begin_comment
comment|/*    following.                                                         */
end_comment
...
end_comment
begin_comment
comment|/*    FT_Module_Class struct instance.                                   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    Used to initialize an instance of an FT_Module_Class struct.       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    When FT_CONFIG_OPTION_PIC is defined a `create' funtion needs to   */
end_comment
begin_comment
comment|/*    be called with a pointer where the allocated structure is          */
end_comment
begin_comment
comment|/*    returned.  And when it is no longer needed a `destroy' function    */
end_comment
...
end_comment
begin_comment
comment|/*    by the module definition calling `FT_DEFINE_MODULE' in the         */
end_comment
begin_comment
comment|/*    following.                                                         */
end_comment
...
end_comment
begin_comment
comment|/*    Used to initialize an instance of an FT_Module_Class struct inside */
end_comment
begin_comment
comment|/*    another struct that contains it or in a function that initializes  */
end_comment
begin_comment
comment|/*    that containing struct.                                            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
parameter_list|)
define|\
value|FT_CALLBACK_TABLE                  \   const FT_Module_Class  class_;
end_define
begin_define
...
parameter_list|)
define|\
value|{                             \     flags_,                     \     size_,                      \                                 \     name_,                      \     version_,                   \     requires_,                  \                                 \     interface_,                 \                                 \     init_,                      \     done_,                      \     get_interface_,             \   },
end_define
begin_define
