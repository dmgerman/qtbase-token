...
end_comment
begin_comment
comment|/*  Copyright 1996-2002, 2007, 2009, 2012 by                               */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    Retrieve the global hints computed for a given face object.  The   */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    Discard the global hints retrieved through                         */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    FT_AutoHinter_InterfaceRec                                         */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
typedef|typedef
struct|struct
name|FT_AutoHinter_InterfaceRec_
block|{
...
parameter_list|)
define|\
value|FT_CALLBACK_TABLE_DEF                       \   const FT_AutoHinter_InterfaceRec  class_ =  \   {                                           \     reset_face_,                              \     get_global_hints_,                        \     done_global_hints_,                       \     load_glyph_                               \   };
end_define
begin_else
else|#
directive|else
...
parameter_list|)
define|\
value|void                                                             \   FT_Init_Class_ ## class_( FT_Library                   library,  \                             FT_AutoHinter_InterfaceRec*  clazz )   \   {                                                                \     FT_UNUSED( library );                                          \                                                                    \     clazz->reset_face        = reset_face_;                        \     clazz->get_global_hints  = get_global_hints_;                  \     clazz->done_global_hints = done_global_hints_;                 \     clazz->load_glyph        = load_glyph_;                        \   }
end_define
begin_endif
endif|#
directive|endif
