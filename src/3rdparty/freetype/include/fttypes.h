...
end_comment
begin_comment
comment|/*  Copyright 1996-2002, 2004, 2006-2009, 2012-2014 by                     */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    A signed 2.14 fixed-point type used for unit vectors.              */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    A signed 26.6 fixed-point type used for vectorial pixel            */
end_comment
begin_comment
comment|/*    coordinates.                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    This type is used to store 16.16 fixed-point values, like scaling  */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    in 16.16 fixed-point format.  The computation performed is:        */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    The address of the FreeType object that is under finalization.     */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    Some FreeType object contains a `generic' field, of type           */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    This macro converts four-letter tags that are used to label        */
end_comment
begin_comment
...
end_define
begin_comment
comment|/* see `ftmoderr.h' for descriptions of the following macros */
end_comment
begin_define
DECL|macro|FT_ERR
define|#
...
parameter_list|)
define|\
value|( FT_ERROR_BASE( x ) == FT_ERROR_BASE( FT_ERR( e ) ) )
end_define
begin_define
DECL|macro|FT_ERR_NEQ
define|#
directive|define
name|FT_ERR_NEQ
parameter_list|(
