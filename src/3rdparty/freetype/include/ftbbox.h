...
end_comment
begin_comment
comment|/*  Copyright 1996-2001, 2003, 2007, 2011, 2013 by                         */
end_comment
begin_comment
...
comment|/*    algorithm that returns _very_ quickly when the two boxes           */
...
comment|/*    @FT_LOAD_NO_SCALE, the resulting BBox is meaningless.  To get      */
comment|/*    reasonable values for the BBox it is necessary to load the glyph   */
comment|/*    at a large ppem value (so that the hinting instructions can        */
comment|/*    properly shift and scale the subglyphs), then extracting the BBox, */
