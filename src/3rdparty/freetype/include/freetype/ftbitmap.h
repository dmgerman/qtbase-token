...
comment|/*                                                                       */
comment|/*<Note>                                                                */
comment|/*    A deprecated name for the same function is `FT_Bitmap_New'.        */
comment|/*                                                                       */
name|FT_EXPORT
parameter_list|(
name|void
parameter_list|)
function_decl|FT_Bitmap_Init
...
end_comment
begin_comment
comment|/*    Destroy a bitmap object initialized with @FT_Bitmap_Init.          */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
