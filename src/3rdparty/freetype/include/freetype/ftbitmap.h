...
end_comment
begin_comment
comment|/*  Copyright 2004, 2005, 2006, 2008 by                                    */
end_comment
begin_comment
...
comment|/*                                                                       */
comment|/*<Description>                                                         */
comment|/*    This section contains functions for converting FT_Bitmap objects.  */
comment|/*                                                                       */
comment|/*************************************************************************/
comment|/*************************************************************************/
comment|/*                                                                       */
...
end_comment
begin_comment
comment|/*    Convert a bitmap object with depth 1bpp, 2bpp, 4bpp, or 8bpp to a  */
end_comment
begin_comment
comment|/*    bitmap object with depth 8bpp, making the number of used bytes per */
end_comment
begin_comment
comment|/*    line (a.k.a. the `pitch') a multiple of `alignment'.               */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
