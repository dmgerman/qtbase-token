...
end_comment
begin_comment
comment|/*  Copyright 1996-2002, 2003, 2004, 2006, 2007, 2008 by                   */
end_comment
begin_comment
...
comment|/* TT_PLATFORM_MACINTOSH.                                                */
comment|/*                                                                       */
comment|/* The canonical source for the Apple assigned Language ID's is at       */
comment|/*                                                                       */
comment|/*   http://fonts.apple.com/TTRefMan/RM06/Chap6name.html                 */
comment|/*                                                                       */
...
comment|/*                                                                       */
comment|/* The canonical source for the MS assigned LCID's (seems to) be at      */
comment|/*                                                                       */
comment|/*   http://www.microsoft.com/globaldev/reference/lcid-all.mspx          */
comment|/*                                                                       */
comment|/* It used to be at various places, among them                           */
comment|/*                                                                       */
comment|/*   http://www.microsoft.com/typography/OTSPEC/lcid-cp.txt              */
comment|/*   http://www.microsoft.com/globaldev/reference/loclanghome.asp        */
comment|/*   http://support.microsoft.com/support/kb/articles/Q224/8/04.ASP      */
comment|/*   http://msdn.microsoft.com/library/en-us/passport25/                 */
comment|/*           NET_Passport_VBScript_Documentation/Single_Sign_In/         */
comment|/*           Advanced_Single_Sign_In/Localization_and_LCIDs.asp          */
comment|/*                                                                       */
comment|/* Hopefully, it seems now that the Globaldev site prevails...           */
comment|/*                                   (updated by Antoine, 2004-02-17)    */
