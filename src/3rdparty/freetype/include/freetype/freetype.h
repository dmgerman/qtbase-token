...
end_comment
begin_comment
comment|/*    In multi-threaded applications it is easiest to use one            */
end_comment
begin_comment
comment|/*    `FT_Library' object per thread.  In case this is too cumbersome,   */
end_comment
begin_comment
comment|/*    a single `FT_Library' object across threads is possible also       */
end_comment
begin_comment
comment|/*    (since FreeType version 2.5.6), as long as a mutex lock is used    */
end_comment
begin_comment
comment|/*    around @FT_New_Face and @FT_Done_Face.                             */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    An `FT_Face' object can only be safely used from one thread at a   */
end_comment
begin_comment
comment|/*    time.  Similarly, creation and destruction of `FT_Face' with the   */
end_comment
begin_comment
comment|/*    same @FT_Library object can only be done from one thread at a      */
end_comment
begin_comment
comment|/*    time.  On the other hand, functions like @FT_Load_Glyph and its    */
end_comment
begin_comment
comment|/*    siblings are thread-safe and do not need the lock to be held as    */
end_comment
begin_comment
comment|/*    long as the same `FT_Face' object is not used from multiple        */
end_comment
begin_comment
comment|/*    threads at the same time.                                          */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*      mathematical symbols and wingdings.  For more information, see   */
end_comment
begin_comment
comment|/*      `http://www.microsoft.com/typography/otspec/recom.htm',          */
end_comment
begin_comment
comment|/*      `http://www.kostis.net/charsets/symbol.htm', and                 */
end_comment
begin_comment
comment|/*      `http://www.kostis.net/charsets/wingding.htm'.                   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*      This encoding uses character codes from the PUA (Private Unicode */
end_comment
begin_comment
comment|/*      Area) in the range U+F020-U+F0FF.                                */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*      `https://msdn.microsoft.com/en-US/goglobal/cc305154'.            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    face_index          :: This field holds two different values.      */
end_comment
begin_comment
comment|/*                           Bits 0-15 are the index of the face in the  */
end_comment
begin_comment
comment|/*                           font file (starting with value~0).  They    */
end_comment
begin_comment
comment|/*                           are set to~0 if there is only one face in   */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*                           Bits 16-30 are relevant to GX variation     */
end_comment
begin_comment
comment|/*                           fonts only, holding the named instance      */
end_comment
begin_comment
comment|/*                           index for the current face index (starting  */
end_comment
begin_comment
comment|/*                           with value~1; value~0 indicates font access */
end_comment
begin_comment
comment|/*                           without GX variation data).  For non-GX     */
end_comment
begin_comment
comment|/*                           fonts, bits 16-30 are ignored.  If we have  */
end_comment
begin_comment
comment|/*                           the third named instance of face~4, say,    */
end_comment
begin_comment
comment|/*                           `face_index' is set to 0x00030004.          */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*                           Bit 31 is always zero (this is,             */
end_comment
begin_comment
comment|/*                           `face_index' is always a positive value).   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    style_flags         :: The lower 16~bits contain a set of bit      */
end_comment
begin_comment
comment|/*                           flags indicating the style of the face; see */
end_comment
begin_comment
comment|/*                           @FT_STYLE_FLAG_XXX for the details.  Bits   */
end_comment
begin_comment
comment|/*                           16-30 hold the number of named instances    */
end_comment
begin_comment
comment|/*                           available for the current face if we have a */
end_comment
begin_comment
comment|/*                           GX variation (sub)font.  Bit 31 is always   */
end_comment
begin_comment
comment|/*                           zero (this is, `style_flags' is always a    */
end_comment
begin_comment
comment|/*                           positive value).                            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*                           In case the font doesn't provide a specific */
end_comment
begin_comment
comment|/*                           family name entry, FreeType tries to        */
end_comment
begin_comment
comment|/*                           synthesize one, deriving it from other name */
end_comment
begin_comment
comment|/*                           entries.                                    */
end_comment
...
end_comment
begin_comment
comment|/*      It is not possible to auto-hint such fonts using                 */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*                         left side bearing while auto-hinting is       */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*                         right side bearing while auto-hinting is      */
end_comment
begin_comment
comment|/*                         active.  Zero otherwise.                      */
end_comment
...
end_comment
begin_comment
comment|/*    Here is a small pseudo code fragment that shows how to use         */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    See the documentation of @FT_Library and @FT_Face for              */
end_comment
begin_comment
comment|/*    multi-threading issues.                                            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    face_index :: See @FT_Open_Face for a detailed description of this */
end_comment
begin_comment
comment|/*                  parameter.                                           */
end_comment
...
end_comment
begin_comment
comment|/*    face_index :: This field holds two different values.  Bits 0-15    */
end_comment
begin_comment
comment|/*                  are the index of the face in the font file (starting */
end_comment
begin_comment
comment|/*                  with value~0).  Set it to~0 if there is only one     */
end_comment
begin_comment
comment|/*                  face in the font file.                               */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*                  Bits 16-30 are relevant to GX variation fonts only,  */
end_comment
begin_comment
comment|/*                  specifying the named instance index for the current  */
end_comment
begin_comment
comment|/*                  face index (starting with value~1; value~0 makes     */
end_comment
begin_comment
comment|/*                  FreeType ignore named instances).  For non-GX fonts, */
end_comment
begin_comment
comment|/*                  bits 16-30 are ignored.  Assuming that you want to   */
end_comment
begin_comment
comment|/*                  access the third named instance in face~4,           */
end_comment
begin_comment
comment|/*                  `face_index' should be set to 0x00030004.  If you    */
end_comment
begin_comment
comment|/*                  want to access face~4 without GX variation handling, */
end_comment
begin_comment
comment|/*                  simply set `face_index' to value~4.                  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*                  FT_Open_Face and its siblings can be used to quickly */
end_comment
begin_comment
comment|/*                  check whether the font format of a given font        */
end_comment
begin_comment
comment|/*                  resource is supported by FreeType.  In general, if   */
end_comment
begin_comment
comment|/*                  the `face_index' argument is negative, the           */
end_comment
begin_comment
comment|/*                  function's return value is~0 if the font format is   */
end_comment
begin_comment
comment|/*                  recognized, or non-zero otherwise.  The function     */
end_comment
begin_comment
comment|/*                  allocates a more or less empty face handle in        */
end_comment
begin_comment
comment|/*                  `*aface' (if `aface' isn't NULL); the only two       */
end_comment
begin_comment
comment|/*                  useful fields in this special case are               */
end_comment
begin_comment
comment|/*                  `face->num_faces' and `face->style_flags'.  For any  */
end_comment
begin_comment
comment|/*                  negative value of `face_index', `face->num_faces'    */
end_comment
begin_comment
comment|/*                  gives the number of faces within the font file.  For */
end_comment
begin_comment
comment|/*                  the negative value `-(N+1)' (with `N' a 16-bit       */
end_comment
begin_comment
comment|/*                  value), bits 16-30 in `face->style_flags' give the   */
end_comment
begin_comment
comment|/*                  number of named instances in face `N' if we have a   */
end_comment
begin_comment
comment|/*                  GX variation font (or zero otherwise).  After        */
end_comment
begin_comment
comment|/*                  examination, the returned @FT_Face structure should  */
end_comment
begin_comment
comment|/*                  be deallocated with a call to @FT_Done_Face.         */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    To loop over all faces, use code similar to the following snippet  */
end_comment
begin_comment
comment|/*    (omitting the error handling).                                     */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*      FT_Face  face;                                                   */
end_comment
begin_comment
comment|/*      FT_Long  i, num_faces;                                           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*      error = FT_Open_Face( library, args, -1,&face );                */
end_comment
begin_comment
comment|/*      if ( error ) { ... }                                             */
end_comment
...
end_comment
begin_comment
comment|/*      num_faces = face->num_faces;                                     */
end_comment
begin_comment
comment|/*      FT_Done_Face( face );                                            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*      for ( i = 0; i< num_faces; i++ )                                */
end_comment
begin_comment
comment|/*      {                                                                */
end_comment
...
end_comment
begin_comment
comment|/*        error = FT_Open_Face( library, args, i,&face );               */
end_comment
begin_comment
comment|/*        ...                                                            */
end_comment
...
end_comment
begin_comment
comment|/*    To loop over all valid values for `face_index', use something      */
end_comment
begin_comment
comment|/*    similar to the following snippet, again without error handling.    */
end_comment
begin_comment
comment|/*    The code accesses all faces immediately (thus only a single call   */
end_comment
begin_comment
comment|/*    of `FT_Open_Face' within the do-loop), with and without named      */
end_comment
begin_comment
comment|/*    instances.                                                         */
end_comment
...
end_comment
begin_comment
comment|/*      FT_Long  num_faces     = 0;                                      */
end_comment
begin_comment
comment|/*      FT_Long  num_instances = 0;                                      */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*      FT_Long  face_idx     = 0;                                       */
end_comment
begin_comment
comment|/*      FT_Long  instance_idx = 0;                                       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*        FT_Long  id = ( instance_idx<< 16 ) + face_idx;               */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*        error = FT_Open_Face( library, args, id,&face );              */
end_comment
begin_comment
comment|/*        if ( error ) { ... }                                           */
end_comment
...
end_comment
begin_comment
comment|/*        num_instances = face->style_flags>> 16;                       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*        if ( instance_idx< num_instances )                            */
end_comment
begin_comment
comment|/*          instance_idx++;                                              */
end_comment
begin_comment
comment|/*        else                                                           */
end_comment
...
end_comment
begin_comment
comment|/*      } while ( face_idx< num_faces )                                 */
end_comment
begin_comment
comment|/*    }                                                                  */
end_comment
...
end_comment
begin_comment
comment|/*    FT_KERNING_DEFAULT  :: Return grid-fitted kerning distances in     */
end_comment
begin_comment
comment|/*                           pixels (value is~0).  Whether they are      */
end_comment
begin_comment
comment|/*                           scaled depends on @FT_LOAD_NO_SCALE.        */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    FT_KERNING_UNFITTED :: Return un-grid-fitted kerning distances in  */
end_comment
begin_comment
comment|/*                           26.6 fractional pixels.  Whether they are   */
end_comment
begin_comment
comment|/*                           scaled depends on @FT_LOAD_NO_SCALE.        */
end_comment
...
end_comment
begin_comment
comment|/*    FT_KERNING_DEFAULT returns full pixel values; it also makes        */
end_comment
begin_comment
comment|/*    FreeType heuristically scale down kerning distances at small ppem  */
end_comment
begin_comment
comment|/*    values so that they don't become too big.                          */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*                   fractional pixels (26.6 format), or pixels for      */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    Be aware that character codes can have values up to 0xFFFFFFFF;    */
end_comment
begin_comment
comment|/*    this might happen for non-Unicode or malformed cmaps.  However,    */
end_comment
begin_comment
comment|/*    even with regular Unicode encoding, so-called `last resort fonts'  */
end_comment
begin_comment
comment|/*    (using SFNT cmap format 13, see function @FT_Get_CMap_Format)      */
end_comment
begin_comment
comment|/*    normally have entries for all Unicode characters up to 0x1FFFFF,   */
end_comment
begin_comment
comment|/*    which can cause *a lot* of iterations.                             */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    http://www.adobe.com/content/dam/Adobe/en/devnet/acrobat/pdfs/FontPolicies.pdf */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    The flags are ORed together, thus more than a single value can be  */
end_comment
begin_comment
comment|/*    returned.                                                          */
end_comment
...
end_comment
begin_comment
comment|/*    `a' rounded to nearest 16.16 fixed integer, halfway cases away     */
end_comment
begin_comment
comment|/*    from zero.                                                         */
end_comment
...
end_comment
begin_comment
comment|/*    `a' rounded towards plus infinity.                                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    `a' rounded towards minus infinity.                                */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
