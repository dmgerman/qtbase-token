...
end_comment
begin_comment
comment|/*  Copyright 1996-2001, 2002, 2004, 2005, 2006 by                         */
end_comment
begin_comment
...
name|s
parameter_list|)
value|( FT_UINT16( FT_INT8_( p, i ) )<< (s) )
end_define
begin_define
...
name|s
parameter_list|)
value|( FT_UINT32( FT_INT8_( p, i ) )<< (s) )
end_define
begin_define
...
name|p
parameter_list|)
value|FT_INT16( FT_INT8_I16( p, 0, 8) | \                                       FT_BYTE_I16( p, 1, 0) )
end_define
begin_define
...
name|p
parameter_list|)
value|FT_INT32( FT_INT8_I32( p, 0, 24 ) | \                                      FT_BYTE_I32( p, 1, 16 ) | \                                      FT_BYTE_I32( p, 2,  8 ) | \                                      FT_BYTE_I32( p, 3,  0 ) )
end_define
begin_define
...
name|p
parameter_list|)
value|FT_INT32( FT_INT8_I32( p, 0, 16 ) | \                                      FT_BYTE_I32( p, 1,  8 ) | \                                      FT_BYTE_I32( p, 2,  0 ) )
end_define
begin_define
...
name|p
parameter_list|)
value|FT_INT16( FT_INT8_I16( p, 1, 8 ) | \                                          FT_BYTE_I16( p, 0, 0 ) )
end_define
begin_define
...
name|p
parameter_list|)
value|FT_INT32( FT_INT8_I32( p, 3, 24 ) | \                                         FT_BYTE_I32( p, 2, 16 ) | \                                         FT_BYTE_I32( p, 1,  8 ) | \                                         FT_BYTE_I32( p, 0,  0 ) )
end_define
begin_define
...
name|p
parameter_list|)
value|FT_INT32( FT_INT8_I32( p, 2, 16 ) | \                                         FT_BYTE_I32( p, 1,  8 ) | \                                         FT_BYTE_I32( p, 0,  0 ) )
end_define
begin_define
...
name|FT_GET_SHORT
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetShort, FT_Short )
end_define
begin_define
...
name|FT_GET_USHORT
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetShort, FT_UShort )
end_define
begin_define
...
name|FT_GET_OFF3
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetOffset, FT_Long )
end_define
begin_define
...
name|FT_GET_UOFF3
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetOffset, FT_ULong )
end_define
begin_define
...
name|FT_GET_LONG
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetLong, FT_Long )
end_define
begin_define
...
name|FT_GET_ULONG
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetLong, FT_ULong )
end_define
begin_define
...
name|FT_GET_SHORT_LE
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetShortLE, FT_Short )
end_define
begin_define
...
name|FT_GET_USHORT_LE
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetShortLE, FT_UShort )
end_define
begin_define
...
name|FT_GET_LONG_LE
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetLongLE, FT_Long )
end_define
begin_define
...
name|FT_GET_ULONG_LE
parameter_list|()
value|FT_GET_MACRO( FT_Stream_GetLongLE, FT_ULong )
end_define
begin_endif
endif|#
directive|endif
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadShort, FT_Short, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadShort, FT_UShort, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadOffset, FT_Long, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadOffset, FT_ULong, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadLong, FT_Long, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadLong, FT_ULong, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadShortLE, FT_Short, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadShortLE, FT_UShort, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadLongLE, FT_Long, var )
end_define
begin_define
...
name|var
parameter_list|)
value|FT_READ_MACRO( FT_Stream_ReadLongLE, FT_ULong, var )
end_define
begin_ifndef
ifndef|#
directive|ifndef
...
end_empty_stmt
begin_comment
comment|/* read a 16-bit big-endian integer from an entered frame */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 24-bit big-endian integer from an entered frame */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 32-bit big-endian integer from an entered frame */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 16-bit little-endian integer from an entered frame */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 32-bit little-endian integer from an entered frame */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 16-bit big-endian integer from a stream */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 24-bit big-endian integer from a stream */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 16-bit little-endian integer from a stream */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
end_empty_stmt
begin_comment
comment|/* read a 32-bit little-endian integer from a stream */
end_comment
begin_macro
name|FT_BASE
argument_list|(
...
parameter_list|)
define|\
value|FT_SET_ERROR( FT_Stream_Seek( stream, position ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_SET_ERROR( FT_Stream_Skip( stream, distance ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_SET_ERROR( FT_Stream_Read( stream,           \                                         (FT_Byte*)buffer, \                                         count ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_SET_ERROR( FT_Stream_ReadAt( stream,            \                                            position,         \                                            (FT_Byte*)buffer, \                                            count ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_SET_ERROR(                                              \             FT_DEBUG_INNER( FT_Stream_EnterFrame( stream, size ) ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_SET_ERROR(                                                       \             FT_DEBUG_INNER( FT_Stream_ExtractFrame( stream, size,             \                                                     (FT_Byte**)&(bytes) ) ) )
end_define
begin_define
