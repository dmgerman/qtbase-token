...
end_comment
begin_comment
comment|/*    FT_DEFINE_SERVICEDESCREC1                                          */
end_comment
begin_comment
comment|/*    FT_DEFINE_SERVICEDESCREC2                                          */
end_comment
begin_comment
comment|/*    FT_DEFINE_SERVICEDESCREC3                                          */
end_comment
begin_comment
comment|/*    FT_DEFINE_SERVICEDESCREC4                                          */
end_comment
begin_comment
comment|/*    FT_DEFINE_SERVICEDESCREC5                                          */
end_comment
begin_comment
comment|/*    FT_DEFINE_SERVICEDESCREC6                                          */
end_comment
begin_comment
comment|/*    FT_DEFINE_SERVICEDESCREC7                                          */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    Used to initialize an array of FT_ServiceDescRec structures.       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    When FT_CONFIG_OPTION_PIC is defined a `create' function needs to  */
end_comment
begin_comment
comment|/*    be called with a pointer to return an allocated array.  As soon as */
end_comment
begin_comment
comment|/*    it is no longer needed, a `destroy' function needs to be called to */
end_comment
begin_comment
comment|/*    release that allocation.                                           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    These functions should be manually called from the `pic_init' and  */
end_comment
begin_comment
...
define|#
directive|define
name|FT_DEFINE_SERVICEDESCREC7
parameter_list|(
name|class_
parameter_list|,                                  \
name|serv_id_1
...
parameter_list|)
define|\
value|static const FT_ServiceDescRec  class_[] =                                \   {                                                                         \     { serv_id_1, serv_data_1 },                                             \     { serv_id_2, serv_data_2 },                                             \     { serv_id_3, serv_data_3 },                                             \     { serv_id_4, serv_data_4 },                                             \     { serv_id_5, serv_data_5 },                                             \     { serv_id_6, serv_data_6 },                                             \     { serv_id_7, serv_data_7 },                                             \     { NULL, NULL }                                                          \   };
end_define
begin_else
else|#
directive|else
...
end_comment
begin_comment
comment|/* ensure that value `1' has the same width as a pointer */
end_comment
begin_define
...
define|#
directive|define
name|FT_SERVICE_PROPERTIES_H
value|<freetype/internal/services/svprop.h>
end_define
begin_define
...
define|#
directive|define
name|FT_SERVICE_FONT_FORMAT_H
value|<freetype/internal/services/svfntfmt.h>
end_define
begin_define
