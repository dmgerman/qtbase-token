...
end_define
begin_comment
comment|/* we use FT_TYPEOF to suppress signedness compilation warnings */
end_comment
begin_define
...
parameter_list|)
define|\
value|( (req)->horiResolution                                          \               ? ( (req)->width * (FT_Pos)(req)->horiResolution + 36 ) / 72 \               : (req)->width )
end_define
begin_define
...
parameter_list|)
define|\
value|( (req)->vertResolution                                           \               ? ( (req)->height * (FT_Pos)(req)->vertResolution + 36 ) / 72 \               : (req)->height )
end_define
begin_comment
...
end_comment
begin_comment
comment|/*     glyph_loader :: Unused.  Used to be glyph loader for all faces    */
end_comment
begin_comment
comment|/*                     managed by this driver.                           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
