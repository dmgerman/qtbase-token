...
end_comment
begin_comment
comment|/*                  collection, in bits 0-15.  The numbered instance     */
end_comment
begin_comment
comment|/*                  index~+~1 of a GX (sub)font, if applicable, in bits  */
end_comment
begin_comment
comment|/*                  16-30.                                               */
end_comment
...
end_comment
begin_comment
comment|/*    From the `name' table, return a given ENGLISH name record in       */
end_comment
begin_comment
comment|/*    ASCII.                                                             */
end_comment
...
end_comment
begin_comment
comment|/*    name     :: The address of an allocated string pointer.  NULL if   */
end_comment
begin_comment
comment|/*                no name is present.                                    */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
