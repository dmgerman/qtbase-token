...
end_comment
begin_comment
comment|/*                        The idea of this function is to be able to     */
end_comment
begin_comment
comment|/*                        perform device-independent text layout without */
end_comment
begin_comment
comment|/*                        loading a single glyph image.                  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    Used to create a forward declaration of an FT_Driver_ClassRec      */
end_comment
begin_comment
comment|/*    struct instance.                                                   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    When FT_CONFIG_OPTION_PIC is defined a `create' function has to be */
end_comment
begin_comment
comment|/*    called with a pointer where the allocated structure is returned.   */
end_comment
begin_comment
comment|/*    And when it is no longer needed a `destroy' function needs to be   */
end_comment
begin_comment
comment|/*    called to release that allocation.                                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    `fcinit.c' (ft_create_default_module_classes) already contains a   */
end_comment
begin_comment
comment|/*    mechanism to call these functions for the default modules          */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    `pic_init' and `pic_free' to allow you to manually allocate and    */
end_comment
begin_comment
comment|/*    initialize any additional global data, like a module specific      */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    empty to resolve the link error.  Also the `pic_init' and          */
end_comment
begin_comment
comment|/*    `pic_free' functions should be declared in `pic.h', to be referred */
end_comment
begin_comment
comment|/*    by driver definition calling `FT_DEFINE_DRIVER' in following.      */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    allocated in the global scope (or the scope where the macro is     */
end_comment
begin_comment
comment|/*    used).                                                             */
end_comment
