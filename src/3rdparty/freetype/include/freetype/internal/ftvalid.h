...
end_comment
begin_comment
comment|/* Use preprocessor prescan to pass FT_ERR_PREFIX.                   */
end_comment
begin_comment
comment|/*                                                                   */
end_comment
...
name|_error
parameter_list|)
value|FT_INVALID_( _prefix, _error )
end_define
begin_define
...
parameter_list|)
define|\
value|ft_validator_error( valid, _prefix ## _error )
end_define
begin_comment
...
define|\
value|FT_INVALID( FT_ERR_PREFIX, Invalid_Table )
end_define
begin_comment
...
define|\
value|FT_INVALID( FT_ERR_PREFIX, Invalid_Offset )
end_define
begin_comment
...
define|\
value|FT_INVALID( FT_ERR_PREFIX, Invalid_Glyph_Index )
end_define
begin_comment
