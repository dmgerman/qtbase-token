...
parameter_list|)
define|\
value|ft_memset( dest, byte, (FT_Offset)(count) )
end_define
begin_define
...
parameter_list|)
define|\
value|ft_memcpy( dest, source, (FT_Offset)(count) )
end_define
begin_define
...
parameter_list|)
define|\
value|ft_memmove( dest, source, (FT_Offset)(count) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_MEM_ZERO( dest,                                     \                        (FT_Offset)(count) * sizeof ( *(dest) ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_MEM_COPY( dest,                                     \                        source,                                   \                        (FT_Offset)(count) * sizeof ( *(dest) ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_MEM_MOVE( dest,                                     \                        source,                                   \                        (FT_Offset)(count) * sizeof ( *(dest) ) )
end_define
begin_comment
