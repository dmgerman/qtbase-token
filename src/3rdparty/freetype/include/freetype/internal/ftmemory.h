...
end_comment
begin_comment
comment|/*  Copyright 1996-2001, 2002, 2004, 2005, 2006, 2007 by                   */
end_comment
begin_comment
...
comment|/*************************************************************************/
comment|/*************************************************************************/
comment|/*    *  C++ refuses to handle statements like p = (void*)anything; where `p'    *  is a typed pointer.  Since we don't have a `typeof' operator in    *  standard C++, we have to use ugly casts.    */
ifdef|#
directive|ifdef
name|__cplusplus
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_alloc( memory, (size),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, 1,        \                                                  (cursz), (newsz), \                                                  (ptr),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_qalloc( memory, (size),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, 1,        \                                                   (cursz), (newsz), \                                                   (ptr),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, sizeof ( *(ptr) ), \                                                   (cursz), (newsz),          \                                                   (ptr),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, (item_size), \                                                  0, (count),          \                                                  NULL,&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, (itmsz),    \                                                  (oldcnt), (newcnt), \                                                  (ptr),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, (item_size), \                                                   0, (count),          \                                                   NULL,&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, (itmsz),    \                                                   (oldcnt), (newcnt), \                                                   (ptr),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, sizeof ( *(ptr) ), \                                                  0, (count),                \                                                  NULL,&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_realloc( memory, sizeof ( *(ptr) ), \                                                  (cursz), (newsz),          \                                                  (ptr),&error ) )
end_define
begin_define
...
parameter_list|)
define|\
value|FT_ASSIGNP_INNER( ptr, ft_mem_qrealloc( memory, sizeof ( *(ptr) ), \                                                   0, (count),                \                                                   NULL,&error ) )
end_define
begin_define
DECL|macro|FT_MEM_QRENEW_ARRAY
define|#
