...
define|#
directive|define
name|FT_POINTER_TO_ULONG
parameter_list|(
name|p
parameter_list|)
value|( (FT_ULong)(FT_Pointer)(p) )
end_define
begin_define
DECL|macro|FTC_FACE_ID_HASH
define|#
directive|define
name|FTC_FACE_ID_HASH
parameter_list|(
name|i
parameter_list|)
define|\
value|((FT_UInt32)(( FT_POINTER_TO_ULONG( i )>> 3 ) ^   \                        ( FT_POINTER_TO_ULONG( i )<< 7 ) ) )
end_define
begin_comment
comment|/*************************************************************************/
end_comment
...
end_comment
begin_comment
comment|/*    If you lookup nodes, you have the ability to `acquire' them, i.e., */
end_comment
begin_comment
comment|/*    to increment their reference count.  This will prevent the node    */
end_comment
begin_comment
comment|/*    from being flushed out of the cache until you explicitly `release' */
end_comment
begin_comment
comment|/*    it (see @FTC_Node_Unref).                                          */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
define|#
directive|define
name|FTC_IMAGE_TYPE_HASH
parameter_list|(
name|d
parameter_list|)
define|\
value|(FT_UFast)( FTC_FACE_ID_HASH( (d)->face_id )  ^ \                       ( (d)->width<< 8 ) ^ (d)->height ^ \                       ( (d)->flags<< 4 )               )
end_define
begin_comment
comment|/*************************************************************************/
end_comment
...
end_comment
begin_comment
comment|/*    A handle to an glyph image cache object.  They are designed to     */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    A simple structure used to describe a given `font' to the cache    */
end_comment
begin_comment
comment|/*    manager.  Note that a `font' is the combination of a given face    */
end_comment
begin_comment
comment|/*    with a given character size.                                       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    face_id    :: The ID of the face to use.                           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    pix_width  :: The character width in integer pixels.               */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    pix_height :: The character height in integer pixels.              */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
parameter_list|)
define|\
value|( (f1)->face_id    == (f2)->face_id&& \             (f1)->pix_width  == (f2)->pix_width&& \             (f1)->pix_height == (f2)->pix_height )
end_define
begin_define
...
parameter_list|)
define|\
value|(FT_UInt32)( FTC_FACE_ID_HASH((f)->face_id) ^ \                        ((f)->pix_width<< 8)          ^ \                        ((f)->pix_height)              )
end_define
begin_typedef
