...
end_comment
begin_comment
comment|/*  Copyright 1996-2001, 2005, 2006 by                                     */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    raster          :: For @FT_GLYPH_FORMAT_OUTLINE renderers only.    */
end_comment
begin_comment
comment|/*                       This is a pointer to the corresponding raster   */
end_comment
begin_comment
comment|/*                       object, if any.                                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
