...
end_comment
begin_comment
comment|/*    units, or 16.16, or 26.6 fixed-point pixel coordinates.            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    FT_PIXEL_MODE_BGRA ::                                              */
end_comment
begin_comment
comment|/*      An image with four 8-bit channels per pixel, representing a      */
end_comment
begin_comment
comment|/*      color image (such as emoticons) with alpha channel.  For each    */
end_comment
begin_comment
comment|/*      pixel, the format is BGRA, which means, the blue channel comes   */
end_comment
begin_comment
comment|/*      first in memory.  The color channels are pre-multiplied and in   */
end_comment
begin_comment
comment|/*      the sRGB colorspace.  For example, full red at half-translucent  */
end_comment
begin_comment
comment|/*      opacity will be represented as `00,00,80,80', not `00,00,FF,80'. */
end_comment
begin_comment
comment|/*      See also @FT_LOAD_COLOR.                                         */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
block|,
DECL|enumerator|FT_PIXEL_MODE_BGRA
...
end_typedef
begin_comment
comment|/* these constants are deprecated; use the corresponding `FT_Pixel_Mode' */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*                    Note that `padding' means the alignment of a       */
end_comment
begin_comment
comment|/*                    bitmap to a byte border, and FreeType functions    */
end_comment
begin_comment
comment|/*                    normally align to the smallest possible integer    */
end_comment
begin_comment
comment|/*                    value.                                             */
end_comment
...
end_comment
begin_comment
comment|/*                    To change the pitch of a bitmap (say, to make it a */
end_comment
begin_comment
comment|/*                    multiple of 4), use @FT_Bitmap_Convert.            */
end_comment
begin_comment
comment|/*                    Alternatively, you might use callback functions to */
end_comment
begin_comment
comment|/*                    directly render to the application's surface; see  */
end_comment
begin_comment
comment|/*                    the file `example2.cpp' in the tutorial for a      */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*                  how to convert/grid-fit it.  See @FT_OUTLINE_XXX.    */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/* `FT_OUTLINE_XXX' values instead                       */
end_comment
begin_define
DECL|macro|ft_outline_none
define|#
...
end_comment
begin_comment
comment|/* specific modules called `renderers'.  See `ftrender.h' for more       */
end_comment
begin_comment
comment|/* details on renderers.                                                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    An opaque handle (pointer) to a raster object.  Each object can be */
end_comment
begin_comment
comment|/*    used independently to convert an outline into a bitmap or pixmap.  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    A structure used to model a single span of gray pixels when        */
end_comment
begin_comment
comment|/*    rendering an anti-aliased bitmap.                                  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    @FT_SpanFunc that takes the y~coordinate of the span as a          */
end_comment
begin_comment
comment|/*    parameter.                                                         */
end_comment
...
end_comment
begin_comment
comment|/*    Deprecated, unimplemented.                                         */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*                              Direct rendering is only possible with   */
end_comment
begin_comment
comment|/*                              anti-aliased glyphs.                     */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/* `FT_RASTER_FLAG_XXX' values instead                   */
end_comment
begin_define
DECL|macro|ft_raster_flag_default
define|#
...
end_comment
begin_comment
comment|/*    black_spans :: Unused.                                             */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    bit_test    :: Unused.                                             */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    bit_set     :: Unused.                                             */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    spans.  This allows direct composition over a pre-existing bitmap  */
end_comment
begin_comment
comment|/*    through user-provided callbacks to perform the span drawing and    */
end_comment
begin_comment
comment|/*    composition.    Not supported by the monochrome rasterizer.        */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    FreeType used to provide an area of memory called the `render      */
end_comment
begin_comment
comment|/*    pool' available to all registered rasters.  This was not thread    */
end_comment
begin_comment
comment|/*    safe however and now FreeType never allocates this pool.  NULL     */
end_comment
begin_comment
comment|/*    is always passed in as pool_base.                                  */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    Rasters should ignore the render pool and rely on dynamic or stack */
end_comment
begin_comment
comment|/*    allocation if they want to (a handle to the memory allocator is    */
end_comment
begin_comment
comment|/*    passed to the raster constructor).                                 */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*         for examples of distinct implementations that support direct  */
end_comment
begin_comment
comment|/*         composition).                                                 */
end_comment
