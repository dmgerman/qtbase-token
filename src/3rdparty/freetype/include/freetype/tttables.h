...
end_comment
begin_comment
comment|/*               be identical except for the names of their fields which */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    A structure used to model a TrueType OS/2 table. This is the long  */
end_comment
begin_comment
comment|/*    table version.  All fields comply to the TrueType specification.   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    Note that we now support old Mac fonts which do not include an     */
end_comment
begin_comment
comment|/*    OS/2 table.  In this case, the `version' field is always set to    */
end_comment
begin_comment
comment|/*    0xFFFF.                                                            */
end_comment
...
end_comment
begin_comment
comment|/*    language ID values are in `freetype/ttnameid.h'.                   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
