...
end_comment
begin_comment
comment|/*    An FT_List iterator function which is called during a list parse   */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    user     :: A user-supplied field which is passed as the second    */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    An @FT_List iterator function which is called during a list        */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    memory  :: The current memory object which handles deallocation.   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    user    :: A user-supplied field which is passed as the last       */
end_comment
begin_comment
