...
end_comment
begin_comment
comment|/*  Copyright 2000-2001, 2003, 2006, 2008 by                               */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/* code resource which should be copied into the application and  */
end_comment
begin_comment
...
comment|/*                                                                       */
comment|/* For emboldened outlines the metrics are estimates only; if you need   */
comment|/* precise values you should call @FT_Outline_Get_CBox.                  */
name|FT_EXPORT
parameter_list|(
name|void
parameter_list|)
