...
comment|/* increased by the strength of the emboldening -- this even affects     */
comment|/* mono-width fonts!                                                     */
comment|/*                                                                       */
comment|/* You can also call @FT_Outline_Get_CBox to get precise values.         */
name|FT_EXPORT
parameter_list|(
name|void
parameter_list|)
