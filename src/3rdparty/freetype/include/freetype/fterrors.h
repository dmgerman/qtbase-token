...
end_comment
begin_comment
comment|/*  Copyright 1996-2001, 2002, 2004, 2007 by                               */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*   with standard builds of FreeType 2).  You can then use the macro    */
end_comment
begin_comment
comment|/*   FT_ERROR_BASE macro to extract the generic error code from an       */
end_comment
begin_comment
comment|/*   FT_Error value.                                                     */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_undef
begin_comment
comment|/* FT_KEEP_ERR_PREFIX is needed for ftvalid.h */
end_comment
begin_ifndef
ifndef|#
directive|ifndef
