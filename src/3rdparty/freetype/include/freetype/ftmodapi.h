...
end_comment
begin_comment
comment|/*    with distinct memory allocators within the same program.  Note,    */
end_comment
begin_comment
comment|/*    however, that the used @FT_Memory structure is expected to remain  */
end_comment
begin_comment
comment|/*    valid for the life of the @FT_Library object.                      */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
