...
comment|/**************************************************************************    *    * @section:    *   quick_advance    *    * @title:    *   Quick retrieval of advance values    *    * @abstract:    *   Retrieve horizontal and vertical advance values without processing    *   glyph outlines, if possible.    *    * @description:    *   This section contains functions to quickly extract advance values    *   without handling glyph outlines, if possible.    */
comment|/*************************************************************************/
comment|/*                                                                       */
comment|/*<Const>                                                               */
...
comment|/*                                                                       */
comment|/*    Typically, glyphs which are either unscaled, unhinted, bitmapped,  */
comment|/*    or light-hinted can have their advance width computed very         */
comment|/*    quickly.                                                           */
comment|/*                                                                       */
comment|/*    Normal and bytecode hinted modes, which require loading, scaling,  */
...
comment|/*    @FT_Face.  By default, the unhinted advance is returned in font    */
comment|/*    units.                                                             */
comment|/*                                                                       */
comment|/*<Input>                                                               */
...
comment|/*<Output>                                                              */
comment|/*    padvance :: The advance value, in either font units or 16.16       */
comment|/*                format.                                                */
comment|/*                                                                       */
...
end_comment
begin_comment
comment|/*    @FT_Face.  By default, the unhinted advances are returned in font  */
end_comment
begin_comment
comment|/*    units.                                                             */
end_comment
...
end_comment
begin_comment
comment|/*    padvance :: The advances, in either font units or 16.16 format.    */
end_comment
begin_comment
comment|/*                This array must contain at least `count' elements.     */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
