...
comment|/*                                                                       */
comment|/*    FT_Orientation                                                     */
comment|/*    FT_Outline_Get_Orientation                                         */
comment|/*                                                                       */
...
comment|/*                                                                       */
comment|/*<InOut>                                                               */
comment|/*    user           :: A typeless pointer that is passed to each        */
...
comment|/*                                                                       */
comment|/*<Note>                                                                */
comment|/*    A contour that contains a single point only is represented by a    */
comment|/*    `move to' operation followed by `line to' to the same point.  In   */
comment|/*    most cases, it is best to filter this out before using the         */
comment|/*    outline for stroking purposes (otherwise it would result in a      */
comment|/*    visible dot when round caps are used).                             */
comment|/*                                                                       */
name|FT_EXPORT
parameter_list|(
name|FT_Error
...
end_comment
begin_comment
comment|/*    numPoints   :: The maximum number of points within the outline.    */
end_comment
begin_comment
comment|/*                   Must be smaller than or equal to 0xFFFF (65535).    */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*    numContours :: The maximum number of contours within the outline.  */
end_comment
begin_comment
comment|/*                   This value must be in the range 0 to `numPoints'.   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    See @FT_Glyph_Get_CBox for a discussion of tricky fonts.           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    @FT_Outline_Get_CBox or @FT_Outline_Get_BBox.                      */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*      if ( face->glyph->format == FT_GLYPH_FORMAT_OUTLINE )            */
end_comment
begin_comment
comment|/*        FT_Outline_Embolden(&face->glyph->outline, strength );        */
end_comment
begin_comment
comment|/*    }                                                                  */
end_comment
...
end_comment
begin_comment
comment|/*    Embolden an outline.  The new outline will be `xstrength' pixels   */
end_comment
begin_comment
comment|/*    wider and `ystrength' pixels higher.  Otherwise, it is similar to  */
end_comment
begin_comment
comment|/*    @FT_Outline_Embolden, which uses the same strength in both         */
end_comment
begin_comment
comment|/*    directions.                                                        */
end_comment
...
end_typedef
begin_comment
comment|/**************************************************************************   *   * @function:   *   FT_Outline_Get_Orientation   *   * @description:   *   This function analyzes a glyph outline and tries to compute its   *   fill orientation (see @FT_Orientation).  This is done by integrating   *   the total area covered by the outline. The positive integral   *   corresponds to the clockwise orientation and @FT_ORIENTATION_POSTSCRIPT   *   is returned. The negative integral corresponds to the counter-clockwise   *   orientation and @FT_ORIENTATION_TRUETYPE is returned.   *   *   Note that this will return @FT_ORIENTATION_TRUETYPE for empty   *   outlines.   *   * @input:   *   outline ::   *     A handle to the source outline.   *   * @return:   *   The orientation.   *   */
end_comment
begin_macro
name|FT_EXPORT
argument_list|(
