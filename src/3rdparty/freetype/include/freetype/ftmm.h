...
end_comment
begin_comment
comment|/*                   allows for intermediate designs to be present.      */
end_comment
begin_comment
comment|/*                   This number cannot exceed~16.                       */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*    axis            :: An axis descriptor table.                       */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    namedstyle      :: A named style table.                            */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/*    num_coords :: The number of available design coordinates.  If it   */
end_comment
begin_comment
comment|/*                  is larger than the number of axes, ignore the excess */
end_comment
begin_comment
comment|/*                  values.  If it is smaller than the number of axes,   */
end_comment
begin_comment
comment|/*                  use default values for the remaining axes.           */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
