...
comment|/*     af_glyph_hints_get_num_segments                                   */
comment|/*     af_glyph_hints_get_segment_offset                                 */
comment|/*                                                                       */
...
comment|/*   https://developer.apple.com/fonts/TrueType-Reference-Manual/RM06/Chap6glyf.html */
comment|/*                                                                       */
...
comment|/*                                                                       */
comment|/* This experimental option is active only if the rendering mode is      */
comment|/* FT_RENDER_MODE_LIGHT; you can switch warping on and off with the      */
comment|/* `warping' property of the auto-hinter (see file `ftautoh.h' for more  */
comment|/* information; by default it is switched off).                          */
comment|/*                                                                       */
