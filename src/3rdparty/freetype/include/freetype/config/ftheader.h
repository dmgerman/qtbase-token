...
directive|define
name|FT_CONFIG_CONFIG_H
value|<freetype/config/ftconfig.h>
end_define
begin_endif
endif|#
directive|endif
...
directive|define
name|FT_CONFIG_STANDARD_LIBRARY_H
value|<freetype/config/ftstdlib.h>
end_define
begin_endif
endif|#
directive|endif
...
directive|define
name|FT_CONFIG_OPTIONS_H
value|<freetype/config/ftoption.h>
end_define
begin_endif
endif|#
directive|endif
...
directive|define
name|FT_CONFIG_MODULES_H
value|<freetype/config/ftmodule.h>
end_define
begin_endif
endif|#
directive|endif
...
directive|define
name|FT_SYNTHESIS_H
value|<freetype/ftsynth.h>
end_define
begin_comment
comment|/*************************************************************************    *    * @macro:    *   FT_FONT_FORMATS_H    *    * @description:    *   A macro used in #include statements to name the file containing the    *   FreeType~2 API which provides functions specific to font formats.    */
end_comment
begin_define
DECL|macro|FT_FONT_FORMATS_H
define|#
directive|define
name|FT_FONT_FORMATS_H
value|<freetype/ftfntfmt.h>
end_define
begin_comment
comment|/* deprecated */
end_comment
...
value|<freetype/internal/internal.h>
end_define
begin_include
include|#
directive|include
