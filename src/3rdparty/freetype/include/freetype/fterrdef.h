...
end_comment
begin_comment
comment|/*   All possible error codes returned by FreeType functions.            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
...
end_comment
begin_comment
comment|/*   The list below is taken verbatim from the file `fterrdef.h'         */
end_comment
begin_comment
comment|/*   (loaded automatically by including `FT_FREETYPE_H').  The first     */
end_comment
begin_comment
comment|/*   argument of the `FT_ERROR_DEF_' macro is the error label; by        */
end_comment
begin_comment
comment|/*   default, the prefix `FT_Err_' gets added so that you get error      */
end_comment
begin_comment
comment|/*   names like `FT_Err_Cannot_Open_Resource'.  The second argument is   */
end_comment
begin_comment
comment|/*   the error code, and the last argument an error string, which is not */
end_comment
begin_comment
comment|/*   used by FreeType.                                                   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*   Within your application you should *only* use error names and       */
end_comment
begin_comment
comment|/*   *never* its numeric values!  The latter might (and actually do)     */
end_comment
begin_comment
comment|/*   change in forthcoming FreeType versions.                            */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
begin_comment
comment|/*   Macro `FT_NOERRORDEF_' defines `FT_Err_Ok', which is always zero.   */
end_comment
begin_comment
comment|/*   See the `Error Enumerations' subsection how to automatically        */
end_comment
begin_comment
comment|/*   generate a list of error strings.                                   */
end_comment
begin_comment
comment|/*                                                                       */
end_comment
