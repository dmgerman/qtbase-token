...
end_define
begin_comment
comment|/* sets otvalid->extra1 (class count) */
end_comment
begin_function
specifier|static
name|void
...
end_function
begin_comment
comment|/* uses otvalid->extra3 (pointer to base table) */
end_comment
begin_function
specifier|static
name|void
...
end_comment
begin_comment
comment|/* sets otvalid->extra3 (pointer to base table) */
end_comment
begin_function
specifier|static
name|void
