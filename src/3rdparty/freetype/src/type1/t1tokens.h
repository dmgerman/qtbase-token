...
end_comment
begin_comment
comment|/*    Type 1 tokenizer (specification).                                    */
end_comment
begin_comment
comment|/*                                                                         */
end_comment
...
end_macro
begin_comment
comment|/* we use pointers to detect modifications made by synthetic fonts */
end_comment
begin_macro
name|T1_FIELD_NUM
argument_list|(
...
argument|unique_id
argument_list|,
argument|T1_FIELD_DICT_FONTDICT | T1_FIELD_DICT_PRIVATE
argument_list|)
end_macro
begin_macro
name|T1_FIELD_NUM
...
directive|define
name|T1CODE
value|T1_FIELD_LOCATION_BLEND
end_define
begin_macro
name|T1_FIELD_NUM_TABLE
argument_list|(
literal|"DesignVector"
argument_list|,
argument|default_design_vector
argument_list|,
argument|T1_MAX_MM_DESIGNS
argument_list|,
argument|T1_FIELD_DICT_FONTDICT
argument_list|)
end_macro
