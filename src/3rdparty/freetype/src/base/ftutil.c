...
name|value2
decl_stmt|;
comment|/*      *  We simply clear the lowest bit in each iteration.  When      *  we reach 0, we know that the previous value was our result.      */
for|for
control|(
init|;
condition|;
