...
end_comment
begin_comment
comment|/*  Copyright 2004-2010, 2013, 2014 by                                     */
end_comment
begin_comment
...
argument_list|(
operator|(
literal|"             : subcount=%d, suboffset=0x%04x\n"
operator|,
name|subcnt
operator|,
name|rpos
...
operator|(
literal|"             [%d]:"
literal|" resource_id=0x%04x, offset=0x%08x\n"
operator|,
name|j
operator|,
name|ref
...
argument_list|(
operator|(
literal|"             -- sort resources by their ids --\n"
operator|)
argument_list|)
expr_stmt|;
for|for
...
argument_list|(
argument|ft_raccess_guess_table
argument_list|,
argument|ft_raccess_guess_rec
argument_list|)
end_macro
begin_macro
name|CONST_FT_RFORK_RULE_ARRAY_ENTRY
argument_list|(
argument|apple_double
argument_list|,
argument|apple_double
argument_list|)
end_macro
...
name|raccess_get_rule_type_from_rule_index
parameter_list|(
name|FT_Library
name|library
parameter_list|,
...
end_function
begin_comment
comment|/*    * For this function, refer ftbase.h.    */
end_comment
begin_macro
