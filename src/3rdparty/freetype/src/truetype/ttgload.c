...
expr_stmt|;
block|}
comment|/* get metrics, horizontal and vertical */
block|{
name|FT_Short
name|left_bearing
init|=
...
literal|1
expr_stmt|;
comment|/* read first glyph header */
name|error
operator|=
name|face
operator|->
...
comment|/* no vertical information within the font (relatively common), make */
comment|/* up some metrics by `hand'...                                      */
block|{
name|FT_Pos
name|top
decl_stmt|;
...
argument_list|(
operator|(
literal|"TT_Load_Glyph: could not access glyph table\n"
operator|)
argument_list|)
expr_stmt|;
return|return
