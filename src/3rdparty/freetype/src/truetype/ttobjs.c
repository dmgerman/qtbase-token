...
name|style_name
decl_stmt|;
comment|/* in `face_index', the instance index starts with value 1 */
name|named_style
operator|=
name|face
operator|->
...
name|Exit
goto|;
comment|/* set style name; if already set, replace it */
if|if
condition|(
name|face
operator|->
...
name|style_name
expr_stmt|;
comment|/* finally, select the named instance */
name|error
operator|=
...
name|max_profile
decl_stmt|;
comment|/* clean up bytecode related data */
name|FT_FREE
argument_list|(
name|size
operator|->
