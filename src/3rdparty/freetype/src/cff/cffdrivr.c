...
argument_list|(
operator|(
literal|"cff_glyph_load: glyph index %d\n"
operator|,
name|glyph_index
operator|)
argument_list|)
...
condition|)
block|{
comment|/* OpenType 1.7 mandates that the data from `hmtx' table be used; */
comment|/* it is no longer necessary that those values are identical to   */
comment|/* the values in the `CFF' table                                  */
name|TT_Face
name|ttface
init|=
operator|(
...
condition|)
block|{
comment|/* check whether we have data from the `vmtx' table at all; */
comment|/* otherwise we extract the info from the CFF glyphstrings  */
comment|/* (instead of synthesizing a global value using the `OS/2' */
comment|/* table)                                                   */
if|if
condition|(
operator|!
...
argument_list|(
operator|(
literal|"  idx %d: advance height %d font units\n"
operator|,
name|start
operator|+
name|nn
...
block|{
comment|/* check whether we have data from the `hmtx' table at all */
if|if
condition|(
operator|!
name|ttface
...
argument_list|(
operator|(
literal|"  idx %d: advance width %d font units\n"
operator|,
name|start
operator|+
name|nn
...
argument|(PS_GetFontValueFunc)  NULL
...
name|sfnt
decl_stmt|;
comment|/* following the OpenType specification 1.7, we return the name stored */
comment|/* in the `name' table for a CFF wrapped into an SFNT container        */
if|if
condition|(
name|sfnt
condition|)
...
argument_list|(
operator|(
literal|"cff_property_set: missing property `%s'\n"
operator|,
name|property_name
operator|)
argument_list|)
...
argument_list|(
operator|(
literal|"cff_property_get: missing property `%s'\n"
operator|,
name|property_name
operator|)
argument_list|)
...
argument_list|(
argument|cff_service_properties
argument_list|,
argument|(FT_Properties_SetFunc)cff_property_set
argument_list|,
argument|(FT_Properties_GetFunc)cff_property_get
argument_list|)
end_macro
begin_comment
comment|/*************************************************************************/
...
argument_list|,
argument|FT_FONT_FORMAT_CFF
argument_list|,
argument|FT_SERVICE_ID_POSTSCRIPT_INFO
argument_list|,
argument|&CFF_SERVICE_PS_INFO_GET
argument_list|,
argument|FT_SERVICE_ID_POSTSCRIPT_FONT_NAME
argument_list|,
argument|&CFF_SERVICE_PS_NAME_GET
argument_list|,
argument|FT_SERVICE_ID_GLYPH_DICT
argument_list|,
argument|&CFF_SERVICE_GLYPH_DICT_GET
argument_list|,
argument|FT_SERVICE_ID_TT_CMAP
argument_list|,
argument|&CFF_SERVICE_GET_CMAP_INFO_GET
argument_list|,
argument|FT_SERVICE_ID_CID
argument_list|,
argument|&CFF_SERVICE_CID_INFO_GET
argument_list|,
argument|FT_SERVICE_ID_PROPERTIES
argument_list|,
argument|&CFF_SERVICE_PROPERTIES_GET
argument_list|)
end_macro
begin_else
else|#
...
name|result
decl_stmt|;
comment|/* CFF_SERVICES_GET dereferences `library' in PIC mode */
ifdef|#
directive|ifdef
...
name|result
return|;
comment|/* `driver' is not yet evaluated in non-PIC mode */
ifndef|#
directive|ifndef
name|FT_CONFIG_OPTION_PIC
if|if
