...
end_comment
begin_comment
comment|/* The `pool' argument makes this function convert the index    */
end_comment
begin_comment
comment|/* entries to C-style strings (this is, NULL-terminated).       */
end_comment
begin_function
specifier|static
name|FT_Error
...
argument_list|(
operator|(
literal|"cff_index_get_pointers:"
literal|" invalid first offset value %d set to zero\n"
operator|,
name|cur_offset
operator|)
argument_list|)
...
block|}
block|}
comment|/* XXX: should check off2 does not exceed the end of this entry; */
comment|/*      at present, only truncate off2 at the end of this stream */
if|if
condition|(
name|off2
operator|>
...
argument_list|(
operator|(
literal|"cff_index_access_element:"
literal|" offset to next entry (%d)"
literal|" exceeds the end of stream (%d)\n"
operator|,
name|off2
operator|,
name|stream
...
end_block
begin_comment
comment|/* get an entry from Name INDEX */
end_comment
begin_macro
name|FT_LOCAL_DEF
argument_list|(
...
end_block
begin_comment
comment|/* get an entry from String INDEX */
end_comment
begin_macro
name|FT_LOCAL_DEF
argument_list|(
...
name|NULL
return|;
comment|/* this is a standard string */
return|return
operator|(
name|FT_String
operator|*
...
argument_list|(
operator|(
literal|"CFF_Load_FD_Select: empty FDSelect array\n"
operator|)
argument_list|)
expr_stmt|;
name|error
...
literal|3
case|:
comment|/* first, compare to the cache */
if|if
condition|(
call|(
name|FT_UInt
...
break|break;
block|}
comment|/* then, look up the ranges array */
block|{
name|FT_Byte
modifier|*
name|p
...
argument_list|(
operator|(
literal|"cff_font_load:"
literal|" invalid subfont index for pure CFF font (%d)\n"
operator|,
name|subfont_index
operator|)
argument_list|)
...
operator|(
literal|"cff_font_load:"
literal|" invalid CFF font with multiple subfonts\n"
literal|"              "
literal|" in SFNT wrapper\n"
operator|)
argument_list|)
expr_stmt|;
name|error
