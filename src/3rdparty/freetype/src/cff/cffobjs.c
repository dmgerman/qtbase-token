...
end_function
begin_comment
comment|/* Strip all subset prefixes of the form `ABCDEF+'.  Usually, there */
end_comment
begin_comment
comment|/* is only one, but font names like `APCOOG+JFABTD+FuturaBQ-Bold'   */
end_comment
begin_comment
comment|/* have been seen in the wild.                                      */
end_comment
begin_function
specifier|static
name|void
DECL|function|remove_subset_prefix
name|remove_subset_prefix
parameter_list|(
name|FT_String
modifier|*
name|name
...
control|)
block|{
comment|/* ASCII uppercase letters */
if|if
condition|(
operator|!
operator|(
...
end_function
begin_comment
comment|/* Remove the style part from the family name (if present). */
end_comment
begin_function
specifier|static
name|void
...
condition|)
block|{
comment|/* family_name ends with style_name; remove it */
name|idx
operator|=
name|family_name_length
operator|-
...
literal|1
expr_stmt|;
comment|/* also remove special characters     */
comment|/* between real family name and style */
while|while
condition|(
name|idx
operator|>
...
argument_list|(
operator|(
literal|"cff_face_init: cannot access `sfnt' module\n"
operator|)
argument_list|)
expr_stmt|;
name|error
...
argument_list|(
operator|(
literal|"  not an OpenType/CFF font\n"
operator|)
argument_list|)
expr_stmt|;
name|error
...
argument_list|)
expr_stmt|;
comment|/* dump string index, including default strings for convenience */
for|for
control|(
name|idx
operator|=
...
name|scaling
decl_stmt|;
comment|/* if we have a top-level matrix, */
comment|/* concatenate the subfont matrix */
if|if
condition|(
name|top
operator|->
...
name|Skip_Unicode
goto|;
comment|/* Apple Unicode platform id? */
if|if
condition|(
name|cmap
operator|->
...
name|module
decl_stmt|;
comment|/* set default property values, cf. `ftcffdrv.h' */
ifdef|#
directive|ifdef
