...
end_comment
begin_comment
comment|/* return number of successfully parsed values               */
end_comment
begin_function
specifier|static
name|FT_Int
...
name|error
decl_stmt|;
comment|/* this might happen in invalid fonts */
if|if
condition|(
operator|!
name|outline
...
argument_list|(
operator|(
literal|"t1_builder_add_contour: no outline to add points to\n"
operator|)
argument_list|)
expr_stmt|;
return|return
