...
end_if
begin_endif
unit|local const char inflate_copyright[] =    " inflate 1.1.4 Copyright 1995-2002 Mark Adler ";
endif|#
directive|endif
end_endif
begin_comment
...
parameter_list|(
comment|/* nl, nd, c, bl, bd, tl, td, hp, z) */
name|uInt
name|nl
parameter_list|,
