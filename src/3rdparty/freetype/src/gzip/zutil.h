begin_unit
begin_comment
comment|/* zutil.h -- internal interface and configuration of the compression library  * Copyright (C) 1995-2002 Jean-loup Gailly.  * For conditions of distribution and use, see copyright notice in zlib.h  */
end_comment
begin_comment
...
parameter_list|)
define|\
value|ft_fopen((name), (mode), "mbc=60", "ctx=stm", "rfm=fix", "mrs=512")
end_define
begin_endif
endif|#
directive|endif
