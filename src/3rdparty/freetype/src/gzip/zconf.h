...
end_endif
begin_comment
comment|/* Old Borland C and LCC incorrectly complains about missing returns: */
end_comment
begin_if
if|#
directive|if
...
name|x
parameter_list|)
value|x __declspec(dllexport) WINAPI
end_define
begin_define
...
name|x
parameter_list|)
value|x __declspec(dllexport) WINAPIV
end_define
begin_else
else|#
directive|else
