...
name|numColors
decl_stmt|;
comment|// The offset (from the start of this structure) to the xDivs& yDivs
comment|// array for this 9patch. To get a pointer to this array, call
comment|// getXDivs or getYDivs. Note that the serialized form for 9patches places
comment|// the xDivs, yDivs and colors arrays immediately after the location
comment|// of the Res_png_9patch struct.
...
block|}
enum|;
comment|// The offset (from the start of this structure) to the colors array
comment|// for this 9patch.
