...
end_define
begin_comment
comment|/*     man 3 pcrejit for a list of supported platforms;     as PCRE 8.35, stable JIT support is available for:     - ARM v5, v7, and Thumb2 (__GNUC__ compilers only)     - x86/x86-64     - MIPS 32bit (__GNUC__ compilers only)     - Power PC 32-bit and 64-bit (__GNUC__ compilers only) */
end_comment
begin_if
if|#
directive|if
