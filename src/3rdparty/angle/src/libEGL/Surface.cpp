...
name|ERR
argument_list|(
literal|"Failed to cast native display pointer to ICoreWindow *."
argument_list|)
expr_stmt|;
return|return
literal|false
...
argument_list|>
name|displayInformationFactory
decl_stmt|;
name|hr
operator|=
name|RoGetActivationFactory
...
name|ERR
argument_list|(
literal|"Failed to get display information."
argument_list|)
expr_stmt|;
return|return
literal|false
...
name|ERR
argument_list|(
literal|"Failed to get extended display information."
argument_list|)
expr_stmt|;
return|return
literal|false
...
name|ERR
argument_list|(
literal|"Failed to get raw pixels per view pixel."
argument_list|)
expr_stmt|;
return|return
literal|false
...
name|ERR
argument_list|(
literal|"Failed to get ICoreWindow bounds."
argument_list|)
expr_stmt|;
return|return
literal|false
