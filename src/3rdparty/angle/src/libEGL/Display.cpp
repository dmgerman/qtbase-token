...
return|;
block|}
comment|//TODO(jmadill): should be part of caps?
name|EGLint
...
block|}
block|}
comment|//TODO(jmadill): shader model is not cross-platform
if|if
condition|(
name|clientVersion
operator|>
...
name|push_back
argument_list|(
literal|"ANGLE_platform_angle_d3d"
argument_list|)
expr_stmt|;
block|}
if|if
...
name|push_back
argument_list|(
literal|"ANGLE_platform_angle_opengl"
argument_list|)
expr_stmt|;
block|}
name|std
...
block|}
decl_stmt|;
comment|//TODO(jmadill): LUID is not cross-platform
if|if
condition|(
name|mRenderer
operator|&&
