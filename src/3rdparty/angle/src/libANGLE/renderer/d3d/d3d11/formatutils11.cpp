...
name|D3D11LoadFunctionMap
name|BuildD3D11_FL9_3_LoadFunctionMap
parameter_list|()
block|{
name|D3D11LoadFunctionMap
name|map
decl_stmt|;
comment|// From GL_EXT_texture_storage. Also used by GL_ALPHA8
comment|// On feature level 9_3, A8_UNORM doesn't support mipmaps, so we must use RGBA8 instead
name|InsertLoadFunction
argument_list|(
operator|&
name|map
...
name|D3D11LoadFunctionMap
name|BuildD3D11_FL10_0Plus_LoadFunctionMap
parameter_list|()
block|{
name|D3D11LoadFunctionMap
name|map
...
name|D3D11LoadFunctionMap
name|BuildBaseD3D11LoadFunctionMap
parameter_list|()
block|{
name|D3D11LoadFunctionMap
name|map
...
comment|// GL_ALPHA8_EXT GL_UNSIGNED_BYTE is in the feature-level-specific load function maps, due to differences between 9_3 and 10_0+
name|InsertLoadFunction
argument_list|(
operator|&
name|map
...
specifier|inline
name|void
name|InsertD3D11FormatInfoBase
parameter_list|(
name|D3D11ES3FormatMap
modifier|*
name|formatMap
...
name|NULL
expr_stmt|;
comment|// Gather all the load functions for this internal format from the base list
specifier|static
specifier|const
name|D3D11LoadFunctionMap
name|loadFunctions
...
block|}
block|}
comment|// Gather load functions for this internal format from the feature-level-specific list
name|D3D11LoadFunctionMap
operator|::
name|const_iterator
name|flLoadFunctionIter
init|=
name|flLoadFunctions
operator|.
name|find
...
specifier|inline
name|void
name|InsertD3D11_FL9_3_FormatInfo
parameter_list|(
name|D3D11ES3FormatMap
modifier|*
name|map
...
specifier|static
name|D3D11ES3FormatMap
name|BuildD3D11_FL9_3FormatOverrideMap
parameter_list|()
block|{
comment|// D3D11 Feature Level 9_3 doesn't support as many texture formats as Feature Level 10_0+.
comment|// In particular, it doesn't support:
comment|//      - mipmaps on DXGI_FORMAT_A8_NORM
comment|//      - *_TYPELESS formats
comment|//      - DXGI_FORMAT_D32_FLOAT_S8X24_UINT or DXGI_FORMAT_D32_FLOAT
name|D3D11ES3FormatMap
name|map
decl_stmt|;
...
condition|)
block|{
comment|// First see if the internalFormat has a special map for FL9_3
name|D3D11ES3FormatMap
operator|::
name|const_iterator
name|fl9_3Iter
