...
name|GetAlphaMaskBlendStateDesc
parameter_list|()
block|{
name|D3D11_BLEND_DESC
name|desc
...
argument_list|)
argument_list|,
literal|"Blit11 3D geometry shader"
argument_list|)
member_init_list|,
...
argument_list|()
argument_list|,
literal|"Blit11 Alpha Mask Blend"
argument_list|)
member_init_list|,
name|mSwizzleCB
argument_list|(
...
argument_list|,
literal|"Failed to create blit vertex buffer, HRESULT: 0x%X"
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to create blit point sampler state, HRESULT: 0x%X"
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to create blit linear sampler state, HRESULT: 0x%X"
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to create blit scissoring rasterizer state, HRESULT: 0x%X"
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to create blit no scissoring rasterizer state, HRESULT: 0x%X"
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to create blit depth stencil state, HRESULT: 0x%X"
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to create blit swizzle buffer, HRESULT: 0x%X"
argument_list|,
name|result
argument_list|)
return|;
...
argument_list|,
literal|"Error compiling internal 2D blit vertex shader"
argument_list|)
return|;
block|}
comment|// Apply shaders
...
comment|// deviceContext->CopySubresourceRegion(dest, destSubresource, 0, 0, 0, destStaging, 0, nullptr);
name|SafeRelease
argument_list|(
name|sourceStaging
argument_list|)
...
name|GL_INVALID_OPERATION
argument_list|,
literal|"Internal blit shader type mismatch"
argument_list|)
return|;
block|}
name|auto
...
name|GL_INVALID_OPERATION
argument_list|,
literal|"Swizzle shader type not found"
argument_list|)
return|;
block|}
name|auto
name|swizzleShaderIt
init|=
name|mSwizzleShaderMap
operator|.
name|find
