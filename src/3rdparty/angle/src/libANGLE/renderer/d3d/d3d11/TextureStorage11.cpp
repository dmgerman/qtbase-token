...
name|miscFlags
operator||=
name|D3D11_RESOURCE_MISC_GENERATE_MIPS
expr_stmt|;
block|}
block|}
return|return
...
name|mSwizzleTexture
argument_list|,
literal|"TexStorage2D.SwizzleTexture"
argument_list|)
expr_stmt|;
block|}
operator|*
...
block|{
comment|// This shouldn't be called unless the zero max LOD workaround is active.
comment|// EGL images are unavailable in this configuration.
name|UNREACHABLE
argument_list|()
expr_stmt|;
return|return
...
name|mSwizzleTexture
argument_list|,
literal|"TexStorageEGLImage.SwizzleTexture"
argument_list|)
expr_stmt|;
block|}
operator|*
...
argument_list|)
expr_stmt|;
comment|// Create a new SRV only for the swizzle texture.  Otherwise just return the Image's
comment|// RenderTarget's SRV.
if|if
condition|(
name|texture
operator|==
...
name|outSRV
argument_list|,
literal|"TexStorageEGLImage.SRV"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|outputTexture
argument_list|,
literal|"TexStorageCube.Texture"
argument_list|)
expr_stmt|;
block|}
return|return
...
name|srv
argument_list|,
literal|"TexStorageCube.RenderTargetSRV"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|rtv
argument_list|,
literal|"TexStorageCube.RenderTargetRTV"
argument_list|)
expr_stmt|;
name|mRenderTarget
index|[
...
name|dsv
argument_list|,
literal|"TexStorageCube.RenderTargetDSV"
argument_list|)
expr_stmt|;
name|mRenderTarget
index|[
...
name|outTexture
argument_list|,
literal|"TexStorageCube.SwizzleTexture"
argument_list|)
expr_stmt|;
block|}
operator|*
...
name|mSwizzleTexture
argument_list|,
literal|"TexStorage3D.SwizzleTexture"
argument_list|)
expr_stmt|;
block|}
operator|*
...
name|mSwizzleTexture
argument_list|,
literal|"TexStorage3D.SwizzleRTV"
argument_list|)
expr_stmt|;
block|}
operator|*
...
name|mTexture
argument_list|,
literal|"TexStorage2DArray.Texture"
argument_list|)
expr_stmt|;
block|}
operator|*
...
name|srv
argument_list|,
literal|"TexStorage2DArray.RenderTargetSRV"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|rtv
argument_list|,
literal|"TexStorage2DArray.RenderTargetRTV"
argument_list|)
expr_stmt|;
name|mRenderTargets
index|[
...
name|outTexture
argument_list|,
literal|"TexStorage2DArray.SwizzleTexture"
argument_list|)
expr_stmt|;
block|}
operator|*
