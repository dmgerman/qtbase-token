...
argument_list|)
expr_stmt|;
comment|// Sampling ops provided by EXT_shader_texture_lod.
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"texture2DLodEXT(1;vf2;f1;"
argument_list|)
expr_stmt|;
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"texture2DProjLodEXT(1;vf3;f1;"
argument_list|)
expr_stmt|;
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"texture2DProjLodEXT(1;vf4;f1;"
argument_list|)
expr_stmt|;
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"textureCubeLodEXT(1;vf4;f1;"
argument_list|)
expr_stmt|;
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"texture2DGradEXT(1;vf2;vf2;vf2;"
argument_list|)
expr_stmt|;
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"texture2DProjGradEXT(1;vf3;vf2;vf2;"
argument_list|)
expr_stmt|;
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"texture2DProjGradEXT(1;vf4;vf2;vf2;"
argument_list|)
expr_stmt|;
name|mSamplingOps
operator|.
name|insert
argument_list|(
literal|"textureCubeGradEXT(1;vf3;vf3;vf3;"
argument_list|)
expr_stmt|;
block|}
end_constructor
