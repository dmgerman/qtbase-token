...
name|out
operator|<<
literal|"modulo second child into first child"
expr_stmt|;
break|break;
case|case
...
name|out
operator|<<
literal|"bit-wise shift first child left by second child"
expr_stmt|;
break|break;
case|case
...
name|out
operator|<<
literal|"bit-wise shift first child right by second child"
expr_stmt|;
break|break;
case|case
...
name|out
operator|<<
literal|"bit-wise and second child into first child"
expr_stmt|;
break|break;
case|case
...
name|out
operator|<<
literal|"bit-wise xor second child into first child"
expr_stmt|;
break|break;
case|case
...
name|out
operator|<<
literal|"bit-wise or second child into first child"
expr_stmt|;
break|break;
case|case
name|EOpIndexDirect
...
literal|"\n"
expr_stmt|;
comment|// Special handling for direct indexes. Because constant
comment|// unions are not aware they are struct indexes, treat them
comment|// here where we have that contextual knowledge.
if|if
condition|(
name|node
operator|->
...
argument_list|)
expr_stmt|;
comment|// The following code finds the field name from the constant union
specifier|const
name|TConstantUnion
modifier|*
name|constantUnion
...
name|out
operator|<<
literal|"arc hyperbolic tangent"
expr_stmt|;
break|break;
case|case
name|EOpExp
...
end_comment
begin_comment
comment|// type of node. Its children will still be processed.
end_comment
begin_comment
comment|//
end_comment
