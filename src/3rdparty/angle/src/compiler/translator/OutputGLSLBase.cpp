...
argument_list|()
decl_stmt|;
comment|// Only for loops can be unrolled
name|ASSERT
argument_list|(
operator|!
name|node
...
name|EbsShared
case|:
comment|// Default block storage is shared.
name|out
operator|<<
literal|"shared"
expr_stmt|;
...
name|EmpColumnMajor
case|:
comment|// Default matrix packing is column major.
name|out
operator|<<
