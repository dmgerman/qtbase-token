...
name|sh
block|{
comment|// Detect Loop Discontinuity
...
return|;
block|}
comment|// The following definitions stop all traversal when we have found a loop
...
return|;
block|}
comment|// Detect Gradient Operation
DECL|function|traverse
name|bool
