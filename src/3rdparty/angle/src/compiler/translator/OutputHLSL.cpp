...
name|out
operator|<<
literal|"float4 gl_texture2DProjLod(Texture2D t, SamplerState s, float3 uvw, float lod)\n"
literal|"{\n"
literal|"    return t.SampleLevel(s, float2(uvw.x / uvw.z, uvw.y / uvw.z), lod);\n"
literal|"}\n"
literal|"\n"
literal|"float4 gl_texture2DProjLod(Texture2D t, SamplerState s, float4 uvw, float lod)\n"
literal|"{\n"
