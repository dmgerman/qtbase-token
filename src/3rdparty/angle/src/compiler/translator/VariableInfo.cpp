...
name|TVariable
modifier|*
name|maxDualSourceDrawBuffersVar
init|=
cast|static_cast
argument_list|<
specifier|const
...
argument_list|)
expr_stmt|;
comment|// Gather field information
for|for
control|(
specifier|const
name|TField
...
condition|)
block|{
comment|// NOTE: we do not determine static use for individual blocks of an array
name|TIntermTyped
modifier|*
name|blockNode
init|=
