...
name|GL_INVALID_OPERATION
argument_list|,
literal|"Cannot bind a transform feedback object that does not exist."
argument_list|)
argument_list|)
expr_stmt|;
return|return;
...
condition|)
block|{
comment|// The 3.0.4 spec [section 6.1.11] states that if ID is zero, IsTransformFeedback
...
argument_list|)
expr_stmt|;
comment|// Current transform feedback must be active and not paused in order to pause (3.0.2 pg 86)
if|if
condition|(
operator|!
name|transformFeedback
...
argument_list|)
expr_stmt|;
comment|// Current transform feedback must be active and paused in order to resume (3.0.2 pg 86)
if|if
condition|(
operator|!
name|transformFeedback
