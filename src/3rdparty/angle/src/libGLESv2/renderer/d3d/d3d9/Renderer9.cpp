...
include|#
directive|include
file|"libGLESv2/renderer/d3d/d3d9/VertexArray9.h"
end_include
begin_include
include|#
directive|include
...
return|;
block|}
comment|// Grab the query data once in blocking and non-blocking case
name|result
operator|=
name|query
operator|->
...
return|;
block|}
comment|// If blocking, loop until the query completes
while|while
condition|(
name|block
operator|&&
