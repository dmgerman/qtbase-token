...
argument_list|,
literal|"Failed to create internal blit vertex shader, result: 0x%X."
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to lock internal blit vertex shader, result: 0x%X."
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to lock internal blit vertex declaration, result: 0x%X."
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to set shader for blit operation, result: 0x%X."
argument_list|,
name|hr
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to blit between textures, StretchRect result: 0x%X."
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to allocate internal texture for blit, result: 0x%X."
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to query surface of internal blit texture, result: 0x%X."
argument_list|,
name|result
argument_list|)
return|;
...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Failed to copy between internal blit textures, result: 0x%X."
argument_list|,
name|result
argument_list|)
return|;
