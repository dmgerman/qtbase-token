...
return|;
block|}
comment|// On Windows 8 systems, IDirect3DSwapChain9::Present sometimes returns 0x88760873 when the windows is
comment|// in the process of entering/exiting fullscreen. This code doesn't seem to have any documentation.  The
comment|// device appears to be ok after emitting this error so simply return a failure to swap.
if|if
condition|(
name|result
operator|==
...
comment|// TODO: remove the AddRef to match SwapChain11
