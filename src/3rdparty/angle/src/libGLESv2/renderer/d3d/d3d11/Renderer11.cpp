...
name|GL_OUT_OF_MEMORY
argument_list|,
literal|"Internal render target pointer unexpectedly null."
argument_list|)
return|;
block|}
name|framebufferRTVs
...
block|}
block|}
comment|// Get the depth stencil render buffter and serials
name|gl
operator|::
name|FramebufferAttachment
modifier|*
