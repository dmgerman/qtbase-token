...
name|rx
operator|::
name|ANGLE_D3D_WORKAROUND_SM3_OPTIMIZER
else|:
name|rx
operator|::
...
operator|)
decl_stmt|;
comment|// The output color is broadcast to all enabled draw buffers when writing to gl_FragColor
specifier|const
name|bool
name|broadcast
init|=
...
name|defined
argument_list|(
name|ANGLE_ENABLE_UNIVERSAL_BINARY
argument_list|)
name|unsigned
name|char
name|commitString
