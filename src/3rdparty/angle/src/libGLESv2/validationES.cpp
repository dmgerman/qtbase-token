...
end_include
begin_comment
comment|// FIXME(jmadill): remove this when we support buffer data caching
end_comment
begin_include
include|#
directive|include
...
return|;
block|}
comment|// Check if this specific format supports enough samples
if|if
condition|(
cast|static_cast
argument_list|<
...
condition|)
block|{
comment|// FIXME(jmadill): Use buffer data caching instead of the D3D back-end
name|rx
operator|::
name|BufferD3D
modifier|*
