...
literal|"  (SELECT sql sql, type type, tbl_name tbl_name, name name"
literal|"     FROM sqlite_master UNION ALL"
literal|"   SELECT sql, type, tbl_name, name FROM sqlite_temp_master) "
...
name|stderr
argument_list|,
literal|"%s: Error: missing argument for option: %s\n"
argument_list|,
name|Argv0
argument_list|,
name|z
