...
ifdef|#
directive|ifdef
name|SQLITE_ENABLE_REGEXP
block|{
specifier|extern
name|int
name|sqlite3_add_regexp_func
argument_list|(
name|sqlite3
operator|*
argument_list|)
...
ifdef|#
directive|ifdef
name|SQLITE_ENABLE_SPELLFIX
block|{
specifier|extern
name|int
name|sqlite3_spellfix1_register
argument_list|(
name|sqlite3
operator|*
argument_list|)
...
literal|"ORDER BY substr(type,2,1), "
literal|" CASE type WHEN 'view' THEN rowid ELSE name END"
argument_list|,
name|callback
argument_list|,
operator|&
