...
name|y_blue
expr_stmt|;
comment|/* The *_checked function handles error reporting, so just return 0 if        * there is a failure here.        */
if|if
condition|(
...
name|iccp_profile
expr_stmt|;
comment|/* Compression_type is a dummy so the API won't have to change        * if we introduce multiple compression types later.        */
operator|*
name|proflen
operator|=
name|info_ptr
...
name|scal_unit
expr_stmt|;
comment|/*TODO: make this work without FP support */
operator|*
name|width
operator|=
name|png_fixed
