...
end_comment
begin_comment
comment|/* Libpng 1.5.10 - March 29, 2012 */
end_comment
begin_comment
comment|/* Copyright (c) 1998-2012 Glenn Randers-Pehrson */
end_comment
begin_comment
...
end_comment
begin_comment
comment|/* If you edit this file by hand you must obey the rules expressed in */
end_comment
begin_comment
comment|/* pnglibconf.dfa with respect to the dependencies between the following */
end_comment
begin_comment
comment|/* symbols.  It is much better to generate a new file using */
end_comment
begin_comment
comment|/* scripts/libpngconf.mak */
end_comment
begin_ifndef
ifndef|#
directive|ifndef
