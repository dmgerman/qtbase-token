...
end_if
begin_comment
comment|/* Remove filler or alpha byte(s) */
end_comment
begin_function
name|void
comment|/* PRIVATE */
...
literal|1
argument_list|,
literal|"in png_do_strip_filler"
argument_list|)
expr_stmt|;
block|{
name|png_bytep
...
condition|)
block|{
comment|/* This converts from RGBX or RGBA to RGB */
if|if
condition|(
name|flags
operator|&
...
block|}
block|}
comment|/* This converts from XRGB or ARGB to RGB */
else|else
block|{
for|for
control|(
...
condition|)
block|{
comment|/* This converts from RRGGBBXX or RRGGBBAA to RRGGBB */
name|sp
operator|+=
literal|8
expr_stmt|;
...
control|)
block|{
comment|/* This could be (although png_memcpy is probably slower):                   png_memcpy(dp, sp, 6);                   sp += 8;                   dp += 6;                   */
operator|*
name|dp
operator|++
operator|=
...
block|{
comment|/* This converts from XXRRGGBB or AARRGGBB to RRGGBB */
for|for
control|(
name|i
operator|=
...
condition|)
block|{
comment|/* This converts from GX or GA to G */
for|for
control|(
name|i
operator|=
...
block|{
comment|/* This converts from XG or AG to G */
for|for
control|(
name|i
operator|=
...
condition|)
block|{
comment|/* This converts from GGXX or GGAA to GG */
name|sp
operator|+=
literal|4
expr_stmt|;
...
block|{
comment|/* This converts from XXGG or AAGG to GG */
for|for
control|(
name|i
operator|=
