...
condition|)
block|{
comment|/* This is here above the if/else case statement below because if the        * unknown handling marks 'IDAT' as unknown then the IDAT handling case is        * completely skipped.        *        * TODO: there must be a better way of doing this.        */
if|if
condition|(
name|png_ptr
operator|->
...
block|}
decl_stmt|;
comment|/* Height of interlace block.  This is not currently used - if you need     * it, uncomment it here and in png.h    static PNG_CONST png_byte FARDATA png_pass_height[] = {8, 8, 4, 4, 2, 2, 1};    */
endif|#
directive|endif
name|png_ptr
operator|->
