...
name|png_ptr
argument_list|,
literal|"XYZ values out of representable range"
argument_list|)
expr_stmt|;
name|png_set_cHRM_fixed
argument_list|(
...
name|png_ptr
argument_list|,
literal|"Out of range gamma value ignored"
argument_list|)
expr_stmt|;
else|else
block|{
...
condition|)
block|{
comment|/* Restore to previous condition */
name|info_ptr
operator|->
name|max_text
operator|=
...
end_ifdef
begin_comment
comment|/* Do not report invalid palette index; added at libng-1.5.10 */
end_comment
begin_function
name|void
name|PNGAPI
