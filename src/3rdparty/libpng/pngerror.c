...
end_comment
begin_comment
comment|/* This function is called when the application wants to use another method  * of handling errors and warnings.  Note that the error function MUST NOT  * return to the calling routine or serious problems will occur.  The return  * method used in the default routine calls longjmp(png_ptr->longjmp_buffer, 1)  */
end_comment
begin_function
name|void
name|PNGAPI
