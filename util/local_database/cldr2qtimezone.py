...
op|':'
op|'['
string|"u'Belarus Standard Time'"
op|','
number|'10800'
op|']'
op|','
...
op|':'
op|'['
string|"u'Eastern Standard Time (Mexico)'"
op|','
op|'-'
number|'18000'
op|']'
...
op|':'
op|'['
string|"u'Line Islands Standard Time'"
op|','
number|'50400'
op|']'
op|','
...
op|':'
op|'['
string|"u'North Korea Standard Time'"
op|','
number|'30600'
op|']'
nl|'\n'
