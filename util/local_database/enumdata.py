...
op|']'
op|','
comment|'# deprecated (alias to "ro_MD")'
nl|'\n'
number|'82'
op|':'
op|'['
...
op|':'
op|'['
string|'"SerboCroatian"'
op|','
string|'"sh"'
op|']'
op|','
comment|'# legacy (alias to "sr_Latn")'
nl|'\n'
number|'102'
op|':'
op|'['
...
op|']'
op|','
comment|'# should be an alias to Akan'
nl|'\n'
number|'128'
op|':'
op|'['
...
op|':'
op|'['
string|'"DemocraticRepublicOfCongo"'
op|','
string|'"CD"'
op|']'
op|','
...
op|':'
op|'['
string|'"DemocraticRepublicOfKorea"'
op|','
string|'"KP"'
op|']'
op|','
...
op|':'
op|'['
string|'"StVincentAndTheGrenadines"'
op|','
string|'"VC"'
op|']'
op|','
