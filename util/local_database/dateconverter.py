...
nl|'\n'
comment|'## No Commercial Usage'
nl|'\n'
comment|'## This file contains pre-release code and may not be distributed.'
nl|'\n'
comment|'## You may use this file in accordance with the terms and conditions'
nl|'\n'
comment|'## contained in the Technology Preview License Agreement accompanying'
nl|'\n'
...
comment|'##'
nl|'\n'
comment|'## If you have questions regarding the use of this file, please contact'
nl|'\n'
comment|'## Nokia at qt-info@nokia.com.'
nl|'\n'
comment|'##'
nl|'\n'
comment|'##'
