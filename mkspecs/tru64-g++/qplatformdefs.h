...
end_if
begin_comment
comment|// Not available in the<unistd.h> header file of Tru64 4.0F.
end_comment
begin_comment
comment|// Fixed in the<unistd.h> header of Tru64 5.0A so we copy/paste from there...
end_comment
begin_extern
extern|extern
literal|"C"
