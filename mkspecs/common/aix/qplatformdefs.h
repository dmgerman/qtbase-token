...
end_comment
begin_comment
comment|// uncomment if you have problems with<sys/proc.h> because your gcc
end_comment
begin_comment
comment|// hasn't been built on exactly the same OS version your are using now.
end_comment
begin_comment
comment|// typedef int crid_t;
end_comment
begin_comment
comment|// typedef unsigned int class_id_t;
end_comment
begin_include
include|#
directive|include
...
end_include
begin_comment
comment|// AIX X11 headers define FD_ZERO using bzero()
end_comment
begin_include
include|#
directive|include
...
end_endif
begin_comment
comment|// Only AIX 4.3 and better support 64-bit
end_comment
begin_define
