...
name|warnOperator
argument_list|(
literal|"in front of AND operator"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|warnOperator
argument_list|(
literal|"in front of OR operator"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|fL1S
argument_list|(
literal|"Excess colon in front of opening brace."
argument_list|)
argument_list|)
expr_stmt|;
name|m_operator
...
name|failOperator
argument_list|(
literal|"in front of opening brace"
argument_list|)
expr_stmt|;
name|flushCond
argument_list|(
...
name|StNew
expr_stmt|;
comment|// Reset possible StCtrl, so colons get rejected.
operator|++
name|m_blockstack
operator|.
name|top
...
name|failOperator
argument_list|(
literal|"in front of closing brace"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|acceptColon
argument_list|(
literal|"in front of assignment"
argument_list|)
expr_stmt|;
name|putLineMarker
argument_list|(
...
name|fL1S
argument_list|(
literal|"Unexpected NOT operator %1."
argument_list|)
operator|.
name|arg
argument_list|(
...
name|fL1S
argument_list|(
literal|"Unexpected AND operator %1."
argument_list|)
operator|.
name|arg
argument_list|(
...
name|fL1S
argument_list|(
literal|"Unexpected OR operator %1."
argument_list|)
operator|.
name|arg
argument_list|(
...
condition|)
block|{
comment|// A colon must be used after else and for() if no brace is used,
comment|// but in this case it is obviously not a binary operator.
if|if
condition|(
name|m_state
operator|==
...
parameter_list|)
define|\
value|do { \         int have = limit - offset; \         if (have< (int)need) { \             *outStr += fL1S("<out of bounds (need %1, got %2)>").arg(need).arg(have); \             return false; \         } \     } while (0)
end_define
begin_function
...
condition|)
break|break;
comment|// Error was already reported, try to continue
if|if
condition|(
name|tmpOff
operator|==
...
name|fL1S
argument_list|(
literal|"/* Warning: Excess tokens follow. */"
argument_list|)
expr_stmt|;
block|}
block|}
...
literal|"TokAppend"
block|,
literal|"TokAppendUnique"
block|,
literal|"TokRemove"
block|,
literal|"TokReplace"
block|,
literal|"TokValueTerminator"
block|,
literal|"TokLiteral"
block|,
literal|"TokHashLiteral"
block|,
literal|"TokVariable"
block|,
literal|"TokProperty"
...
literal|"TokFuncName"
block|,
literal|"TokArgSeparator"
block|,
literal|"TokFuncTerminator"
block|,
literal|"TokCondition"
block|,
literal|"TokTestCall"
block|,
literal|"TokReturn"
...
name|TokFuncTerminator
case|:
comment|// Recursion, but not a sub-block
return|return
literal|true
return|;
case|case
...
name|TokValueTerminator
case|:
comment|// Not recursion
case|case
name|TokTerminator
case|:
comment|// Recursion, and limited by (sub-)block length
case|case
name|TokCondition
case|:
case|case
...
name|TokReplace
case|:
comment|// The parameter is the sizehint for the output.
comment|// fallthrough
case|case
name|TokLine
case|:
