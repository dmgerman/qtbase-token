...
name|fL1S
argument_list|(
literal|"Using uppercased builtin functions is deprecated."
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|fL1S
argument_list|(
literal|"%1(var, prefix) requires one or two arguments."
argument_list|)
operator|.
name|arg
argument_list|(
...
name|args
expr_stmt|;
comment|// It is "safe" to ignore returns - due to qmake brokeness
comment|// they cannot be used to terminate loops anyway.
if|if
condition|(
name|m_cumulative
condition|)
