...
specifier|const
name|char
name|_GUIDDistributionFiles
index|[]
init|=
literal|"{B83CAF91-C7BF-462F-B76C-EA11631F866C}"
decl_stmt|;
end_decl_stmt
begin_expr_stmt
...
specifier|const
name|char
name|_slnProjRelConfTag3
index|[]
init|=
literal|".Release|%1.Deploy.0 = Release|"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
specifier|const
name|char
name|_slnProjDbgConfTag3
index|[]
init|=
literal|".Debug|%1.Deploy.0 = Debug|"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
argument_list|)
expr_stmt|;
comment|// LIBPATH isn't relevant for deployment
if|if
condition|(
name|dllName
operator|.
...
condition|)
continue|continue;
comment|// We want to deploy .dlls not .libs
if|if
condition|(
name|dllName
operator|.
...
argument_list|)
expr_stmt|;
comment|// Use only the file name and check in Qt's install path and LIBPATHs to check for existence
name|dllName
operator|.
name|remove
argument_list|(
...
name|QLatin1String
argument_list|(
literal|"../plugins/platforms/qwindows"
argument_list|)
operator|+
name|debugInfixChar
operator|+
