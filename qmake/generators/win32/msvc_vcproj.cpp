...
specifier|const
name|char
name|_GUIDDeploymentFiles
index|[]
init|=
literal|"{D9D6E243-F8AF-46E4-B9FD-80ECBC20BA3E}"
decl_stmt|;
end_decl_stmt
begin_expr_stmt
...
literal|" none in your PATH. Falling back to lowest version (%s)"
argument_list|,
name|qPrintable
argument_list|(
name|lowestInstalledVersion
...
name|QStringLiteral
argument_list|(
literal|" -list relative -dir \"$(MSBuildProjectDirectory)\" \"$(OutDir)\\$(TargetName).exe\"> "
argument_list|)
operator|+
name|MakefileGenerator
operator|::
...
name|isActiveConfig
argument_list|(
literal|"autogen_wmappmanifest"
argument_list|)
condition|)
return|return;
comment|// autogen_wmappmanifest
name|QFile
name|file
argument_list|(
name|Option
...
operator|<<
literal|"<Deployment xmlns=\"http://schemas.microsoft.com/windowsphone/2012/deployment\" AppPlatformVersion=\"8.0\">\n"
operator|<<
literal|"<DefaultLanguage xmlns=\"\" code=\"en-US\"/>\n"
operator|<<
literal|"<App xmlns=\"\" ProductID=\""
operator|<<
name|productID
operator|<<
literal|"\" Title=\""
...
name|target
operator|<<
literal|"\" RuntimeType=\"Modern Native\" Version=\"1.0.0.0\""
operator|<<
literal|" Genre=\"apps.normal\"  Author=\""
operator|<<
name|author
operator|<<
literal|"\" Description=\""
...
literal|"\">\n"
operator|<<
literal|"<IconPath IsRelative=\"true\" IsResource=\"false\">ApplicationIcon.png</IconPath>\n"
operator|<<
literal|"<Capabilities>\n"
operator|<<
literal|"<Capability Name=\"ID_CAP_NETWORKING\" />\n"
operator|<<
literal|"<Capability Name=\"ID_CAP_MEDIALIB_AUDIO\" />\n"
operator|<<
literal|"<Capability Name=\"ID_CAP_MEDIALIB_PLAYBACK\" />\n"
operator|<<
literal|"</Capabilities>\n"
operator|<<
literal|"<Tasks>\n"
operator|<<
literal|"<DefaultTask Name=\"_default\" ImagePath=\""
operator|<<
name|target
operator|<<
literal|".exe\" ImageParams=\"\" />\n"
operator|<<
literal|"</Tasks>\n"
operator|<<
literal|"<Tokens>\n"
operator|<<
literal|"<PrimaryToken TokenID=\""
operator|<<
name|target
operator|<<
literal|"Token\" TaskName=\"_default\">\n"
operator|<<
literal|"<TemplateType5>\n"
operator|<<
literal|"<Count>0</Count>\n"
operator|<<
literal|"<Title>"
operator|<<
name|target
...
literal|"</TemplateType5>\n"
operator|<<
literal|"</PrimaryToken>\n"
operator|<<
literal|"</Tokens>\n"
operator|<<
literal|"<ScreenResolutions>\n"
operator|<<
literal|"<ScreenResolution Name=\"ID_RESOLUTION_WVGA\" />\n"
operator|<<
literal|"<ScreenResolution Name=\"ID_RESOLUTION_WXGA\" />\n"
operator|<<
literal|"<ScreenResolution Name=\"ID_RESOLUTION_HD720P\" />\n"
operator|<<
literal|"</ScreenResolutions>\n"
operator|<<
literal|"</App>\n"
