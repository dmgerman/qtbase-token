...
name|stderr
argument_list|,
literal|"Failed to find the Visual Studio 2012 installation directory.\n"
literal|"Is it installed?.\n"
argument_list|)
expr_stmt|;
return|return
literal|false
...
name|QStringLiteral
argument_list|(
literal|"/../../Windows Phone Kits/8.0"
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|stderr
argument_list|,
literal|"Failed to find the Windows Phone Kit in %s.\n"
literal|"Check that it is properly installed.\n"
argument_list|,
name|qPrintable
argument_list|(
...
name|stderr
argument_list|,
literal|"Failed to find the Windows Kit in %s.\n"
literal|"Check that it is properly installed.\n"
argument_list|,
name|qPrintable
argument_list|(
