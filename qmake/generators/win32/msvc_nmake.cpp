...
argument_list|)
expr_stmt|;
comment|// ### Investigate why VS uses 10056 first
name|incDirs
operator|<<
name|kitDir
operator|+
name|QStringLiteral
argument_list|(
literal|"Include/10.0.10056.0/ucrt"
argument_list|)
expr_stmt|;
name|incDirs
operator|<<
...
name|QStringLiteral
argument_list|(
literal|"Include/10.0.10069.0/ucrt"
argument_list|)
expr_stmt|;
name|incDirs
operator|<<
...
name|QStringLiteral
argument_list|(
literal|"Include/10.0.10069.0/um"
argument_list|)
expr_stmt|;
name|incDirs
operator|<<
...
name|QStringLiteral
argument_list|(
literal|"Include/10.0.10069.0/shared"
argument_list|)
expr_stmt|;
name|incDirs
operator|<<
...
name|QStringLiteral
argument_list|(
literal|"Include/10.0.10069.0/winrt"
argument_list|)
expr_stmt|;
name|libDirs
operator|<<
