...
name|QStringLiteral
argument_list|(
literal|"Software\\Microsoft\\VisualStudio\\"
argument_list|)
operator|+
name|msvcVer
operator|+
...
name|windowsPath
operator|=
literal|"Software\\Microsoft\\Microsoft SDKs\\WindowsPhoneApp\\v"
expr_stmt|;
block|}
else|else
block|{
name|windowsPath
operator|=
literal|"Software\\Microsoft\\Microsoft SDKs\\Windows\\v"
expr_stmt|;
block|}
name|regKey
operator|=
...
condition|)
block|{
comment|// Add the compiler's PDB file.
name|QString
name|pdbfile
init|=
name|var
...
argument_list|)
expr_stmt|;
comment|// Add the linker's PDB file to the distclean target.
name|project
operator|->
name|values
argument_list|(
