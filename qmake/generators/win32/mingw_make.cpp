...
argument_list|)
condition|)
comment|// Fallback for unresolved -l libs.
return|return
name|QLatin1String
argument_list|(
literal|"-l"
...
argument_list|)
condition|)
comment|// Lib search path. Needed only by -l above.
return|return
name|QLatin1String
argument_list|(
literal|"-L"
...
argument_list|)
condition|)
comment|// Fallback for unresolved MSVC-style libs.
return|return
name|QLatin1String
argument_list|(
literal|"-l"
...
parameter_list|)
block|{
comment|// Skip MSVC handling from Win32MakefileGenerator
return|return
name|MakefileGenerator
operator|::
name|parseLibFlag
