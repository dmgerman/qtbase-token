...
specifier|const
name|char
name|_CompileAsWinRT
index|[]
init|=
literal|"CompileAsWinRT"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
specifier|const
name|char
name|_GenerateWindowsMetadata
index|[]
init|=
literal|"GenerateWindowsMetadata"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
specifier|const
name|char
name|_ImageHasSafeExceptionHandlers
index|[]
init|=
literal|"ImageHasSafeExceptionHandlers"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
specifier|const
name|char
name|_WindowsMetadataFile
index|[]
init|=
literal|"WindowsMetadataFile"
decl_stmt|;
end_decl_stmt
begin_decl_stmt
...
name|tagValue
argument_list|(
literal|"MinimumVisualStudioVersion"
argument_list|,
name|tool
operator|.
name|Version
...
literal|"XapFilename"
argument_list|,
literal|"$(RootNamespace)_$(Configuration)_$(Platform).xap"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|tagValue
argument_list|(
literal|"AppContainerApplication"
argument_list|,
literal|"true"
argument_list|)
operator|<<
...
argument_list|,
literal|"Windows Store"
argument_list|)
operator|<<
name|tagValue
argument_list|(
literal|"ApplicationTypeRevision"
argument_list|,
name|tool
operator|.
name|SdkVersion
...
name|QStringLiteral
argument_list|(
literal|"Package.appxmanifest"
argument_list|)
decl_stmt|;
comment|// Find all icons referenced in the manifest
name|QSet
argument_list|<
name|QString
argument_list|>
...
name|regexp
argument_list|(
literal|"[\\\\/a-zA-Z0-9_\\-\\!]*\\.(png|jpg|jpeg)"
argument_list|)
decl_stmt|;
name|int
name|pos
...
block|}
block|}
comment|// Write out manifest + icons as content items
name|xml
operator|<<
name|tag
argument_list|(
...
literal|"Project"
argument_list|,
literal|"$(MSBuildExtensionsPath)\\Microsoft\\WindowsPhone\\v8.0\\Microsoft.Cpp.WindowsPhone.8.0.targets"
argument_list|)
expr_stmt|;
name|xml
operator|<<
...
operator|::
name|xml_output
name|fixedProgramDataBaseFileNameOutput
parameter_list|(
specifier|const
...
condition|)
block|{
comment|// Force the creation of an empty tag to work-around Visual Studio bug. See QTBUG-35570.
return|return
name|tagValue
argument_list|(
name|_ProgramDataBaseFileName
...
name|QStringLiteral
argument_list|(
literal|"PopulateWinDeployQtItems_"
argument_list|)
operator|+
name|tool
operator|.
