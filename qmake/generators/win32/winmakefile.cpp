...
name|ret
return|;
comment|// MSVC compatibility. This should be deprecated.
if|if
condition|(
name|flag
operator|.
...
return|;
block|}
comment|// These are pure qmake inventions. They *really* should be deprecated.
if|if
condition|(
name|flag
operator|.
...
block|}
block|}
comment|// We assume if it never finds it that it's correct
name|found
label|:
empty_stmt|;
block|}
