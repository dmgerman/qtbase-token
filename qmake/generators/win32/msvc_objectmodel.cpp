...
name|WarnLogic
argument_list|,
literal|"Could not parse %s option '%s'; added to AdditionalOptions."
argument_list|,
name|tool
argument_list|,
name|option
...
name|WarnLogic
argument_list|,
literal|"You can suppress these warnings with CONFIG+=suppress_vcproj_warnings."
argument_list|)
expr_stmt|;
block|}
block|}
