...
argument_list|)
expr_stmt|;
comment|// Escape from make and the shell
block|}
elseif|else
if|if
condition|(
...
name|stderr
argument_list|,
literal|"Error: This platform does not support relative paths in QMAKE_RPATHDIR (%s)\n"
argument_list|,
name|rpathdir
operator|.
name|toLatin1
...
name|values
argument_list|(
literal|"QMAKE_LFLAGS_REL_RPATH"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
goto|goto
name|foundPrecompiledDependency
goto|;
block|}
block|}
name|foundPrecompiledDependency
