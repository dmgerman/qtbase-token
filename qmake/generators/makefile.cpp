...
end_function
begin_comment
comment|// Manipulate directories, so it's possible to build
end_comment
begin_comment
comment|// several cross-platform targets concurrently
end_comment
begin_function
name|void
...
name|QString
argument_list|(
literal|"QMAKE_LIBS_QT"
argument_list|)
block|,
name|QString
argument_list|(
literal|"QMAKE_LIBS_QT_THREAD"
argument_list|)
block|,
name|QString
argument_list|(
literal|"QMAKE_LIBS_QT_ENTRY"
argument_list|)
block|,
name|QString
argument_list|()
...
condition|)
block|{
comment|// In sbsv2 the command inputs and outputs need to use absolute paths
name|cmd
operator|=
name|replaceExtraCompilerVariables
argument_list|(
...
name|values
argument_list|(
literal|"QMAKE_INTERNAL_QMAKE_DEPS"
argument_list|)
operator|.
name|indexOf
argument_list|(
...
directive|if
literal|0
block|if(!spec.isEmpty())         return spec;
endif|#
directive|endif
name|spec
operator|=
