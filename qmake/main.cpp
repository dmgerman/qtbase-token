...
name|stderr
argument_list|,
literal|"Error: unrecognized ln option '%s'\n"
argument_list|,
name|argv
index|[
name|i
...
name|stderr
argument_list|,
literal|"Error: this ln requires exactly two file arguments\n"
argument_list|)
expr_stmt|;
return|return
literal|3
...
name|stderr
argument_list|,
literal|"Error: this ln supports faking symlinks only\n"
argument_list|)
expr_stmt|;
return|return
literal|3
...
name|stderr
argument_list|,
literal|"Error: destination directory %s does not exist\n"
argument_list|,
name|qPrintable
argument_list|(
name|destdir
...
name|stderr
argument_list|,
literal|"Error: this ln does not support symlinking non-existing targets\n"
argument_list|)
expr_stmt|;
return|return
literal|3
...
name|stderr
argument_list|,
literal|"Error: this ln does not support symlinking directories\n"
argument_list|)
expr_stmt|;
return|return
literal|3
...
name|stderr
argument_list|,
literal|"Error: cannot overwrite %s\n"
argument_list|,
name|qPrintable
argument_list|(
name|lfi
...
name|stderr
argument_list|,
literal|"Error: cannot copy %s to %s\n"
argument_list|,
name|qPrintable
argument_list|(
name|tfi
