...
end_function
begin_comment
comment|// defined in symbian generator
end_comment
begin_function_decl
specifier|extern
name|QString
...
name|stderr
argument_list|,
literal|"%s:%d: generate_uid(var) requires one argument.\n"
argument_list|,
name|parser
operator|.
name|file
...
name|stderr
argument_list|,
literal|"%s:%d: resolve_depends(var, prefix) requires one or two arguments.\n"
argument_list|,
name|parser
operator|.
name|file
