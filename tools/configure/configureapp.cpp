...
break|break;
block|}
comment|// External location of ANGLE library  (Open GL ES 2)
block|}
elseif|else
if|if
condition|(
...
name|cout
operator|<<
literal|"Argument passed to -angle option is not a directory."
operator|<<
name|endl
expr_stmt|;
name|dictionary
...
literal|"-angle<dir>"
argument_list|,
literal|"Use ANGLE library from location<dir>.\n"
argument_list|)
expr_stmt|;
if|#
directive|if
...
parameter_list|)
block|{
comment|// "Link" configured mkspec to default directory, but remove the old one first, if there is any
name|QString
name|defSpec
init|=
name|buildPath
...
name|cout
operator|<<
literal|"Couldn't update default "
operator|<<
name|pfx
operator|<<
literal|"mkspec! Are files in "
operator|<<
name|qPrintable
argument_list|(
name|defSpec
...
name|spec
decl_stmt|;
comment|// We copied it to the build dir
name|fileStream
operator|<<
...
name|fileStream
operator|<<
literal|"include($$QMAKESPEC_ORIGINAL/qmake.conf)"
operator|<<
name|endl
expr_stmt|;
name|qfile
...
expr_stmt|;
block|}
comment|//create default mkspecs
name|QString
name|spec
init|=
name|dictionary
...
name|cout
operator|<<
literal|"Error installing default mkspecs"
operator|<<
name|endl
operator|<<
name|endl
