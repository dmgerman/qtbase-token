...
name|cout
operator|<<
literal|"ERROR: invalid C++ standard "
operator|<<
name|level
operator|<<
...
argument_list|)
operator|==
literal|"-system-doubleconversion"
condition|)
name|dictionary
index|[
literal|"DOUBLECONVERSION"
...
argument_list|)
operator|==
literal|"-no-headersclean"
condition|)
block|{
name|dictionary
index|[
literal|"HEADERSCLEAN"
index|]
operator|=
literal|"no"
expr_stmt|;
...
argument_list|)
operator|==
literal|"-no-android-style-assets"
condition|)
block|{
name|dictionary
index|[
literal|"ANDROID_STYLE_ASSETS"
index|]
operator|=
literal|"no"
expr_stmt|;
...
name|desc
argument_list|(
literal|"You may use these to change the layout of the install. Note that all directories\n"
literal|"except -sysconfdir should be located under -prefix/-hostprefix:\n\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-use-gold-linker"
argument_list|,
literal|"Link using the GNU gold linker (gcc only)."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-no-use-gold-linker"
argument_list|,
literal|"Do not link using the GNU gold linker.\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-enable-new-dtags"
argument_list|,
literal|"Use new DTAGS for RPATH (Linux only)."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-disable-new-dtags"
argument_list|,
literal|"Do not use new DTAGS for RPATH.\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-static-runtime"
argument_list|,
literal|"Statically link the C/C++ runtime library.\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-no-pch"
argument_list|,
literal|"Do not use precompiled header support."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-pch"
argument_list|,
literal|"Use precopmiled header support.\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-no-doubleconversion"
argument_list|,
literal|"Use sscanf_l and snprintf_l for (imprecise) double conversion."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-qt-doubleconversion"
argument_list|,
literal|"Use the libdouble-conversion bundled with Qt."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-system-doubleconversion"
argument_list|,
literal|"Use the libdouble-conversion provided by the system."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-no-avx512"
argument_list|,
literal|"Do not compile with use of AVX512 instructions."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-avx512"
argument_list|,
literal|"Compile with use of AVX512 instructions.\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-no-ssl"
argument_list|,
literal|"Do not compile support for SSL."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-ssl"
argument_list|,
literal|"Enable run-time SSL support."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-no-libproxy"
argument_list|,
literal|"Do not compile in libproxy support."
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-libproxy"
argument_list|,
literal|"Compile in libproxy support (for cross compilation targets).\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
literal|"-directwrite"
argument_list|,
literal|"Build support for DirectWrite font rendering.\n"
argument_list|)
expr_stmt|;
name|desc
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// Ensures at least the June 2010 DXSDK is present
if|if
condition|(
operator|!
name|findFile
...
block|}
decl_stmt|;
comment|// try AVX512 Foundation. No Foundation, nothing else works.
if|if
condition|(
operator|!
name|tryCompileProject
argument_list|(
literal|"common/avx512"
argument_list|,
literal|"AVX512=F"
argument_list|)
condition|)
...
name|buildPath
operator|+
literal|"/config.tests/common/c++default/c++default.ii"
argument_list|)
decl_stmt|;
if|if
condition|(
...
name|cout
operator|<<
literal|"Could not determine the C++ standard the compiler uses by default, assuming C++98."
operator|<<
name|endl
expr_stmt|;
name|dictionary
...
block|{
comment|// On Desktop Windows openssl and ssl always have the same value (for now). OpenSSL is
comment|// the only backend and if it is available and should be built, that also means that
comment|// SSL support in general is enabled.
if|if
condition|(
name|dictionary
index|[
...
literal|"no"
expr_stmt|;
comment|// Detection of tslib support
if|if
condition|(
name|dictionary
index|[
...
name|cout
operator|<<
literal|"WARNING: It is not possible to change the C++ standard edition with MSVC compilers. "
literal|"Therefore, the option -c++std "
operator|<<
name|dictionary
index|[
literal|"C++STD"
...
name|cout
operator|<<
literal|"ERROR: -static-runtime requires -static"
operator|<<
name|endl
operator|<<
name|endl
...
name|cout
operator|<<
literal|"ERROR: Qt cannot be compiled with Visual Studio 2008 or 2010."
operator|<<
name|endl
expr_stmt|;
name|prompt
...
name|cout
operator|<<
literal|"ERROR: Option -no-opengl is not valid for WinRT."
operator|<<
name|endl
expr_stmt|;
name|dictionary
...
name|cout
operator|<<
literal|"WARNING: Bundled FreeType can't be used."
literal|"  FontConfig use requires system FreeType."
operator|<<
name|endl
expr_stmt|;
name|dictionary
...
name|cout
operator|<<
literal|"WARNING: FreeType can't be disabled."
literal|"  FontConfig use requires system FreeType."
operator|<<
name|endl
expr_stmt|;
...
name|qmakeVars
operator|+=
literal|"CONFIG -= precompile_header"
expr_stmt|;
if|if
condition|(
name|dictionary
...
name|append
argument_list|(
literal|" QMAKE_CXXFLAGS+=--sysroot="
operator|+
name|sysroot
argument_list|)
expr_stmt|;
...
name|sourcePath
operator|+
literal|"/config.tests/arch/arch"
operator|+
operator|(
name|data
operator|.
...
name|deviceStream
operator|<<
literal|"    DEFAULT_ANDROID_NDK_HOST = "
operator|<<
name|dictionary
index|[
literal|"ANDROID_HOST"
...
name|tmpStream
operator|<<
literal|"#define QT_VERSION_MAJOR    "
operator|<<
name|dictionary
index|[
literal|"VERSION_MAJOR"
...
name|endl
operator|<<
literal|"#define QT_VERSION_MINOR    "
operator|<<
name|dictionary
index|[
literal|"VERSION_MINOR"
...
name|endl
operator|<<
literal|"#define QT_VERSION_PATCH    "
operator|<<
name|dictionary
index|[
literal|"VERSION_PATCH"
...
name|tmpStream
operator|<<
literal|"#define QT_COMPILER_SUPPRTS_"
operator|<<
name|avx512feature
operator|.
name|toUpper
...
name|tmpStream
operator|<<
literal|"#define QT_COORD_TYPE_STRING "
operator|<<
name|dictionary
index|[
literal|"QREAL_STRING"
...
name|qconfigList
operator|<<
literal|"QT_NO_SYSTEMSEMAPHORE"
operator|<<
literal|"QT_NO_SHAREDMEMORY"
expr_stmt|;
if|if
condition|(
name|dictionary
...
name|formatConfigPath
argument_list|(
literal|"QT_REL_INSTALL_HEADERS"
argument_list|)
operator|<<
name|endl
expr_stmt|;
...
name|formatConfigPath
argument_list|(
literal|"QT_REL_INSTALL_ARCHDATA"
argument_list|)
operator|<<
name|endl
expr_stmt|;
...
name|formatConfigPath
argument_list|(
literal|"QT_REL_INSTALL_PLUGINS"
argument_list|)
operator|<<
name|endl
expr_stmt|;
...
name|formatConfigPath
argument_list|(
literal|"QT_REL_INSTALL_LIBEXECS"
argument_list|)
operator|<<
name|endl
expr_stmt|;
...
name|formatConfigPath
argument_list|(
literal|"QT_REL_INSTALL_IMPORTS"
argument_list|)
operator|<<
name|endl
expr_stmt|;
...
name|formatConfigPath
argument_list|(
literal|"QT_REL_INSTALL_TRANSLATIONS"
argument_list|)
operator|<<
name|endl
expr_stmt|;
...
name|formatConfigPath
argument_list|(
literal|"QT_REL_INSTALL_EXAMPLES"
argument_list|)
operator|<<
name|endl
expr_stmt|;
...
name|endl
operator|<<
literal|"NOTE:  -optimized-tools is not useful in -release mode."
operator|<<
name|endl
expr_stmt|;
block|}
...
name|option
operator|+
literal|" is not a subdirectory of "
operator|+
name|varmod
index|[
name|i
...
condition|)
block|{
comment|// If QT_INSTALL_* have not been specified on the command line,
comment|// default them here, unless prefix is empty (WinCE).
if|if
condition|(
name|dictionary
index|[
...
name|dictionary
index|[
literal|"QT_REL_INSTALL_ARCHDATA_PREFIX"
index|]
operator|=
name|dictionary
index|[
...
name|dictionary
index|[
literal|"QT_REL_INSTALL_DATA_PREFIX"
index|]
operator|=
name|dictionary
index|[
...
name|endl
operator|<<
literal|"static const char qt_configure_host_prefix_path_str  [512 + 12] = \"qt_hpfxpath="
operator|<<
name|dictionary
index|[
literal|"QT_HOST_PREFIX"
...
name|endl
operator|<<
literal|"static const short qt_configure_str_offsets[] = {\n"
operator|<<
literal|"    "
operator|<<
name|confStrOffsets
...
literal|"};\n"
operator|<<
literal|"static const char qt_configure_strs[] =\n"
operator|<<
name|confStrings
index|[
literal|0
...
literal|"#ifdef QT_BUILD_QMAKE\n"
operator|<<
literal|"# define QT_CONFIGURE_SYSROOTIFY_PREFIX "
operator|<<
operator|(
name|sysrootifyPrefix
condition|?
