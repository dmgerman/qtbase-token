...
end_function
begin_comment
comment|/*  Things that affect the Qt API/ABI:    Options:      minimal-config small-config medium-config large-config full-config     Options:      debug release      stl   Things that do not affect the Qt API/ABI:      system-jpeg no-jpeg jpeg      system-png no-png png      system-zlib no-zlib zlib      system-tiff no-tiff tiff      no-gif gif      dll staticlib       nocrosscompiler      GNUmake      largefile      nis      nas      tablet       X11     : x11sm xinerama xcursor xfixes xrandr xrender fontconfig xkb      Embedded: embedded freetype */
end_comment
begin_function
