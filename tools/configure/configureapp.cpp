...
name|QString
argument_list|(
literal|"%1/bin/qmake.exe -spec %2 %3/config.tests/arch/arch.pro -o %4/Makefile.unused 2>&1"
argument_list|)
operator|.
name|arg
argument_list|(
...
condition|)
continue|continue;
comment|// strip everything up to and including 'Project MESSAGE: '
name|QString
name|ProjectMESSAGE
init|=
name|QStringLiteral
argument_list|(
literal|"Project MESSAGE: "
argument_list|)
decl_stmt|;
name|int
name|at
...
argument_list|)
expr_stmt|;
comment|// strip lines beginning with a #
name|at
operator|=
literal|0
expr_stmt|;
...
condition|)
block|{
comment|// # isnt' at the beginning of a line, skip it
operator|++
name|at
expr_stmt|;
continue|continue;
