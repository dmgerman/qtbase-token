...
include|#
directive|include
file|<QtGui/QSplitter>
end_include
begin_include
include|#
directive|include
file|<QtGui/QScrollArea>
end_include
begin_include
include|#
directive|include
file|<QtGui/QAbstractButton>
end_include
begin_include
include|#
directive|include
file|<QtGui/QAbstractItemView>
end_include
begin_include
include|#
directive|include
...
end_destructor
begin_comment
comment|/*!     \fn QWidget *QAbstractFormBuilder::load(QIODevice *device, QWidget *parent)      Loads an XML representation of a widget from the given \a device,     and constructs a new widget with the specified \a parent.      \sa save() */
end_comment
begin_function
DECL|function|load
name|QWidget
...
end_function
begin_comment
comment|// Return the buttongroups assigned to a button except the internal one
end_comment
begin_comment
comment|// (with empty object name) used by Q3ButtonGroup.
end_comment
begin_function
...
argument_list|()
operator|<<
literal|"QAbstractFormBuilder::nameToIcon() is obsoleted"
expr_stmt|;
return|return
name|QIcon
argument_list|()
...
argument_list|()
operator|<<
literal|"QAbstractFormBuilder::iconToFilePath() is obsoleted"
expr_stmt|;
return|return
name|QString
argument_list|()
...
argument_list|()
operator|<<
literal|"QAbstractFormBuilder::iconToQrcPath() is obsoleted"
expr_stmt|;
return|return
name|QString
argument_list|()
...
argument_list|()
operator|<<
literal|"QAbstractFormBuilder::nameToPixmap() is obsoleted"
expr_stmt|;
return|return
name|QPixmap
argument_list|()
...
argument_list|()
operator|<<
literal|"QAbstractFormBuilder::pixmapToFilePath() is obsoleted"
expr_stmt|;
return|return
name|QString
argument_list|()
...
argument_list|()
operator|<<
literal|"QAbstractFormBuilder::pixmapToQrcPath() is obsoleted"
expr_stmt|;
return|return
name|QString
argument_list|()
